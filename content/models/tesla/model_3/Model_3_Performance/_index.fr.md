...
description: "Tesla Model 3 Performance est une berline entièrement électrique avec une autonomie de WLTP allant jusqu'à 547 km (340 miles). EVKX.net a tous les détails."
weight: 10
hidden: true
shownavtabs: true
...
Le Tesla Model 3 Performance a une puissance maximale de 393 KW (534 ch/527 ch). Le couple total est de 660 nm (487 ft-lb). Il effectue le sprint de 0 à 100 km/h (0 à 62 mph) en 3,3 secondes. La vitesse maximale est de 261 km/h.
...
Tesla Model 3 Performance dispose de plusieurs fonctionnalités pour rendre votre vie de conducteur ou de passager plus confortable.
...
Le Tesla Model 3 Performance dispose d'un [**système de freinage antiblocage (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/) comme un standard. Ce système permet d'éviter le blocage des roues d'un véhicule lors du freinage.

Le Tesla Model 3 Performance dispose d'un [**Contrôle électronique de stabilité**](../../../../technology/driverassistance/electronicstabilitycontrol/) comme un standard système conçu pour améliorer la stabilité et la maniabilité d'un véhicule lors de manœuvres brusques ou de routes glissantes.
...
Le Tesla Model 3 Performance propose [l'automatisation de la conduite au niveau 2 ou 3](../../../../technology/driverassistance/#level-of-autonomous-driving ), selon le niveau d'équipement.
