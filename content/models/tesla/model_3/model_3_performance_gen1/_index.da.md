...
description: "Tesla Model 3 Performance (GEN1) er en fuldelektrisk sedan med en WLTP rækkevidde på op til 547 km (340 miles). EVKX.net har alle detaljerne."
weight: 10
hidden: true
shownavtabs: true
...
Vi har opdelt vores Tesla Model 3 Performance (GEN1) artikel i sektioner. Hvis du vil vente med at læse hele artiklen, skal du klikke på nedenstående links til de forskellige områder. Vi har også en oversigt over de [fulde specifikationer](specifications/), et [billedgalleri](gallery/), detaljerede oplysninger om [opladningsydelse](chargingcurve/), og nogle [online anmeldelser](reviews/). Vores sektioner:
...
Tesla Model 3 Performance (GEN1) leverer en solid præstation med en maksimal effekt på 377 kW (513 hk) og et totalt drejningsmoment på 660 Nm. Den kan accelerere fra 0 til 100 km/t på 3,4 sekunder og når en topfart på 261 km/t, hvilket gør den konkurrencedygtig i sin klasse.
...
Ifølge [WLTP](../../../../guides/understandingrange/wltp/) (Worldwide Harmonized Light Vehicles Test Procedure) standarden er bilens rækkevidde 547 km, med et energiforbrugsrate på 13,7 kWh/100 km. For mere detaljerede virkelige data og rækkeviddeoplysninger, henvises til modellens dedikerede [rækkevidde- og forbrugsside.](rangeandconsumption/)

Den maksimale DC-opladningshastighed er 250kW. En fuld opladning fra 0 - 100 % ville tage 69 minutter, mens et mere almindeligt scenarie på 10-80 % ville tage 33 minutter. Hvis du antager, at du mister 5 minutters kørsel pr. ladestop ud over opladningstiden, er det optimale opladningsområde fra 5% til 43%, hvilket resulterer i en faktisk opladningshastighed, inklusive tidstab på 116kW. Hver opladningssession ville tage 15 minutter og 45 sekunder.

I en teoretisk 1000 km udfordring, der starter med et fuldt batteri og opretholder en konstant hastighed på 120 km/t under ideelle forhold med et antaget forbrug på 17,5 kWh/100 km, ville turen tage cirka 9 timer og 13 minutter. Denne rejse ville kræve to opladningsstop fra 5% til 39%, med en samlet opladningstid på 53 minutter
...
Dynamisk styring er en standard-funktion på Tesla Model 3 Performance (GEN1). Dynamisk styring varierer styreforholdet som en funktion af kørehastigheden.
...
Den Tesla Model 3 Performance (GEN1), med dimensioner på 4694 mm i længde, 1849 mm i bredde og 1443 mm i højde, tilhører D-segmentet af biler, også kendt som mellemstore eller familiebiler. Disse biler tilbyder mere plads, komfort og funktioner end mindre segmenter og er velegnede til forskellige førere. Tesla Model 3 Performance (GEN1) fås i alt 5 lakfarver, herunder både solide og metalliske muligheder.
...
Tesla Model 3 Performance (GEN1) har plads til fem passagerer med to sæder foran og en tre-personers bænk bagtil.

#### Første række sæder

Tesla Model 3 Performance (GEN1) tilbyder kun én type forreste sæde.
...
Tesla Model 3 Performance (GEN1) inkluderer flere funktioner, der forbedrer komfort og bekvemmelighed:
...
Én type lydsystem er tilgængelig for Tesla Model 3 Performance (GEN1).
...
Den Tesla Model 3 Performance (GEN1) inkluderer flere standard- og valgfri [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) for at forbedre sikkerhed og komfort.

### Sikkerhedssystemer

[**Anti-lock Bremsesystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Tesla Model 3 Performance (GEN1), dette system forhindrer hjulene i at låse under opbremsning.

[**Electronic Stability Control (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Tesla Model 3 Performance (GEN1), dette system forbedrer bilens stabilitet og håndtering under pludselige manøvrer eller på glatte vejforhold.
...
[**Front Cross Traffic Assist (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/): Standard på Tesla Model 3 Performance (GEN1), dette førerassistentsystem hjælper føreren med at opdage modkørende trafik ved krydsning af et kryds eller ved sving til venstre eller højre fra en stopposition.

[**Forward Collision Warning (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Tesla Model 3 Performance (GEN1), dette førerassistentsystem hjælper føreren med at undgå eller formilde frontale kollisioner.

[**Automatisk nødbremsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Tesla Model 3 Performance (GEN1), dette system anvender bremserne autonomt for at forhindre eller reducere alvoren af en kollision, hvis føreren ikke reagerer i tide.
...
[**Blind-spot Monitoring (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard på Tesla Model 3 Performance (GEN1), dette sideassistentsystem hjælper med at registrere trafik i døde vinkler.
...
Tesla Model 3 Performance (GEN1) er udstyret med avancerede sikkerhedsfunktioner for at beskytte dig og dit køretøj. Disse inkluderer:
