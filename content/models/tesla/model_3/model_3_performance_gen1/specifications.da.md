---
title: Tesla Model 3 Performance (GEN1) specifikationer
linktitle: "Specifikationer"
description: "EVKX.net giver dig de fulde specifikationer for Tesla Model 3 Performance (GEN1)."
weight: 4
hidden: true
...
EVKX.net søger at have de mest komplette specifikationer for Tesla Model 3 Performance (GEN1). Klik på billedet ovenfor for [fuld artikel](../), besøg [billedgalleriet](../gallery/) for billeder i høj opløsning af Tesla Model 3 Performance (GEN1), besøg [chargeinfo](../chargingcurve/) for Tesla Model 3 Performance (GEN1) med chargecurve, se [extended range info](../rangeandconsumption/) for real world ranges.
