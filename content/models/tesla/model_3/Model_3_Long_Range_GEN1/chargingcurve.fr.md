---
title: Courbe de charge et performance de Tesla Model 3 Long Range (GEN1)
linktitle: "Courbe de charge"
description: "Ci-dessous se trouve la courbe de charge pour Tesla Model 3 Long Range (GEN1), illustrant la vitesse de charge à différents niveaux de batterie. De plus, des graphiques pour l'autonomie et le temps fournissent des détails complets sur les performances de charge."
weight: 3
hidden: true
...
Tesla Model 3 Long Range (GEN1) dispose d'un chauffage de batterie, facilitant la charge à une température optimale de la batterie.
