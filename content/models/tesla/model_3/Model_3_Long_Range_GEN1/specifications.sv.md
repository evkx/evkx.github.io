---
title: Tesla Model 3 Long Range (GEN1) Specifikationer
linktitle: "Specifikationer"
description: "EVKX.net ger dig alla specifikationer för Tesla Model 3 Long Range (GEN1)."
weight: 4
hidden: true
...
EVKX.net vill ha de mest kompletta specifikationerna för Tesla Model 3 Long Range (GEN1). Klicka på bilden ovan för [fullständig artikel](../), besök [bildgalleri](../gallery/) för hög upplösningsbilder av Tesla Model 3 Long Range (GEN1), gå till [chargeinfo](../chargingcurve/) för Tesla Model 3 Long Range (GEN1) med laddningskurva, se [extended range info](../rangeandconsumption/) för verkliga räckvidd.
