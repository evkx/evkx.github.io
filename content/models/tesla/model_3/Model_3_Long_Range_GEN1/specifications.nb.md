...
EVKX.net søker å ha de mest komplette spesifikasjonene for Tesla Model 3 Long Range (GEN1). Klikk på bildet ovenfor for [full artikkel](../), besøk [bildegalleriet](../gallery/) for høyoppløselige bilder av Tesla Model 3 Long Range (GEN1), gå til [chargeinfo](../chargingcurve/) for Tesla Model 3 Long Range (GEN1) med ladekurve, se [extended range info](../rangeandconsumption/) for real world ranges.
