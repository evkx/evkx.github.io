...
title: Tesla Model 3
linktitle: "Model 3"
description: "Tesla Model 3 är en helelektrisk sedan med en räckvidd på WLTP på upp till 513 km. EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Tesla Model 3 har en maximal effekt på 208 KW (283hk). Totalt vridmoment är 420 Nm. Den gör sprinten 0-100 km/h på 6,1 sekunder. Topphastigheten är 225 km/h.
...
[WLTP-intervall](../../../../guides/understandingrange/wltp/) är 513 km. Förbrukningen är 11.5kWh/100 km för WLTP-standardtestet. För mer information om sortimentet, se verkliga data och räckvidd på denna modells sida [rangeandconsumption](rangeandconsumption/).
...
Tesla Model 3 har flera funktioner för att göra ditt liv som förare eller passagerare bekvämare.
...
Tesla Model 3 har en enda skärm. Dashboardcentret har en enda [infotainment-skärm](../../../../technology/userinterface/screens/#infotainment-screen) för bilinformation och infotainment. Skärmen  i mitten av instrumentbrädan är 15.0 tum och har en upplösning på 2200 x 1300 pixlar.
...
Tesla Model 3 har ett [**ABS-bromssystem**](../../../../technology/driverassistance/antilockbrakingsystem/) som standard-systemet. Detta system hjälper till att förhindra att ett fordons hjul låser sig under inbromsning.

Tesla Model 3 har ett [**elektronisk stabilitetskontroll**](../../../../technology/driverassistance/electronicstabilitycontrol/) vilket standard-system är utformat för att förbättra ett fordons stabilitet och hantering under plötsliga manövrar eller halt väglag.

Tesla Model 3 har en [**filhållningsassistent**](../../../../technology/driverassistance/lanekeepingassist/) som standard-system. Detta system bidrar för att förhindra att bilen lämnar körfältet. Dessutom har den ett [**filavvikelsevarning**](../../../../technology/driverassistance/lanedeparturewarning/) system som varnar föraren om fordonet lämnar körfältet.
...
Tesla Model 3 har [**automatisk nödbroms**](../../../../technology/driverassistance/automaticemergencybraking/) som standard-system. Detta system hjälper till att förhindra eller mildra kollisioner genom att ansätta bromsarna autonomt om föraren inte reagerar på en förestående kollision.
...
Tesla Model 3 erbjuder [nivå 2 eller 3 körautomation](../../../../technology/driverassistance/#level-of-autonomous-driving), beroende på utrustningsnivå.
...
Lastutrymmets kapacitet är 593 liter. På taket kan du lasta upp till 70 kg. Bilens maximala vikt är 2149 kg, och med basvikten på 1760 kg kan du lasta maximalt 389 kg, inklusive förare och passagerare. Vissa utrustningsalternativ kan öka basvikten och minska den maximala lastvikten.
