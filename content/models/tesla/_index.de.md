...
Tesla Cybertruck ist ein Pickup-Truck, der in 2 Varianten erhältlich ist.
</p>
	<a href="cybertruck/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
...
Tesla Model 3 ist eine Limousine, die in 6 Varianten erhältlich ist.
    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Tesla Model S ist eine Limousine, die in 3 Varianten erhältlich ist.
</p>
	<a href="model_s/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Tesla Model X ist ein SUV, der in 3 Varianten erhältlich ist.
</p>
	<a href="model_x/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Tesla Model Y ist ein Coupé-SUV, das in 4 Varianten erhältlich ist.
</p>
	<a href="model_y/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
        </div>
