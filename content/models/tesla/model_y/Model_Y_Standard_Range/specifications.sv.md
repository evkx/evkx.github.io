---
title: Tesla Model Y Standard Range Specifikationer
linktitle: "Specifikationer"
description: "EVKX.net ger dig alla specifikationer för Tesla Model Y Standard Range."
weight: 4
hidden: true
...
EVKX.net vill ha de mest kompletta specifikationerna för Tesla Model Y Standard Range. Klicka på bilden ovan för [fullständig artikel](../), besök [bildgalleri](../gallery/) för hög upplösningsbilder av Tesla Model Y Standard Range, gå till [chargeinfo](../chargingcurve/) för Tesla Model Y Standard Range med laddningskurva, se [extended range info](../rangeandconsumption/) för verkliga räckvidd.
