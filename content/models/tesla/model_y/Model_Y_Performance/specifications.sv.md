---
title: Tesla Model Y Performance Specifikationer
linktitle: "Specifikationer"
description: "EVKX.net ger dig alla specifikationer för Tesla Model Y Performance."
weight: 4
hidden: true
...
EVKX.net vill ha de mest kompletta specifikationerna för Tesla Model Y Performance. Klicka på bilden ovan för [fullständig artikel](../), besök [bildgalleri](../gallery/) för hög upplösningsbilder av Tesla Model Y Performance, gå till [chargeinfo](../chargingcurve/) för Tesla Model Y Performance med laddningskurva, se [extended range info](../rangeandconsumption/) för verkliga räckvidd.
