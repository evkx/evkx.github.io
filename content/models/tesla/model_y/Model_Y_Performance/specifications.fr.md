---
title: Tesla Model Y Performance spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Tesla Model Y Performance."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Tesla Model Y Performance. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Tesla Model Y Performance, visitez les [chargeinfo](../chargecurve/) pour Tesla Model Y Performance avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
