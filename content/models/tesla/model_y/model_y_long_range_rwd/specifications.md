---
title: Tesla Model Y Long Range RWD specifications
linktitle: "Specifications"
description: "EVKX.net gives you the full specifications for Tesla Model Y Long Range RWD."
weight: 4
hidden: true
...
EVKX.net seeks to have the most complete specifications for Tesla Model Y Long Range RWD. Click on image above for [full article](../), visit the [image gallery](../gallery/) for high-res images of Tesla Model Y Long Range RWD, visit the [chargeinfo](../chargingcurve/) for Tesla Model Y Long Range RWD with chargecurve, vist [extended range info](../rangeandconsumption/) for real world ranges.
