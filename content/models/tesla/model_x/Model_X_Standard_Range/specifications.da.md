---
title: Tesla Model X Standard Range specifikationer
linktitle: "Specifikationer"
description: "EVKX.net giver dig de fulde specifikationer for Tesla Model X Standard Range."
weight: 4
hidden: true
...
EVKX.net søger at have de mest komplette specifikationer for Tesla Model X Standard Range. Klik på billedet ovenfor for [fuld artikel](../), besøg [billedgalleriet](../gallery/) for billeder i høj opløsning af Tesla Model X Standard Range, besøg [chargeinfo](../chargingcurve/) for Tesla Model X Standard Range med chargecurve, se [extended range info](../rangeandconsumption/) for real world ranges.
	...
	<tbody>
		<tr>
			...
			<td>
				Pearl White (Hvid)</br>
				Solid Black (Sort)</br>
				Midnight Silver Metallic (Sølv)</br>
				Deep Blue Metallic (Sølv)</br>
				Red Multi-Coat (Rød)</br>
			</td>
		</tr>
	</tbody>
</table>
