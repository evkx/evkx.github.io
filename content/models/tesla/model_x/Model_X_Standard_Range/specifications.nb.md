...
EVKX.net søker å ha de mest komplette spesifikasjonene for Tesla Model X Standard Range. Klikk på bildet ovenfor for [full artikkel](../), besøk [bildegalleriet](../gallery/) for høyoppløselige bilder av Tesla Model X Standard Range, gå til [chargeinfo](../chargingcurve/) for Tesla Model X Standard Range med ladekurve, se [extended range info](../rangeandconsumption/) for real world ranges.
