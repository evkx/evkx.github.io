...
EVKX.net søker å ha de mest komplette spesifikasjonene for Tesla Model X. Klikk på bildet ovenfor for [full artikkel](../), besøk [bildegalleriet](../gallery/) for høyoppløselige bilder av Tesla Model X, gå til [chargeinfo](../chargingcurve/) for Tesla Model X med ladekurve, se [extended range info](../rangeandconsumption/) for real world ranges.
