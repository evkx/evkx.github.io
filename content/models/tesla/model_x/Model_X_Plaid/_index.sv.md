...
description: "Tesla Model X Plaid är en helelektrisk SUV med en räckvidd på WLTP på upp till 543 km. EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Tesla Model X Plaid har en maximal effekt på 760 KW (1033hk). Totalt vridmoment är 1020 Nm. Den gör sprinten 0-100 km/h på 2,6 sekunder. Topphastigheten är 262 km/h.
...
Tesla Model X Plaid har ett fyrhjulsdriftssystem som stöds av tre motorer. En på framaxeln och två på bakaxeln. Motorerna som används är [induktionsmotorer](../../../../technology/motors/asm/) på framaxeln och [Permanent Magnet Synchronous Motors] (../../../../technology/motors/pmsm/) på bakaxeln.
...
Tesla Model X Plaid erbjuder [nivå 2 eller 3 körautomation](../../../../technology/driverassistance/#level-of-autonomous-driving), beroende på utrustningsnivå.
