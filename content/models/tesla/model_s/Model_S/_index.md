...
We have separated our description of Tesla Model S into sections. If you do not want to read the full article now, you can click on the links below to the different areas. We also have an overview of the [full specifications](specifications), an [image gallery](gallery), detailed information about [charging performance](chargingcurve), and some [online reviews](reviews). Our sections:
...
The Tesla Model S has a maximum power of 760KW (1033hp). The total torque is 493nm. The 0-100km/h sprint (0-62mph) is performed in 2,1 seconds. The top speed is 322 kph. 

## Battery, range, and charging

The battery has a gross capacity of 100kWh and a net capacity of 96kWh, meaning you have a 4kWh buffer for protection. (4,0%). Depending on car options, the [WLTP range](../../../../guides/understandingrange/wltp) varies from 649 to 634 km (403-394 mi). Bigger wheels are an example of an equipment option that increases consumption and reduces the electric range.   The consumption is between 14,8kWh/100km for the basic version and 15,1kWh/100km for the top trim version for the WLTP standard test. 
...
For the theoretical 1000km challenge, starting with a full battery and driving at 120km/h (75 mph), assuming optimal driving conditions and consumption of 20,5kWh/100km, 1000km will take 9 hours and 6 minutes to drive. This will requires three charge sessions charging from 8% to 46%. The total time lost for charging will be 46 minutes.   
### Onboard charger
...
Tesla Model S has an all-wheel drive system supported by two motors. One on each axle. 
...
Dynamic steering is standard on Tesla Model S. Dynamic steering varies the steering ratio as a function of driving speed. 
...
The Tesla Model S has a **lane-keeping** assistant as a standard system. This system helps to prevent the car from getting out of its lane. In addition, the system warns the driver if the vehicle leaves the driving lane.

**Side/blind spot assist** is a standard driver assist system. This side assist system helps to detect traffic in blind spots. 
### Driving Automation

The Tesla Model S offers driving automation on level 2 or 3, depending on the equipment level. 
