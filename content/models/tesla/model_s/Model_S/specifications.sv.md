...
description: "EVKX.net ger dig alla specifikationer för Tesla Model S."
weight: 4
hidden: true
...
EVKX.net vill ha de mest kompletta specifikationerna för Tesla Model S. Klicka på bilden ovan för [fullständig artikel](../), besök [bildgalleri](../gallery/) för hög upplösningsbilder av Tesla Model S, gå till [chargeinfo](../chargingcurve/) för Tesla Model S med laddningskurva, se [extended range info](../rangeandconsumption/) för verkliga räckvidd.
