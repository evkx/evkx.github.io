...
description: "Tesla Model S Plaid är en helelektrisk sedan med en räckvidd på WLTP på upp till 600 km. EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Tesla Model S Plaid har en maximal effekt på 760 KW (1033hk). Totalt vridmoment är 1420 Nm. Den gör sprinten 0-100 km/h på 2,1 sekunder. Topphastigheten är 322 km/h.
...
För den teoretiska 1000km-utmaningen, att börja med fullt batteri och köra i 120km/h (75 mph), förutsatt optimala körförhållanden och förbrukning på 21,0kWh/100km, tar 1000km 9 timmar och 8 minuter. Den här resan kommer att kräva tre laddningssession(er) laddning från 7% till 47%. Total tid som går förlorad för att ladda batteriet kommer att vara 48 minuter.

### Inbyggd laddare

För nivå 1 och nivå 2 AC-laddning stöder  inbyggd laddare upp till 11KW-laddning. Som ett resultat kan du ladda batteriet 0-100 % hemifrån på ca. 8 timmar och 43 minuter.
...
Endast en typ av framsäte är tillgänglig i Tesla Model S Plaid.
...
Tesla Model S Plaid har flera funktioner för att göra ditt liv som förare eller passagerare bekvämare.
...
En typ av ljudsystem är tillgänglig för Tesla Model S Plaid. Med Tesla Premium Sound får du 22 högtalare med en maximal systemeffekt på 560 watt.
...
Tesla Model S Plaid har ett [**ABS-bromssystem**](../../../../technology/driverassistance/antilockbrakingsystem/) som standard-systemet. Detta system hjälper till att förhindra att ett fordons hjul låser sig under inbromsning.

Tesla Model S Plaid har ett [**elektronisk stabilitetskontroll**](../../../../technology/driverassistance/electronicstabilitycontrol/) vilket standard-system är utformat för att förbättra ett fordons stabilitet och hantering under plötsliga manövrar eller halt väglag.
...
Tesla Model S Plaid har [**automatisk nödbroms**](../../../../technology/driverassistance/automaticemergencybraking/) som standard-system. Detta system hjälper till att förhindra eller mildra kollisioner genom att ansätta bromsarna autonomt om föraren inte reagerar på en förestående kollision.
