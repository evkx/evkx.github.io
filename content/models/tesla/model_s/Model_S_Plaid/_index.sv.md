...
description: "Tesla Model S Plaid är en helelektrisk sedan med en WLTP räckvidd på upp till 600 km. EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Tesla Model S Plaid levererar en häpnadsväckande maximal effekt på 760 KW (1033 hk) och ett massivt vridmoment på 1420 Nm. Denna kraftmaskin kan accelerera från 0 till 100 km/h på bara 2,1 sekunder, vilket visar på dess fantastiska acceleration. Dessutom uppnår den en topphastighet på 322 km/h, vilket gör den till ett verkligt ingenjörsmässigt och prestandamässigt underverk.
...
I en teoretisk 1000 km-utmaning, med en fulladdad batteri och en konstant hastighet på 120 km/h (75 mph) under ideala förhållanden med en antagen förbrukning på 21,0 kWh/100 km, skulle resan ta ungefär 9 timmar och 9 minuter. Denna resa skulle kräva två laddningsstopp från 9% till 47%, med en total laddningstid på 49 minuter.
...
Tesla Model S Plaid har ett fyrhjulsdriftssystem som stöds av tre motorer. En på framaxeln och två på bakaxeln. Motorerna som används är [Permanent Magnet Synchronous Motors](../../../../technology/motors/pmsm/).
...
Dynamisk styrning är standard-funktionen för Tesla Model S Plaid. Dynamisk styrning varierar styrförhållandet som en funktion av körhastigheten.
...
Tesla Model S Plaid rymmer fem passagerare med två säten fram och en tre-sitsig bänk bak.
...
Tesla Model S Plaid inkluderar flera funktioner för att förbättra komfort och bekvämlighet:
...
Tesla Model S Plaid har dubbla skärmar med förar- och passagerarinformation och en tredje bakre skärm för multimedia.
...
Tesla Model S Plaid är utrustad med en enda typ av ratt:
...
En typ av ljudsystem är tillgänglig för Tesla Model S Plaid.
...
Tesla Model S Plaid inkluderar flera [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) som standard och som tillval för att förbättra säkerheten och komforten.

### Säkerhetssystem

[**Låsningsfria bromsar (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Tesla Model S Plaid, detta system förhindrar att hjulen låser sig under bromsning.

[**Elektronisk Stabilitetskontroll (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Tesla Model S Plaid, detta system förbättrar fordonets stabilitet och hantering vid plötsliga manövrer eller på hala vägar.
...
[**Frontkorsningstrafikassist (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/): Standard på Tesla Model S Plaid, detta förarassistanssystem hjälper till att upptäcka mötande trafik vid korsningar eller vid svängning till vänster eller höger från en stillastående position.

[**Framåt Kollisionsvarning (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Tesla Model S Plaid, detta förarassistanssystem hjälper till att undvika eller mildra frontalkollisioner.

[**Automatisk nödbromsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Tesla Model S Plaid, detta system bromsar autonomt för att förhindra eller minska allvaret av en kollision om föraren inte reagerar i tid.
...
[**Blindspotsövervakning (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard på Tesla Model S Plaid, detta sidostödssystem hjälper till att upptäcka trafik i döda vinklar.

### Körautomatisering

Tesla Model S Plaid erbjuder [körautomatisering på nivå 2 eller 3](../../../../technology/driverassistance/#level-of-autonomous-driving), beroende på utrustningsnivå.
