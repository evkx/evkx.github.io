...
Maserati GranCabrio es un convertible de lujo disponible en 1 variantes.
    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Maserati GranTurismo es un coupé de lujo disponible en 1 variantes.
</p>
	<a href="granturismo/" class="btn btn-outline-primary" role="button">Ir a la información del modelo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
