...
Maserati GranCabrio is a luxury convertible available in 1 variants.
</p>
	<a href="grancabrio/" class="btn btn-outline-primary" role="button">Go to model info</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Maserati GranTurismo is a luxury coupe available in 1 variants.
</p>
	<a href="granturismo/" class="btn btn-outline-primary" role="button">Go to model info</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
