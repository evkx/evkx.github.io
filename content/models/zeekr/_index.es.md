...
Zeekr 001 es una camioneta disponible en 4 variantes.
    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Zeekr 007 es un sedán disponible en 1 variantes.
</p>
	<a href="007/" class="btn btn-outline-primary" role="button">Ir a la información del modelo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
...
Zeekr 7X es un SUV disponible en 1 variantes.
    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Zeekr X es un crossover disponible en 2 variantes.
</p>
