...
description: "Zeekr X Long Range RWD es un crossover eléctrico con una autonomía WLTP de hasta 440 km (274 millas). EVKX.net tiene todos los detalles."
weight: 10
hidden: true
shownavtabs: true
...
El Zeekr X Long Range RWD ofrece un rendimiento modesto con una potencia máxima de 200 kW (272 hp / 268 bhp) y un par total de 343 Nm (253 lb-ft). Acelera de 0 a 100 km/h (0 a 62 mph) en 5,6 segundos y alcanza una velocidad máxima de 180 km/h (112 mph), alineándose más con los vehículos tradicionales de motor de combustión interna.

## Batería, Autonomía y Carga

La batería de alta capacidad tiene una capacidad bruta de 69,0 kWh y una capacidad neta utilizable de 64,0 kWh, proporcionando un buffer de 5,0 kWh (7,2%) para la protección de la batería. Esta batería de iones de litio utiliza tecnología [NMC (Níquel Manganeso Cobalto)](../../../../technology/battery/cellchemistry/#lithium-nickel-manganese-cobalt-oxides-nmc).

Según el estándar [WLTP](../../../../guides/understandingrange/wltp/) (Procedimiento de Prueba de Vehículos Ligeros Armonizado a Nivel Mundial), la autonomía del vehículo es de 440 km (274 millas), con una tasa de consumo de energía de 14,5 kWh/100 km (3 mi/kWh). Para más detalles sobre la autonomía, consulte los datos del mundo real y las listas de autonomía en la página de [autonomía y consumo](rangeandconsumption/) de este modelo.

El vehículo admite carga rápida DC con una potencia máxima de 150 kW. Cargar del 0% al 100% toma aproximadamente 84 minutos, mientras que un escenario más típico del 10% al 80% toma 32 minutos con una velocidad de carga promedio de 85 kW. Considerando 5 minutos adicionales para cada parada de carga debido a interrupciones de conducción, el rango de carga óptimo es del 5% al 54%. Esto resulta en una velocidad de carga efectiva, incluyendo el tiempo perdido, de 88 kW, con cada sesión de carga tomando aproximadamente 21 minutos y 19 segundos.

En un desafío de 1000 km a una velocidad constante de 120 km/h (75 mph) con una tasa de consumo asumida de 26 kWh/100 km, el viaje tomaría aproximadamente 10 horas y 34 minutos, requiriendo siete paradas de carga del 5% al 49%, totalizando 135 minutos de tiempo de carga.

### Cargador a Bordo

El cargador a bordo estándar admite hasta 22 kW para carga AC de Nivel 1 y Nivel 2, permitiendo una carga completa del 0 al 100% en aproximadamente 2 horas y 54 minutos usando una configuración doméstica.
...
El Zeekr X Long Range RWD tiene un sistema de tracción trasera soportado por un motor en el eje trasero.
...
El Zeekr X Long Range RWD está equipado con [frenos de disco de hierro fundido](../../../../technology/brakes/#disc-brakes) tanto en la parte delantera como en la trasera. Los discos delanteros miden 350 mm, mientras que los discos traseros son de 333 mm.
...
El Zeekr X Long Range RWD, con dimensiones de 4432 mm de longitud, 1836 mm de ancho y 1566 mm de altura, pertenece al segmento de coches B-SUV, también conocidos como SUV subcompactos o crossovers, que ofrecen una combinación del tamaño compacto y la maniobrabilidad de los coches del segmento B con la posición de conducción más alta, mayor espacio de carga y estilo robusto de un SUV. El Zeekr X Long Range RWD está disponible en un total de 6 colores de pintura, todos los cuales incluyen opciones metálicas y perladas.

Puede seleccionar entre varios diseños de ruedas, todos disponibles en el mismo tamaño, en el Zeekr X Long Range RWD, lo que le permite personalizar su vehículo para que coincida con su estilo y preferencias de conducción. Las combinaciones de neumáticos y ruedas disponibles incluyen:

- 245/45 neumáticos en llantas de 18"
...
El Zeekr X Long Range RWD acomoda cinco pasajeros con dos asientos delanteros y un banco de tres asientos en la parte trasera.

#### Asientos de la Primera Fila

El Zeekr X Long Range RWD ofrece un solo tipo de asiento delantero.
...
- White/Blue [tapicería de cuero sintético](../../../../technology/seats/materials/#leatherette)
...
- La pantalla  en la columna de dirección mide 8,0 pulgadas.
...
El Zeekr X Long Range RWD viene equipado con una opción de sistema de sonido:

- **Yamaha surround sound system:** Cuenta con 13 altavoces y ofrece una potencia máxima de 1040 vatios.

Además, el modelo incluye 4 conexiones USB-C como estándar.

## Luces

Puede elegir entre dos tipos de faros delanteros para el Zeekr X Long Range RWD.
...
El Zeekr X Long Range RWD cuenta con una gama de sistemas [avanzados de asistencia al conductor](../../../../technology/driverassistance/) (ADAS) estándar y opcionales diseñados para mejorar la seguridad y la comodidad.
...
[**Control Electrónico de Estabilidad (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Estándar en el Zeekr X Long Range RWD, este sistema mejora la estabilidad y el manejo del vehículo durante maniobras repentinas o en condiciones de carretera resbaladiza.

[**Asistencia de Mantenimiento de Carril (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Estándar en el Zeekr X Long Range RWD, este sistema ayuda a evitar que el vehículo se desvíe de su carril. También incluye un sistema de [**Advertencia de Salida de Carril**](../../../../technology/driverassistance/lanedeparturewarning/) para alertar al conductor si el vehículo se desvía del carril.

[**Alerta de Tráfico Cruzado Trasero (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Estándar en el Zeekr X Long Range RWD, este sistema utiliza sensores para detectar vehículos que se aproximan desde el lado al retroceder de un espacio de estacionamiento o entrada.

[**Advertencia de Colisión Frontal (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Estándar en el Zeekr X Long Range RWD, este sistema de asistencia al conductor ayuda a los conductores a evitar o mitigar colisiones frontales.

[**Frenado automático de emergencia (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Estándar en el Zeekr X Long Range RWD, este sistema aplica los frenos de manera autónoma para prevenir o reducir la gravedad de una colisión si el conductor no reacciona a tiempo.

[**Advertencia de Salida**](../../../../technology/driverassistance/exitwarning/): Estándar en el Zeekr X Long Range RWD, este sistema alerta a los ocupantes contra la apertura de puertas si hay riesgo de golpear algo.
...
El Zeekr X Long Range RWD está equipado con características de seguridad avanzadas para protegerlo a usted y a su vehículo. Estas incluyen:
...
Este modelo hizo su estreno mundial el 12.04.2023, con entregas anticipadas para comenzar en November 2023.
{{< pagenavigation b_url="../" b_title="Zeekr X" f_url="rangeandconsumption/" f_title="Autonomía" >}}
