---
title: Zeekr X Privilege AWD Specifikationer
linktitle: "Specifikationer"
description: "EVKX.net ger dig alla specifikationer för Zeekr X Privilege AWD."
weight: 4
hidden: true
...
EVKX.net vill ha de mest kompletta specifikationerna för Zeekr X Privilege AWD. Klicka på bilden ovan för [fullständig artikel](../), besök [bildgalleri](../gallery/) för hög upplösningsbilder av Zeekr X Privilege AWD, gå till [chargeinfo](../chargingcurve/) för Zeekr X Privilege AWD med laddningskurva, se [extended range info](../rangeandconsumption/) för verkliga räckvidd.
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Athens White (Vit)</br>
				Berlin Grey (Grå)</br>
				Hangzhou Green (Grön)</br>
				Sydney Blue (Blå)</br>
				California Pink (Rosa)</br>
			</td>
		</tr>
	</tbody>
</table>
