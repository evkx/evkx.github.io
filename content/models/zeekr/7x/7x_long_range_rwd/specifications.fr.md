---
title: Zeekr 7X Long Range RWD spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Zeekr 7X Long Range RWD."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Zeekr 7X Long Range RWD. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Zeekr 7X Long Range RWD, visitez les [chargeinfo](../chargingcurve/) pour Zeekr 7X Long Range RWD avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Midnight White (Blanc)</br>
				Polar Night Black (Noir)</br>
				Star Dusk Grey (Gris)</br>
				Bluestone (Bleu)</br>
				Morino Green (Vert)</br>
				Cloud Orange</br>
				Dawn Brown (Marron)</br>
			</td>
		</tr>
	</tbody>
</table>
