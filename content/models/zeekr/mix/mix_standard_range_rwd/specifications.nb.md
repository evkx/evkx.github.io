---
title: Zeekr MIX Standard Range RWD spesifikasjoner
linktitle: "Spesifikasjoner"
description: "EVKX.net gir deg alle spesifikasjonene for Zeekr MIX Standard Range RWD."
weight: 4
hidden: true
...
EVKX.net søker å ha de mest komplette spesifikasjonene for Zeekr MIX Standard Range RWD. Klikk på bildet ovenfor for [full artikkel](../), besøk [bildegalleriet](../gallery/) for høyoppløselige bilder av Zeekr MIX Standard Range RWD, gå til [chargeinfo](../chargingcurve/) for Zeekr MIX Standard Range RWD med ladekurve, se [extended range info](../rangeandconsumption/) for real world ranges.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Midnight White (Hvit)</br>
				Polar Night Black (Svart)</br>
				Star Dusk Grey (Grå)</br>
				Bluestone (Blå)</br>
				Morino Green (Grønn)</br>
				Cloud Orange (Oransje)</br>
				Dawn Brown (Brun)</br>
			</td>
		</tr>
	</tbody>
