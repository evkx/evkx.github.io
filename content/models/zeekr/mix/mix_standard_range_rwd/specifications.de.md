---
title: Zeekr MIX Standard Range RWD Spezifikationen
linktitle: "Spezifikationen"
description: "EVKX.net bietet Ihnen die vollständigen Spezifikationen für Zeekr MIX Standard Range RWD."
weight: 4
hidden: true
...
EVKX.net strebt an, die vollständigsten Spezifikationen für Zeekr MIX Standard Range RWD zu haben. Klicken Sie auf das Bild oben für den [vollständigen Artikel](../), besuchen Sie die [Bildergalerie](../gallery/) für hochauflösende Bilder von Zeekr MIX Standard Range RWD, besuchen Sie die [Ladeinformationen](../chargingcurve/) für Zeekr MIX Standard Range RWD mit Ladekurve, besuchen Sie die [erweiterten Reichweiteninformationen](../rangeandconsumption/) für reale Reichweiten.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Midnight White (Weiß)</br>
				Polar Night Black (Schwarz)</br>
				Star Dusk Grey (Grau)</br>
				Bluestone (Blau)</br>
				Morino Green (Grün)</br>
				Cloud Orange</br>
				Dawn Brown (Braun)</br>
			</td>
		</tr>
