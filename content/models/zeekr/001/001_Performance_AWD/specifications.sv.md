---
title: Zeekr 001 Performance AWD Specifikationer
linktitle: "Specifikationer"
description: "EVKX.net ger dig alla specifikationer för Zeekr 001 Performance AWD."
weight: 4
hidden: true
...
EVKX.net vill ha de mest kompletta specifikationerna för Zeekr 001 Performance AWD. Klicka på bilden ovan för [fullständig artikel](../), besök [bildgalleri](../gallery/) för hög upplösningsbilder av Zeekr 001 Performance AWD, gå till [chargeinfo](../chargingcurve/) för Zeekr 001 Performance AWD med laddningskurva, se [extended range info](../rangeandconsumption/) för verkliga räckvidd.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Crystal (Vit)</br>
				Electric Blue (Blå)</br>
				Tech Grey (Grå)</br>
				Phantom Black (Svart)</br>
			</td>
		</tr>
	</tbody>
</table>
