...
description: "Zeekr 001 Privilege AWD er en elektrisk stasjonsvogn med en WLTP rekkevidde på opptil 580 km (361 miles). EVKX.net har alle detaljene."
weight: 10
hidden: true
shownavtabs: true
...
Zeekr 001 Privilege AWD har imponerende kraft med en maksimal effekt på 400 kW (544 hk / 536 bhp) og et kommanderende totalt dreiemoment på 686 Nm (506 lb-ft). Denne høyytelsesmaskinen kan sprinte fra 0 til 100 km/t på bare 3,8 sekunder, og den når en topphastighet på 200 km/t (124 mph), noe som gjør den til en utmerket i sin klasse.
...
Zeekr 001 Privilege AWD har et firehjulsdrift-system drevet av to motorer, en på hver aksel. Motorene som brukes er [permanent magnet synkronmotorer](../../../../technology/motors/pmsm/).
...
Zeekr 001 Privilege AWD er utstyrt med [støpejernsskivebremser](../../../../technology/brakes/#disc-brakes) både foran og bak. Skivene foran måler 533 mm, mens skivene bak er 457 mm.
...
Zeekr 001 Privilege AWD, med dimensjoner på 4955 mm i lengde, 1999 mm i bredde og 1548 mm i høyde, tilhører E-segmentet. Også kjent som luksusbiler, er disse større og mer luksuriøse enn D-segment biler. De er designet for å tilby overlegen komfort, avansert teknologi og høy ytelse. Zeekr 001 Privilege AWD er tilgjengelig i totalt 4 lakkfarger, inkludert flere slående metallic-lakker.

Du kan velge mellom flere hjuldesign, alle tilgjengelige i samme størrelse, på Zeekr 001 Privilege AWD, slik at du kan tilpasse kjøretøyet etter din stil og kjørepreferanser. De tilgjengelige dekk- og hjulkombinasjonene inkluderer:
...
Zeekr 001 Privilege AWD har plass til fem passasjerer med to forseter og en treseters benk bak.

#### Forseter

Zeekr 001 Privilege AWD tilbyr bare én type forsete.
...
Zeekr 001 Privilege AWD inkluderer flere funksjoner for å øke komfort og bekvemmelighet:
...
Zeekr 001 Privilege AWD har flere integrerte skjermer. Bak rattet er det et [digitalt instrumentpanel](../../../../technology/userinterface/screens/#digital-instruments), og i midtkonsollen er det en [infotainmentskjerm](../../../../technology/userinterface/screens/#infotainment-screen) øverst.
...
Zeekr 001 Privilege AWD er utstyrt med én type ratt:
...
Zeekr 001 Privilege AWD støtter Android Auto og Apple CarPlay, som lar deg speile telefonskjermen på bilens skjerm. Denne funksjonaliteten gjør at du kan kjøre apper som Google Maps eller Waze direkte fra telefonen.

### Lydsystem

Zeekr 001 Privilege AWD kommer med ett lydsystem:
...
Zeekr 001 Privilege AWD har en rekke standard og valgfrie [avanserte førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) designet for å øke sikkerhet og komfort.
...
[**Filholderassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på Zeekr 001 Privilege AWD, dette systemet hjelper med å hindre kjøretøyet i å drive ut av filen. Den inkluderer også et [**Filskiftevarsel**](../../../../technology/driverassistance/lanedeparturewarning/) system som varsler føreren hvis kjøretøyet beveger seg ut av filen.

[**Kryssende trafikkvarsling bak (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard på Zeekr 001 Privilege AWD, dette systemet bruker sensorer for å oppdage kjøretøy som nærmer seg fra siden når man rygger ut av en parkeringsplass eller innkjørsel.

[**Frontkollisjonsvarsling (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Zeekr 001 Privilege AWD, dette førerassistentsystemet hjelper førere med å unngå eller redusere frontkollisjoner.

[**Automatisk nødbrems (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Zeekr 001 Privilege AWD, dette systemet aktiverer bremsene automatisk for å forhindre eller redusere alvorlighetsgraden av en kollisjon hvis føreren ikke reagerer i tide.
...
Zeekr 001 Privilege AWD er utstyrt med avanserte sikkerhetsfunksjoner for å beskytte deg og kjøretøyet ditt. Disse inkluderer:
...
Zeekr 001 Privilege AWD hadde sin verdenspremiere 14.04.2021, med leveringer som startet i October 2021.
