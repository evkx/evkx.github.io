...
Lucid Air est une berline disponible en 5 variantes.
</p>
	<a href="air/" class="btn btn-outline-primary" role="button">Aller aux informations sur le modèle</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
...
Lucid Gravity est un SUV disponible en 2 variantes.
    ...
    <div id="module-company" class="accordion-collapse collapse">
        <div class="accordion-body">
{{% insert "content/models/lucid/company.fr.md" %}}
</div>
</div>
</div>
</div>
