...
The vehicle supports fast DC charging with a maximum power of  kW. Charging from 0% to 100% takes approximately 79 minutes, while a more typical scenario from 10% to 80% takes 33 minutes with an average charging speed of 147 kW. Considering an additional 5 minutes for each charging stop due to driving interruptions, the optimal charging range is from 1% to 46%. This results in an effective charging speed, including time lost, of 172 kW, with each charging session taking about 18 minutes and 24 seconds.

In a 1000 km challenge at a constant speed of 120 km/h (75 mph) with an assumed consumption rate of 19.5 kWh/100 km, the trip would take about 8 hours and 48 minutes, requiring two charging stops from 1% to 35%, totaling 29 minutes of charging time.

### Onboard Charger

The standard onboard charger supports up to 22 kW for Level 1 and Level 2 AC charging, allowing a full charge from 0 to 100% in about 5 hours and 19 minutes using a home setup.
...
The Lucid Air Dream Edition Performance features an all-wheel drive system powered by two motors, one on each axle. The motors used are [Permanent Magnet Synchronous Motors](../../../../technology/motors/pmsm/).
...
The Lucid Air Dream Edition Performance is equipped with [cast-iron disc brakes](../../../../technology/brakes/#disc-brakes) on both the front and rear. The front discs measure 380 mm, while the rear discs are 375 mm.
...
The Lucid Air Dream Edition Performance accommodates five passengers with two front seats and a three-seat bench in the rear.

#### First Row Seats

The Lucid Air Dream Edition Performance offers a single type of front seat.
...
The Lucid Air Dream Edition Performance includes several features to enhance comfort and convenience:
...
You can choose between two sound systems for the Lucid Air Dream Edition Performance:
...
The Lucid Air Dream Edition Performance features a range of standard and optional [advanced driver assistance systems](../../../../technology/driverassistance/) (ADAS) designed to enhance safety and comfort.

### Safety Systems

[**Anti-lock Braking System (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard on the Lucid Air Dream Edition Performance, this system prevents the wheels from locking during braking.

[**Electronic Stability Control (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard on the Lucid Air Dream Edition Performance, this system improves the vehicle's stability and handling during sudden maneuvers or on slippery road conditions.

[**Lane-Keeping Assist (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard on the Lucid Air Dream Edition Performance, this system helps prevent the vehicle from drifting out of its lane. It also includes a [**Lane Departure Warning**](../../../../technology/driverassistance/lanedeparturewarning/) system to alert the driver if the vehicle veers out of the lane.

[**Front Cross Traffic Assist (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/) : Standard on the Lucid Air Dream Edition Performance, this driver assist system that helps drivers detect oncoming traffic when crossing an intersection or turning left or right from a stopped position.

[**Automatic Emergency Steering (AES)**](../../../../technology/driverassistance/automaticemergencysteering/): Standard on the Lucid Air Dream Edition Performance, this system assists in avoiding collisions by automatically steering the vehicle in an emergency.

[**Blind-spot Monitoring (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard on the Lucid Air Dream Edition Performance, this side assist system helps to detect traffic in blind spots.

### Driving Automation

With the standard ADAS level 2 system, you get the following driving automation features.
...
The Lucid Air Dream Edition Performance is equipped with advanced security features to protect you and your vehicle. These include:
...
The trunk offers a cargo capacity of 456 liters (16.1 CU FT). With the rear seat folded down, this expands to 627 liters (22.1 CU FT). On the roof, you can load up to 75 kg (165.3 lbs). Additionally, there is a frunk (front trunk) with a storage capacity of 283 liters (10.0 CU FT).

The vehicle’s maximum weight is 2850 kg (6283 lbs), with a base weight of 2360 kg (5203 lbs). This allows for a maximum load of 490 kg (1080 lbs), including the driver and passengers. Note that some options may increase the base weight and reduce the maximum loading capacity.
