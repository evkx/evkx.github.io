...
linktitle: "Air Pure"
description: "Lucid Air Pure er en fuldelektrisk sedan med en WLTP rækkevidde på op til 747 km (464 miles). EVKX.net har alle detaljerne."
weight: 10
hidden: true
shownavtabs: true
...
Vi har opdelt vores Lucid Air Pure artikel i sektioner. Hvis du vil vente med at læse hele artiklen, skal du klikke på nedenstående links til de forskellige områder. Vi har også en oversigt over de [fulde specifikationer](specifications/), et [billedgalleri](gallery/), detaljerede oplysninger om [opladningsydelse](chargingcurve/), og nogle [online anmeldelser](reviews/). Vores sektioner:
...
Det højkapacitetsbatteri har en bruttokapacitet på 88,0 kWh og en nettoanvendelig kapacitet på 84,0 kWh, hvilket giver en buffer på 4,0 kWh (3%) til batteribeskyttelse. Med en nominel spænding på 800 volt, kvalificerer det sig som et 800-volt batterisystem. Denne høje spænding er afgørende for at muliggøre systemets opladningsegenskaber.

Ifølge [WLTP (Worldwide Harmonized Light Vehicles Test Procedure)](../../../../guides/understandingrange/wltp/) standarden varierer køretøjets rækkevidde mellem 747 og 708 km, afhængigt af specifikke konfigurationer og muligheder, såsom hjulstørrelse. Større hjul kan for eksempel øge energiforbruget og dermed reducere den samlede rækkevidde. Køretøjets energiforbrug er vurderet til 11,2 kWh/100 km for basismodellen og 11,9 kWh/100 km for topmodellen under WLTP testcyklussen. For mere detaljerede virkelige data og rækkeviddeoplysninger, henvises til modellens dedikerede [rækkevidde- og forbrugsside.](rangeandconsumption/)

Den maksimale DC-opladningshastighed er kW. En fuld opladning fra 0 - 100 % ville tage 56 minutter, mens et mere almindeligt scenarie på 10-80 % ville tage 23 minutter. Hvis du antager, at du mister 5 minutters kørsel pr. ladestop ud over opladningstiden, er det optimale opladningsområde fra 1% til 50%, hvilket resulterer i en faktisk opladningshastighed, inklusive tidstab på 158kW. Hver opladningssession ville tage 16 minutter og 38 sekunder. Denne effektive opladningskapacitet gør Lucid Air Pure til et praktisk valg til langdistancerejser.

I en teoretisk 1000 km udfordring, der starter med et fuldt batteri og opretholder en konstant hastighed på 120 km/t under ideelle forhold med et antaget forbrug på 19 kWh/100 km, ville turen tage cirka 9 timer og 1 minutter. Denne rejse ville kræve to opladningsstop fra 1% til 44%, med en samlet opladningstid på 42 minutter

### Ombordlader

Den standard ombordlader understøtter op til 22 kW til Level 1 og Level 2 AC-opladning. Dette gør det muligt at fuldt oplade batteriet fra 0 til 100% på cirka 3 timer og 49 minutter ved brug af en hjemmeoplader.
...
Dynamisk styring er en standard-funktion på Lucid Air Pure. Dynamisk styring varierer styreforholdet som en funktion af kørehastigheden.
...
Lucid Air Pure inkluderer flere funktioner, der forbedrer komfort og bekvemmelighed:
...
Lucid Air Pure er udstyret med en enkelt type rat:
...
Du kan vælge mellem to lydsystemer på Lucid Air Pure.
...
Den Lucid Air Pure inkluderer flere standard- og valgfri [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) for at forbedre sikkerhed og komfort.

### Sikkerhedssystemer

[**Anti-lock Bremsesystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Lucid Air Pure, dette system forhindrer hjulene i at låse under opbremsning.

[**Electronic Stability Control (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Lucid Air Pure, dette system forbedrer bilens stabilitet og håndtering under pludselige manøvrer eller på glatte vejforhold.
...
[**Front Cross Traffic Assist (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/): Standard på Lucid Air Pure, dette førerassistentsystem hjælper føreren med at opdage modkørende trafik ved krydsning af et kryds eller ved sving til venstre eller højre fra en stopposition.
...
[**Blind-spot Monitoring (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard på Lucid Air Pure, dette sideassistentsystem hjælper med at registrere trafik i døde vinkler.
