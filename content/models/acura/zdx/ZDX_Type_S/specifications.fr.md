---
title: Acura ZDX Type S spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Acura ZDX Type S."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Acura ZDX Type S. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Acura ZDX Type S, visitez les [chargeinfo](../chargecurve/) pour Acura ZDX Type S avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
