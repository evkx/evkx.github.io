...
description: "Acura ZDX A-Spec AWD is an all-electric SUV with a EPA range of up to 489 km (304 miles). EVKX.net has all the details."
weight: 10
hidden: true
shownavtabs: true
...
The Acura ZDX A-Spec AWD features an all-wheel drive system powered by two motors, one on each axle. The motors used are [Permanent Magnet Synchronous Motors](../../../../technology/motors/pmsm/).
...
Dynamic steering is a standard on the Acura ZDX A-Spec AWD, varying the steering ratio based on driving speed for enhanced control and comfort.
...
The Acura ZDX A-Spec AWD is equipped with [cast-iron disc brakes](../../../../technology/brakes/#disc-brakes) on both the front and rear. The front discs measure 320 mm, while the rear discs are 345 mm.
...
The Acura ZDX A-Spec AWD, with dimensions of 5022 mm in length, 1956 mm in width, and 1636 mm in height, falls into the Full-size SUVs offer the most space, power, and capability among SUV categories, making them suitable for a specific set of drivers with unique needs The Acura ZDX A-Spec AWD is available in a total of 5 paint colors, all of which include metallic and pearlescent options.

You can select from multiple wheel designs, all available in the same size, on the Acura ZDX A-Spec AWD, allowing you to personalize your vehicle to match your style and driving preferences. The available tire and wheel combinations include:
...
The Acura ZDX A-Spec AWD boasts a driver-centric interior, enhancing the cockpit feel with high-quality materials in several areas instead of hard plastic. A standout feature is the split-level center console, which separates the driver and passenger while offering convenient storage and enhanced functionality. You can choose between several interior designs.

### Seats

The Acura ZDX A-Spec AWD accommodates five passengers with two front seats and a three-seat bench in the rear.
...
The Acura ZDX A-Spec AWD provides ample interior storage solutions to enhance convenience and organization:
...
The Acura ZDX A-Spec AWD includes several features to enhance comfort and convenience:
...
The control interface for the Acura ZDX A-Spec AWD combines buttons, stalks, and screens for a seamless and user-friendly experience.

The Acura ZDX A-Spec AWD has multiple integrated screens. Behind the steering wheel is a [digital instrument cluster](../../../../technology/userinterface/screens/#digital-instruments), and in the center console, there is one [infotainment screen](../../../../technology/userinterface/screens/#infotainment-screen) at the top of the center console.
...
The Acura ZDX A-Spec AWD is equipped with a single type of steering wheel:
...
The Acura ZDX A-Spec AWD supports Android Auto and Apple CarPlay, allowing you to mirror your phone's screen on the car's display. This functionality enables you to run apps like Google Maps or Waze directly from your phone.

### Sound System

The Acura ZDX A-Spec AWD comes equipped with one sound system option:
...
The Acura ZDX A-Spec AWD comes with a dedicated mobile app, available for both Android and iOS devices, allowing you to manage and monitor your vehicle remotely. The app offers a wide range of features designed to enhance your driving experience:
...
The Acura ZDX A-Spec AWD features a range of standard and optional [advanced driver assistance systems](../../../../technology/driverassistance/) (ADAS) designed to enhance safety and comfort.

### Safety Systems

[**Anti-lock Braking System (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard on the Acura ZDX A-Spec AWD, this system prevents the wheels from locking during braking.

[**Electronic Stability Control (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard on the Acura ZDX A-Spec AWD, this system improves the vehicle's stability and handling during sudden maneuvers or on slippery road conditions.
...
[**Forward Collision Warning (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard on the Acura ZDX A-Spec AWD, this driver assist system helps drivers avoid or mitigate frontal collisions.

[**Automatic Emergency Braking (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard on the Acura ZDX A-Spec AWD, this system autonomously applies the brakes to prevent or reduce the severity of a collision if the driver does not react in time.

[**Blind-spot Monitoring (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard on the Acura ZDX A-Spec AWD, this side assist system helps to detect traffic in blind spots.

[**Exit Warning**](../../../../technology/driverassistance/exitwarning/): Standard on the Acura ZDX A-Spec AWD, this system that alerts occupants against opening doors if there is a risk of hitting something.
...
The Acura ZDX A-Spec AWD is equipped with multiple airbags to ensure occupant protection in the event of a collision. The airbag system includes:
...
The Acura ZDX A-Spec AWD is equipped with advanced security features to protect you and your vehicle. These include:
...
The Acura ZDX A-Spec AWD had its world premiere on 18.08.2023, with deliveries starting in March 2024. Please note that this model is available exclusively in North America.
...
In the rapidly expanding EV market, EVKX.net has identified several alternatives to the Acura ZDX A-Spec AWD that are worth considering based on features, specifications, and pricing. While these models may not be exact matches, comparing them could help you make a more informed buying decision:
...
<a href="https://db.evkx.net/evcompare?evs=828991%2c12fe37%2c97f254%2cb42577%2c4c67ea%2c7d633b" target="_blank">Explore a detailed comparison of these models.</a>
