---
title: Onvo L60 AWD spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Onvo L60 AWD."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Onvo L60 AWD. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Onvo L60 AWD, visitez les [chargeinfo](../chargingcurve/) pour Onvo L60 AWD avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				Toit gauche au-dessus du pare-brise</br>
				</br>
				Avant</br>
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Dawn Orange</br>
				Coastal Blue (Bleu)</br>
				Starry Black (Noir)</br>
				Polar Silver (Argent)</br>
				Snow Peak White (Blanc)</br>
				Distant Mountain Green (Vert)</br>
				Cloud Mist Purple (Violet)</br>
			</td>
		</tr>
	</tbody>
</table>
