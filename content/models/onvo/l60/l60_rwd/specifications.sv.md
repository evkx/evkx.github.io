...
description: "EVKX.net ger dig alla specifikationer för Onvo L60 RWD."
weight: 4
hidden: true
...
EVKX.net vill ha de mest kompletta specifikationerna för Onvo L60 RWD. Klicka på bilden ovan för [fullständig artikel](../), besök [bildgalleri](../gallery/) för hög upplösningsbilder av Onvo L60 RWD, gå till [chargeinfo](../chargingcurve/) för Onvo L60 RWD med laddningskurva, se [extended range info](../rangeandconsumption/) för verkliga räckvidd.
