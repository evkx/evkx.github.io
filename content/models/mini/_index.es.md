...
Mini Cooper es un hatchback premium disponible en 1 variantes.
</p>
	<a href="cooper/" class="btn btn-outline-primary" role="button">Ir a la información del modelo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Mini Countryman es un SUV premium disponible en 1 variantes.
</p>
	<a href="countryman/" class="btn btn-outline-primary" role="button">Ir a la información del modelo</a>
		</div>
	</div>
</div>
        </div>
