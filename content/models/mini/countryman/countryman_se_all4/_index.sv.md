...
description: "Mini Countryman SE ALL4 är en helelektrisk premium-SUV med en WLTP räckvidd på upp till 440 km. EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Vi har delat in vår beskrivning av Mini Countryman SE ALL4 i avsnitt. Om du vill vänta med att läsa hela artikeln, klicka på länkarna nedan till de olika avsnitten. Vi har även en översikt över [fullständiga specifikationer](specifications/), [räckvidde och förbrukning](rangeandconsumption/), ett [bildgalleri](gallery/), detaljerad information om [laddningsprestanda](chargingcurve/) och några [recensioner](reviews/). Våra avsnitt:
...
Mini Countryman SE ALL4 levererar en solid prestanda med en maximal effekt på 230 kW (313 hk) och ett totalt vridmoment på 494 Nm. Den kan accelerera från 0 till 100 km/h på 5,6 sekunder och når en topphastighet på 180 km/h, vilket gör den konkurrenskraftig i sin klass.
...
I en teoretisk 1000 km-utmaning, med en fulladdad batteri och en konstant hastighet på 120 km/h (75 mph) under ideala förhållanden med en antagen förbrukning på 23 kWh/100 km, skulle resan ta ungefär 10 timmar och 20 minuter. Denna resa skulle kräva två laddningsstopp från 10% till 44%, med en total laddningstid på 121 minuter.
...
Mini Countryman SE ALL4 har ett fyrhjulsdriftsystem som stöds av två motorer, en på varje axel. Motorn som används är [induktionsmotor](../../../../technology/motors/asm/).
...
Dynamisk styrning är standard-funktionen för Mini Countryman SE ALL4. Dynamisk styrning varierar styrförhållandet som en funktion av körhastigheten.
...
Mini Countryman SE ALL4 rymmer fem passagerare med två säten fram och en tre-sitsig bänk bak.

#### Framsäten

För första raden erbjuder Mini Countryman SE ALL4 två olika sätestyper att välja mellan, som tillgodoser olika komfort- och stilpreferenser.
...
Mini Countryman SE ALL4 inkluderar flera funktioner för att förbättra komfort och bekvämlighet:
...
Mini Countryman SE ALL4 har två skärmar med information för föraren och passagerarna. Bak rattet er en [digital instrumentklynge](../../../../technology/userinterface/screens/#digitala-instrument), og på høyre del , det er en [infotainment-skjerm](../../../../technology/userinterface/screens/#digitala-instrument).
...
Mini Countryman SE ALL4 är utrustad med en enda typ av ratt:
...
Dessutom stöder Mini Countryman SE ALL4 Android Auto och Apple CarPlay. Denna funktion gör att du kan visa telefonens skärm på bilens skärm så att du kan köra appar som Google Maps eller Waze.

### Ljudsystem

Du kan välja mellan två ljudsystem på Mini Countryman SE ALL4.
...
Du kan välja mellan två typer av strålkastare för Mini Countryman SE ALL4.
...
Mini Countryman SE ALL4 inkluderar flera [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) som standard och som tillval för att förbättra säkerheten och komforten.

### Säkerhetssystem

[**Låsningsfria bromsar (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Mini Countryman SE ALL4, detta system förhindrar att hjulen låser sig under bromsning.

[**Elektronisk Stabilitetskontroll (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Mini Countryman SE ALL4, detta system förbättrar fordonets stabilitet och hantering vid plötsliga manövrer eller på hala vägar.

[**Körfältsassistans (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på Mini Countryman SE ALL4, detta system hjälper till att förhindra att fordonet driver ut ur sitt körfält. Det inkluderar även ett system för [**Varning för Utträde från Körfält**](../../../../technology/driverassistance/lanedeparturewarning/) som varnar föraren om fordonet är på väg ut ur körfältet.

[**Bakre Korsande Trafikvarning (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Valfritt på Mini Countryman SE ALL4, detta system använder sensorer för att upptäcka närstående fordon från sidan när du backar ut från en parkeringsplats eller in- och utfart.

[**Framåt Kollisionsvarning (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Valfritt på Mini Countryman SE ALL4, detta förarassistanssystem hjälper till att undvika eller mildra frontalkollisioner.

[**Automatisk nödbromsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Mini Countryman SE ALL4, detta system bromsar autonomt för att förhindra eller minska allvaret av en kollision om föraren inte reagerar i tid.

[**Automatisk nödstyrning (AES)**](../../../../technology/driverassistance/automaticemergencysteering/): Valfritt på Mini Countryman SE ALL4, detta system hjälper till att undvika kollisioner genom att automatiskt styra fordonet i en nödsituation.
...
Bagageutrymmet erbjuder en lastkapacitet på 460 liter. Med baksätena nedfällda ökar detta till 1450 liter. På taket kan du lasta upp till 75 kg. Valfria takräcken finns tillgängliga för enkel montering av ett takbox eller takräcke.

Fordonets maximala vikt är 2570 kg, med en grundvikt på 2000 kg. Detta tillåter en maximal last på 570 kg, inklusive förare och passagerare. Observera att vissa alternativ kan öka grundvikten och minska den maximala lastkapaciteten.
