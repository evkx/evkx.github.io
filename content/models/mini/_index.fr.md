...
Mini Cooper est une citadine premium disponible en 1 variantes.
    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Mini Countryman est un SUV premium disponible en 1 variantes.
</p>
	<a href="countryman/" class="btn btn-outline-primary" role="button">Aller aux informations sur le modèle</a>
		</div>
	</div>
</div>
        </div>
