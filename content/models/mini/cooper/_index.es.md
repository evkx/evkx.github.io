...
title: Mini Cooper
linktitle: "Cooper"
description: "Consulta a continuación los detalles de las diferentes variantes de Mini Cooper"
weight: 30
---
...
<i class="bi bi-battery-full"></i> 54,2 kWh <i class="bi bi-ev-station"></i> 95 kW 
		</div>
		<div class="col col-12 col-md-6">
			<ul class="list-group list-group-flush">
				...
				<li class="list-group-item list-group-item-action"><a href="cooper_se/rangeandconsumption/" class="text-decoration-none text-black" ><i class="bi-file-earmark-bar-graph"></i> Rango</a></li>
