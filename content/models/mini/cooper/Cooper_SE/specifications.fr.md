---
title: Mini Cooper SE spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Mini Cooper SE."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Mini Cooper SE. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Mini Cooper SE, visitez les [chargeinfo](../chargingcurve/) pour Mini Cooper SE avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
...
Ce modèle est disponible avec une configuration de sièges à quatre sièges.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Sunny Slide Show (Jaune)</br>
				Chilli Red (Rouge)</br>
				Melting Solver III (Argent)</br>
				Ocean Wave Green (Vert)</br>
				Ocean Wave Green (Bleu)</br>
				British Racing Green (Vert)</br>
				Indigo Sunset Blue (Bleu)</br>
				Midnight Black (Noir)</br>
				Nanuq White (Blanc)</br>
				Legend Grey (Gris)</br>
			</td>
		</tr>
	</tbody>
