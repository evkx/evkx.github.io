...
linktitle: "Cooper SE"
description: "Mini Cooper SE er en elektrisk premium kombi med en WLTP rekkevidde på opptil 402 km (250 miles). EVKX.net har alle detaljene."
weight: 10
hidden: true
shownavtabs: true
...
Mini Cooper SE tilbyr beskjeden ytelse med en maksimal effekt på 160 kW (218 hk / 215 bhp) og et totalt dreiemoment på 330 Nm (244 lb-ft). Den akselererer fra 0 til 100 km/t på 6,7 sekunder og har en topphastighet på 170 km/t (106 mph), mer på linje med tradisjonelle forbrenningsmotorer.

<a id="section-battery" style="display: block; position: relative; top: -60px; visibility: hidden;"></a>

## Batteri, rekkevidde og lading

Batteriet med høy kapasitet har en brutto kapasitet på 54,2 kWh og en netto brukbar kapasitet på 49,0 kWh, som gir en 5,2 kWh buffer (9,6%) for batteribeskyttelse.

Under [WLTP](../../../../guides/understandingrange/wltp/) (Worldwide Harmonized Light Vehicles Test Procedure) standarden, varierer kjørelengden mellom 402 til 377 km (250-234 miles), avhengig av spesifikk konfigurasjon og valg, som for eksempel hjulstørrelse. Større hjul kan øke energiforbruket og følgelig redusere total rekkevidde. Bilens energiforbruk er oppgitt til 12,2 kWh/100 km for basismodellen og 13,0 kWh/100 km for toppmodellen under WLTP testsyklusen. For mer informasjon om rekkevidde, se faktiske data og rekkeviddelister på denne modellens [rekkevidde og forbruk](rangeandconsumption/) side.

Kjøretøyet støtter hurtig DC-lading med en maksimal effekt på 95 kW. Lading fra 0% til 100% tar omtrent 71 minutter, mens et mer typisk scenario fra 10% til 80% tar 30 minutter med en gjennomsnittlig ladehastighet på 68 kW. Med tanke på ytterligere 5 minutter for hver ladestopp på grunn av kjøreavbrudd, er det optimale ladeområdet fra 8% til 76%. Dette gir en effektiv ladehastighet, inkludert tapt tid, på 59 kW, hvor hver ladeøkt tar omtrent 34 minutter og 51 sekunder.
...
Mini Cooper SE har et forhjulsdrift-system med én motor på forakselen.

### Fjæring

Forhjulsopphenget er [MacPherson Strut](../../../../technology/suspension/#macpherson-strut), og bakhjulsopphenget er [Multilink](../../../../technology/suspension/#multilink). Standardfjæringen inkluderer stålfjærer og hydrauliske dempere. har fast høyde og demping på fjæringen. Bakkeklaring med denne hjulopphenget er 128 mm.
...
Mini Cooper SE, med dimensjoner på 3900 mm i lengde, 1750 mm i bredde og 1450 mm i høyde, tilhører B-segmentet. Også kjent som småbiler, er dette kompakte biler som er spesielt egnet for bykjøring og tilbyr en god balanse mellom effektivitet, størrelse og kostnad. Mini Cooper SE er tilgjengelig i totalt 10 lakkfarger, inkludert både solide og metallic-lakker.

Mini Cooper SE tilbyr flere hjulalternativer i ulike størrelser, slik at du kan tilpasse kjøretøyet etter din stil og kjørepreferanser. De tilgjengelige dekk- og hjulkombinasjonene inkluderer:
...
Mini Cooper SE tilbyr bare én type forsete.
...
Mini Cooper SE inkluderer flere funksjoner for å øke komfort og bekvemmelighet:
...
Mini Cooper SE er utstyrt med én type ratt:
...
Mini Cooper SE kommer med ett lydsystem:
...
Mini Cooper SE har en rekke standard og valgfrie [avanserte førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) designet for å øke sikkerhet og komfort.

### Sikkerhetssystemer

[**Filholderassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på Mini Cooper SE, dette systemet hjelper med å hindre kjøretøyet i å drive ut av filen. Den inkluderer også et [**Filskiftevarsel**](../../../../technology/driverassistance/lanedeparturewarning/) system som varsler føreren hvis kjøretøyet beveger seg ut av filen.
...
Mini Cooper SE er utstyrt med avanserte sikkerhetsfunksjoner for å beskytte deg og kjøretøyet ditt. Disse inkluderer:
...
Bagasjerommet har en lastekapasitet på 200 liter (7,1 CU FT). Med baksetet nedfelt øker dette til 800 liter (28,3 CU FT).
...
{{< pagenavigation b_url="../" b_title="Mini Cooper" f_url="rangeandconsumption/" f_title="Rekkevidde" >}}
