...
title: BYD Seal AWD
linktitle: "Seal AWD"
description: "BYD Seal AWD är en helelektrisk sedan med en räckvidd på WLTP på upp till 520 km. EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
BYD Seal AWD har en maximal effekt på 390 KW (530hk). Totalt vridmoment är 670 Nm. Den gör sprinten 0-100 km/h på 3,8 sekunder. Topphastigheten är 180 km/h.

## Batteri, räckvidd och laddning

Batteriet har en bruttokapacitet på 85,4kWh och en nettokapacitet på 82,5kWh, vilket innebär att du har en 2,9kWh buffert för skydd. (3,4%). Litiumjonbatteriet använder [LFP-teknik.](../../../../technology/battery/cellchemistry/#lithium-iron-phosphate-battery-lfp) Detta har vissa fördelar och nackdelar från de typiska NCA/NCM-batterierna.

[WLTP-intervall](../../../../guides/understandingrange/wltp/) är 520 km. Förbrukningen är 15.9kWh/100 km för WLTP-standardtestet. För mer information om sortimentet, se verkliga data och räckvidd på denna modells sida [rangeandconsumption](rangeandconsumption/).

Maximal DC-laddningshastighet är 150 kW. En full laddning från 0 - 100 % tar 64 minuter, medan ett vanligare scenario på 10-80 % tar 35 minuter. Om du antar att du förlorar 5 minuters körning per laddningsstopp utöver laddningstiden, är den optimala laddningsytan från 4% till 59%, vilket resulterar i en faktisk laddning hastighet inklusive tidsförlust , på 92kW. Varje laddningssession tar 29 minuter och 27 sekunder.

För den teoretiska 1000km-utmaningen, att börja med fullt batteri och köra i 120km/h (75 mph), förutsatt optimala körförhållanden och förbrukning på 25kWh/100km, tar 1000km 10 timmar och 10 minuter. Den här resan kommer att kräva fyra laddningssession(er) laddning från 8% till 59%. Total tid som går förlorad för att ladda batteriet kommer att vara 110 minuter.

### Inbyggd laddare

För nivå 1 och nivå 2 AC-laddning stöder  inbyggd laddare upp till 11KW-laddning. Som ett resultat kan du ladda batteriet 0-100 % hemifrån på ca. 7 timmar och 30 minuter.
...
Endast en typ av framsäte är tillgänglig i BYD Seal AWD.
...
BYD Seal AWD har flera funktioner för att göra ditt liv som förare eller passagerare bekvämare.
...
BYD Seal AWD har ett [**ABS-bromssystem**](../../../../technology/driverassistance/antilockbrakingsystem/) som standard-systemet. Detta system hjälper till att förhindra att ett fordons hjul låser sig under inbromsning.

BYD Seal AWD har ett [**elektronisk stabilitetskontroll**](../../../../technology/driverassistance/electronicstabilitycontrol/) vilket standard-system är utformat för att förbättra ett fordons stabilitet och hantering under plötsliga manövrar eller halt väglag.

BYD Seal AWD har en [**filhållningsassistent**](../../../../technology/driverassistance/lanekeepingassist/) som standard-system. Detta system bidrar för att förhindra att bilen lämnar körfältet. Dessutom har den ett [**filavvikelsevarning**](../../../../technology/driverassistance/lanedeparturewarning/) system som varnar föraren om fordonet lämnar körfältet.
...
BYD Seal AWD har [**automatisk nödbroms**](../../../../technology/driverassistance/automaticemergencybraking/) som standard-system. Detta system hjälper till att förhindra eller mildra kollisioner genom att ansätta bromsarna autonomt om föraren inte reagerar på en förestående kollision.
