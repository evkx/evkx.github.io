...
BYD Atto 3 ist ein Crossover, das in 1 Varianten erhältlich ist.
</p>
	<a href="atto_3/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
BYD Dolphin ist ein Schrägheck, das in 3 Varianten erhältlich ist.
</p>
	<a href="dolphin/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
BYD Han ist eine Limousine, die in 1 Varianten erhältlich ist.
</p>
	<a href="han/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
BYD Seagull ist ein Schrägheck, das in 1 Varianten erhältlich ist.
</p>
	<a href="seagull/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
BYD Seal ist eine Limousine, die in 2 Varianten erhältlich ist.
</p>
	<a href="seal/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
BYD Seal U ist ein SUV, der in 1 Varianten erhältlich ist.
</p>
	<a href="seal_u/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
BYD Sealion 7 ist ein Coupé-SUV, das in 1 Varianten erhältlich ist.
</p>
	<a href="sealion_7/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
...
BYD Tang ist ein SUV, der in 2 Varianten erhältlich ist.
    ...
    <div id="module-company" class="accordion-collapse collapse">
        <div class="accordion-body">
{{% insert "content/models/byd/company.de.md" %}}
</div>
</div>
</div>
</div>
