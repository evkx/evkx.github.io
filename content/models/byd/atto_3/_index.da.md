...
<i class="bi bi-record2-fill"></i> FWD <i class="bi bi-battery-full"></i> 60,5 kWh <i class="bi bi-ev-station"></i> 88 kW 
		...
		<div class="col col-12 col-md-6">
			<ul class="list-group list-group-flush">
				...
				<li class="list-group-item list-group-item-action"><a href="atto_3/rangeandconsumption/" class="text-decoration-none text-black" ><i class="bi-file-earmark-bar-graph"></i> Rækkevidde</a></li>
