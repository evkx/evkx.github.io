...
BYD Atto 3 har en maximal effekt på 150 KW (204hk). Totalt vridmoment är 310 Nm. Den gör sprinten 0-100 km/h på 7,3 sekunder. Topphastigheten är 160 km/h.

## Batteri, räckvidd och laddning

Batteriet har en bruttokapacitet på 60,5kWh och en nettokapacitet på 58kWh, vilket innebär att du har en 2,5kWh buffert för skydd. (4,1%). Litiumjonbatteriet använder [LFP-teknik.](../../../../technology/battery/cellchemistry/#lithium-iron-phosphate-battery-lfp) Detta har vissa fördelar och nackdelar från de typiska NCA/NCM-batterierna.

[WLTP-intervall](../../../../guides/understandingrange/wltp/) är 420 km. Förbrukningen är 13.8kWh/100 km för WLTP-standardtestet. För mer information om sortimentet, se verkliga data och räckvidd på denna modells sida [rangeandconsumption](rangeandconsumption/).
...
För den teoretiska 1000km-utmaningen, att börja med fullt batteri och köra i 120km/h (75 mph), förutsatt optimala körförhållanden och förbrukning på 23kWh/100km, tar 1000km 10 timmar och 55 minuter. Den här resan kommer att kräva fem laddningssession(er) laddning från 3% till 63%. Total tid som går förlorad för att ladda batteriet kommer att vara 156 minuter.

### Inbyggd laddare

För nivå 1 och nivå 2 AC-laddning stöder  inbyggd laddare upp till 7KW-laddning. Som ett resultat kan du ladda batteriet 0-100 % hemifrån på ca. 8 timmar och 17 minuter.
...
Endast en typ av framsäte är tillgänglig i BYD Atto 3.
...
BYD Atto 3 har flera funktioner för att göra ditt liv som förare eller passagerare bekvämare.
...
En typ av ljudsystem är tillgänglig för BYD Atto 3. Med Dirac får du åtta högtalare med en maximal systemeffekt på  watt.
...
BYD Atto 3 har flera standard- och valfria [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) för bättre säkerhet och komfort.
### Säkerhetssystem



BYD Atto 3 har ett [**ABS-bromssystem**](../../../../technology/driverassistance/antilockbrakingsystem/) som standard-systemet. Detta system hjälper till att förhindra att ett fordons hjul låser sig under inbromsning.

BYD Atto 3 har ett [**elektronisk stabilitetskontroll**](../../../../technology/driverassistance/electronicstabilitycontrol/) vilket standard-system är utformat för att förbättra ett fordons stabilitet och hantering under plötsliga manövrar eller halt väglag.

BYD Atto 3 har en [**filhållningsassistent**](../../../../technology/driverassistance/lanekeepingassist/) som standard-system. Detta system bidrar för att förhindra att bilen lämnar körfältet. Dessutom har den ett [**filavvikelsevarning**](../../../../technology/driverassistance/lanedeparturewarning/) system som varnar föraren om fordonet lämnar körfältet.
...
BYD Atto 3 har [**automatisk nödbroms**](../../../../technology/driverassistance/automaticemergencybraking/) som standard-system. Detta system hjälper till att förhindra eller mildra kollisioner genom att ansätta bromsarna autonomt om föraren inte reagerar på en förestående kollision.
...
BYD Atto 3 erbjuder [nivå 1 körautomation](../../../../technology/driverassistance/#level-of-autonomous-driving), beroende på utrustningsnivå.
...
Lastkapaciteten i bagageutrymmet är 440 liter. Med baksätet nedfällt är det 1338 liter. På taket kan du lasta upp till 50 kg. Bilens maximala vikt är 2160 kg, och med basvikten på 1750 kg kan du lasta maximalt 410 kg, inklusive förare och passagerare. Vissa utrustningsalternativ kan öka basvikten och minska den maximala lastvikten.
