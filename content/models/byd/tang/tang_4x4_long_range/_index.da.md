...
description: "BYD Tang 4x4 Long Range er en fuldelektrisk SUV med en rækkevidde på WLTP på op til 530 km (329 miles). EVKX.net har alle detaljerne."
weight: 10
hidden: true
shownavtabs: true
...
Vi har opdelt vores BYD Tang 4x4 Long Range artikel i sektioner. Hvis du vil vente med at læse hele artiklen, skal du klikke på nedenstående links til de forskellige områder. Vi har også en oversigt over de [fulde specifikationer](specifications/), et [billedgalleri](gallery/), detaljerede oplysninger om [opladningsydelse](chargingcurve/), og nogle [online anmeldelser](reviews/). Vores sektioner:
...
BYD Tang 4x4 Long Range leverer en solid præstation med en maksimal effekt på 380 kW (517 hk) og et totalt drejningsmoment på 680 Nm. Den kan accelerere fra 0 til 100 km/t på 4,9 sekunder og når en topfart på 190 km/t, hvilket gør den konkurrencedygtig i sin klasse.

## Batteri, rækkevidde og opladning

Det højkapacitetsbatteri har en bruttokapacitet på 108,8 kWh og en nettoanvendelig kapacitet på 107,0 kWh, hvilket giver en buffer på 1,8 kWh (3%) til batteribeskyttelse. Med en nominel spænding på 640 volt, kvalificerer det sig som et 800-volt batterisystem. Denne høje spænding er afgørende for at muliggøre systemets opladningsegenskaber. Lithium-Ion-batteriet bruger [LFP-teknologi.](../../../../technology/battery/cellchemistry/#lithium-iron-phosphate-battery-lfp) Dette har nogle fordele og ulemper fra de typiske NCA/NCM-batterier.
...
Den maksimale DC-opladningshastighed er 170kW. En fuld opladning fra 0 - 100 % ville tage 85 minutter, mens et mere almindeligt scenarie på 10-80 % ville tage 46 minutter. Hvis du antager, at du mister 5 minutters kørsel pr. ladestop ud over opladningstiden, er det optimale opladningsområde fra 4% til 59%, hvilket resulterer i en faktisk opladningshastighed, inklusive tidstab på 94kW. Hver opladningssession ville tage 37 minutter og 24 sekunder.

I en teoretisk 1000 km udfordring, der starter med et fuldt batteri og opretholder en konstant hastighed på 120 km/t under ideelle forhold med et antaget forbrug på 31,7 kWh/100 km, ville turen tage cirka 10 timer og 37 minutter. Denne rejse ville kræve to opladningsstop fra 9% til 59%, med en samlet opladningstid på 137 minutter
...
Denne model understøtter V2L (Vehicle 2 Load), hvilket betyder, at du kan forsyne elektrisk udstyr, der kræver op til 4 kW effekt, inklusive opladning af andre køretøjer.

{{<evkxdisplayaddarticle />}}

## Drivetrain

BYD Tang 4x4 Long Range har et firehjulstræk, der understøttes af to motorer, en på hver aksel. Dene anvendte motorer er [Permanent Magnet Synchronous Motors](../../../../technology/motors/pmsm/).
...
Dynamisk styring er en standard-funktion på BYD Tang 4x4 Long Range. Dynamisk styring varierer styreforholdet som en funktion af kørehastigheden.
...
Den BYD Tang 4x4 Long Range, med dimensioner på 4970 mm i længde, 1955 mm i bredde og 1745 mm i højde, tilhører mellemstore SUV'er og tilbyder en blanding af plads, komfort, ydelse og alsidighed, hvilket gør dem velegnede til en bred vifte af førere med forskellige behov. BYD Tang 4x4 Long Range fås i alt i 3 ensfarvede lakfarver.

Du kan vælge mellem flere hjuldesigns, alle tilgængelige i samme størrelse, på BYD Tang 4x4 Long Range, så du kan tilpasse din bil efter din stil og dine kørselspræferencer.
...
BYD Tang 4x4 Long Range har et førerfokuseret interiør, der forbedrer cockpitfølelsen med materialer af høj kvalitet i flere områder i stedet for hård plast. Det inkluderer også en traditionel midterkonsol, der adskiller fører og passager, og som giver praktisk opbevaring og funktionalitet.
...
BYD Tang 4x4 Long Range tilbyder kun én type forreste sæde.
...
BYD Tang 4x4 Long Range inkluderer flere funktioner, der forbedrer komfort og bekvemmelighed:
...
BYD Tang 4x4 Long Range har to skærme med information til fører og passagerer. Bag rattet er en [digital instrumentklynge](../../../../technology/userinterface/screens/#digital-instruments), og på den højre del , der er en [infotainment-skærm](../../../../technology/userinterface/screens/#infotainment-skærm).

Vigtige skærmdetaljer:

- Skærmen  bag rattet monteret i instrumentbrættet er 12,3 tommer stor
- Skærmen touch i dashboardets midte er 15,3 tommer stor
...
BYD Tang 4x4 Long Range er udstyret med en enkelt type rat:
...
Yderligere understøtter BYD Tang 4x4 Long Range Android Auto og Apple CarPlay. Denne funktionalitet giver dig mulighed for at præsentere din telefons skærm på bilens skærm, så du kan køre apps som Google Maps eller Waze.

### Lydsystem

Én type lydsystem er tilgængelig for BYD Tang 4x4 Long Range.

- Med Dynaudi sound system får du 12 højttalere med en maksimal systemeffekt på 200 watt.

Modellen har 4 USB-A-forbindelser som standard.

## Mobilapp

Den BYD Tang 4x4 Long Range kommer med sin dedikerede mobilapp, tilgængelig til både Android og iOS-enheder, som giver dig mulighed for at administrere og overvåge dit køretøj eksternt. Appen tilbyder et bredt udvalg af funktioner designet til at forbedre din køreoplevelse:
...
Den BYD Tang 4x4 Long Range inkluderer flere standard- og valgfri [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) for at forbedre sikkerhed og komfort.

### Sikkerhedssystemer

[**Anti-lock Bremsesystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på BYD Tang 4x4 Long Range, dette system forhindrer hjulene i at låse under opbremsning.

[**Electronic Stability Control (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på BYD Tang 4x4 Long Range, dette system forbedrer bilens stabilitet og håndtering under pludselige manøvrer eller på glatte vejforhold.
...
[**Front Cross Traffic Assist (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/): Standard på BYD Tang 4x4 Long Range, dette førerassistentsystem hjælper føreren med at opdage modkørende trafik ved krydsning af et kryds eller ved sving til venstre eller højre fra en stopposition.

[**Rear Cross Traffic Alert (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard på BYD Tang 4x4 Long Range, dette system bruger sensorer til at registrere tilstødende køretøjer fra siden, når du bakker ud af en parkeringsplads eller indkørsel.

[**Forward Collision Warning (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på BYD Tang 4x4 Long Range, dette førerassistentsystem hjælper føreren med at undgå eller formilde frontale kollisioner.

[**Automatisk nødbremsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på BYD Tang 4x4 Long Range, dette system anvender bremserne autonomt for at forhindre eller reducere alvoren af en kollision, hvis føreren ikke reagerer i tide.

[**Blind-spot Monitoring (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard på BYD Tang 4x4 Long Range, dette sideassistentsystem hjælper med at registrere trafik i døde vinkler.

[**Exit Warning**](../../../../technology/driverassistance/exitwarning/): Standard på BYD Tang 4x4 Long Range, dette system advarer passagererne mod at åbne dørene, hvis der er risiko for at ramme noget.
...
BYD Tang 4x4 Long Range er udstyret med avancerede sikkerhedsfunktioner for at beskytte dig og dit køretøj. Disse inkluderer:
...
Køretøjets maksimale vægt er 3205 kg, med en basisvægt på 2630 kg. Dette giver en maksimal last på 575 kg, inklusive fører og passagerer. Bemærk, at nogle valgmuligheder kan øge basisvægten og reducere den maksimale lastekapacitet.
...
Denne model havde verdenspremiere den 22.08.2024, og leveringerne startede i October 2024. Denne model er kun tilgængelig i Europa.
...
I det hastigt voksende marked for elbiler har EVKX.net identificeret flere alternativer til BYD Tang 4x4 Long Range, der er værd at overveje baseret på funktioner, specifikationer og pris. Selvom disse modeller måske ikke er helt identiske, kan det være nyttigt at sammenligne dem, før du træffer din endelige købsbeslutning:
