...
description: "BYD Tang 4x4 Long Range es un SUV totalmente eléctrico con una autonomía WLTP de hasta 530 km (329 millas). EVKX.net tiene todos los detalles."
weight: 10
hidden: true
shownavtabs: true
...
Hemos separado nuestro artículo BYD Tang 4x4 Long Range en secciones. Si desea esperar para leer el artículo completo, haga clic en los enlaces a continuación para acceder a las diferentes áreas. También tenemos una descripción general de las [especificaciones completas](specifications/), una [galería de imágenes](gallery/), información detallada sobre [rendimiento de carga](chargingcurve/) y algunas [reseñas en línea](reviews/). Nuestras secciones:
...
El BYD Tang 4x4 Long Range ofrece un rendimiento sólido con una potencia máxima de 380 kW (517 hp) y un par total de 680 Nm. Puede acelerar de 0 a 100 km/h en 4,9 segundos y alcanza una velocidad máxima de 190 km/h, lo que lo hace competitivo en su clase.

## Batería, autonomía y carga

La batería de alta capacidad tiene una capacidad bruta de 108,8 kWh y una capacidad neta utilizable de 107,0 kWh, proporcionando un buffer de 1,8 kWh (1,7%) para la protección de la batería. Operando a un voltaje nominal de 640 voltios, se califica como un sistema de batería de 800 voltios. Este alto voltaje es fundamental para habilitar las capacidades de carga del sistema. La batería de iones de litio utiliza [tecnología LFP](../../../../technology/battery/cellchemistry/#batería-de-fosfato-de-hierro-y-litio-lfp). Esto tiene algunos beneficios y desventajas de las baterías NCA/NCM típicas

Según el estándar [WLTP](../../../../guides/understandingrange/wltp/) (Worldwide Harmonized Light Vehicles Test Procedure), la autonomía del vehículo es de 530 km, con una tasa de consumo de energía de 20,2 kWh/100 km. Para obtener datos más detallados del mundo real e información sobre la autonomía, consulte la página dedicada a la [autonomía y el consumo del modelo.](rangeandconsumption/)

La velocidad máxima de carga de CC es 170kW. Una carga completa del 0 al 100 % tardaría 85 minutos, mientras que un escenario más común del 10 al 80 % tardaría 46 minutos. Si supone que pierde 5 minutos conduciendo por cada parada de carga, además del tiempo de carga, el área de carga óptima es del 4% al 59%, lo que da como resultado una velocidad de carga real, incluida la pérdida de tiempo, de 94kW. Cada sesión de carga tardaría 37 minutos y 24 segundos.

En un desafío teórico de 1000 km, comenzando con una batería completa y manteniendo una velocidad constante de 120 km/h en condiciones ideales con un consumo asumido de 31,7 kWh/100 km, el viaje tomaría aproximadamente 10 horas y 37 minutos. Este viaje requeriría dos paradas de carga del 9% al 59%, con un tiempo total de carga de 137 minutos.
...
Este modelo admite V2L (carga de vehículo 2), lo que significa que puedes alimentar equipos eléctricos que requieran hasta 4 kW de potencia, incluida la carga de otros vehículos.

{{<evkxdisplayaddarticle />}}

## Tren de transmisión

BYD Tang 4x4 Long Range tiene un sistema de tracción total sostenido por dos motores, uno en cada eje. Los motores utilizados son [Motores síncronos de imanes permanentes](../../../../technology/motors/pmsm/).
...
La dirección dinámica es una característica un estándar en el BYD Tang 4x4 Long Range. La dirección dinámica varía la relación de dirección en función de la velocidad de conducción.
...
El BYD Tang 4x4 Long Range, con dimensiones de 4970 mm de longitud, 1955 mm de anchura y 1745 mm de altura, pertenece a los SUV de tamaño mediano y ofrece una mezcla de espacio, confort, rendimiento y versatilidad, siendo adecuados para una amplia gama de conductores con necesidades diversas. El BYD Tang 4x4 Long Range está disponible en un total de 3 colores de pintura sólidos.

Puedes seleccionar entre múltiples diseños de ruedas, todos disponibles en el mismo tamaño, en el BYD Tang 4x4 Long Range, lo que te permite personalizar tu vehículo según tu estilo y preferencias de conducción.
...
El BYD Tang 4x4 Long Range ofrece un único tipo de asiento delantero.
...
- La touch pantalla en el centro del tablero mide 15,3 pulgadas de tamaño
...
El BYD Tang 4x4 Long Range cuenta con un sistema de infoentretenimiento llamado BYD DiLink, que está basado en Android. Este sistema está diseñado para proporcionar una interfaz fácil de usar con una variedad de funciones y características para mejorar la experiencia de conducción. Incluye varias aplicaciones y servicios, como navegación, transmisión de música y configuraciones del vehículo, todos accesibles a través de la pantalla táctil. El sistema también admite actualizaciones por aire, lo que garantiza que el vehículo se mantenga actualizado con las últimas funciones y mejoras.
...
Además, el BYD Tang 4x4 Long Range es compatible con Android Auto y Apple CarPlay. Esta funcionalidad te permite presentar la pantalla de tu teléfono en la pantalla del auto para que puedas ejecutar aplicaciones como Google Maps o Waze.

### Sistema de sonido

Un tipo de sistema de sonido está disponible para el BYD Tang 4x4 Long Range.

- Con el Dynaudi sound system, obtienes 12 parlantes con una salida máxima del sistema de 200 vatios.

El modelo tiene 4 conexiones USB-A de serie.

## Aplicación móvil

El BYD Tang 4x4 Long Range viene con su propia aplicación móvil, disponible para dispositivos Android e iOS, que te permite gestionar y monitorear tu vehículo de forma remota. La aplicación ofrece una amplia gama de funciones diseñadas para mejorar tu experiencia de conducción:
...
El BYD Tang 4x4 Long Range incluye varios [sistemas avanzados de asistencia al conductor](../../../../technology/driverassistance/) (ADAS) estándar y opcionales para mejorar la seguridad y el confort.
...
[**Control Electrónico de Estabilidad (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Estándar en el BYD Tang 4x4 Long Range, este sistema mejora la estabilidad y el manejo del vehículo durante maniobras repentinas o en condiciones de carretera resbaladizas.

[**Asistencia para Mantener el Carril (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Estándar en el BYD Tang 4x4 Long Range, este sistema ayuda a prevenir que el vehículo se desplace fuera de su carril. También incluye un sistema de [**Advertencia de Salida de Carril**](../../../../technology/driverassistance/lanedeparturewarning/) para alertar al conductor si el vehículo se sale del carril.

[**Asistencia de Tráfico Cruzado Delantero (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/): Estándar en el BYD Tang 4x4 Long Range, este sistema de asistencia al conductor ayuda a detectar tráfico que se aproxima al cruzar una intersección o al girar a la izquierda o derecha desde una posición detenida.

[**Advertencia de Tráfico Cruzado Trasero (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Estándar en el BYD Tang 4x4 Long Range, este sistema usa sensores para detectar vehículos que se aproximan desde los laterales al retroceder de un espacio de estacionamiento o entrada.

[**Advertencia de Colisión Frontal (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Estándar en el BYD Tang 4x4 Long Range, este sistema de asistencia al conductor ayuda a evitar o mitigar colisiones frontales.

[**Frenado de emergencia automático (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Estándar en el BYD Tang 4x4 Long Range, este sistema aplica los frenos automáticamente para prevenir o reducir la gravedad de una colisión si el conductor no reacciona a tiempo.

[**Monitoreo de Punto Ciego (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Estándar en el BYD Tang 4x4 Long Range, este sistema de asistencia lateral ayuda a detectar tráfico en los puntos ciegos.

[**Advertencia de Salida**](../../../../technology/driverassistance/exitwarning/): Estándar en el BYD Tang 4x4 Long Range, este sistema alerta a los ocupantes para que no abran las puertas si hay riesgo de golpear algo.
...
El BYD Tang 4x4 Long Range está equipado con características de seguridad avanzadas para protegerlo a usted y a su vehículo. Estos incluyen:
...
El peso máximo del vehículo es 3205 kg, con un peso base de 2630 kg. Esto permite una carga máxima de 575 kg, incluyendo el conductor y los pasajeros. Ten en cuenta que algunas opciones pueden aumentar el peso base y reducir la capacidad máxima de carga.
...
Este modelo tuvo un estreno mundial el 22.08.2024 y las entregas comenzaron en October 2024. Este modelo sólo está disponible en Europa.
