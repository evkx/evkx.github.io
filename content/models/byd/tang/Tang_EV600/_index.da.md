...
Den maksimale DC-opladningshastighed er 110kW. En fuld opladning fra 0 - 100 % ville tage 68 minutter, mens et mere almindeligt scenarie på 10-80 % ville tage 37 minutter. Hvis du antager, at du mister 5 minutters kørsel pr. ladestop ud over opladningstiden, er det optimale opladningsområde fra 4% til 59%, hvilket resulterer i en faktisk opladningshastighed, inklusive tidstab på 91kW. Hver opladningssession ville tage 31 minutter og 44 sekunder.

I en teoretisk 1000 km udfordring, der starter med et fuldt batteri og opretholder en konstant hastighed på 120 km/t under ideelle forhold med et antaget forbrug på 31,7 kWh/100 km, ville turen tage cirka 10 timer og 53 minutter. Denne rejse ville kræve to opladningsstop fra 4% til 59%, med en samlet opladningstid på 154 minutter
...
Denne model understøtter V2L (Vehicle 2 Load), hvilket betyder, at du kan forsyne elektrisk udstyr, der kræver op til 2 kW effekt, inklusive opladning af andre køretøjer.

{{<evkxdisplayaddarticle />}}

## Drivetrain

BYD Tang EV600 har et firehjulstræk, der understøttes af to motorer, en på hver aksel. Dene anvendte motorer er [Permanent Magnet Synchronous Motors](../../../../technology/motors/pmsm/).
...
Den BYD Tang EV600, med dimensioner på 4870 mm i længde, 1950 mm i bredde og 1725 mm i højde, tilhører mellemstore SUV'er og tilbyder en blanding af plads, komfort, ydelse og alsidighed, hvilket gør dem velegnede til en bred vifte af førere med forskellige behov. BYD Tang EV600 fås i alt i 5 ensfarvede lakfarver.

Du kan vælge mellem flere hjuldesigns, alle tilgængelige i samme størrelse, på BYD Tang EV600, så du kan tilpasse din bil efter din stil og dine kørselspræferencer.
...
BYD Tang EV600 har et førerfokuseret interiør, der forbedrer cockpitfølelsen med materialer af høj kvalitet i flere områder i stedet for hård plast. Det inkluderer også en traditionel midterkonsol, der adskiller fører og passager, og som giver praktisk opbevaring og funktionalitet.
...
BYD Tang EV600 inkluderer flere funktioner, der forbedrer komfort og bekvemmelighed:
...
Den BYD Tang EV600 inkluderer flere standard- og valgfri [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) for at forbedre sikkerhed og komfort.

### Sikkerhedssystemer

[**Anti-lock Bremsesystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på BYD Tang EV600, dette system forhindrer hjulene i at låse under opbremsning.

[**Electronic Stability Control (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på BYD Tang EV600, dette system forbedrer bilens stabilitet og håndtering under pludselige manøvrer eller på glatte vejforhold.
...
[**Front Cross Traffic Assist (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/): Standard på BYD Tang EV600, dette førerassistentsystem hjælper føreren med at opdage modkørende trafik ved krydsning af et kryds eller ved sving til venstre eller højre fra en stopposition.
...
[**Exit Warning**](../../../../technology/driverassistance/exitwarning/): Standard på BYD Tang EV600, dette system advarer passagererne mod at åbne dørene, hvis der er risiko for at ramme noget.
...
BYD Tang EV600 er udstyret med avancerede sikkerhedsfunktioner for at beskytte dig og dit køretøj. Disse inkluderer:
