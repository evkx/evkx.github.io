...
title: BYD Seal U
linktitle: "Seal U"
description: "Voir ci-dessous pour plus de détails sur les différentes variantes de BYD Seal U"
weight: 30
---
...
<i class="bi bi-battery-full"></i> 87 kWh <i class="bi bi-ev-station"></i> 140 kW 
		...
		<div class="col col-12 col-md-6">
			<ul class="list-group list-group-flush">
				...
				<li class="list-group-item list-group-item-action"><a href="seal_u_design/rangeandconsumption/" class="text-decoration-none text-black" ><i class="bi-file-earmark-bar-graph"></i> Plage</a></li>
				...
				<li class="list-group-item list-group-item-action"><a href="seal_u_design/reviews/" class="text-decoration-none text-black" ><i class="bi-person-video2"></i> Avis</a></li>
			</ul>
		</div>
	</div>
</div>
