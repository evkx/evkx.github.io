---
title: Fisker Ocean Sport Spezifikationen
linktitle: "Spezifikationen"
description: "EVKX.net bietet Ihnen die vollständigen Spezifikationen für Fisker Ocean Sport."
weight: 4
hidden: true
...
EVKX.net strebt an, die vollständigsten Spezifikationen für Fisker Ocean Sport zu haben. Klicken Sie auf das Bild oben für den [vollständigen Artikel](../), besuchen Sie die [Bildergalerie](../gallery/) für hochauflösende Bilder von Fisker Ocean Sport, besuchen Sie die [Ladeinformationen](../chargingcurve/) für Fisker Ocean Sport mit Ladekurve, besuchen Sie die [erweiterten Reichweiteninformationen](../rangeandconsumption/) für reale Reichweiten.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Matt Big Sur Blue (Blau)</br>
				Great White (Weiß)</br>
				Night Drive (Schwarz)</br>
				Blue Planet (Blau)</br>
				Silver Lining (Silber)</br>
				Horizon Gray (Grau)</br>
				Mariana (Blau)</br>
				Sun Soaked (Kupfer)</br>
				Sea Grass (Blau)</br>
				Black Pearl (Schwarz)</br>
				Marine Layer (Weiß)</br>
				Solar Orange</br>
			</td>
		</tr>
	</tbody>
