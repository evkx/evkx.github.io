...
description: "Fisker Ocean Sport er en fuldelektrisk SUV med en rækkevidde på WLTP på op til 464 km (288 miles). EVKX.net har alle detaljerne."
weight: 10
hidden: true
shownavtabs: true
...
Vi har opdelt vores Fisker Ocean Sport artikel i sektioner. Hvis du vil vente med at læse hele artiklen, skal du klikke på nedenstående links til de forskellige områder. Vi har også en oversigt over de [fulde specifikationer](specifications/), et [billedgalleri](gallery/), detaljerede oplysninger om [opladningsydelse](chargingcurve/), og nogle [online anmeldelser](reviews/). Vores sektioner:
...
Den maksimale DC-opladningshastighed er 125kW. En fuld opladning fra 0 - 100 % ville tage 60 minutter, mens et mere almindeligt scenarie på 10-80 % ville tage 33 minutter. Hvis du antager, at du mister 5 minutters kørsel pr. ladestop ud over opladningstiden, er det optimale opladningsområde fra 2% til 63%, hvilket resulterer i en faktisk opladningshastighed, inklusive tidstab på 85kW. Hver opladningssession ville tage 30 minutter og 12 sekunder.

I en teoretisk 1000 km udfordring, der starter med et fuldt batteri og opretholder en konstant hastighed på 120 km/t under ideelle forhold med et antaget forbrug på 29 kWh/100 km, ville turen tage cirka 10 timer og 56 minutter. Denne rejse ville kræve to opladningsstop fra 1% til 64%, med en samlet opladningstid på 156 minutter
...
Den Fisker Ocean Sport, med dimensioner på 4774 mm i længde, 1982 mm i bredde og 1631 mm i højde, tilhører kompakte SUV'er, også kendt som C-SUV'er. Disse biler tilbyder en balance mellem praktisk anvendelighed og manøvredygtighed fra mindre køretøjer samt plads og alsidighed fra større SUV'er. Fisker Ocean Sport fås i alt 12 lakfarver, herunder flere iøjnefaldende metalliske muligheder.
...
Fisker Ocean Sport har plads til fem passagerer med to sæder foran og en tre-personers bænk bagtil.

#### Første række sæder

Fisker Ocean Sport tilbyder kun én type forreste sæde.
...
Fisker Ocean Sport inkluderer flere funktioner, der forbedrer komfort og bekvemmelighed:
...
Fisker Ocean Sport er udstyret med en enkelt type rat:
...
Én type lydsystem er tilgængelig for Fisker Ocean Sport.
...
Den Fisker Ocean Sport inkluderer flere standard- og valgfri [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) for at forbedre sikkerhed og komfort.
...
[**Anti-lock Bremsesystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Fisker Ocean Sport, dette system forhindrer hjulene i at låse under opbremsning.

[**Electronic Stability Control (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Fisker Ocean Sport, dette system forbedrer bilens stabilitet og håndtering under pludselige manøvrer eller på glatte vejforhold.
...
[**Forward Collision Warning (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Fisker Ocean Sport, dette førerassistentsystem hjælper føreren med at undgå eller formilde frontale kollisioner.

[**Automatisk nødbremsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Fisker Ocean Sport, dette system anvender bremserne autonomt for at forhindre eller reducere alvoren af en kollision, hvis føreren ikke reagerer i tide.
...
[**Blind-spot Monitoring (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard på Fisker Ocean Sport, dette sideassistentsystem hjælper med at registrere trafik i døde vinkler.

[**Exit Warning**](../../../../technology/driverassistance/exitwarning/): Standard på Fisker Ocean Sport, dette system advarer passagererne mod at åbne dørene, hvis der er risiko for at ramme noget.
...
Fisker Ocean Sport er udstyret med avancerede sikkerhedsfunktioner for at beskytte dig og dit køretøj. Disse inkluderer:
