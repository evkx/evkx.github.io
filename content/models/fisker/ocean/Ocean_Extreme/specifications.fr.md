---
title: Fisker Ocean Extreme spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Fisker Ocean Extreme."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Fisker Ocean Extreme. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Fisker Ocean Extreme, visitez les [chargeinfo](../chargecurve/) pour Fisker Ocean Extreme avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
