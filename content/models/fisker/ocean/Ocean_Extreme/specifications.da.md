---
title: Fisker Ocean Extreme specifikationer
linktitle: "Specifikationer"
description: "EVKX.net giver dig de fulde specifikationer for Fisker Ocean Extreme."
weight: 4
hidden: true
...
EVKX.net søger at have de mest komplette specifikationer for Fisker Ocean Extreme. Klik på billedet ovenfor for [fuld artikel](../), besøg [billedgalleriet](../gallery/) for billeder i høj opløsning af Fisker Ocean Extreme, besøg [chargeinfo](../chargingcurve/) for Fisker Ocean Extreme med chargecurve, se [extended range info](../rangeandconsumption/) for real world ranges.
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Night Drive (Sort)</br>
				Blue Planet (Blå)</br>
				Silver Lining (Sølv)</br>
				Horizon Gray (Grå)</br>
				Mariana (Blå)</br>
				Sun Soaked (Kobber)</br>
				Sea Grass (Blå)</br>
				Black Pearl (Sort)</br>
				Marine Layer (Hvid)</br>
				Solar Orange</br>
			</td>
		</tr>
	</tbody>
