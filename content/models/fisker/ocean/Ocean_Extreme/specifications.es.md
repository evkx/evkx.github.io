---
title: Fisker Ocean Extreme especificaciones
linktitle: "Especificaciones"
description: "EVKX.net le brinda las especificaciones completas para Fisker Ocean Extreme."
weight: 4
hidden: true
...
EVKX.net busca tener las especificaciones más completas para Fisker Ocean Extreme. Haga clic en la imagen de arriba para ver [artículo completo](../), visite la [galería de imágenes](../gallery/) para imágenes de alta resolución de Fisker Ocean Extreme, visite [chargeinfo](../chargecurve/) para Fisker Ocean Extreme con chargecurve, visite [información de rango extendido](../rangeandconsumption/) para rangos del mundo real.
