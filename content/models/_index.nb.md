...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<p>
	Audi har 5 modell(er) med totalt 36 varianter.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Hyundai</h2>
	<p>
	Hyundai har 4 modell(er) med totalt 9 varianter.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Kia</h2>
	<p>
	Kia har 4 modell(er) med totalt 11 varianter.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Porsche</h2>
	<p>
	Porsche har 2 modell(er) med totalt 26 varianter.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<p>
	Skoda har 1 modell(er) med totalt 12 varianter.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Volkswagen</h2>
	<p>
	Volkswagen har 5 modell(er) med totalt 25 varianter.
	</p>
