...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<p>
	Audi har 5 modell(er) med totalt 31 varianter.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Ford</h2>
	<p>
	Ford har 3 modell(er) med totalt 10 varianter.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	<h2>Maserati</h2>
	<p>
	Maserati har 1 modell(er) med totalt 1 varianter.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Mercedes</h2>
	<p>
	Mercedes har 7 modell(er) med totalt 30 varianter.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Porsche</h2>
	<p>
	Porsche har 2 modell(er) med totalt 23 varianter.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Tesla</h2>
	<p>
	Tesla har 5 modell(er) med totalt 17 varianter.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Volkswagen</h2>
	<p>
	Volkswagen har 5 modell(er) med totalt 20 varianter.
	</p>
