...
description: "XPENG G9 RWD Standard Range er en helt elektrisk SUV med en rækkevidde på WLTP på op til 460 km (286 miles). EVKX.net har alle detaljerne."
weight: 10
hidden: true
shownavtabs: true
...
Batteriet har en bruttokapacitet på 78,2kWh og en nettokapacitet på 75kWh, hvilket betyder, at du har en 3,2kWh buffer til beskyttelse. (4,1%). Lithium-Ion-batteriet bruger [LFP-teknologi.](../../../../technology/battery/cellchemistry/#lithium-iron-phosphate-battery-lfp) Dette har nogle fordele og ulemper fra de typiske NCA/NCM-batterier.

[WLTP-rækkevidde](../../../../guides/understandingrange/wltp/) er 460 km (286 mi). Forbruget er 16.3kWh/100 km for WLTP-standardtesten. For flere detaljer om rækkevidden, se virkelige data og rækkevidde på denne models [rækkevidde og forbrug](rangeandconsumption/) side.
...
Til den teoretiske 1000 km-udfordring, der starter med fuldt batteri og kører med 120 km/t (75 mph), forudsat optimale køreforhold og forbrug på 25kWh/100 km, vil 1000 km tage 9 timer og 33 minutter. Denne tur vil kræve fem opladningssession(er) opladning fra 1 % til 48%. Den samlede tid, der går tabt for at oplade batteriet, vil være 74 minutter.
...
XPENG G9 RWD Standard Range har et baghjulstræksystem, der understøttes af en motor på bagakslen. Den(e) anvendte motor(er) er [Permanent Magnet Synchronous Motors](../../../../technology/motors/pmsm/).
...
Kun én type forsæde er tilgængelig i XPENG G9 RWD Standard Range.
...
XPENG G9 RWD Standard Range har flere funktioner til at gøre dit liv som chauffør eller passager mere behageligt.
