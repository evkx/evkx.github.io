---
title: XPENG G6 RWD Standard Range especificaciones
linktitle: "Especificaciones"
description: "EVKX.net le brinda las especificaciones completas para XPENG G6 RWD Standard Range."
weight: 4
hidden: true
...
EVKX.net busca tener las especificaciones más completas para XPENG G6 RWD Standard Range. Haga clic en la imagen de arriba para ver [artículo completo](../), visite la [galería de imágenes](../gallery/) para imágenes de alta resolución de XPENG G6 RWD Standard Range, visite [chargeinfo](../chargingcurve/) para XPENG G6 RWD Standard Range con chargecurve, visite [información de rango extendido](../rangeandconsumption/) para rangos del mundo real.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Artic White (Blanco)</br>
				Silver Frost (Plata)</br>
				Graphite Gray (Gris)</br>
				Midnight Black (Negro)</br>
				Kaitoke Green Matte (Verde)</br>
			</td>
		</tr>
	</tbody>
</table>
