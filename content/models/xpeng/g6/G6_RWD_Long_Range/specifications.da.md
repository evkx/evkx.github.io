---
title: XPENG G6 RWD Long Range specifikationer
linktitle: "Specifikationer"
description: "EVKX.net giver dig de fulde specifikationer for XPENG G6 RWD Long Range."
weight: 4
hidden: true
...
EVKX.net søger at have de mest komplette specifikationer for XPENG G6 RWD Long Range. Klik på billedet ovenfor for [fuld artikel](../), besøg [billedgalleriet](../gallery/) for billeder i høj opløsning af XPENG G6 RWD Long Range, besøg [chargeinfo](../chargingcurve/) for XPENG G6 RWD Long Range med chargecurve, se [extended range info](../rangeandconsumption/) for real world ranges.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Artic White (Hvid)</br>
				Silver Frost (Sølv)</br>
				Graphite Gray (Grå)</br>
				Midnight Black (Sort)</br>
				Kaitoke Green Matte (Grøn)</br>
			</td>
		</tr>
	</tbody>
</table>
