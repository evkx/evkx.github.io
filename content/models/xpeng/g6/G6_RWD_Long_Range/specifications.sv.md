...
description: "EVKX.net ger dig alla specifikationer för XPENG G6 RWD Long Range."
weight: 4
hidden: true
...
EVKX.net vill ha de mest kompletta specifikationerna för XPENG G6 RWD Long Range. Klicka på bilden ovan för [fullständig artikel](../), besök [bildgalleri](../gallery/) för hög upplösningsbilder av XPENG G6 RWD Long Range, gå till [chargeinfo](../chargecurve/) för XPENG G6 RWD Long Range med laddningskurva, se [extended range info](../rangeandconsumption/) för verkliga räckvidd.
