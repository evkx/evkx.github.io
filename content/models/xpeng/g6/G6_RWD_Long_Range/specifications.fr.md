---
title: XPENG G6 RWD Long Range spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de XPENG G6 RWD Long Range."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour XPENG G6 RWD Long Range. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de XPENG G6 RWD Long Range, visitez les [chargeinfo](../chargingcurve/) pour XPENG G6 RWD Long Range avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Silver Frost (Argent)</br>
				Graphite Gray (Gris)</br>
				Midnight Black (Noir)</br>
				Kaitoke Green Matte (Vert)</br>
			</td>
		</tr>
	</tbody>
</table>
