...
Le XPENG P7 AWD Performance a une puissance maximale de 405 KW (551 ch/543 ch). Le couple total est de 717 nm (529 ft-lb). Il effectue le sprint de 0 à 100 km/h (0 à 62 mph) en 3,9 secondes. La vitesse maximale est de 205 km/h.

## Batterie, autonomie et charge

La batterie a une capacité brute de 86,2kWh et une capacité nette de 82,7kWh, ce qui signifie que vous disposez d'une réserve de 3,5kWh pour la protection. (4,1%). La batterie Lithium-Ion utilise la [technologie NMC.](../../../../technology/battery/cellchemistry/#lithium-nickel-manganese-cobalt- oxydes-nmc)

La [plage WLTP](../../../../guides/understandingrange/wltp/) est de 505 km (314 mi). La consommation est de 16,4kWh/100km pour le test standard WLTP. Pour plus de détails sur l'autonomie, consultez les données réelles et la liste de l'autonomie sur la page [autonomie et consommation](autonomie et consommation/) de ce modèle.
...
Pour le défi théorique de 1 000 km, en commençant avec une batterie pleine et en roulant à 120 km/h (75 mph), en supposant des conditions de conduite optimales et une consommation de 28kWh/100 km, 1 000 km prendront 9 heures et 40 minutes. Ce trajet nécessitera cinq sessions de charge de 1 % à 49 %. Le temps total perdu pour charger la batterie sera de 80 minutes.

### Chargeur embarqué

Pour la recharge CA de niveau 1 et de niveau 2, le chargeur embarqué  prend en charge jusqu'à 11 KW de charge. Par conséquent, vous pouvez charger la batterie de 0 à 100 % depuis chez vous en environ 7 heures et 31 minutes.
...
XPENG P7 AWD Performance dispose d'un système de transmission intégrale pris en charge par deux moteurs, un sur chaque essieu. Le(s) moteur(s) utilisé(s) sont des [Moteurs synchrones à aimants permanents](../../../../technology/motors/pmsm/).
...
Un seul type de siège avant est disponible dans le XPENG P7 AWD Performance.
...
XPENG P7 AWD Performance dispose de plusieurs fonctionnalités pour rendre votre vie de conducteur ou de passager plus confortable.
...
Le XPENG P7 AWD Performance dispose de plusieurs [systèmes avancés d'aide à la conduite](../../../../technology/driverassistance/) (ADAS) standard et en option pour une sécurité et un confort améliorés.
### Systèmes de sécurité



Le XPENG P7 AWD Performance dispose d'un [**système de freinage antiblocage (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/) comme un standard. Ce système permet d'éviter le blocage des roues d'un véhicule lors du freinage.

Le XPENG P7 AWD Performance dispose d'un [**Contrôle électronique de stabilité**](../../../../technology/driverassistance/electronicstabilitycontrol/) comme un standard système conçu pour améliorer la stabilité et la maniabilité d'un véhicule lors de manœuvres brusques ou de routes glissantes.
