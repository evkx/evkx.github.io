...
title: XPENG P7
linktitle: "P7"
description: "Vea a continuación los detalles de las diferentes variantes de XPENG P7"
weight: 30
---
...
<i class="bi bi-record2-fill"></i> AWD <i class="bi bi-battery-full"></i> 86,2 kWh <i class="bi bi-ev-station"></i> 175 kW 
		...
		<div class="col col-12 col-md-6">
			<ul class="list-group list-group-flush">
				...
				<li class="list-group-item list-group-item-action"><a href="p7_awd_performance/rangeandconsumption/" class="text-decoration-none text-black" ><i class="bi-file-earmark-bar-graph"></i> Autonomía</a></li>
