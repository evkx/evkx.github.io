---
title: BMW iX3 Specifikationer
linktitle: "Specifikationer"
description: "EVKX.net ger dig alla specifikationer för BMW iX3."
weight: 4
hidden: true
...
EVKX.net vill ha de mest kompletta specifikationerna för BMW iX3. Klicka på bilden ovan för [fullständig artikel](../), besök [bildgalleri](../gallery/) för hög upplösningsbilder av BMW iX3, gå till [chargeinfo](../chargecurve/) för BMW iX3 med laddningskurva, se [extended range info](../rangeandconsumption/) för verkliga räckvidd.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Carbon black metallic (Svart)</br>
				Kaschmir silver metallic</br>
				Mineral white metallic (Vit)</br>
				Phytonic Blue (Blå)</br>
				Piemont Red (Röd)</br>
				Sophisto grey brilliant effect metallic (Grå)</br>
			</td>
		</tr>
	</tbody>
</table>
