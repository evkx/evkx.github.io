...
EVKX.net seeks to have the most complete specifications for BMW iX3. Click on image above for [full article](../), visit the [image gallery](../gallery/) for high-res images of BMW iX3, visit the [chargeinfo](../chargingcurve/) for BMW iX3 with chargecurve, vist [extended range info](../rangeandconsumption/) for real world ranges.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Carbon black metallic</br>
				Kaschmir silver metallic</br>
				Mineral white metallic</br>
				Phytonic Blue</br>
				Piemont Red</br>
				Sophisto grey brilliant effect metallic (Gray)</br>
			</td>
		</tr>
	</tbody>
</table>
