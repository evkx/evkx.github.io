---
title: BMW iX3 especificaciones
linktitle: "Especificaciones"
description: "EVKX.net le brinda las especificaciones completas para BMW iX3."
weight: 4
hidden: true
...
EVKX.net busca tener las especificaciones más completas para BMW iX3. Haga clic en la imagen de arriba para ver [artículo completo](../), visite la [galería de imágenes](../gallery/) para imágenes de alta resolución de BMW iX3, visite [chargeinfo](../chargingcurve/) para BMW iX3 con chargecurve, visite [información de rango extendido](../rangeandconsumption/) para rangos del mundo real.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Carbon black metallic (Negro)</br>
				Kaschmir silver metallic (Plata)</br>
