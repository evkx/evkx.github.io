...
description: "Genesis Electrified GV70 ist ein vollelektrisches Premium-SUV mit einer Reichweite von bis zu 470 km (292 Meilen). EVKX.net hat alle Details."
weight: 10
hidden: true
shownavtabs: true
...
Der Genesis Electrified GV70 liefert eine solide Leistung mit einer maximalen Leistung von 320 kW (435 PS / 429 bhp) und einem Gesamtdrehmoment von 700 Nm (517 lb-ft). Er beschleunigt in 4,8 Sekunden von 0 auf 100 km/h (0 auf 62 mph) und erreicht eine Höchstgeschwindigkeit von 235 km/h (146 mph), was ihn wettbewerbsfähig in seiner Klasse macht.
...
Der Genesis Electrified GV70 verfügt über ein Allradantriebssystem, das von zwei Motoren angetrieben wird, einem an jeder Achse. Die verwendeten Motoren sind [Permanentmagnet-Synchronmotoren](../../../../technology/motors/pmsm/).
...
Der Genesis Electrified GV70, mit Abmessungen von 4715 mm Länge, 1910 mm Breite und 1630 mm Höhe, fällt in die Kategorie der kompakten SUVs, auch als C-SUVs bekannt. Diese bieten eine Balance zwischen der Praktikabilität und Manövrierfähigkeit kleinerer Fahrzeuge und dem Raum und der Vielseitigkeit größerer SUVs. Der Genesis Electrified GV70 ist in insgesamt 8 Lackfarben erhältlich, darunter mehrere auffällige Metallic-Optionen.

Der Genesis Electrified GV70 bietet mehrere Radoptionen in verschiedenen Größen, sodass Sie Ihr Fahrzeug an Ihren Stil und Ihre Fahrpräferenzen anpassen können. Die verfügbaren Reifen- und Radkombinationen umfassen:
...
Der Genesis Electrified GV70 bietet Platz für fünf Passagiere mit zwei Vordersitzen und einer Dreiersitzbank hinten.

#### Vordersitze

Der Genesis Electrified GV70 bietet nur einen Typ von Vordersitz.
...
- Green [Leder-Polsterung](../../../../technology/seats/materials/#leather)
...
- Green [Nappa-Leder-Polsterung](../../../../technology/seats/materials/#leather)
- Black/White [Nappa-Leder-Polsterung](../../../../technology/seats/materials/#leather)
...
Der Genesis Electrified GV70 umfasst mehrere Funktionen, um Komfort und Bequemlichkeit zu verbessern:
...
- Der -Bildschirm hinter dem Lenkrad im Armaturenbrett integriert ist 8,0 Zoll groß.
- Der touch-Bildschirm in der Mitte des Armaturenbretts ist 14,9 Zoll groß.
- Der touch-Bildschirm unten in der Mittelkonsole ist 5,0 Zoll groß.
...
Der Genesis Electrified GV70 ist mit einem einzigen Lenkradtyp ausgestattet:
...
Der Genesis Electrified GV70 unterstützt Android Auto und Apple CarPlay, sodass Sie den Bildschirm Ihres Telefons auf dem Display des Autos spiegeln können. Diese Funktion ermöglicht es Ihnen, Apps wie Google Maps oder Waze direkt von Ihrem Telefon aus zu nutzen.
...
Der Genesis Electrified GV70 verfügt über eine Reihe von standardmäßigen und optionalen [fortschrittlichen Fahrerassistenzsystemen](../../../../technology/driverassistance/) (ADAS), die die Sicherheit und den Komfort verbessern sollen.

### Sicherheitssysteme

[**Antiblockiersystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard im Genesis Electrified GV70, dieses System verhindert das Blockieren der Räder beim Bremsen.

[**Elektronische Stabilitätskontrolle (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard im Genesis Electrified GV70, dieses System verbessert die Stabilität und das Handling des Fahrzeugs bei plötzlichen Manövern oder auf rutschigen Straßenbedingungen.

[**Spurhalteassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard im Genesis Electrified GV70, dieses System hilft, das Fahrzeug in seiner Spur zu halten. Es umfasst auch ein [**Spurverlassenswarnsystem**](../../../../technology/driverassistance/lanedeparturewarning/), das den Fahrer warnt, wenn das Fahrzeug die Spur verlässt.

[**Front Cross Traffic Assist (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/): Standard im Genesis Electrified GV70, dieses Fahrerassistenzsystem hilft Fahrern, den Querverkehr zu erkennen, wenn sie eine Kreuzung überqueren oder von einer stehenden Position nach links oder rechts abbiegen.

[**Querverkehrswarnung hinten (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard im Genesis Electrified GV70, dieses System verwendet Sensoren, um herannahende Fahrzeuge von der Seite zu erkennen, wenn Sie aus einer Parklücke oder Einfahrt zurücksetzen.

[**Automatische Notbremsung (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard im Genesis Electrified GV70, dieses System bremst autonom, um eine Kollision zu verhindern oder deren Schwere zu verringern, wenn der Fahrer nicht rechtzeitig reagiert.

[**Automatische Notlenkung (AES)**](../../../../technology/driverassistance/automaticemergencysteering/): Standard im Genesis Electrified GV70, dieses System hilft, Kollisionen zu vermeiden, indem es das Fahrzeug in einer Notlage automatisch lenkt.

[**Totwinkelüberwachung (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/): Standard im Genesis Electrified GV70, dieses Seitenassistenzsystem hilft, den Verkehr im toten Winkel zu erkennen.
...
Der Genesis Electrified GV70 ist mit wesentlichen Sicherheitsfunktionen ausgestattet, um Sie und Ihr Fahrzeug zu schützen und Einfachheit und Zuverlässigkeit zu bieten. Diese umfassen:

{{<evkxdisplayaddarticle />}}

## Ladekapazität und Anhängelast

Der Kofferraum bietet ein Ladevolumen von 503 Litern (17,8 CU FT). Mit umgeklappter Rücksitzbank erweitert sich dies auf 1678 Liter (59,3 CU FT). Auf dem Dach können Sie bis zu 100 kg (220,5 lbs) laden. Dachreling ist serienmäßig für die einfache Montage einer Dachbox oder eines Dachträgers. Zusätzlich gibt es einen Frunk (vorderer Kofferraum) mit einem Ladevolumen von 25 Litern (0,9 CU FT).

Das maximale Gewicht des Fahrzeugs beträgt 2845 kg (6272 lbs) bei einem Leergewicht von 2235 kg (4927 lbs). Dies ermöglicht eine maximale Zuladung von 610 kg (1345 lbs), einschließlich Fahrer und Passagieren. Beachten Sie, dass einige Optionen das Leergewicht erhöhen und die maximale Zuladung verringern können.
...
{{< pagenavigation b_url="../" b_title="Genesis GV70" f_url="rangeandconsumption/" f_title="Reichweite" >}}
