...
Con overboost, el Genesis Electrified GV70 tiene una potencia máxima de 360 KW (490 hp / 483 bhp). Sin overboost, es de 320 KW (435 CV / 435 CV). El par total es 700 nm (517 ft-lb). Realiza el sprint de 0 a 100 km/h (0 a 62 mph) en 4,2 segundos con overboost y 4,8 segundos sin overboost. La velocidad máxima es 235 km/h.
...
El [rango WLTP](../../../../guides/understandingrange/wltp/) es 470 km (292 mi). El consumo es de 15,7kWh/100 km para la prueba estándar WLTP. Para obtener más detalles sobre el alcance, consulte los datos del mundo real y el listado de alcance en la página [rango y consumo](rangeandconsumption/) de este modelo.
...
Sólo hay un tipo de asiento delantero disponible en el Genesis Electrified GV70.
...
Además, con el sistema de navegación para automóvil estándar, obtienes la ayuda que necesitas para encontrar tu destino. Además, el Genesis Electrified GV70 es compatible con Android Auto y Apple CarPlay. Esta funcionalidad te permite presentar la pantalla de tu teléfono en la pantalla del auto para que puedas ejecutar aplicaciones como Google Maps o Waze.
...
El Genesis Electrified GV70 tiene varios [sistemas avanzados de asistencia al conductor](../../../../technology/driverassistance/) (ADAS) estándar y opcionales para mayor seguridad y comodidad.
### Sistemas de seguridad



El Genesis Electrified GV70 tiene un [**sistema de frenos antibloqueo (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/) como un estándar sistema. Este sistema ayuda a evitar que las ruedas del vehículo se bloqueen durante el frenado.

El Genesis Electrified GV70 tiene un [**Control Electrónico de Estabilidad**](../../../../technology/driverassistance/electronicstabilitycontrol/) como sistema un estándar diseñado para mejorar la estabilidad y el manejo de un vehículo durante maniobras repentinas o condiciones de carretera resbaladizas.

El Genesis Electrified GV70 tiene un [**asistente para mantenerse en el carril**](../../../../technology/driverassistance/lanekeepingassist/) como sistema un estándar. El sistema ayuda a evitar que el coche se salga de su carril. Además, cuenta con un sistema de [**aviso de salida de carril**](../../../../technology/driverassistance/lanedeparturewarning/) que avisa al conductor si el vehículo abandona el carril de conducción.
...
El Genesis Electrified GV70 tiene [**frenado automático de emergencia**](../../../../technology/driverassistance/automaticemergencybraking/) como sistema un estándar. Este sistema ayuda prevenir o mitigar colisiones aplicando los frenos de forma autónoma si el conductor no reacciona ante una colisión inminente.
...
La capacidad de carga en el maletero es de 503 litros. Con el asiento trasero abatido, es de 1678 litros. En el techo, puedes cargar hasta 100 kg (220,5 lbs). Debajo del capó, hay un maletero con más espacio de almacenamiento. Este maletero mide 25 litros (0,9 CU FT). El peso máximo del automóvil es 2845 kg (6272 lbs), y con el peso base de 2235 kg (4927 lbs), puedes cargar como máximo 610 kg (1345 lbs), incluidos el conductor y los pasajeros. Algunas opciones pueden aumentar el peso base y reducir el peso máximo de carga.
