...
Genesis GV60 ist ein SUV, der in 3 Varianten erhältlich ist.
</p>
	<a href="gv60/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Genesis GV70 ist ein Premium-SUV, der in 1 Varianten erhältlich ist.
</p>
	<a href="gv70/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
        </div>
