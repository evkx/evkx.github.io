---
title: Genesis GV60 AWD Performance especificaciones
linktitle: "Especificaciones"
description: "EVKX.net le brinda las especificaciones completas para Genesis GV60 AWD Performance."
weight: 4
hidden: true
...
EVKX.net busca tener las especificaciones más completas para Genesis GV60 AWD Performance. Haga clic en la imagen de arriba para ver [artículo completo](../), visite la [galería de imágenes](../gallery/) para imágenes de alta resolución de Genesis GV60 AWD Performance, visite [chargeinfo](../chargingcurve/) para Genesis GV60 AWD Performance con chargecurve, visite [información de rango extendido](../rangeandconsumption/) para rangos del mundo real.
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Matterhorn White (Blanco)</br>
				Hanauma Mint (Menta)</br>
				Vik Black (Negro)</br>
				Carbon Metal (Negro)</br>
				Savile Silver (Plata)</br>
				Uyuni White (Blanco)</br>
				Atacama Copper (Cobre)</br>
				Royal Blue (Azul)</br>
				Sao Paulo Lime (Lima)</br>
			</td>
		</tr>
	</tbody>
</table>
