---
title: Genesis GV60 AWD Performance spesifikasjoner
linktitle: "Spesifikasjoner"
description: "EVKX.net gir deg alle spesifikasjonene for Genesis GV60 AWD Performance."
weight: 4
hidden: true
...
EVKX.net søker å ha de mest komplette spesifikasjonene for Genesis GV60 AWD Performance. Klikk på bildet ovenfor for [full artikkel](../), besøk [bildegalleriet](../gallery/) for høyoppløselige bilder av Genesis GV60 AWD Performance, gå til [chargeinfo](../chargingcurve/) for Genesis GV60 AWD Performance med ladekurve, se [extended range info](../rangeandconsumption/) for real world ranges.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Melbourne Gray (Grå)</br>
				Matterhorn White (Hvit)</br>
				Hanauma Mint</br>
				Vik Black (Svart)</br>
				Carbon Metal (Svart)</br>
				Savile Silver (Sølv)</br>
				Uyuni White (Hvit)</br>
				Atacama Copper (Kobber)</br>
				Royal Blue (Blå)</br>
				Sao Paulo Lime</br>
			</td>
		</tr>
