...
EVKX.net søker å ha de mest komplette spesifikasjonene for Lotus Eletre. Klikk på bildet ovenfor for [full artikkel](../), besøk [bildegalleriet](../gallery/) for høyoppløselige bilder av Lotus Eletre, gå til [chargeinfo](../chargingcurve/) for Lotus Eletre med ladekurve, se [extended range info](../rangeandconsumption/) for real world ranges.
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				Senter tak over bakvindu (Valgfritt)</br>
				Venstre fremre side (Valgfritt)</br>
				Høyre fremre side (Valgfritt)</br>
			</td>
		</tr>
	</tbody>
</table>
