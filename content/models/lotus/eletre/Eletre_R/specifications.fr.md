---
title: Lotus Eletre R spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Lotus Eletre R."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Lotus Eletre R. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Lotus Eletre R, visitez les [chargeinfo](../chargingcurve/) pour Lotus Eletre R avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				Toit central au-dessus de la fenêtre arrière (Optionnel)</br>
				Côté avant gauche (Optionnel)</br>
				Côté avant droit (Optionnel)</br>
			</td>
		</tr>
	</tbody>
</table>
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Kaimu Grey (Gris)</br>
				Stellar Black (Noir)</br>
				Solar Yellow (Jaune)</br>
				Natron Red (Rouge)</br>
				Galloway Green (Vert)</br>
				Blossom Grey (Gris)</br>
			</td>
		</tr>
	</tbody>
</table>
