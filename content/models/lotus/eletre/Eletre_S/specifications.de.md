---
title: Lotus Eletre S Spezifikationen
linktitle: "Spezifikationen"
description: "EVKX.net bietet Ihnen die vollständigen Spezifikationen für Lotus Eletre S."
weight: 4
hidden: true
...
EVKX.net strebt an, die vollständigsten Spezifikationen für Lotus Eletre S zu haben. Klicken Sie auf das Bild oben für den [vollständigen Artikel](../), besuchen Sie die [Bildergalerie](../gallery/) für hochauflösende Bilder von Lotus Eletre S, besuchen Sie die [Ladeinformationen](../chargingcurve/) für Lotus Eletre S mit Ladekurve, besuchen Sie die [erweiterten Reichweiteninformationen](../rangeandconsumption/) für reale Reichweiten.
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				Mitteldach über Heckscheibe (Optional)</br>
				Linke Vorderseite (Optional)</br>
				Rechte Vorderseite (Optional)</br>
			</td>
		</tr>
	</tbody>
</table>
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Kaimu Grey (Grau)</br>
				Stellar Black (Schwarz)</br>
				Solar Yellow (Gelb)</br>
				Natron Red (Rot)</br>
				Galloway Green (Grün)</br>
				Blossom Grey (Grau)</br>
			</td>
		</tr>
	</tbody>
</table>
