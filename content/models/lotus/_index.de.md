...
Lotus Eletre ist ein Luxus-SUV, der in 3 Varianten erhältlich ist.
</p>
	<a href="eletre/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Lotus Emeya ist eine Luxuslimousine, die in 3 Varianten erhältlich ist.
</p>
	<a href="emeya/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
        </div>
