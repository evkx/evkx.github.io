...
Chevrolet Blazer EV ist ein SUV, der in 2 Varianten erhältlich ist.
</p>
	<a href="blazer_ev/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Chevrolet Equinox EV ist ein SUV, der in 2 Varianten erhältlich ist.
</p>
	<a href="equinox_ev/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Chevrolet Silverado EV ist ein Pickup-Truck, der in 3 Varianten erhältlich ist.
</p>
	<a href="silverado_ev/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
        </div>
