...
Chevrolet Blazer EV es un SUV disponible en 3 variantes.
</p>
	<a href="blazer_ev/" class="btn btn-outline-primary" role="button">Ir a la información del modelo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Chevrolet Equinox EV es un SUV disponible en 2 variantes.
</p>
	<a href="equinox_ev/" class="btn btn-outline-primary" role="button">Ir a la información del modelo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Chevrolet Silverado EV es una camioneta pickup disponible en 3 variantes.
</p>
