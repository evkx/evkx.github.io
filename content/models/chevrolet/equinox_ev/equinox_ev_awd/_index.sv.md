...
Chevrolet Equinox EV AWD har en maximal effekt på 215 KW (292hk). Totalt vridmoment är 469 Nm. Den gör sprinten 0-100 km/h på 5,9 sekunder.
...
För nivå 1 och nivå 2 AC-laddning stöder standard inbyggd laddare upp till 11,5KW-laddning. Som ett resultat kan du ladda batteriet 0-100 % hemifrån på ca. 7 timmar och 23 minuter. Du kan också välja en valfri inbyggd laddare som stöder upp till 19,2 KW laddning. Som ett resultat kan du ladda batteriet 0-100 % hemifrån på cirka 4 timmar och 25 minuter.
...
Chevrolet Equinox EV AWD har ett fyrhjulsdriftsystem som stöds av två motorer, en på varje axel. Motorerna som används är [Permanent Magnet Synchronous Motors](../../../../technology/motors/pmsm/).
...
Endast en typ av framsäte är tillgänglig i Chevrolet Equinox EV AWD.
...
Chevrolet Equinox EV AWD har flera funktioner för att göra ditt liv som förare eller passagerare bekvämare.
...
Du kan välja mellan två ljudsystem på Chevrolet Equinox EV AWD. Med Lyric sound system får du sju högtalare med en maximal systemeffekt på  watt. Med Lyric sound system får du sju högtalare med en maximal systemeffekt på  watt.

Dessutom, med standard navigationssystemet i bilen får du den hjälp du behöver för att hitta din destination. Dessutom stöder Chevrolet Equinox EV AWD Android Auto och Apple CarPlay. Denna funktion gör att du kan visa telefonens skärm på bilens skärm så att du kan köra appar som Google Maps eller Waze.
...
Chevrolet Equinox EV AWD har flera standard- och valfria [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) för bättre säkerhet och komfort.
### Säkerhetssystem



Chevrolet Equinox EV AWD har en [**filhållningsassistent**](../../../../technology/driverassistance/lanekeepingassist/) som standard-system. Detta system bidrar för att förhindra att bilen lämnar körfältet. Dessutom har den ett [**filavvikelsevarning**](../../../../technology/driverassistance/lanedeparturewarning/) system som varnar föraren om fordonet lämnar körfältet.
...
Chevrolet Equinox EV AWD har [**automatisk nödbroms**](../../../../technology/driverassistance/automaticemergencybraking/) som standard-system. Detta system hjälper till att förhindra eller mildra kollisioner genom att ansätta bromsarna autonomt om föraren inte reagerar på en förestående kollision.
...
Chevrolet Equinox EV AWD erbjuder [nivå 1 eller 2 körautomation](../../../../technology/driverassistance/#nivå-av-autonom-körning), beroende på utrustningsnivå.

Med   nivå 1-systemet får du följande körautomationsfunktioner.
- [**Adaptiv farthållare**](../../../../technology/driverassistance/adaptivecruisecontrol/)


Med Super Cruise  nivå 2-systemet får du fler körautomatiseringsfunktioner än de som anges ovan.
