...
Chevrolet Blazer EV RS AWD erbjuder blygsamma prestanda med en maximal effekt på 214 kW (291 hk) och ett totalt vridmoment på 451 Nm. Den accelererar från 0 till 100 km/h på 6 sekunder och har en topphastighet på 210 km/h, vilket är mer i linje med traditionella förbränningsmotorfordon.
...
[EPA-räckvidd](../../../../guides/understandingrange/epa/) är 279 miles (449 km). Förbrukningen är 3,3mi/kWh för EPA-standardtestet. För mer detaljerad verklig data och information om räckvidd, se modellens dedikerade [räckvidds- och förbrukningssida.](rangeandconsumption/)
...
Endast en typ av framsäte är tillgänglig i Chevrolet Blazer EV RS AWD.
...
Chevrolet Blazer EV RS AWD har flera funktioner för att göra ditt liv som förare eller passagerare bekvämare.
...
En typ av ljudsystem är tillgänglig för Chevrolet Blazer EV RS AWD. Med Lyric sound system får du sju högtalare med en maximal systemeffekt på  watt.

Dessutom, med standard navigationssystemet i bilen får du den hjälp du behöver för att hitta din destination. Dessutom stöder Chevrolet Blazer EV RS AWD Android Auto och Apple CarPlay. Denna funktion gör att du kan visa telefonens skärm på bilens skärm så att du kan köra appar som Google Maps eller Waze.
...
Chevrolet Blazer EV RS AWD har flera standard- och valfria [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) för bättre säkerhet och komfort.
### Säkerhetssystem



Chevrolet Blazer EV RS AWD har en [**filhållningsassistent**](../../../../technology/driverassistance/lanekeepingassist/) som standard-system. Detta system bidrar för att förhindra att bilen lämnar körfältet. Dessutom har den ett [**filavvikelsevarning**](../../../../technology/driverassistance/lanedeparturewarning/) system som varnar föraren om fordonet lämnar körfältet.
...
Chevrolet Blazer EV RS AWD har [**automatisk nödbroms**](../../../../technology/driverassistance/automaticemergencybraking/) som standard-system. Detta system hjälper till att förhindra eller mildra kollisioner genom att ansätta bromsarna autonomt om föraren inte reagerar på en förestående kollision.
