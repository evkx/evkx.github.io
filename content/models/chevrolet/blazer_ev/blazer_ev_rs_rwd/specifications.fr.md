---
title: Chevrolet Blazer EV RS RWD spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Chevrolet Blazer EV RS RWD."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Chevrolet Blazer EV RS RWD. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Chevrolet Blazer EV RS RWD, visitez les [chargeinfo](../chargingcurve/) pour Chevrolet Blazer EV RS RWD avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
