...
EVKX.net søker å ha de mest komplette spesifikasjonene for VinFast VF8 Eco. Klikk på bildet ovenfor for [full artikkel](../), besøk [bildegalleriet](../gallery/) for høyoppløselige bilder av VinFast VF8 Eco, gå til [chargeinfo](../chargingcurve/) for VinFast VF8 Eco med ladekurve, se [extended range info](../rangeandconsumption/) for real world ranges.
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Neptune Grey (Grå)</br>
				VinFast Blue (Blå)</br>
				Sunset Orange (Oransje)</br>
				Deep Ocean (Grønn)</br>
				Brahminy White (Hvit)</br>
				Jet Black (Svart)</br>
				Desat Silver (Sølv)</br>
			</td>
		</tr>
	</tbody>
</table>
