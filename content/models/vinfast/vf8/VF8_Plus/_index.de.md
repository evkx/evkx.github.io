...
linktitle: "VF8 Plus"
description: "VinFast VF8 Plus ist ein vollelektrisches SUV mit einer Reichweite von bis zu 447 km (278 Meilen). EVKX.net hat alle Details."
weight: 10
hidden: true
shownavtabs: true
...
Der VinFast VF8 Plus liefert eine solide Leistung mit einer maximalen Leistung von 300 kW (408 PS / 402 bhp) und einem Gesamtdrehmoment von 620 Nm (458 lb-ft). Er beschleunigt in 5,5 Sekunden von 0 auf 100 km/h (0 auf 62 mph) und erreicht eine Höchstgeschwindigkeit von 200 km/h (124 mph), was ihn wettbewerbsfähig in seiner Klasse macht.

## Batterie, Reichweite und Laden

Die Hochkapazitätsbatterie hat eine Bruttokapazität von 94,0 kWh und eine nutzbare Nettokapazität von 87,7 kWh, was einen Puffer von 6,3 kWh (6,7%) zum Schutz der Batterie bietet. Mit einer Nennspannung von 403 Volt wird das System als 400-Volt-Batteriesystem klassifiziert und entspricht den Industriestandards.

Nach dem [WLTP](../../../../guides/understandingrange/wltp/) (Worldwide Harmonized Light Vehicles Test Procedure) Standard beträgt die Reichweite des Fahrzeugs 447 km (278 Meilen) mit einem Energieverbrauch von 19,6 kWh/100 km (3 mi/kWh). Für weitere Details zur Reichweite siehe reale Daten und Reichweitenliste auf der [Reichweite und Verbrauch](rangeandconsumption/) Seite dieses Modells.
...
Der VinFast VF8 Plus verfügt über ein Allradantriebssystem, das von zwei Motoren angetrieben wird, einem an jeder Achse. Die verwendeten Motoren sind [Permanentmagnet-Synchronmotoren](../../../../technology/motors/pmsm/).
...
Der VinFast VF8 Plus, mit Abmessungen von 4750 mm Länge, 1934 mm Breite und 1667 mm Höhe, fällt in die Kategorie der kompakten SUVs, auch als C-SUVs bekannt. Diese bieten eine Balance zwischen der Praktikabilität und Manövrierfähigkeit kleinerer Fahrzeuge und dem Raum und der Vielseitigkeit größerer SUVs. Der VinFast VF8 Plus ist in insgesamt 8 Lackfarben erhältlich, darunter mehrere auffällige Metallic-Optionen.

Sie können aus mehreren Raddesigns wählen, die alle in derselben Größe für den VinFast VF8 Plus erhältlich sind, sodass Sie Ihr Fahrzeug an Ihren Stil und Ihre Fahrpräferenzen anpassen können. Die verfügbaren Reifen- und Radkombinationen umfassen:
...
Der VinFast VF8 Plus umfasst mehrere Funktionen, um Komfort und Bequemlichkeit zu verbessern:
...
Der VinFast VF8 Plus hat einen einzelnen Bildschirm für den Fahrer. In der Mitte des Armaturenbretts befindet sich ein einzelner [Infotainment-Bildschirm](../../../../technology/userinterface/screens/#infotainment-screen), der als Hauptanzeige für Fahrzeuginformationen und Infotainment-Funktionen dient.
...
Der VinFast VF8 Plus ist mit einem einzigen Lenkradtyp ausgestattet:
...
Der VinFast VF8 Plus unterstützt Android Auto und Apple CarPlay, sodass Sie den Bildschirm Ihres Telefons auf dem Display des Autos spiegeln können. Diese Funktion ermöglicht es Ihnen, Apps wie Google Maps oder Waze direkt von Ihrem Telefon aus zu nutzen.

### Soundsystem

Der VinFast VF8 Plus ist mit einer Soundsystemoption ausgestattet:
...
Der VinFast VF8 Plus verfügt über eine Reihe von standardmäßigen und optionalen [fortschrittlichen Fahrerassistenzsystemen](../../../../technology/driverassistance/) (ADAS), die die Sicherheit und den Komfort verbessern sollen.

### Sicherheitssysteme

[**Antiblockiersystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard im VinFast VF8 Plus, dieses System verhindert das Blockieren der Räder beim Bremsen.

[**Elektronische Stabilitätskontrolle (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard im VinFast VF8 Plus, dieses System verbessert die Stabilität und das Handling des Fahrzeugs bei plötzlichen Manövern oder auf rutschigen Straßenbedingungen.

[**Spurhalteassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard im VinFast VF8 Plus, dieses System hilft, das Fahrzeug in seiner Spur zu halten. Es umfasst auch ein [**Spurverlassenswarnsystem**](../../../../technology/driverassistance/lanedeparturewarning/), das den Fahrer warnt, wenn das Fahrzeug die Spur verlässt.

[**Querverkehrswarnung hinten (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard im VinFast VF8 Plus, dieses System verwendet Sensoren, um herannahende Fahrzeuge von der Seite zu erkennen, wenn Sie aus einer Parklücke oder Einfahrt zurücksetzen.

[**Vorwärtskollisionswarnung (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard im VinFast VF8 Plus, dieses Fahrerassistenzsystem hilft Fahrern, Frontalzusammenstöße zu vermeiden oder zu mildern.

[**Automatische Notbremsung (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard im VinFast VF8 Plus, dieses System bremst autonom, um eine Kollision zu verhindern oder deren Schwere zu verringern, wenn der Fahrer nicht rechtzeitig reagiert.

[**Totwinkelüberwachung (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/): Standard im VinFast VF8 Plus, dieses Seitenassistenzsystem hilft, den Verkehr im toten Winkel zu erkennen.

[**Aussteigewarnung**](../../../../technology/driverassistance/exitwarning/): Standard im VinFast VF8 Plus, dieses System warnt Insassen davor, Türen zu öffnen, wenn die Gefahr besteht, etwas zu treffen.
...
Der VinFast VF8 Plus ist mit fortschrittlichen Sicherheitsfunktionen ausgestattet, um Sie und Ihr Fahrzeug zu schützen. Diese umfassen:
...
Der Kofferraum bietet ein Ladevolumen von 376 Litern (13,3 CU FT). Mit umgeklappter Rücksitzbank erweitert sich dies auf 1373 Liter (48,5 CU FT). Zusätzlich gibt es einen Frunk (vorderer Kofferraum) mit einem Ladevolumen von 78 Litern (2,8 CU FT).

Das maximale Gewicht des Fahrzeugs beträgt 3075 kg (6779 lbs) bei einem Leergewicht von 2600 kg (5732 lbs). Dies ermöglicht eine maximale Zuladung von 475 kg (1047 lbs), einschließlich Fahrer und Passagieren. Beachten Sie, dass einige Optionen das Leergewicht erhöhen und die maximale Zuladung verringern können. 475 kg wird für diesen Fahrzeugtyp als niedrig angesehen und könnte einschränken, wie viel zusätzlich zu den Passagieren mitgenommen werden kann.
...
{{< pagenavigation b_url="../" b_title="VinFast VF8" f_url="rangeandconsumption/" f_title="Reichweite" >}}
