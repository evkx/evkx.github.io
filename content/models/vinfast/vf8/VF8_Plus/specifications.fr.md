---
title: VinFast VF8 Plus spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de VinFast VF8 Plus."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour VinFast VF8 Plus. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de VinFast VF8 Plus, visitez les [chargeinfo](../chargingcurve/) pour VinFast VF8 Plus avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Crimson Red (Rouge)</br>
				Neptune Grey (Gris)</br>
				VinFast Blue (Bleu)</br>
				Sunset Orange</br>
				Deep Ocean (Vert)</br>
				Brahminy White (Blanc)</br>
				Jet Black (Noir)</br>
				Desat Silver (Argent)</br>
			</td>
		</tr>
	</tbody>
</table>
