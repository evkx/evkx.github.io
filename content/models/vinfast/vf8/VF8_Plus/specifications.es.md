---
title: VinFast VF8 Plus especificaciones
linktitle: "Especificaciones"
description: "EVKX.net le brinda las especificaciones completas para VinFast VF8 Plus."
weight: 4
hidden: true
...
EVKX.net busca tener las especificaciones más completas para VinFast VF8 Plus. Haga clic en la imagen de arriba para ver [artículo completo](../), visite la [galería de imágenes](../gallery/) para imágenes de alta resolución de VinFast VF8 Plus, visite [chargeinfo](../chargingcurve/) para VinFast VF8 Plus con chargecurve, visite [información de rango extendido](../rangeandconsumption/) para rangos del mundo real.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Crimson Red (Rojo)</br>
				Neptune Grey (Gris)</br>
				VinFast Blue (Azul)</br>
				Sunset Orange (Naranja)</br>
				Deep Ocean (Verde)</br>
				Brahminy White (Blanco)</br>
				Jet Black (Negro)</br>
				Desat Silver (Plata)</br>
			</td>
		</tr>
	</tbody>
</table>
