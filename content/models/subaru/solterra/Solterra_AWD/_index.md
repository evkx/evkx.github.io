...
The Subaru Solterra AWD features an all-wheel drive system powered by two motors, one on each axle.
...
You can select from multiple wheel options in different sizes on the Subaru Solterra AWD, allowing you to customize your vehicle to suit your style and driving preferences. The available tire and wheel combinations include:
...
[**Blind-spot Monitoring (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Optional on the Subaru Solterra AWD, this side assist system helps to detect traffic in blind spots.
