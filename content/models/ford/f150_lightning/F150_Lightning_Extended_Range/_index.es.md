...
description: "Ford F150 Lightning Extended Range es una camioneta totalmente eléctrica con un EPA alcance de hasta 515 km (320 millas). EVKX.net tiene todos los detalles."
weight: 10
hidden: true
shownavtabs: true
...
Hemos separado nuestro artículo Ford F150 Lightning Extended Range en secciones. Si desea esperar para leer el artículo completo, haga clic en los enlaces a continuación para acceder a las diferentes áreas. También tenemos una descripción general de las [especificaciones completas](specifications/), una [galería de imágenes](gallery/), información detallada sobre [rendimiento de carga](chargingcurve/) y algunas [reseñas en línea](reviews/). Nuestras secciones:
...
El Ford F150 Lightning Extended Range impresiona con una potencia máxima de 433 kW (589 hp) y un impresionante par total de 1050 Nm. Esta máquina de alto rendimiento puede acelerar de 0 a 100 km/h en solo 4,2 segundos y alcanza una velocidad máxima de 180 km/h, destacándose en su clase.

## Batería, autonomía y carga

La batería de alta capacidad tiene una capacidad bruta de 150 kWh y una capacidad neta utilizable de 130 kWh, proporcionando un buffer de 20 kWh (13,3%) para la protección de la batería. Esta batería de iones de litio utiliza tecnología [NMC (Níquel Manganeso Cobalto).](../../../../technology/battery/cellchemistry/#óxidos-de-litio-níquel-manganeso-y-cobalto-nmc)
...
Ford F150 Lightning Extended Range tiene un sistema de tracción total sostenido por dos motores, uno en cada eje.
...
El Ford F150 Lightning Extended Range tiene capacidad para cinco pasajeros con dos asientos delanteros y un banco trasero de tres plazas.

#### Asientos de primera fila

El Ford F150 Lightning Extended Range ofrece un único tipo de asiento delantero.
...
Hay dos configuraciones de pantalla diferentes disponibles en Ford F150 Lightning Extended Range.
...
Puedes elegir entre tres sistemas de sonido en el Ford F150 Lightning Extended Range.
...
El Ford F150 Lightning Extended Range incluye varios [sistemas avanzados de asistencia al conductor](../../../../technology/driverassistance/) (ADAS) estándar y opcionales para mejorar la seguridad y el confort.
...
[**Asistencia para Mantener el Carril (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Estándar en el Ford F150 Lightning Extended Range, este sistema ayuda a prevenir que el vehículo se desplace fuera de su carril. También incluye un sistema de [**Advertencia de Salida de Carril**](../../../../technology/driverassistance/lanedeparturewarning/) para alertar al conductor si el vehículo se sale del carril.

[**Advertencia de Colisión Frontal (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Estándar en el Ford F150 Lightning Extended Range, este sistema de asistencia al conductor ayuda a evitar o mitigar colisiones frontales.

[**Frenado de emergencia automático (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Estándar en el Ford F150 Lightning Extended Range, este sistema aplica los frenos automáticamente para prevenir o reducir la gravedad de una colisión si el conductor no reacciona a tiempo.

[**Dirección de emergencia automática (AES)**](../../../../technology/driverassistance/automaticemergencysteering/): Opcional en el Ford F150 Lightning Extended Range, este sistema ayuda a evitar colisiones dirigiendo automáticamente el vehículo en una emergencia.

[**Monitoreo de Punto Ciego (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Opcional en el Ford F150 Lightning Extended Range, este sistema de asistencia lateral ayuda a detectar tráfico en los puntos ciegos.

### Automatización de la Conducción

Ford F150 Lightning Extended Range ofrece [automatización de la conducción en niveles 1 o 2](../../../../technology/driverassistance/#level-of-autonomous-driving), dependiendo del nivel de equipamiento.
...
El peso máximo del vehículo es 3878 kg, con un peso base de 2988 kg. Esto permite una carga máxima de 890 kg, incluyendo el conductor y los pasajeros. Ten en cuenta que algunas opciones pueden aumentar el peso base y reducir la capacidad máxima de carga.
