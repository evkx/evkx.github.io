...
description: "Se nedenfor for detaljer om de forskellige varianter af Ford F150 Lightning"
weight: 30
---
...
<i class="bi bi-record2-fill"></i> AWD <i class="bi bi-battery-full"></i> 150 kWh <i class="bi bi-ev-station"></i> 155 kW 
		...
		<div class="col col-12 col-md-6">
			<ul class="list-group list-group-flush">
				...
				<li class="list-group-item list-group-item-action"><a href="f150_lightning_extended_range/rangeandconsumption/" class="text-decoration-none text-black" ><i class="bi-file-earmark-bar-graph"></i> Rækkevidde</a></li>
...
<i class="bi bi-record2-fill"></i> AWD <i class="bi bi-battery-full"></i> 110 kWh <i class="bi bi-ev-station"></i> 155 kW 
		...
		<div class="col col-12 col-md-6">
			<ul class="list-group list-group-flush">
				...
				<li class="list-group-item list-group-item-action"><a href="f150_lightning_standard_range/rangeandconsumption/" class="text-decoration-none text-black" ><i class="bi-file-earmark-bar-graph"></i> Rækkevidde</a></li>
