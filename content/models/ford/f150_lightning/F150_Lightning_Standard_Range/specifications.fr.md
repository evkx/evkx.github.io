---
title: Ford F150 Lightning Standard Range spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Ford F150 Lightning Standard Range."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Ford F150 Lightning Standard Range. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Ford F150 Lightning Standard Range, visitez les [chargeinfo](../chargingcurve/) pour Ford F150 Lightning Standard Range avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Iconic Silver Metallic (Argent)</br>
				Stone Gray Metallic (Gris)</br>
				Antimatter Blue Metallic (Bleu)</br>
				Oxford White (Blanc)</br>
				Avalanche (Gris)</br>
			</td>
		</tr>
	</tbody>
