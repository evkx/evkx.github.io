...
Ford Capri es un SUV Coupé disponible en 2 variantes.
    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Ford Explorer es un crossover disponible en 3 variantes.
</p>
...
Ford Mustang Mach-E es un SUV Coupé disponible en 5 variantes.
    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Ford Puma es un crossover disponible en 1 variantes.
</p>
	<a href="puma/" class="btn btn-outline-primary" role="button">Ir a la información del modelo</a>
		</div>
	</div>
</div>
        </div>
