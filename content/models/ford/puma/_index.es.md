...
title: Ford Puma
linktitle: "Puma"
description: "Vea a continuación los detalles de las diferentes variantes de Ford Puma"
weight: 30
---
...
<i class="bi bi-record2-fill"></i> FWD <i class="bi bi-battery-full"></i> 43 kWh <i class="bi bi-ev-station"></i> 100 kW 
		...
		<div class="col col-12 col-md-6">
			<ul class="list-group list-group-flush">
				...
				<li class="list-group-item list-group-item-action"><a href="puma_gen-e/rangeandconsumption/" class="text-decoration-none text-black" ><i class="bi-file-earmark-bar-graph"></i> Autonomía</a></li>
