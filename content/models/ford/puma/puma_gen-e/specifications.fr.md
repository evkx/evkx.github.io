---
title: Ford Puma Gen-E spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Ford Puma Gen-E."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Ford Puma Gen-E. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Ford Puma Gen-E, visitez les [chargeinfo](../chargingcurve/) pour Ford Puma Gen-E avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Agatha Black (Noir)</br>
				Frozen White (Blanc)</br>
				Solar Silver (Argent)</br>
				Electric Yellow (Jaune)</br>
				Digital Aqua Blue (Bleu)</br>
				Fantastic Red (Rouge)</br>
				Solar Silver (Argent)</br>
				Electric Yellow (Jaune)</br>
				Digital Aqua Blue (Bleu)</br>
				Fantastic Red (Rouge)</br>
