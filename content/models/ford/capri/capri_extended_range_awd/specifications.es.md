---
title: Ford Capri Extended Range AWD especificaciones
linktitle: "Especificaciones"
description: "EVKX.net le brinda las especificaciones completas para Ford Capri Extended Range AWD."
weight: 4
hidden: true
...
EVKX.net busca tener las especificaciones más completas para Ford Capri Extended Range AWD. Haga clic en la imagen de arriba para ver [artículo completo](../), visite la [galería de imágenes](../gallery/) para imágenes de alta resolución de Ford Capri Extended Range AWD, visite [chargeinfo](../chargingcurve/) para Ford Capri Extended Range AWD con chargecurve, visite [información de rango extendido](../rangeandconsumption/) para rangos del mundo real.
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Lucid Red Metallic (Rojo)</br>
				Vivid Yellow Metallic (Amarillo)</br>
			</td>
		</tr>
	</tbody>
</table>
