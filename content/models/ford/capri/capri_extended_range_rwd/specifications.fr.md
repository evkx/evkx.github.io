---
title: Ford Capri Extended Range RWD spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Ford Capri Extended Range RWD."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Ford Capri Extended Range RWD. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Ford Capri Extended Range RWD, visitez les [chargeinfo](../chargingcurve/) pour Ford Capri Extended Range RWD avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Blue My Mind Metallic (Bleu)</br>
				Agate Black Metallic (Noir)</br>
				Magnetic Grey Metallic (Gris)</br>
				Frozen White (Blanc)</br>
				Lucid Red Metallic (Rouge)</br>
				Vivid Yellow Metallic (Jaune)</br>
			</td>
		</tr>
	</tbody>
</table>
