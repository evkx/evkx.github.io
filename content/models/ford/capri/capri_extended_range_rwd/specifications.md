---
title: Ford Capri Extended Range RWD specifications
linktitle: "Specifications"
description: "EVKX.net gives you the full specifications for Ford Capri Extended Range RWD."
weight: 4
hidden: true
...
EVKX.net seeks to have the most complete specifications for Ford Capri Extended Range RWD. Click on image above for [full article](../), visit the [image gallery](../gallery/) for high-res images of Ford Capri Extended Range RWD, visit the [chargeinfo](../chargingcurve/) for Ford Capri Extended Range RWD with chargecurve, vist [extended range info](../rangeandconsumption/) for real world ranges.
...
<table class="table table-striped border">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				Yes (Dynamic Chassis Control), optional equipment
			</td>
		</tr>
		<tr>
			<td>
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Yes (Lane Assist), standard equipment
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				Yes (Area View), optional equipment
			</td>
		</tr>
		<tr>
			<td>
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Blue My Mind Metallic</br>
				Agate Black Metallic</br>
				Magnetic Grey Metallic (Gray)</br>
				Frozen White</br>
				Lucid Red Metallic</br>
				Vivid Yellow Metallic</br>
			</td>
		</tr>
	</tbody>
</table>
