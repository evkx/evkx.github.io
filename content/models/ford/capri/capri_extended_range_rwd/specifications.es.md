---
title: Ford Capri Extended Range RWD especificaciones
linktitle: "Especificaciones"
description: "EVKX.net le brinda las especificaciones completas para Ford Capri Extended Range RWD."
weight: 4
hidden: true
...
EVKX.net busca tener las especificaciones más completas para Ford Capri Extended Range RWD. Haga clic en la imagen de arriba para ver [artículo completo](../), visite la [galería de imágenes](../gallery/) para imágenes de alta resolución de Ford Capri Extended Range RWD, visite [chargeinfo](../chargingcurve/) para Ford Capri Extended Range RWD con chargecurve, visite [información de rango extendido](../rangeandconsumption/) para rangos del mundo real.
