---
title: Ford Capri Extended Range RWD spesifikasjoner
linktitle: "Spesifikasjoner"
description: "EVKX.net gir deg alle spesifikasjonene for Ford Capri Extended Range RWD."
weight: 4
hidden: true
...
EVKX.net søker å ha de mest komplette spesifikasjonene for Ford Capri Extended Range RWD. Klikk på bildet ovenfor for [full artikkel](../), besøk [bildegalleriet](../gallery/) for høyoppløselige bilder av Ford Capri Extended Range RWD, gå til [chargeinfo](../chargingcurve/) for Ford Capri Extended Range RWD med ladekurve, se [extended range info](../rangeandconsumption/) for real world ranges.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Blue My Mind Metallic (Blå)</br>
				Agate Black Metallic (Svart)</br>
				Magnetic Grey Metallic (Grå)</br>
				Frozen White (Hvit)</br>
				Lucid Red Metallic (Rød)</br>
				Vivid Yellow Metallic (Gul)</br>
			</td>
		</tr>
	</tbody>
</table>
