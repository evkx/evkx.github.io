...
Ford F150 Lightning est une camionnette disponible en 2 variantes.
    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Ford Mustang Mach-E est un SUV coupé disponible en 5 variantes.
</p>
	<a href="mustang_mach-e/" class="btn btn-outline-primary" role="button">Aller aux informations sur le modèle</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
