...
description: "Ford Explorer Standard Range RWD är en helelektrisk SUV med en WLTP räckvidd på upp till 380 km. EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Ford Explorer Standard Range RWD har en maximal effekt på 125 KW (170hk). Totalt vridmoment är 310 Nm. Den gör sprinten 0-100 km/h på 9 sekunder. Topphastigheten är 160 km/h.
...
Maximal DC-laddningshastighet är 135 kW. En full laddning från 0 - 100 % tar 42 minuter, medan ett vanligare scenario på 10-80 % tar 23 minuter. Om du antar att du förlorar 5 minuters körning per laddningsstopp utöver laddningstiden, är den optimala laddningsytan från 2% till 49%, vilket resulterar i en faktisk laddning hastighet inklusive tidsförlust , på 90kW. Varje laddningssession tar 16 minuter och 13 sekunder.

För den teoretiska 1000km-utmaningen, att börja med fullt batteri och köra i 120km/h (75 mph), förutsatt optimala körförhållanden och förbrukning på 22kWh/100km, tar 1000km 10 timmar och 12 minuter. Den här resan kommer att kräva sex laddningssession(er) laddning från 2% till 56%. Total tid som går förlorad för att ladda batteriet kommer att vara 113 minuter.

### Inbyggd laddare

För nivå 1 och nivå 2 AC-laddning stöder  inbyggd laddare upp till 11KW-laddning. Som ett resultat kan du ladda batteriet 0-100 % hemifrån på ca. 4 timmar och 43 minuter.
...
Det finns två sätestyper du kan välja mellan för den främre raden av Ford Explorer Standard Range RWD.
...
Ford Explorer Standard Range RWD har flera funktioner för att göra ditt liv som förare eller passagerare bekvämare.
...
Du kan välja mellan två ljudsystem på Ford Explorer Standard Range RWD. Med Sound system får du sex högtalare med en maximal systemeffekt på 140 watt. Med B&O Soundsystem får du tio högtalare med en maximal systemeffekt på 480 watt.
...
Ford Explorer Standard Range RWD har flera standard- och valfria [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) för bättre säkerhet och komfort.
...
Ford Explorer Standard Range RWD har ett [**ABS-bromssystem**](../../../../technology/driverassistance/antilockbrakingsystem/) som standard-systemet. Detta system hjälper till att förhindra att ett fordons hjul låser sig under inbromsning.

Ford Explorer Standard Range RWD har ett [**elektronisk stabilitetskontroll**](../../../../technology/driverassistance/electronicstabilitycontrol/) vilket standard-system är utformat för att förbättra ett fordons stabilitet och hantering under plötsliga manövrar eller halt väglag.

Ford Explorer Standard Range RWD har en [**filhållningsassistent**](../../../../technology/driverassistance/lanekeepingassist/) som standard-system. Detta system bidrar för att förhindra att bilen lämnar körfältet. Dessutom har den ett [**filavvikelsevarning**](../../../../technology/driverassistance/lanedeparturewarning/) system som varnar föraren om fordonet lämnar körfältet.
...
Ford Explorer Standard Range RWD har [**automatisk nödbroms**](../../../../technology/driverassistance/automaticemergencybraking/) som standard-system. Detta system hjälper till att förhindra eller mildra kollisioner genom att ansätta bromsarna autonomt om föraren inte reagerar på en förestående kollision.
...
Ford Explorer Standard Range RWD erbjuder [nivå 1 eller 2 körautomation](../../../../technology/driverassistance/#nivå-av-autonom-körning), beroende på utrustningsnivå.
...
Lastkapaciteten i bagageutrymmet är 536 liter. Med baksätet nedfällt är det 1422 liter. På taket kan du lasta upp till 75 kg. Bilens maximala vikt är 2490 kg, och med basvikten på 1932 kg kan du lasta maximalt 558 kg, inklusive förare och passagerare. Vissa utrustningsalternativ kan öka basvikten och minska den maximala lastvikten.
