...
La Ford Mustang Mach-E Standard Range AWD offre des performances solides avec une puissance maximale de 258 kW (351 ch) et un couple total de 580 Nm. Elle peut accélérer de 0 à 100 km/h en 5,8 secondes et atteindre une vitesse maximale de 180 km/h, ce qui la rend compétitive dans sa catégorie.

## Batterie, autonomie et charge

La batterie haute capacité a une capacité brute de 75,7 kWh et une capacité nette utilisable de 70,0 kWh, offrant une réserve de 5,7 kWh (7,5%) pour la protection de la batterie. Avec une tension nominale de 360 volts, le système est classé comme un système de batterie de 400 volts, conforme aux normes de l'industrie. Cette batterie au lithium-ion utilise la technologie [NMC (Nickel Manganèse Cobalt).](../../../../technology/battery/cellchemistry/#lithium-nickel-manganese-cobalt-oxydes-nmc)
...
La vitesse de charge DC maximale est de 150kW. Une charge complète de 0 à 100 % prendrait 119 minutes, tandis qu'un scénario plus courant de 10 à 80 % prendrait 35 minutes. Si vous supposez que vous perdez 5 minutes de conduite par arrêt de charge en plus du temps de charge, la zone de charge optimale est comprise entre 4 % et 46 %, ce qui correspond à une vitesse de charge réelle, y compris la perte de temps, de 79kW. Chaque session de charge prendrait 22 minutes et 25 secondes.

Dans un défi théorique de 1000 km, en commençant avec une batterie pleine et en maintenant une vitesse constante de 120 km/h dans des conditions idéales avec une consommation supposée de 24 kWh/100 km, le voyage prendrait environ 10 heures et 31 minutes. Ce trajet nécessiterait deux arrêts de recharge de 5% à 46%, avec un temps de recharge total de 131 minutes.
...
Ford Mustang Mach-E Standard Range AWD dispose d'un système de transmission intégrale pris en charge par deux moteurs, un sur chaque essieu.
...
Vous pouvez choisir parmi plusieurs options de roues de différentes tailles sur l'Ford Mustang Mach-E Standard Range AWD, ce qui vous permet de personnaliser votre véhicule selon votre style et vos préférences de conduite.
...
Le Ford Mustang Mach-E Standard Range AWD peut accueillir cinq passagers avec deux sièges à l'avant et une banquette arrière à trois places.
...
L'Ford Mustang Mach-E Standard Range AWD comprend plusieurs fonctionnalités pour améliorer le confort et la commodité :
...
De plus, le Ford Mustang Mach-E Standard Range AWD prend en charge Android Auto et Apple CarPlay. Cette fonctionnalité vous permet d'afficher l'écran de votre téléphone sur l'écran de la voiture afin que vous puissiez exécuter des applications comme Google Maps ou Waze.

### Système audio

Un type de système audio est disponible pour le Ford Mustang Mach-E Standard Range AWD.
...
Le Ford Mustang Mach-E Standard Range AWD comprend plusieurs [systèmes avancés d'assistance au conducteur](../../../../technology/driverassistance/) (ADAS) de série et en option pour améliorer la sécurité et le confort.
...
[**Contrôle Électronique de Stabilité (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard sur le Ford Mustang Mach-E Standard Range AWD, ce système améliore la stabilité et la maniabilité du véhicule lors de manœuvres soudaines ou en conditions de route glissantes.
...
[**Alerte de Trafic Croisé Arrière (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard sur le Ford Mustang Mach-E Standard Range AWD, ce système utilise des capteurs pour détecter les véhicules qui approchent par les côtés lors de la marche arrière depuis une place de stationnement ou une entrée.

[**Alerte de Collision Frontale (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard sur le Ford Mustang Mach-E Standard Range AWD, ce système d'assistance au conducteur aide à éviter ou à atténuer les collisions frontales.

[**Freinage d'urgence automatique (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard sur le Ford Mustang Mach-E Standard Range AWD, ce système applique les freins de manière autonome pour éviter ou réduire la gravité d'une collision si le conducteur ne réagit pas à temps.
