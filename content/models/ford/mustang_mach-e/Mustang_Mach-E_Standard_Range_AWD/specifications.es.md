...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Absolute Black (Negro)</br>
				Vapor Blue (Azul)</br>
				Grabber Blue (Azul)</br>
				Space White (Blanco)</br>
				Star White (Blanco)</br>
				Rapid Red (Rojo)</br>
				Carbonized (Gris)</br>
				Cyber (Naranja)</br>
			</td>
