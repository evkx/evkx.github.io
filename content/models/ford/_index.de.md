...
Ford Capri ist ein Coupé-SUV, das in 2 Varianten erhältlich ist.
</p>
	<a href="capri/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Ford Explorer ist ein Crossover, das in 3 Varianten erhältlich ist.
</p>
	<a href="explorer/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Ford F150 Lightning ist ein Pickup-Truck, der in 2 Varianten erhältlich ist.
</p>
	<a href="f150_lightning/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Ford Mustang Mach-E ist ein Coupé-SUV, das in 5 Varianten erhältlich ist.
</p>
	<a href="mustang_mach-e/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
        </div>
