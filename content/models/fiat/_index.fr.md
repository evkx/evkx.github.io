...
Fiat 600e est un crossover disponible en 1 variantes.
</p>
	<a href="600e/" class="btn btn-outline-primary" role="button">Aller aux informations sur le modèle</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Fiat Grande Panda est un crossover disponible en 1 variantes.
</p>
	<a href="grande_panda/" class="btn btn-outline-primary" role="button">Aller aux informations sur le modèle</a>
		</div>
	</div>
</div>
        </div>
