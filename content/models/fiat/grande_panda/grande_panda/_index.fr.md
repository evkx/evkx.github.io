...
La vitesse de charge DC maximale est de 100kW. Une charge complète de 0 à 100 % prendrait 67 minutes, tandis qu'un scénario plus courant de 10 à 80 % prendrait 26 minutes. Si vous supposez que vous perdez 5 minutes de conduite par arrêt de charge en plus du temps de charge, la zone de charge optimale est comprise entre 13 % et 68 %, ce qui correspond à une vitesse de charge réelle, y compris la perte de temps, de 63kW. Chaque session de charge prendrait 23 minutes et 57 secondes.

Dans un défi théorique de 1000 km, en commençant avec une batterie pleine et en maintenant une vitesse constante de 120 km/h dans des conditions idéales avec une consommation supposée de 24 kWh/100 km, le voyage prendrait environ 11 heures et 26 minutes. Ce trajet nécessiterait deux arrêts de recharge de 13% à 69%, avec un temps de recharge total de 187 minutes.
...
Fiat Grande Panda dispose d'un système de traction avant pris en charge par un moteur sur l'essieu avant.
...
La direction dynamique est une fonctionnalité un standard sur le Fiat Grande Panda. La direction dynamique fait varier le rapport de direction en fonction de la vitesse de conduite.
...
La Fiat Grande Panda est disponible en un total de 5 couleurs de peinture, comprenant des options à la fois solides et métalliques.
...
Le Fiat Grande Panda peut accueillir cinq passagers avec deux sièges à l'avant et une banquette arrière à trois places.
...
De plus, le Fiat Grande Panda prend en charge Android Auto et Apple CarPlay. Cette fonctionnalité vous permet d'afficher l'écran de votre téléphone sur l'écran de la voiture afin que vous puissiez exécuter des applications comme Google Maps ou Waze.

### Système audio

Vous pouvez choisir entre deux systèmes audio sur le Fiat Grande Panda.

- **:** Comprend deux haut-parleurs.
- **Max Sound system:** Comprend deux haut-parleurs.
...
Le Fiat Grande Panda comprend plusieurs [systèmes avancés d'assistance au conducteur](../../../../technology/driverassistance/) (ADAS) de série et en option pour améliorer la sécurité et le confort.
...
[**Contrôle Électronique de Stabilité (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard sur le Fiat Grande Panda, ce système améliore la stabilité et la maniabilité du véhicule lors de manœuvres soudaines ou en conditions de route glissantes.

[**Freinage d'urgence automatique (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard sur le Fiat Grande Panda, ce système applique les freins de manière autonome pour éviter ou réduire la gravité d'une collision si le conducteur ne réagit pas à temps.
...
Ce modèle a été présenté en première mondiale le 12.07.2024 et les livraisons devraient commencer en December 2024.
{{< pagenavigation b_url="../" b_title="Fiat Grande Panda" f_url="rangeandconsumption/" f_title="Plage" >}}
