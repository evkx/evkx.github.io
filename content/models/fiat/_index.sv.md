...
Fiat 600e är en crossover tillgänglig i 1 varianter.
    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Fiat Grande Panda är en crossover tillgänglig i 1 varianter.
</p>
	<a href="grande_panda/" class="btn btn-outline-primary" role="button">Gå till modellinformation</a>
		</div>
	</div>
</div>
        </div>
