...
Fiat 600e ist ein Crossover, das in 1 Varianten erhältlich ist.
</p>
	<a href="600e/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Fiat Grande Panda ist ein Crossover, das in 1 Varianten erhältlich ist.
</p>
	<a href="grande_panda/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
        </div>
