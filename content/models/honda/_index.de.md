...
Honda e:Ny1 ist ein Crossover, das in 1 Varianten erhältlich ist.
</p>
	<a href="e_ny1/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Honda Prologue ist ein SUV, der in 2 Varianten erhältlich ist.
</p>
	<a href="prologue/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
        </div>
