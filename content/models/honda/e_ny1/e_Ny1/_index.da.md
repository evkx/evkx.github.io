...
Honda e:Ny1 tilbyder beskedne præstationer med en maksimal effekt på 150 kW (204 hk) og et samlet drejningsmoment på 310 Nm. Den accelererer fra 0 til 100 km/t på 7,7 sekunder og har en topfart på 160 km/t, hvilket ligger tættere på traditionelle forbrændingsmotorbiler.
...
Den maksimale DC-opladningshastighed er 78kW. En fuld opladning fra 0 - 100 % ville tage 125 minutter, mens et mere almindeligt scenarie på 10-80 % ville tage 44 minutter. Hvis du antager, at du mister 5 minutters kørsel pr. ladestop ud over opladningstiden, er det optimale opladningsområde fra 4% til 55%, hvilket resulterer i en faktisk opladningshastighed, inklusive tidstab på 56kW. Hver opladningssession ville tage 34 minutter og 48 sekunder.

I en teoretisk 1000 km udfordring, der starter med et fuldt batteri og opretholder en konstant hastighed på 120 km/t under ideelle forhold med et antaget forbrug på 24,5 kWh/100 km, ville turen tage cirka 11 timer og 38 minutter. Denne rejse ville kræve to opladningsstop fra 5% til 55%, med en samlet opladningstid på 199 minutter
...
Placeringen af ladeporten er på [forsiden](../../../../technology/charging/connectors/#front). Denne placering gør det letanvendelige ladestationer, hvor du skal parkere med fronten ind. Denne model bruger [**CCS Combo 2**](../../../../technology/charging/connectors/#ccs) stikket til ladestikket.
...
Dynamisk styring er en standard-funktion på Honda e:Ny1. Dynamisk styring varierer styreforholdet som en funktion af kørehastigheden.
...
Den Honda e:Ny1, med dimensioner på 4387 mm i længde, 1790 mm i bredde og 1584 mm i højde, tilhører B-SUV segmentet af biler, også kendt som subkompakte SUV'er eller crossovers. De tilbyder en kombination af den kompakte størrelse og manøvredygtighed fra B-segment biler med den højere kørestilling, øgede lastkapacitet og robuste styling af en SUV. Honda e:Ny1 fås i alt 5 lakfarver, som alle inkluderer metalliske og perlemorsmuligheder.
...
Honda e:Ny1 har plads til fem passagerer med to sæder foran og en tre-personers bænk bagtil.
...
- Skærmen touch øverst på midterkonsollen er 15,2 tommer stor
...
Yderligere understøtter Honda e:Ny1 Android Auto og Apple CarPlay. Denne funktionalitet giver dig mulighed for at præsentere din telefons skærm på bilens skærm, så du kan køre apps som Google Maps eller Waze.
...
[**Anti-lock Bremsesystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Honda e:Ny1, dette system forhindrer hjulene i at låse under opbremsning.

[**Electronic Stability Control (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Honda e:Ny1, dette system forbedrer bilens stabilitet og håndtering under pludselige manøvrer eller på glatte vejforhold.
...
[**Rear Cross Traffic Alert (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard på Honda e:Ny1, dette system bruger sensorer til at registrere tilstødende køretøjer fra siden, når du bakker ud af en parkeringsplads eller indkørsel.

[**Forward Collision Warning (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Honda e:Ny1, dette førerassistentsystem hjælper føreren med at undgå eller formilde frontale kollisioner.

[**Automatisk nødbremsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Honda e:Ny1, dette system anvender bremserne autonomt for at forhindre eller reducere alvoren af en kollision, hvis føreren ikke reagerer i tide.
...
[**Blind-spot Monitoring (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard på Honda e:Ny1, dette sideassistentsystem hjælper med at registrere trafik i døde vinkler.

### Køreautomatisering

Med standard Honda Sensing niveau 2-systemet får du følgende funktioner til køreautomatisering.
...
Denne model havde verdenspremiere den 11.05.2023, og leveringerne startede i October 2023. Denne model er kun tilgængelig i Europa.
...
I det hastigt voksende marked for elbiler har EVKX.net identificeret flere alternativer til Honda e:Ny1, der er værd at overveje baseret på funktioner, specifikationer og pris. Selvom disse modeller måske ikke er helt identiske, kan det være nyttigt at sammenligne dem, før du træffer din endelige købsbeslutning:
...
{{< pagenavigation b_url="../" b_title="Honda e:Ny1" f_url="rangeandconsumption/" f_title="Range" >}}
