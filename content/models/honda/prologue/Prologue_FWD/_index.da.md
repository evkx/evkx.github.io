...
description: "Honda Prologue FWD er en elektrisk SUV med en EPA rækkevidde på op til 476 km (296 miles). EVKX.net har alle detaljerne."
weight: 10
hidden: true
shownavtabs: true
...
Honda Prologue FWD tilbyder beskeden ydeevne med en maksimal effekt på 158 kW (215 hk / 212 bhp) og et samlet drejningsmoment på 320 Nm (236 lb-ft). Den accelererer fra 0 til 100 km/t (0 til 62 mph) på 7,5 sekunder og har en tophastighed på 182 km/t (113 mph), hvilket ligger tættere på traditionelle forbrændingsmotorer.
...
Ifølge [EPA](../../../../guides/understandingrange/epa/) (Environmental Protection Agency) standarden har køretøjet en rækkevidde på 296 miles (476 km) med et energiforbrug på 3,3 miles per kWh. For flere detaljer om rækkevidden, se data fra den virkelige verden og rækkeviddelister på denne models [rækkevidde og forbrug](rangeandconsumption/) side.

Køretøjet understøtter hurtig DC-opladning med en maksimal effekt på 150 kW. Opladning fra 0% til 100% tager cirka 77 minutter, mens et mere typisk scenario fra 10% til 80% tager 40 minutter med en gennemsnitlig ladehastighed på 95 kW. Når der medregnes yderligere 5 minutter for hvert opladningsstop på grund af køreafbrydelser, er det optimale opladningsområde fra 6% til 58%. Dette resulterer i en effektiv ladehastighed, inklusive tabt tid, på 100 kW, hvor hver opladningssession tager cirka 28 minutter og 23 sekunder.

I en 1000 km udfordring ved konstant hastighed på 120 km/t med et antaget forbrug på 25 kWh/100 km, ville turen tage cirka 9 timer og 56 minutter, med fire opladningsstop fra 7% til 51%, i alt 97 minutters opladningstid.
...
Honda Prologue FWD har et forhjulstræksystem understøttet af én motor på forakslen. Den anvendte motor er en [permanent magnet synkronmotor](../../../../technology/motors/pmsm/).

### Affjedring

standard affjedringen har fast højde og dæmpning. Frihøjden med denne affjedring er 201 mm.

### Styring

Dynamisk styring er standard på Honda Prologue FWD, hvor styringsforholdet varierer baseret på kørehastighed for forbedret kontrol og komfort.

### Køretilstande

Honda Prologue FWD lader brugeren vælge forskellige [køretilstande](../../../../technology/drivemodes/) som påvirker bilens håndtering. Føreren kan vælge mellem 2 tilstande:
...
Honda Prologue FWD er udstyret med [støbejerns-skivebremser](../../../../technology/brakes/#disc-brakes) både for og bag. De forreste skiver måler 321 mm, mens de bageste skiver er 345 mm.
...
Honda Prologue FWD, med dimensioner på 4877 mm i længde, 1989 mm i bredde og 1634 mm i højde, tilhører mellemklasse SUV'er, der tilbyder en kombination af plads, komfort, ydeevne og alsidighed, hvilket gør dem velegnede til en bred vifte af bilister med forskellige behov. Honda Prologue FWD fås i alt i 7 lakfarver, inklusive almindelige, metalliske og perlemor muligheder.

Honda Prologue FWD tilbyder flere hjulmuligheder i forskellige størrelser, så du kan tilpasse din bil efter din stil og kørepræferencer. De tilgængelige dæk- og hjulkombinationer inkluderer:

- 255/60 dæk på 19" fælge
...
Honda Prologue FWD tilbyder rigelige opbevaringsløsninger i kabinen for at øge bekvemmelighed og organisation:
...
Honda Prologue FWD inkluderer flere funktioner for at forbedre komfort og bekvemmelighed:
...
Kontrolgrænsefladen for Honda Prologue FWD kombinerer knapper, kontaktarme og skærme for en problemfri og brugervenlig oplevelse.

Honda Prologue FWD har flere integrerede skærme. Bag rattet er der et [digitalt instrumentpanel](../../../../technology/userinterface/screens/#digital-instruments), og i midterkonsollen er der én [infotainmentskærm](../../../../technology/userinterface/screens/#infotainment-screen) øverst i midterkonsollen.
...
Honda Prologue FWD er udstyret med én type rat:
...
Honda Prologue FWD understøtter Android Auto og Apple CarPlay, så du kan spejle din telefons skærm på bilens display. Denne funktionalitet gør det muligt at køre apps som Google Maps eller Waze direkte fra din telefon.

### Lydsystem

Du kan vælge mellem to lydsystemer til Honda Prologue FWD:
...
Honda Prologue FWD kommer med en dedikeret mobilapp, tilgængelig til både Android og iOS-enheder, så du kan styre og overvåge din bil på afstand. Appen tilbyder en bred vifte af funktioner designet til at forbedre din køreoplevelse:
...
Honda Prologue FWD har en række standard og valgfrie [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) designet til at forbedre sikkerhed og komfort.

### Sikkerhedssystemer

[**Antiblokeringssystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Honda Prologue FWD, dette system forhindrer hjulene i at låse under bremsning.

[**Elektronisk Stabilitetskontrol (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Honda Prologue FWD, dette system forbedrer bilens stabilitet og håndtering under pludselige manøvrer eller på glatte veje.
...
[**Front Tværgående Trafik Assistent (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/) : Ekstraudstyr på Honda Prologue FWD, dette førerassistentsystem hjælper førere med at registrere modkørende trafik ved krydsning af et vejkryds eller når der drejes til venstre eller højre fra stillestående position.

[**Advarsel om Krydsende Trafik Bag (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard på Honda Prologue FWD, dette system bruger sensorer til at opdage køretøjer, der nærmer sig fra siden, når man bakker ud af en parkeringsplads eller indkørsel.

[**Advarsel om Frontal Kollision (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Honda Prologue FWD, dette førerassistentsystem hjælper førere med at undgå eller mindske frontale kollisioner.

[**Automatisk Nødbremsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Honda Prologue FWD, dette system aktiverer automatisk bremserne for at forhindre eller reducere alvorligheden af en kollision, hvis føreren ikke reagerer i tide.

[**Blindvinkel Overvågning (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard på Honda Prologue FWD, dette system hjælper med at opdage trafik i blinde vinkler.
...
Honda Prologue FWD er udstyret med flere airbags for at sikre beskyttelse af passagererne i tilfælde af en kollision. Airbagsystemet omfatter:
...
Honda Prologue FWD er udstyret med avancerede sikkerhedsfunktioner for at beskytte dig og dit køretøj. Disse omfatter:
...
Bagagerummet har en lastkapacitet på 714 liter (25,2 CU FT). Med bagsædet lagt ned udvides dette til 1634 liter (57,7 CU FT). På taget kan du laste op til 75 kg (165,3 lbs). Tagbøjler fås som ekstraudstyr for nem montering af tagboks eller lastbærer.

Køretøjets maksimale vægt er 2730 kg (6019 lbs), med en egenvægt på 2237 kg (4932 lbs). Dette giver en maksimal last på 493 kg (1087 lbs), inklusive fører og passagerer. Bemærk at nogle tilvalg kan øge egenvægten og reducere den maksimale lasteevne. 493kg anses for at være lavt for denne type bil og kan begrænse hvor meget du kan medbringe ud over passagerer.
...
Honda Prologue FWD havde sin verdenspremiere den 06.10.2022, og leveringerne startede i March 2024. Bemærk venligst at denne model kun er tilgængelig i Nordamerika.
