...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Acura</h2>
	<p>
		Acura er luksus- og præstationsdivisionen af den japanske bilproducent Honda, primært baseret i Nordamerika. Mærket blev lanceret i 1986 og markedsfører luksus- og præstationsbiler. Acura sælger biler i USA, Canada, Mexico, Panama og Kuwait.
	</p>
	<p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Kia</h2>
	<p>
		Kia, en sydkoreansk bilproducent grundlagt i 1944, har udviklet sig til en global leder kendt for innovation og kvalitet. Med et stærkt fokus på elektrisk mobilitet udvider Kia sit EV-sortiment med henblik på bæredygtighed og avanceret teknologi. Mærkets engagement i tilgængelige, miljøvenlige køretøjer positionerer det som en nøglespiller på EV-markedet.
	</p>
	<p>
	Kia har 4 modeller med i alt 15 varianter.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Volkswagen</h2>
	<p>
	Volkswagen har 6 modeller med i alt 30 varianter.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Zeekr</h2>
	<p>
	Zeekr har 6 modeller med i alt 12 varianter.
	</p>
