...
SKODA Elroq ist ein Coupé-SUV, das in 3 Varianten erhältlich ist.
</p>
	<a href="elroq/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
SKODA Enyaq iV ist ein SUV/Coupé-SUV, das in 12 Varianten erhältlich ist.
</p>
	<a href="enyaq_iv/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
        </div>
    ...
    <div id="module-company" class="accordion-collapse collapse">
        <div class="accordion-body">
{{% insert "content/models/skoda/company.de.md" %}}
</div>
</div>
</div>
</div>
