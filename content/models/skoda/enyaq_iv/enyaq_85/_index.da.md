...
linktitle: "ENYAQ 85"
description: "SKODA ENYAQ 85 er en fuldelektrisk SUV med en rækkevidde på WLTP på op til 566 km (352 miles). EVKX.net har alle detaljerne."
weight: 10
hidden: true
shownavtabs: true
...
Vi har opdelt vores SKODA ENYAQ 85 artikel i sektioner. Hvis du vil vente med at læse hele artiklen, skal du klikke på nedenstående links til de forskellige områder. Vi har også en oversigt over de [fulde specifikationer](specifications/), et [billedgalleri](gallery/), detaljerede oplysninger om [opladningsydelse](chargingcurve/), og nogle [online anmeldelser](reviews/). Vores sektioner:
...
SKODA ENYAQ 85 leverer en solid præstation med en maksimal effekt på 210 kW (286 hk) og et totalt drejningsmoment på 545 Nm. Den kan accelerere fra 0 til 100 km/t på 6,7 sekunder og når en topfart på 180 km/t, hvilket gør den konkurrencedygtig i sin klasse.
...
Ifølge [WLTP (Worldwide Harmonized Light Vehicles Test Procedure)](../../../../guides/understandingrange/wltp/) standarden varierer køretøjets rækkevidde mellem 566 og 547 km, afhængigt af specifikke konfigurationer og muligheder, såsom hjulstørrelse. Større hjul kan for eksempel øge energiforbruget og dermed reducere den samlede rækkevidde. Køretøjets energiforbrug er vurderet til 13,6 kWh/100 km for basismodellen og 14,1 kWh/100 km for topmodellen under WLTP testcyklussen. For mere detaljerede virkelige data og rækkeviddeoplysninger, henvises til modellens dedikerede [rækkevidde- og forbrugsside.](rangeandconsumption/)

Den maksimale DC-opladningshastighed er 135kW. En fuld opladning fra 0 - 100 % ville tage 64 minutter, mens et mere almindeligt scenarie på 10-80 % ville tage 28 minutter. Hvis du antager, at du mister 5 minutters kørsel pr. ladestop ud over opladningstiden, er det optimale opladningsområde fra 1% til 70%, hvilket resulterer i en faktisk opladningshastighed, inklusive tidstab på 102kW. Hver opladningssession ville tage 31 minutter og 22 sekunder.

I en teoretisk 1000 km udfordring, der starter med et fuldt batteri og opretholder en konstant hastighed på 120 km/t under ideelle forhold med et antaget forbrug på 21 kWh/100 km, ville turen tage cirka 9 timer og 40 minutter. Denne rejse ville kræve to opladningsstop fra 1% til 59%, med en samlet opladningstid på 80 minutter
...
SKODA ENYAQ 85 har et baghjulstræksystem, der understøttes af en motor på bagakslen. Den anvendte motor er [Permanent Magnet Synchronous Motors](../../../../technology/motors/pmsm/).
...
Dynamisk styring er en standard-funktion på SKODA ENYAQ 85. Dynamisk styring varierer styreforholdet som en funktion af kørehastigheden.
...
Den SKODA ENYAQ 85, med dimensioner på 4653 mm i længde, 1879 mm i bredde og 1607 mm i højde, tilhører kompakte SUV'er, også kendt som C-SUV'er. Disse biler tilbyder en balance mellem praktisk anvendelighed og manøvredygtighed fra mindre køretøjer samt plads og alsidighed fra større SUV'er. SKODA ENYAQ 85 fås i alt 9 lakfarver, herunder solide, metalliske og perlemorsmuligheder.

Du kan vælge mellem flere hjul i forskellige størrelser på SKODA ENYAQ 85, så du kan tilpasse din bil efter din stil og dine kørselspræferencer.
...
SKODA ENYAQ 85 har plads til fem passagerer med to sæder foran og en tre-personers bænk bagtil.

#### Første række sæder

SKODA ENYAQ 85 tilbyder kun én type forreste sæde.
...
SKODA ENYAQ 85 inkluderer flere funktioner, der forbedrer komfort og bekvemmelighed:
...
SKODA ENYAQ 85 er udstyret med en enkelt type rat:
...
Yderligere understøtter SKODA ENYAQ 85 Android Auto og Apple CarPlay. Denne funktionalitet giver dig mulighed for at præsentere din telefons skærm på bilens skærm, så du kan køre apps som Google Maps eller Waze.

### Lydsystem

Én type lydsystem er tilgængelig for SKODA ENYAQ 85.
...
Den SKODA ENYAQ 85 inkluderer flere standard- og valgfri [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) for at forbedre sikkerhed og komfort.
...
[**Anti-lock Bremsesystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på SKODA ENYAQ 85, dette system forhindrer hjulene i at låse under opbremsning.

[**Electronic Stability Control (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på SKODA ENYAQ 85, dette system forbedrer bilens stabilitet og håndtering under pludselige manøvrer eller på glatte vejforhold.
...
[**Front Cross Traffic Assist (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/): Standard på SKODA ENYAQ 85, dette førerassistentsystem hjælper føreren med at opdage modkørende trafik ved krydsning af et kryds eller ved sving til venstre eller højre fra en stopposition.

[**Forward Collision Warning (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på SKODA ENYAQ 85, dette førerassistentsystem hjælper føreren med at undgå eller formilde frontale kollisioner.

[**Automatisk nødbremsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på SKODA ENYAQ 85, dette system anvender bremserne autonomt for at forhindre eller reducere alvoren af en kollision, hvis føreren ikke reagerer i tide.
...
[**Blind-spot Monitoring (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard på SKODA ENYAQ 85, dette sideassistentsystem hjælper med at registrere trafik i døde vinkler.
...
SKODA ENYAQ 85 er udstyret med avancerede sikkerhedsfunktioner for at beskytte dig og dit køretøj. Disse inkluderer:
