...
El SKODA ENYAQ 85x ofrece un rendimiento modesto con una potencia máxima de 210 kW (286 hp) y un par total de 679 Nm. Acelera de 0 a 100 km/h en 6,6 segundos y tiene una velocidad máxima 180 km/h, lo que lo alinea más con los vehículos de motor de combustión interna tradicionales.
...
Sólo hay un tipo de asiento delantero disponible en el SKODA ENYAQ 85x.
...
SKODA ENYAQ 85x tiene varias características para hacer tu vida como conductor o pasajero más cómoda.
...
El SKODA ENYAQ 85x tiene un [**sistema de frenos antibloqueo (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/) como un estándar sistema. Este sistema ayuda a evitar que las ruedas del vehículo se bloqueen durante el frenado.

El SKODA ENYAQ 85x tiene un [**Control Electrónico de Estabilidad**](../../../../technology/driverassistance/electronicstabilitycontrol/) como sistema un estándar diseñado para mejorar la estabilidad y el manejo de un vehículo durante maniobras repentinas o condiciones de carretera resbaladizas.
...
El SKODA ENYAQ 85x tiene [**frenado automático de emergencia**](../../../../technology/driverassistance/automaticemergencybraking/) como sistema un estándar. Este sistema ayuda prevenir o mitigar colisiones aplicando los frenos de forma autónoma si el conductor no reacciona ante una colisión inminente.
