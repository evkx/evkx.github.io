...
The SKODA ENYAQ 85x delivers a solid performance with a maximum power of 210 kW (286 hp / 282 bhp) and a total torque of 679 Nm (501 lb-ft). It can accelerate from 0 to 100 km/h (0 to 62 mph) in 6.6 seconds and reaches a top speed of 180 km/h (112 mph), making it competitive within its class.
...
SKODA ENYAQ 85x features an all-wheel drive system powered by two motors, one on each axle. The motors used are [Induction Motors](../../../../technology/motors/asm/) at the front axle and [Permanent Magnet Synchronous Motors](../../../../technology/motors/pmsm/) at the rear axle.
...
Dynamic steering is a standard feature on the SKODA ENYAQ 85x. Dynamic steering varies the steering ratio as a function of driving speed.
...
The SKODA ENYAQ 85x, with dimensions of 4653 mm in length, 1879 mm in width, and 1607 mm in height, falls into the Compact SUVs, also known as C-SUVs, offer a balance between the practicality and maneuverability of smaller vehicles and the space and versatility of larger SUV The SKODA ENYAQ 85x is available in a total of 9 paint colors, including solid, metallic, and pearlescent options.

You can select from multiple wheel options in different sizes on the SKODA ENYAQ 85x, allowing you to customize your vehicle to suit your style and driving preferences. The available tire and wheel combinations include:
...
The SKODA ENYAQ 85x accommodates five passengers with two seats in the front and a three-seat bench in the rear.
...
Furthermore, the SKODA ENYAQ 85x supports Android Auto and Apple CarPlay. This functionality allows you to present your phone's screen in the car's screen so you can run apps like Google Maps or Waze.

### Sound system

One type of sound system is available for the SKODA ENYAQ 85x.
...
The SKODA ENYAQ 85x has several standard and optional [advanced driver assistance systems](../../../../technology/driverassistance/) (ADAS) to enhance safety and comfort.
...
[**Electronic Stability Control (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/) : Standard on the SKODA ENYAQ 85x, is a system designed to improve a vehicle's stability and handling during sudden maneuvers or slippery road conditions.

[**Lane-Keeping Assist (LKA)**](../../../../technology/driverassistance/lanekeepingassist/) : Standard on the SKODA ENYAQ 85x, this system helps prevent the vehicle from drifting out of its lane. It also includes a [**Lane Departure Warning**](../../../../technology/driverassistance/lanedeparturewarning/) system to alert the driver if the vehicle veers out of the lane.

[**Front Cross Traffic Assist**](../../../../technology/driverassistance/frontcrosstrafficassist/) : Standard on the SKODA ENYAQ 85x, is a driver assist system that helps drivers detect oncoming traffic when crossing an intersection or turning left or right from a stopped position.

[**Forward Collision Warning (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/) : Standard on the SKODA ENYAQ 85x, is a driver assist system to help drivers avoid or mitigate frontal collisions.

[**Automatic Emergency Braking**](../../../../technology/driverassistance/automaticemergencybraking/) : Standard on the SKODA ENYAQ 85x, this system autonomously applies the brakes to prevent or reduce the severity of a collision if the driver does not react in time.

[**Automatic emergency steering**](../../../../technology/driverassistance/automaticemergencysteering/) : Standard on the SKODA ENYAQ 85x, this system assists in avoiding collisions by automatically steering the vehicle in an emergency.
