...
linktitle: Enyaq iV
description: SKODA Enyaq iV is an all-electric SUV with a WLTP range of up to 529 km (329 miles). EVKX.net have all the details. 
weight: 10
---
<!-- markdownlint-disable MD033 -->

We have separated our description of SKODA Enyaq iV into sections. If you do not want to read the full article now, you can click on the links below to the different areas. We also have an overview of the [full specifications](specifications), an [image gallery](gallery), detailed information about [charging performance](chargingcurve), and some [online reviews](reviews). Our sections:
...
The SKODA Enyaq iV has a maximum power of 150KW (204hp). The total torque is 310nm. The 0-100km/h sprint (0-62mph) is performed in 8,5 seconds. The top speed is 160 kph. 
...
SKODA Enyaq iV has a rear-wheel drive system supported by one motor on the rear axle. 
...
You can order SKODA Enyaq iV with an alternative sport suspension. The sport suspension has a fixed height and damping. The ground clearance with this suspension is 163 mm. 

### Steering

Dynamic steering is optional on SKODA Enyaq iV. Dynamic steering varies the steering ratio as a function of driving speed. 
...
There are two seat types you can choose from for the front row in the SKODA Enyaq iV. 
...
SKODA Enyaq iV has several features to make your life as a driver or passenger more comfortable. 
...
Two different screen setups are available on the SKODA Enyaq iV. 
...
You can choose between two sound systems on the SKODA Enyaq iV. With the Sound system, you get six amplifier channels and six speakers with a max system output of 140 watts. With the Volkswagen Soundsystem, you get 12 amplifier channels and six speakers with a max system output of 450 watts. 

In addition, with the optional in-car navigation system, you get the help you need to find your destination. Furthermore, the SKODA Enyaq iV supports Android Auto and Apple CarPlay. This functionality allows you to present your phone's screen in the car's screen so you can run apps like Google Maps or Waze. 

The models is equipped with 4 USB-C connections as standard. 
## Lights

You can choose between two types of headlights for the SKODA Enyaq iV. The standard headlights use LED technology.  Headlights based on LED Matrix technology are available as an option. LED Matrix is an adaptive system that splits the traditional single headlight beam into dozens of smaller rays that can be turned on and off individually to un-light small areas in front. 
## Driver assistance

The SKODA Enyaq iV has several standard and optional driver assistance systems for better safety and comfort.
...
The SKODA Enyaq iV has a **lane-keeping** assistant as a standard system. This system helps to prevent the car from getting out of its lane. In addition, the system warns the driver if the vehicle leaves the driving lane.

**Side/blind spot assist** is a optional driver assist system. This side assist system helps to detect traffic in blind spots. 
### Driving Automation

The SKODA Enyaq iV offers driving automation on level 1 or 2, depending on the equipment level.
