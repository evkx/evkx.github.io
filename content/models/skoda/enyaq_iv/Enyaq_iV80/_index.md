...
The SKODA Enyaq iV80 has a maximum power of 150KW (204hp). The total torque is 310nm. It performs the 0-100km/h sprint (0-62mph) in 8,6 seconds. The top speed is 160 km/h. 
...
SKODA Enyaq iV80 has a rear-wheel drive system supported by one motor on the rear axle. The motor(s) used are [Permanent Magnet Synchronous Motors](../../../../technology/motors/pmsm/). 
...
The SKODA Enyaq iV80 has [**automatic emergency braking**](../../../../technology/driverassistance/automaticemergencybraking/) as a standard system. This system helps prevent or mitigate collisions by applying the brakes autonomously if the driver fails to react to an impending collision.
...
The cargo capacity in the trunk is 585 liters. With the rear seat down, it is 1710 liters. On the roof, you can load up to 75kg. The maxium weight of the car is 2540kg, and with the base weight of 2032 kg, you can max load 508 kg, including driver and passengers. Some options can increase the base weight and reduce the maximum loading weight. 
