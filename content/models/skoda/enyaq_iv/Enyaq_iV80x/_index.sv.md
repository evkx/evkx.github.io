...
SKODA Enyaq iV80x har en maximal effekt på 195 KW (265hk). Totalt vridmoment är 425 Nm. Den gör sprinten 0-100 km/h på 6.9 sekunder. Topphastigheten är 160 km/h.
...
[WLTP-räckvidd](../../../../guides/understandingrange/wltp/) är 504 km. Förbrukningen är 15.3kWh/100 km för WLTP-standardtestet. För mer information om sortimentet, se verkliga data och räckvidd på denna modells [räckvidd og förbruk](rangeandconsumption/) sida.
...
För den teoretiska 1000km-utmaningen, att börja med fullt batteri och köra i 120km/h (75 mph), förutsatt optimala körförhållanden och förbrukning på 23kWh/100km, tar 1000km 9 timmar och 51 minuter. Den här resan kommer att kräva fem laddningssession(er) laddning från 2% till 42%. Total tid som går förlorad för att ladda batteriet kommer att vara 91 minuter.
...
SKODA Enyaq iV80x har flera funktioner för att göra ditt liv som förare eller passagerare bekvämare.
...
Du kan välja mellan två ljudsystem på SKODA Enyaq iV80x. Med Sound system får du åtta högtalare med en maximal systemeffekt på 80 watt. Med Canton Soundsystem får du tio högtalare med en maximal systemeffekt på 550 watt.

Dessutom, med valfritt navigationssystemet i bilen får du den hjälp du behöver för att hitta din destination. Dessutom stöder SKODA Enyaq iV80x Android Auto och Apple CarPlay. Denna funktion gör att du kan visa telefonens skärm på bilens skärm så att du kan köra appar som Google Maps eller Waze.
...
SKODA Enyaq iV80x har ett [**ABS-bromssystem**](../../../../technology/driverassistance/antilockbrakingsystem/) som standard-systemet. Detta system hjälper till att förhindra att ett fordons hjul låser sig under inbromsning.

SKODA Enyaq iV80x har ett [**elektronisk stabilitetskontroll**](../../../../technology/driverassistance/electronicstabilitycontrol/) vilket standard-system är utformat för att förbättra ett fordons stabilitet och hantering under plötsliga manövrar eller halt väglag.

SKODA Enyaq iV80x har en [**filhållningsassistent**](../../../../technology/driverassistance/lanekeepingassist/) som standard-system. Detta system bidrar för att förhindra att bilen lämnar körfältet. Dessutom har den ett [**filavvikelsevarning**](../../../../technology/driverassistance/lanedeparturewarning/) system som varnar föraren om fordonet lämnar körfältet.
...
SKODA Enyaq iV80x har [**automatisk nödbroms**](../../../../technology/driverassistance/automaticemergencybraking/) som standard-system. Detta system hjälper till att förhindra eller mildra kollisioner genom att ansätta bromsarna autonomt om föraren inte reagerar på en förestående kollision.
...
Denna modell hade världspremiär 1/1/2020 och leveranser startade i March 2021. Denna modell har nu utgått.<div class="mt-3 mb-3">
