...
description: "SKODA ENYAQ RS iV (GEN1) er en elektrisk SUV med en WLTP rekkevidde på opptil 514 km (320 miles). EVKX.net har alle detaljene."
weight: 10
hidden: true
shownavtabs: true
...
Med overboost når SKODA ENYAQ RS iV (GEN1) en maksimal effekt på 220 kW (299 hk / 295 bhp). Uten overboost leverer den 195 kW (265 hk / 262 bhp). Det maksimale dreiemomentet er 460 Nm (339 lb-ft). Den akselererer fra 0 til 100 km/t på 6,5 sekunder og når en topphastighet på 180 km/t (112 mph), noe som viser dens solide ytelse.
...
Under [WLTP](../../../../guides/understandingrange/wltp/) (Worldwide Harmonized Light Vehicles Test Procedure) standarden, varierer kjørelengden mellom 514 til 496 km (320-308 miles), avhengig av spesifikk konfigurasjon og valg, som for eksempel hjulstørrelse. Større hjul kan øke energiforbruket og følgelig redusere total rekkevidde. Bilens energiforbruk er oppgitt til 15,0 kWh/100 km for basismodellen og 15,5 kWh/100 km for toppmodellen under WLTP testsyklusen. For mer informasjon om rekkevidde, se faktiske data og rekkeviddelister på denne modellens [rekkevidde og forbruk](rangeandconsumption/) side.
...
SKODA ENYAQ RS iV (GEN1) har et firehjulsdrift-system drevet av to motorer, en på hver aksel. Motorene som brukes er [induksjonsmotorer](../../../../technology/motors/asm/) på forakselen og [permanent magnet synkronmotorer](../../../../technology/motors/pmsm/) på bakakselen.
...
SKODA ENYAQ RS iV (GEN1), med dimensjoner på 4649 mm i lengde, 1879 mm i bredde og 1616 mm i høyde, tilhører kategorien kompakte SUVer, også kjent som C-SUVer. Disse tilbyr en balanse mellom praktisk bruk og manøvrerbarhet fra mindre kjøretøy og plassen og allsidigheten til større SUVer. SKODA ENYAQ RS iV (GEN1) er tilgjengelig i totalt 9 lakkfarger, inkludert solide, metallic- og perlemorslakker.

SKODA ENYAQ RS iV (GEN1) tilbyr flere hjulalternativer i ulike størrelser, slik at du kan tilpasse kjøretøyet etter din stil og kjørepreferanser. De tilgjengelige dekk- og hjulkombinasjonene inkluderer:
...
SKODA ENYAQ RS iV (GEN1) har plass til fem passasjerer med to forseter og en treseters benk bak.

#### Forseter

SKODA ENYAQ RS iV (GEN1) tilbyr bare én type forsete.
...
SKODA ENYAQ RS iV (GEN1) inkluderer flere funksjoner for å øke komfort og bekvemmelighet:
...
SKODA ENYAQ RS iV (GEN1) er utstyrt med én type ratt:
...
SKODA ENYAQ RS iV (GEN1) støtter Android Auto og Apple CarPlay, som lar deg speile telefonskjermen på bilens skjerm. Denne funksjonaliteten gjør at du kan kjøre apper som Google Maps eller Waze direkte fra telefonen.

### Lydsystem

SKODA ENYAQ RS iV (GEN1) kommer med ett lydsystem:
...
SKODA ENYAQ RS iV (GEN1) kommer med avanserte LED Matrix frontlykter. Dette adaptive systemet deler den tradisjonelle frontlyktsstrålen inn i flere mindre stråler, som lar lyskontrolleren selektivt skru dem av og på for å unngå å blende andre sjåfører. For økt sikkerhet inkluderer frontlyktene også svinglys som lyser opp siden når du svinger.
...
SKODA ENYAQ RS iV (GEN1) har en rekke standard og valgfrie [avanserte førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) designet for å øke sikkerhet og komfort.
...
[**Blokkeringsfrie bremser (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på SKODA ENYAQ RS iV (GEN1), dette systemet hindrer hjulene i å låse seg under bremsing.

[**Elektronisk stabilitetskontroll (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på SKODA ENYAQ RS iV (GEN1), dette systemet forbedrer kjøretøyets stabilitet og håndtering under plutselige manøvrer eller på glatte veier.

[**Filholderassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på SKODA ENYAQ RS iV (GEN1), dette systemet hjelper med å hindre kjøretøyet i å drive ut av filen. Den inkluderer også et [**Filskiftevarsel**](../../../../technology/driverassistance/lanedeparturewarning/) system som varsler føreren hvis kjøretøyet beveger seg ut av filen.

[**Kryssende trafikkvarsling foran (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/) : Standard på SKODA ENYAQ RS iV (GEN1), dette førerassistentsystemet hjelper førere med å oppdage møtende trafikk når de krysser et veikryss eller svinger til venstre eller høyre fra stillestående posisjon.

[**Frontkollisjonsvarsling (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på SKODA ENYAQ RS iV (GEN1), dette førerassistentsystemet hjelper førere med å unngå eller redusere frontkollisjoner.

[**Automatisk nødbrems (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på SKODA ENYAQ RS iV (GEN1), dette systemet aktiverer bremsene automatisk for å forhindre eller redusere alvorlighetsgraden av en kollisjon hvis føreren ikke reagerer i tide.

[**Automatisk nødstyring (AES)**](../../../../technology/driverassistance/automaticemergencysteering/): Standard på SKODA ENYAQ RS iV (GEN1), dette systemet hjelper til med å unngå kollisjoner ved å automatisk styre kjøretøyet i en nødsituasjon.

[**Blindsoneovervåking (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard på SKODA ENYAQ RS iV (GEN1), dette sideassistentsystemet hjelper med å oppdage trafikk i blindsoner.
...
SKODA ENYAQ RS iV (GEN1) er utstyrt med avanserte sikkerhetsfunksjoner for å beskytte deg og kjøretøyet ditt. Disse inkluderer:
...
Bagasjerommet har en lastekapasitet på 585 liter (20,7 CU FT). Med baksetet nedfelt øker dette til 1710 liter (60,4 CU FT). På taket kan du laste opptil 75 kg (165,3 lbs).

Kjøretøyets maksimale vekt er 2750 kg (6063 lbs), med en egenvekt på 2117 kg (4667 lbs). Dette tillater en maksimal last på 633 kg (1396 lbs), inkludert fører og passasjerer. Merk at noen tilvalg kan øke egenvekten og redusere maksimal lastekapasitet.
...
Denne modellen hadde sin verdenspremiere 01.01.2020, og leveringene startet i March 2021. Denne modellen er nå utgått.
