...
description: "SKODA ENYAQ COUPÉ RS iV (GEN1) er en fuldelektrisk coupé-SUV med en WLTP rækkevidde på op til 514 km (320 miles). EVKX.net har alle detaljerne."
weight: 10
hidden: true
shownavtabs: true
...
Vi har opdelt vores SKODA ENYAQ COUPÉ RS iV (GEN1) artikel i sektioner. Hvis du vil vente med at læse hele artiklen, skal du klikke på nedenstående links til de forskellige områder. Vi har også en oversigt over de [fulde specifikationer](specifications/), et [billedgalleri](gallery/), detaljerede oplysninger om [opladningsydelse](chargingcurve/), og nogle [online anmeldelser](reviews/). Vores sektioner:
...
Denne model er blevet erstattet af [SKODA ENYAQ COUPÉ RS iV](/models/skoda/enyaq_iv/enyaq_coupé_rs_iv/).

</div>

## Ydeevne

Med overboost når SKODA ENYAQ COUPÉ RS iV (GEN1) en maksimal effekt på 220 kW (299 hk). Uden overboost leverer den 195 kW (265 hk). Det maksimale drejningsmoment er 460 Nm. Den kan accelerere fra 0 til 100 km/t på 6,5 sekunder og når en topfart på 180 km/t, hvilket demonstrerer dens solide præstation.
...
SKODA ENYAQ COUPÉ RS iV (GEN1) har et firehjulstræk, der understøttes af to motorer, en på hver aksel. De anvendte motorer er [induktionsmotorer](../../../../technology/motors/asm/) på forakslen og [Permanent Magnet Synchronous Motors] (../../../../technology/motors/pmsm/) på bagakslen.
...
Den SKODA ENYAQ COUPÉ RS iV (GEN1), med dimensioner på 4653 mm i længde, 1879 mm i bredde og 1607 mm i højde, tilhører kompakte SUV'er, også kendt som C-SUV'er. Disse biler tilbyder en balance mellem praktisk anvendelighed og manøvredygtighed fra mindre køretøjer samt plads og alsidighed fra større SUV'er. SKODA ENYAQ COUPÉ RS iV (GEN1) fås i alt 9 lakfarver, herunder solide, metalliske og perlemorsmuligheder.

Du kan vælge mellem flere hjul i forskellige størrelser på SKODA ENYAQ COUPÉ RS iV (GEN1), så du kan tilpasse din bil efter din stil og dine kørselspræferencer.
...
SKODA ENYAQ COUPÉ RS iV (GEN1) har plads til fem passagerer med to sæder foran og en tre-personers bænk bagtil.

#### Første række sæder

SKODA ENYAQ COUPÉ RS iV (GEN1) tilbyder kun én type forreste sæde.
...
SKODA ENYAQ COUPÉ RS iV (GEN1) inkluderer flere funktioner, der forbedrer komfort og bekvemmelighed:
...
SKODA ENYAQ COUPÉ RS iV (GEN1) har to skærme med information til fører og passagerer. Bag rattet er en [digital instrumentgruppe](../../../../technology/userinterface/screens/#digital-instruments) monteret på ratstammen , og oven på dashboardet er en [infotainment-skærm](../../../../technology/userinterface/screens/#infotainment-skærm).
...
SKODA ENYAQ COUPÉ RS iV (GEN1) er udstyret med en enkelt type rat:
...
Yderligere understøtter SKODA ENYAQ COUPÉ RS iV (GEN1) Android Auto og Apple CarPlay. Denne funktionalitet giver dig mulighed for at præsentere din telefons skærm på bilens skærm, så du kan køre apps som Google Maps eller Waze.

### Lydsystem

Én type lydsystem er tilgængelig for SKODA ENYAQ COUPÉ RS iV (GEN1).
...
Den SKODA ENYAQ COUPÉ RS iV (GEN1) inkluderer flere standard- og valgfri [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) for at forbedre sikkerhed og komfort.
...
[**Anti-lock Bremsesystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på SKODA ENYAQ COUPÉ RS iV (GEN1), dette system forhindrer hjulene i at låse under opbremsning.

[**Electronic Stability Control (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på SKODA ENYAQ COUPÉ RS iV (GEN1), dette system forbedrer bilens stabilitet og håndtering under pludselige manøvrer eller på glatte vejforhold.

[**Lane-Keeping Assist (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på SKODA ENYAQ COUPÉ RS iV (GEN1), dette system hjælper med at forhindre køretøjet i at drive ud af sin vognbane. Den inkluderer også et [**Lane Departure Warning**](../../../../technology/driverassistance/lanedeparturewarning/) system, der advarer føreren, hvis køretøjet forlader sin vognbane.

[**Front Cross Traffic Assist (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/): Standard på SKODA ENYAQ COUPÉ RS iV (GEN1), dette førerassistentsystem hjælper føreren med at opdage modkørende trafik ved krydsning af et kryds eller ved sving til venstre eller højre fra en stopposition.

[**Forward Collision Warning (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på SKODA ENYAQ COUPÉ RS iV (GEN1), dette førerassistentsystem hjælper føreren med at undgå eller formilde frontale kollisioner.

[**Automatisk nødbremsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på SKODA ENYAQ COUPÉ RS iV (GEN1), dette system anvender bremserne autonomt for at forhindre eller reducere alvoren af en kollision, hvis føreren ikke reagerer i tide.

[**Automatisk nødstyring (AES)**](../../../../technology/driverassistance/automaticemergencysteering/): Standard på SKODA ENYAQ COUPÉ RS iV (GEN1), dette system hjælper med at undgå kollisioner ved automatisk at styre køretøjet i en nødsituation.

[**Blind-spot Monitoring (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard på SKODA ENYAQ COUPÉ RS iV (GEN1), dette sideassistentsystem hjælper med at registrere trafik i døde vinkler.
...
SKODA ENYAQ COUPÉ RS iV (GEN1) er udstyret med avancerede sikkerhedsfunktioner for at beskytte dig og dit køretøj. Disse inkluderer:
...
Denne model havde verdenspremiere den 01.01.2020, og leveringerne startede i March 2021. Denne model er nu udgået. Denne model er blevet erstattet af [SKODA ENYAQ COUPÉ RS iV](/models/skoda/enyaq_iv/enyaq_coupé_rs_iv).
