...
description: "SKODA ENYAQ COUPÉ RS iV (GEN1) er en elektrisk coupé SUV med en WLTP rækkevidde på op til 514 km (320 miles). EVKX.net har alle detaljerne."
weight: 10
hidden: true
shownavtabs: true
...
Denne model er blevet erstattet af [SKODA ENYAQ COUPÉ RS iV](/nb-NO/models/skoda/enyaq_iv/enyaq_coupé_rs_iv/).
...
Med overboost når SKODA ENYAQ COUPÉ RS iV (GEN1) en maksimal effekt på 220 kW (299 hk / 295 bhp). Uden overboost leverer den 195 kW (265 hk / 262 bhp). Det maksimale drejningsmoment er 460 Nm (339 lb-ft). Den accelererer fra 0 til 100 km/t (0 til 62 mph) på 6,5 sekunder og når en tophastighed på 180 km/t (112 mph), hvilket demonstrerer dens solide ydeevne.
...
SKODA ENYAQ COUPÉ RS iV (GEN1) har et firehjulstræksystem drevet af to motorer, én på hver aksel. De anvendte motorer er [induktionsmotorer](../../../../technology/motors/asm/) på forakslen og [permanent magnet synkronmotorer](../../../../technology/motors/pmsm/) på bagakslen.
...
Dynamisk styring er standard på SKODA ENYAQ COUPÉ RS iV (GEN1), hvor styringsforholdet varierer baseret på kørehastighed for forbedret kontrol og komfort.
...
SKODA ENYAQ COUPÉ RS iV (GEN1), med dimensioner på 4653 mm i længde, 1879 mm i bredde og 1607 mm i højde, tilhører kategorien Kompakt SUV, også kendt som C-SUV. Disse tilbyder en balance mellem mindre bilers praktiske egenskaber og manøvredygtighed og større SUV'ers plads og alsidighed. SKODA ENYAQ COUPÉ RS iV (GEN1) fås i alt i 9 lakfarver, inklusive almindelige, metalliske og perlemor muligheder.

SKODA ENYAQ COUPÉ RS iV (GEN1) tilbyder flere hjulmuligheder i forskellige størrelser, så du kan tilpasse din bil efter din stil og kørepræferencer. De tilgængelige dæk- og hjulkombinationer inkluderer:
...
SKODA ENYAQ COUPÉ RS iV (GEN1) har plads til fem passagerer med to forsæder og en trebænk bagtil.

#### Forsæder

SKODA ENYAQ COUPÉ RS iV (GEN1) tilbyder én type forsæde.
...
SKODA ENYAQ COUPÉ RS iV (GEN1) inkluderer flere funktioner for at forbedre komfort og bekvemmelighed:
...
SKODA ENYAQ COUPÉ RS iV (GEN1) er udstyret med én type rat:
...
SKODA ENYAQ COUPÉ RS iV (GEN1) understøtter Android Auto og Apple CarPlay, så du kan spejle din telefons skærm på bilens display. Denne funktionalitet gør det muligt at køre apps som Google Maps eller Waze direkte fra din telefon.

### Lydsystem

SKODA ENYAQ COUPÉ RS iV (GEN1) kommer med ét lydsystem:
...
SKODA ENYAQ COUPÉ RS iV (GEN1) er udstyret med avancerede LED Matrix-forlygter. Dette adaptive system opdeler den traditionelle enkeltstråle i flere mindre stråler, så lyskontrolenheden selektivt kan tænde og slukke dem for at undgå at blænde andre bilister. For øget sikkerhed inkluderer forlygterne også kurvelys, der oplyser siden ved drejning.
...
SKODA ENYAQ COUPÉ RS iV (GEN1) har en række standard og valgfrie [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) designet til at forbedre sikkerhed og komfort.
...
[**Antiblokeringssystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på SKODA ENYAQ COUPÉ RS iV (GEN1), dette system forhindrer hjulene i at låse under bremsning.

[**Elektronisk Stabilitetskontrol (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på SKODA ENYAQ COUPÉ RS iV (GEN1), dette system forbedrer bilens stabilitet og håndtering under pludselige manøvrer eller på glatte veje.
...
[**Front Tværgående Trafik Assistent (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/) : Standard på SKODA ENYAQ COUPÉ RS iV (GEN1), dette førerassistentsystem hjælper førere med at registrere modkørende trafik ved krydsning af et vejkryds eller når der drejes til venstre eller højre fra stillestående position.

[**Advarsel om Frontal Kollision (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på SKODA ENYAQ COUPÉ RS iV (GEN1), dette førerassistentsystem hjælper førere med at undgå eller mindske frontale kollisioner.

[**Automatisk Nødbremsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på SKODA ENYAQ COUPÉ RS iV (GEN1), dette system aktiverer automatisk bremserne for at forhindre eller reducere alvorligheden af en kollision, hvis føreren ikke reagerer i tide.
...
[**Blindvinkel Overvågning (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard på SKODA ENYAQ COUPÉ RS iV (GEN1), dette system hjælper med at opdage trafik i blinde vinkler.
...
SKODA ENYAQ COUPÉ RS iV (GEN1) er udstyret med avancerede sikkerhedsfunktioner for at beskytte dig og dit køretøj. Disse omfatter:
...
Denne model havde sin verdenspremiere den 01.01.2020, og leveringerne startede i March 2021. Denne model er nu udgået. Denne model er blevet erstattet af [SKODA ENYAQ COUPÉ RS iV](/models/skoda/enyaq_iv/enyaq_coupé_rs_iv).
