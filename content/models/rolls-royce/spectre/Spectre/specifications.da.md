---
title: Rolls-Royce Spectre specifikationer
linktitle: "Specifikationer"
description: "EVKX.net giver dig de fulde specifikationer for Rolls-Royce Spectre."
weight: 4
hidden: true
...
EVKX.net søger at have de mest komplette specifikationer for Rolls-Royce Spectre. Klik på billedet ovenfor for [fuld artikel](../), besøg [billedgalleriet](../gallery/) for billeder i høj opløsning af Rolls-Royce Spectre, besøg [chargeinfo](../chargingcurve/) for Rolls-Royce Spectre med chargecurve, se [extended range info](../rangeandconsumption/) for real world ranges.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Chartreuse (Grøn)</br>
				Morganite (Lyserød)</br>
				Wittering bLue (Blå)</br>
				Tempest Grey (Grå)</br>
				Dark Emerald (Sort)</br>
				Gunmetal Grey (Grå)</br>
				Midnight Sapphire (Blå)</br>
				Twilight Purple (Lilla)</br>
			</td>
		</tr>
	</tbody>
</table>
