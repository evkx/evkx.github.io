---
title: Rolls-Royce Spectre spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Rolls-Royce Spectre."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Rolls-Royce Spectre. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Rolls-Royce Spectre, visitez les [chargeinfo](../chargingcurve/) pour Rolls-Royce Spectre avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
	...
	<tbody>
		<tr>
			...
			<td>
				Chartreuse (Vert)</br>
				Morganite (Rose)</br>
				Wittering bLue (Bleu)</br>
				Tempest Grey (Gris)</br>
				Dark Emerald (Noir)</br>
				Gunmetal Grey (Gris)</br>
				Midnight Sapphire (Bleu)</br>
				Twilight Purple (Violet)</br>
			</td>
		</tr>
	</tbody>
</table>
