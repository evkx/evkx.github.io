---
title: Rolls-Royce Spectre Spezifikationen
linktitle: "Spezifikationen"
description: "EVKX.net bietet Ihnen die vollständigen Spezifikationen für Rolls-Royce Spectre."
weight: 4
hidden: true
...
EVKX.net strebt an, die vollständigsten Spezifikationen für Rolls-Royce Spectre zu haben. Klicken Sie auf das Bild oben für den [vollständigen Artikel](../), besuchen Sie die [Bildergalerie](../gallery/) für hochauflösende Bilder von Rolls-Royce Spectre, besuchen Sie die [Ladeinformationen](../chargingcurve/) für Rolls-Royce Spectre mit Ladekurve, besuchen Sie die [erweiterten Reichweiteninformationen](../rangeandconsumption/) für reale Reichweiten.
	...
	<tbody>
		<tr>
			...
			<td>
				Chartreuse (Grün)</br>
				Morganite (Rosa)</br>
				Wittering bLue (Blau)</br>
				Tempest Grey (Grau)</br>
				Dark Emerald (Schwarz)</br>
				Gunmetal Grey (Grau)</br>
				Midnight Sapphire (Blau)</br>
				Twilight Purple (Lila)</br>
			</td>
		</tr>
	</tbody>
</table>
