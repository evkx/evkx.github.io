...
description: "HiPhi Z 5 Seater es un sedán de lujo totalmente eléctrico con un WLTP alcance de hasta 555 km (345 millas). EVKX.net tiene todos los detalles."
weight: 10
hidden: true
shownavtabs: true
...
El HiPhi Z 5 Seater impresiona con una potencia máxima de 494 kW (672 hp) y un impresionante par total de 820 Nm. Esta máquina de alto rendimiento puede acelerar de 0 a 100 km/h en solo 3,8 segundos y alcanza una velocidad máxima de 200 km/h, destacándose en su clase.
...
La velocidad máxima de carga de CC es kW. Una carga completa del 0 al 100 % tardaría 94 minutos, mientras que un escenario más común del 10 al 80 % tardaría 48 minutos. Si supone que pierde 5 minutos conduciendo por cada parada de carga, además del tiempo de carga, el área de carga óptima es del 4% al 48%, lo que da como resultado una velocidad de carga real, incluida la pérdida de tiempo, de 101kW. Cada sesión de carga tardaría 29 minutos y 30 segundos.

En un desafío teórico de 1000 km, comenzando con una batería completa y manteniendo una velocidad constante de 120 km/h en condiciones ideales con un consumo asumido de 28 kWh/100 km, el viaje tomaría aproximadamente 9 horas y 59 minutos. Este viaje requeriría dos paradas de carga del 5% al 42%, con un tiempo total de carga de 100 minutos.

### Cargador a bordo

El cargador a bordo estándar soporta hasta 11 kW para carga AC de Nivel 1 y Nivel 2. Esto permite cargar completamente la batería del 0 al 100% en aproximadamente 10 horas y 16 minutos usando un cargador en casa.

{{< sitefiguresized thumb="models/hiphi/z/z_5_seater/charging_1_st.jpg" title="HiPhi Z 5 Seater" width="3000" height="2032"  >}}

### Puerto de carga

La ubicación del puerto de carga está en el [lado trasero derecho](../../../../technology/charging/connectors/#parte-trasera). Esta ubicación facilita el uso de estaciones de carga en las que es necesario realizar una copia de seguridad del cargador. Este modelo usa [**GBT**](../../../../technology/charging/connectors/#gbt) para China y Europa, lo que significa que debe utilizar un adaptador CCS2>GBT en Europa. Consulte las especificaciones completas para todos los mercados.

{{<evkxdisplayaddarticle />}}

## Tren de transmisión

HiPhi Z 5 Seater tiene un sistema de tracción total sostenido por dos motores, uno en cada eje. Los motores utilizados son [Motores síncronos de imanes permanentes](../../../../technology/motors/pmsm/).
...
Puedes seleccionar entre múltiples diseños de ruedas, todos disponibles en el mismo tamaño, en el HiPhi Z 5 Seater, lo que te permite personalizar tu vehículo según tu estilo y preferencias de conducción.
...
El HiPhi Z 5 Seater tiene capacidad para cinco pasajeros con dos asientos delanteros y un banco trasero de tres plazas.

#### Asientos de primera fila

El HiPhi Z 5 Seater ofrece un único tipo de asiento delantero.
...
El HiPhi Z 5 Seater incluye varios [sistemas avanzados de asistencia al conductor](../../../../technology/driverassistance/) (ADAS) estándar y opcionales para mejorar la seguridad y el confort.
...
[**Control Electrónico de Estabilidad (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Estándar en el HiPhi Z 5 Seater, este sistema mejora la estabilidad y el manejo del vehículo durante maniobras repentinas o en condiciones de carretera resbaladizas.
...
[**Asistencia de Tráfico Cruzado Delantero (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/): Estándar en el HiPhi Z 5 Seater, este sistema de asistencia al conductor ayuda a detectar tráfico que se aproxima al cruzar una intersección o al girar a la izquierda o derecha desde una posición detenida.

[**Advertencia de Colisión Frontal (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Estándar en el HiPhi Z 5 Seater, este sistema de asistencia al conductor ayuda a evitar o mitigar colisiones frontales.

[**Frenado de emergencia automático (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Estándar en el HiPhi Z 5 Seater, este sistema aplica los frenos automáticamente para prevenir o reducir la gravedad de una colisión si el conductor no reacciona a tiempo.

[**Monitoreo de Punto Ciego (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Estándar en el HiPhi Z 5 Seater, este sistema de asistencia lateral ayuda a detectar tráfico en los puntos ciegos.

[**Advertencia de Salida**](../../../../technology/driverassistance/exitwarning/): Estándar en el HiPhi Z 5 Seater, este sistema alerta a los ocupantes para que no abran las puertas si hay riesgo de golpear algo.
...
El HiPhi Z 5 Seater está equipado con características de seguridad avanzadas para protegerlo a usted y a su vehículo. Estos incluyen:
...
El maletero ofrece una capacidad de carga de 316 litros. Con el asiento trasero plegado, esto se expande a 684 litros. Además, hay un frunk (maletero delantero) con una capacidad de almacenamiento de 40 litros.
...
{{< pagenavigation b_url="../" b_title="HiPhi Z" f_url="rangeandconsumption/" f_title="Rango" >}}
