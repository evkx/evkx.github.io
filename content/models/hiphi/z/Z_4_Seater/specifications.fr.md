---
title: HiPhi Z 4 Seater spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de HiPhi Z 4 Seater."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour HiPhi Z 4 Seater. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de HiPhi Z 4 Seater, visitez les [chargeinfo](../chargingcurve/) pour HiPhi Z 4 Seater avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Sonic Grey (Gris)</br>
				StarChase Silver (Argent)</br>
				Anthelion White (Blanc)</br>
				Star Ocean Blue (Bleu)</br>
				Ice Crystal Blue (Bleu)</br>
				Khaki Green (Vert)</br>
			</td>
		</tr>
	</tbody>
