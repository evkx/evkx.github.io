...
EVKX.net søker å ha de mest komplette spesifikasjonene for HiPhi Z 4 Seater. Klikk på bildet ovenfor for [full artikkel](../), besøk [bildegalleriet](../gallery/) for høyoppløselige bilder av HiPhi Z 4 Seater, gå til [chargeinfo](../chargingcurve/) for HiPhi Z 4 Seater med ladekurve, se [extended range info](../rangeandconsumption/) for real world ranges.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Sonic Grey (Grå)</br>
				StarChase Silver (Sølv)</br>
				Anthelion White (Hvit)</br>
				Star Ocean Blue (Blå)</br>
				Ice Crystal Blue (Blå)</br>
