...
description: "HiPhi Y Performance er en fuldelektrisk premium-SUV med en rækkevidde på WLTP på op til 620 km (385 miles). EVKX.net har alle detaljerne."
weight: 10
hidden: true
shownavtabs: true
...
Den maksimale DC-opladningshastighed er kW. En fuld opladning fra 0 - 100 % ville tage 92 minutter, mens et mere almindeligt scenarie på 10-80 % ville tage 48 minutter. Hvis du antager, at du mister 5 minutters kørsel pr. ladestop ud over opladningstiden, er det optimale opladningsområde fra 4% til 49%, hvilket resulterer i en faktisk opladningshastighed, inklusive tidstab på 97kW. Hver opladningssession ville tage 30 minutter og 28 sekunder.

I en teoretisk 1000 km udfordring, der starter med et fuldt batteri og opretholder en konstant hastighed på 120 km/t under ideelle forhold med et antaget forbrug på 28 kWh/100 km, ville turen tage cirka 10 timer og 8 minutter. Denne rejse ville kræve to opladningsstop fra 3% til 56%, med en samlet opladningstid på 108 minutter

### Ombordlader

Den standard ombordlader understøtter op til 11 kW til Level 1 og Level 2 AC-opladning. Dette gør det muligt at fuldt oplade batteriet fra 0 til 100% på cirka 9 timer og 54 minutter ved brug af en hjemmeoplader.
...
Forhjulsophænget er [double wishbone](../../../../technology/suspension/#double-wishbone), og baghjulsophænget er [Multilink](../../../../technology/suspension/#multilink). Den bruger stålfjedre og hydrauliske dæmpere. affjedringen har stålfjedre med en fast højde, men du kan justere dæmpningen, så den passer til din kørestil eller vejforhold. Mindste frihøjde med denne affjedring er 200 mm.

### Styring

Dynamisk styring er en standard-funktion på HiPhi Y Performance. Dynamisk styring varierer styreforholdet som en funktion af kørehastigheden. Derudover er baghjulsstyring tilgængelig som en standard-funktion. Baghjulsstyring reducerer drejecirklen, når du kører langsomt.
...
HiPhi Y Performance inkluderer flere funktioner, der forbedrer komfort og bekvemmelighed:
...
HiPhi Y Performance er udstyret med en enkelt type rat:
...
Du kan vælge mellem to lydsystemer på HiPhi Y Performance.
...
Den HiPhi Y Performance inkluderer flere standard- og valgfri [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) for at forbedre sikkerhed og komfort.

### Sikkerhedssystemer

[**Anti-lock Bremsesystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på HiPhi Y Performance, dette system forhindrer hjulene i at låse under opbremsning.

[**Electronic Stability Control (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på HiPhi Y Performance, dette system forbedrer bilens stabilitet og håndtering under pludselige manøvrer eller på glatte vejforhold.
...
[**Front Cross Traffic Assist (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/): Standard på HiPhi Y Performance, dette førerassistentsystem hjælper føreren med at opdage modkørende trafik ved krydsning af et kryds eller ved sving til venstre eller højre fra en stopposition.

[**Forward Collision Warning (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på HiPhi Y Performance, dette førerassistentsystem hjælper føreren med at undgå eller formilde frontale kollisioner.

[**Automatisk nødbremsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på HiPhi Y Performance, dette system anvender bremserne autonomt for at forhindre eller reducere alvoren af en kollision, hvis føreren ikke reagerer i tide.

[**Blind-spot Monitoring (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard på HiPhi Y Performance, dette sideassistentsystem hjælper med at registrere trafik i døde vinkler.

[**Exit Warning**](../../../../technology/driverassistance/exitwarning/): Standard på HiPhi Y Performance, dette system advarer passagererne mod at åbne dørene, hvis der er risiko for at ramme noget.
...
HiPhi Y Performance er udstyret med avancerede sikkerhedsfunktioner for at beskytte dig og dit køretøj. Disse inkluderer:
...
Denne model havde verdenspremiere den 18.04.2023, og leveringerne startede i March 2024. Denne model er nu udgået.
