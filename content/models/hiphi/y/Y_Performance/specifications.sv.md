...
description: "EVKX.net ger dig alla specifikationer för HiPhi Y Performance."
weight: 4
hidden: true
...
EVKX.net vill ha de mest kompletta specifikationerna för HiPhi Y Performance. Klicka på bilden ovan för [fullständig artikel](../), besök [bildgalleri](../gallery/) för hög upplösningsbilder av HiPhi Y Performance, gå till [chargeinfo](../chargingcurve/) för HiPhi Y Performance med laddningskurva, se [extended range info](../rangeandconsumption/) för verkliga räckvidd.
