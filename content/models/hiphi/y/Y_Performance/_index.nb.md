...
description: "HiPhi Y Performance er en helelektrisk premium-SUV med en WLTP rekkevidde på opptil 620 km (385 miles). EVKX.net har alle detaljene. "
weight: 10
hidden: true
shownavtabs: true
...
Vi har delt vår HiPhi Y Performance-artikkel i seksjoner. Hvis du vil vente med å lese hele artikkelen, klikker du på lenkene nedenfor til de forskjellige områdene. Vi har også en oversikt over [fullstendige spesifikasjoner]( spesifikasjoner), et [bildegalleri](galleri), detaljert informasjon om [ladeytelse](ladekurve), og noen [online anmeldelser](anmeldelser). Våre seksjoner:
...
HiPhi Y Performance har en maksimal effekt på 371KW (504hk).Totalt dreiemoment er 620nm. Den utfører sprinten 0-100 km/t (0-62 mph) på 4,7 sekunder. 

## Batteri, rekkevidde og lading

Batteriet har en bruttokapasitet på 115kWh og en nettokapasitet på 109kWh, noe som betyr at du har en 6kWh-buffer for beskyttelse. (5,2%).Lithium-ion-batteriet bruker [NMC-teknologi.](../../../../technology/battery/cellchemistry/#lithium-nikkel-manganese-cobalt- oksider-nmc)

 [WLTP-området](../../../../guides/understandingrange/wltp) er 620 km (385 mi). Forbruket er 17.6kWh/100 km for WLTP-standardtesten. For flere detaljer om utvalget, se virkelige data og rekkevidde på denne modellens [rekkevidde og forbruk](rangeandconsumption/)-side. 
...
exterior.doors.standardandstandardgullwinghatcbackliftbackElektriske dører er a standard funksjon for sidedørene. 
...
Du kan velge mellom two lydsystemer på HiPhi Y Performance. Med SONIC LINE SYSTEM får du 14 høyttalere med en maksimal systemeffekt på 600 watt. Med SONIC PRO SYSTEM får du 25 høyttalere med en maksimal systemeffekt på 2820 watt. 
...
HiPhi Y Performance har et [**låsefri bremsesystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/) som a standard-systemet. Dette systemet bidrar til å forhindre at et kjøretøys hjul låser seg under bremsing.

HiPhi Y Performance har et [**Electronic Stability Control**](../../../../technology/driverassistance/electronicstabilitycontrol/) som a standard-system utviklet for å forbedre et kjøretøys stabilitet og håndtering under plutselige manøvrer eller glatte veiforhold. 

HiPhi Y Performance har et [**kjørefeltassistent**](../../../../technology/driverassistance/lanekeepingassist/) som a standard-system. Dette systemet bidrar til å forhindre at bilen kommer ut av kjørefeltet.I tillegg har den et [**filskiftevarsel**](../../../../technology/driverassistance/lanedeparturewarning/) system som varsler sjåføren hvis kjøretøyet forlater kjørefeltet.
...
HiPhi Y Performance har [**automatisk nødbremsing**](../../../../technology/driverassistance/automaticemergencybraking/) som a standard-system. Dette systemet hjelper forhindre eller dempe kollisjoner ved å sette på bremsene autonomt hvis føreren ikke reagerer på en forestående kollisjon.
