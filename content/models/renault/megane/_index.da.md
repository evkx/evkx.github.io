...
<i class="bi bi-record2-fill"></i> FWD <i class="bi bi-battery-full"></i> 65 kWh <i class="bi bi-ev-station"></i> 130 kW 
		...
		<div class="col col-12 col-md-6">
			<ul class="list-group list-group-flush">
				...
				<li class="list-group-item list-group-item-action"><a href="megane_e-tech_techno/rangeandconsumption/" class="text-decoration-none text-black" ><i class="bi-file-earmark-bar-graph"></i> Rækkevidde</a></li>
