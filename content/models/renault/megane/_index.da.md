...
linktitle: "Megane"
description: "Se nedenfor for detaljer om de forskellige varianter af Renault Megane"
weight: 30
---
...
<i class="bi bi-record2-fill"></i> FWD <i class="bi bi-battery-full"></i> 65 kWh <i class="bi bi-ev-station"></i> 130 kW 
		...
		<div class="col col-12 col-md-6">
			<ul class="list-group list-group-flush">
				...
				<li class="list-group-item list-group-item-action"><a href="megane_e-tech_techno/chargingcurve/" class="text-decoration-none text-black" ><i class="bi-battery-charging"></i> Opladningskurve</a></li>
