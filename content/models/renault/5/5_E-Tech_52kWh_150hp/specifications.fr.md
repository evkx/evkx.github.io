---
title: Renault 5 E-Tech 52kWh 150hp spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Renault 5 E-Tech 52kWh 150hp."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Renault 5 E-Tech 52kWh 150hp. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Renault 5 E-Tech 52kWh 150hp, visitez les [chargeinfo](../chargingcurve/) pour Renault 5 E-Tech 52kWh 150hp avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
...
<table class="table table-striped border">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				Oui (Traffic sign assist), équipement standard
			</td>
		</tr>
		<tr>
			<td>
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Sur le coin arrière gauche du pare-chocs (Optionnel)</br>
				Sur le coin arrière droit du pare-chocs (Optionnel)</br>
				Sur le pare-chocs arrière (Optionnel)</br>
				Sur le pare-chocs arrière (Optionnel)</br>
			</td>
		</tr>
		<tr>
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Starry Black (Noir)</br>
				Midnight Blue (Bleu)</br>
			</td>
		</tr>
	</tbody>
</table>
