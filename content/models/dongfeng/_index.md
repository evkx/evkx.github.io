...
Dongfeng Nammi Box is a budget hatchback available in 1 variants.
    ...
    <div id="module-company" class="accordion-collapse collapse">
        <div class="accordion-body">
{{% insert "content/models/dongfeng/company.md" %}}
</div>
</div>
</div>
</div>
