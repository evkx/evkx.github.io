...
description: "Dongfeng Nammi Box 42.3kWh es un hatchback eléctrico económico con una autonomía WLTP de hasta 310 km (193 millas). EVKX.net tiene todos los detalles."
weight: 10
hidden: true
shownavtabs: true
...
La batería de alta capacidad tiene una capacidad bruta de 42,3 kWh y una capacidad neta utilizable de 40,0 kWh, proporcionando un buffer de 2,3 kWh (5,4%) para la protección de la batería. La batería de iones de litio utiliza tecnología [LFP](../../../../technology/battery/cellchemistry/#lithium-iron-phosphate-battery-lfp), ofreciendo tanto beneficios como desventajas en comparación con las baterías típicas NCA/NMC.

Según el estándar [WLTP](../../../../guides/understandingrange/wltp/) (Procedimiento de Prueba de Vehículos Ligeros Armonizado a Nivel Mundial), la autonomía del vehículo es de 310 km (193 millas), con una tasa de consumo de energía de 12,9 kWh/100 km (3 mi/kWh). Para más detalles sobre la autonomía, consulte los datos del mundo real y las listas de autonomía en la página de [autonomía y consumo](rangeandconsumption/) de este modelo.

El vehículo admite carga rápida DC con una potencia máxima de 70 kW. Cargar del 0% al 100% toma aproximadamente 79 minutos, mientras que un escenario más típico del 10% al 80% toma 38 minutos con una velocidad de carga promedio de 44 kW. Considerando 5 minutos adicionales para cada parada de carga debido a interrupciones de conducción, el rango de carga óptimo es del 7% al 56%. Esto resulta en una velocidad de carga efectiva, incluyendo el tiempo perdido, de 43 kW, con cada sesión de carga tomando aproximadamente 27 minutos y 27 segundos.

En un desafío de 1000 km a una velocidad constante de 120 km/h (75 mph) con una tasa de consumo asumida de 23 kWh/100 km, el viaje tomaría aproximadamente 12 horas y 48 minutos, requiriendo nueve paradas de carga del 5% al 58%, totalizando 268 minutos de tiempo de carga.

### Cargador a Bordo

El cargador a bordo estándar admite hasta 6,6 kW para carga AC de Nivel 1 y Nivel 2, permitiendo una carga completa del 0 al 100% en aproximadamente 6 horas y 3 minutos usando una configuración doméstica.
...
El Dongfeng Nammi Box 42.3kWh tiene un sistema de tracción delantera soportado por un motor en el eje delantero. El motor utilizado es un [Motor Síncrono de Imán Permanente](../../../../technology/motors/pmsm/).
...
El Dongfeng Nammi Box 42.3kWh está equipado con [frenos de disco de hierro fundido](../../../../technology/brakes/#disc-brakes) tanto en la parte delantera como en la trasera. Los discos delanteros miden 300 mm, mientras que los discos traseros son de 300 mm.
...
El Dongfeng Nammi Box 42.3kWh, con dimensiones de 4020 mm de longitud, 1810 mm de ancho y 1570 mm de altura, pertenece al segmento de coches B, a menudo conocido como supermini, es un coche pequeño típicamente adecuado para la conducción urbana, ofreciendo un buen equilibrio entre eficiencia, tamaño y costo. El Dongfeng Nammi Box 42.3kWh está disponible en un total de 4 colores de pintura sólidos.

Puede seleccionar entre varios diseños de ruedas, todos disponibles en el mismo tamaño, en el Dongfeng Nammi Box 42.3kWh, lo que le permite personalizar su vehículo para que coincida con su estilo y preferencias de conducción. Las combinaciones de neumáticos y ruedas disponibles incluyen:
...
El Dongfeng Nammi Box 42.3kWh acomoda cinco pasajeros con dos asientos delanteros y un banco de tres asientos en la parte trasera.
...
La interfaz de control del Dongfeng Nammi Box 42.3kWh se centra principalmente en la interacción con la pantalla, con funcionalidad limitada disponible a través de botones físicos y palancas. Este diseño puede resultar en una experiencia de usuario y usabilidad menos que ideal para algunos usuarios.
...
El Dongfeng Nammi Box 42.3kWh cuenta con un sistema de información y entretenimiento personalizado diseñado para proporcionar una interfaz con una variedad de características y funciones para mejorar la experiencia de conducción.

### Sistema de Sonido

El Dongfeng Nammi Box 42.3kWh viene equipado con una opción de sistema de sonido:
...
El Dongfeng Nammi Box 42.3kWh cuenta con una gama de sistemas [avanzados de asistencia al conductor](../../../../technology/driverassistance/) (ADAS) estándar y opcionales diseñados para mejorar la seguridad y la comodidad.
...
[**Control Electrónico de Estabilidad (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Estándar en el Dongfeng Nammi Box 42.3kWh, este sistema mejora la estabilidad y el manejo del vehículo durante maniobras repentinas o en condiciones de carretera resbaladiza.

[**Asistencia de Mantenimiento de Carril (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Estándar en el Dongfeng Nammi Box 42.3kWh, este sistema ayuda a evitar que el vehículo se desvíe de su carril. También incluye un sistema de [**Advertencia de Salida de Carril**](../../../../technology/driverassistance/lanedeparturewarning/) para alertar al conductor si el vehículo se desvía del carril.

[**Advertencia de Colisión Frontal (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Estándar en el Dongfeng Nammi Box 42.3kWh, este sistema de asistencia al conductor ayuda a los conductores a evitar o mitigar colisiones frontales.

[**Frenado automático de emergencia (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Estándar en el Dongfeng Nammi Box 42.3kWh, este sistema aplica los frenos de manera autónoma para prevenir o reducir la gravedad de una colisión si el conductor no reacciona a tiempo.

### Automatización de la Conducción

El Dongfeng Nammi Box 42.3kWh ofrece [automatización de la conducción en nivel 1](../../../../technology/driverassistance/#level-of-autonomous-driving), dependiendo del nivel de equipamiento.
...
Hasta uno [sensores de radar](../../../../technology/sensorsandcameras/radar/), cinco [cámaras](../../../../technology/sensorsandcameras/cameras/) y tres [sensores ultrasónicos](../../../../technology/sensorsandcameras/ultrasonic/) monitorean los alrededores del vehículo.
...
El Dongfeng Nammi Box 42.3kWh está equipado con características de seguridad avanzadas para protegerlo a usted y a su vehículo. Estas incluyen:
...
El peso máximo del vehículo es de 1730 kg (3814 libras), con un peso base de 1355 kg (2987 libras). Esto permite una carga máxima de 375 kg (827 libras), incluyendo el conductor y los pasajeros. Tenga en cuenta que algunas opciones pueden aumentar el peso base y reducir la capacidad máxima de carga.
...
El Dongfeng Nammi Box 42.3kWh tuvo su estreno mundial el 07.01.2024, con entregas comenzando en November 2024.
...
En el mercado de vehículos eléctricos en rápida expansión, EVKX.net ha identificado varias alternativas al Dongfeng Nammi Box 42.3kWh que vale la pena considerar en función de las características, especificaciones y precios. Aunque estos modelos pueden no ser coincidencias exactas, compararlos podría ayudarlo a tomar una decisión de compra más informada:
...
<a href="https://db.evkx.net/evcompare?evs=0d91e7%2c36e7a8%2c90b31f%2cc21f41" target="_blank">Explore una comparación detallada de estos modelos.</a>
