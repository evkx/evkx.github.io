...
Mercedes EQE SUV est un SUV de luxe disponible en 5 variantes.
    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Mercedes EQS est une berline de luxe disponible en 6 variantes.
</p>
...
Mercedes EQS SUV est un SUV de luxe disponible en 6 variantes.
    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Mercedes G est un SUV de luxe disponible en 1 variantes.
</p>
	<a href="g/" class="btn btn-outline-primary" role="button">Aller aux informations sur le modèle</a>
		</div>
	</div>
</div>
        </div>
