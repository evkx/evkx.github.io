...
linktitle: "EQB 250"
description: "Mercedes-EQ EQB 250 är en helelektrisk premium-SUV med en räckvidd på WLTP på upp till 474 km. EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Mercedes-EQ EQB 250 har en maximal effekt på 140 KW (190hk). Totalt vridmoment är 385 Nm. Den gör sprinten 0-100 km/h på 8,9 sekunder. Topphastigheten är 160 km/h.
...
Mercedes-EQ EQB 250 har ett framhjulsdriftssystem som stöds av en motor på framaxeln. Motorerna som används är [induktionsmotorer](../../../../technology/motors/asm/).
...
Det finns två sätestyper du kan välja mellan för den främre raden av Mercedes-EQ EQB 250.
...
Mercedes-EQ EQB 250 har flera funktioner för att göra ditt liv som förare eller passagerare bekvämare.
...
Mercedes-EQ EQB 250 har ett [**ABS-bromssystem**](../../../../technology/driverassistance/antilockbrakingsystem/) som standard-systemet. Detta system hjälper till att förhindra att ett fordons hjul låser sig under inbromsning.

Mercedes-EQ EQB 250 har ett [**elektronisk stabilitetskontroll**](../../../../technology/driverassistance/electronicstabilitycontrol/) vilket standard-system är utformat för att förbättra ett fordons stabilitet och hantering under plötsliga manövrar eller halt väglag.

Mercedes-EQ EQB 250 har en [**filhållningsassistent**](../../../../technology/driverassistance/lanekeepingassist/) som standard-system. Detta system bidrar för att förhindra att bilen lämnar körfältet. Dessutom har den ett [**filavvikelsevarning**](../../../../technology/driverassistance/lanedeparturewarning/) system som varnar föraren om fordonet lämnar körfältet.
...
Mercedes-EQ EQB 250 har [**automatisk nödbroms**](../../../../technology/driverassistance/automaticemergencybraking/) som standard-system. Detta system hjälper till att förhindra eller mildra kollisioner genom att ansätta bromsarna autonomt om föraren inte reagerar på en förestående kollision.
...
Mercedes-EQ EQB 250 erbjuder [nivå 1 körautomation](../../../../technology/driverassistance/#level-of-autonomous-driving), beroende på utrustningsnivå.
...
Lastkapaciteten i bagageutrymmet är 495 liter. Med baksätet nedfällt är det 1410 liter. På taket kan du lasta upp till 75 kg. Bilens maximala vikt är 2520 kg, och med basvikten på 2035 kg kan du lasta maximalt 485 kg, inklusive förare och passagerare. Vissa utrustningsalternativ kan öka basvikten och minska den maximala lastvikten. 485 kg anses som lavt for denne typen biler og kan begrense hvor mye ting du kan ta med i tillegg til passasjerer.
