---
title: Mercedes-EQ EQB 350 4MATIC Spezifikationen
linktitle: "Spezifikationen"
description: "EVKX.net bietet Ihnen die vollständigen Spezifikationen für Mercedes-EQ EQB 350 4MATIC."
weight: 4
hidden: true
...
EVKX.net strebt an, die vollständigsten Spezifikationen für Mercedes-EQ EQB 350 4MATIC zu haben. Klicken Sie auf das Bild oben für den [vollständigen Artikel](../), besuchen Sie die [Bildergalerie](../gallery/) für hochauflösende Bilder von Mercedes-EQ EQB 350 4MATIC, besuchen Sie die [Ladeinformationen](../chargingcurve/) für Mercedes-EQ EQB 350 4MATIC mit Ladekurve, besuchen Sie die [erweiterten Reichweiteninformationen](../rangeandconsumption/) für reale Reichweiten.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Polar white (Weiß)</br>
				Night black (Schwarz)</br>
				Pategonia red metallic (Rot)</br>
				Mountain grey MAGNO (Grau)</br>
				Cosmos black metallic (Schwarz)</br>
				Denim blue (Blau)</br>
				Iridium silver metallic (Silber)</br>
				Mountain grey metallic (Grau)</br>
				Rosé gold metallic</br>
				Digital white metallic (Weiß)</br>
			</td>
		</tr>
	</tbody>
</table>
