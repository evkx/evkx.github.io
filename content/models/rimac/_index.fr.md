    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            <div class="col col-12 col-md-6">
                <a href="nevera">
                    <img src="https://media.evkx.net/multimedia/models/rimac/nevera/nevera/main_1_st.jpg" class="img-fluid" alt="Rimac Nevera" >
                </a>
            </div>
            <div class="col col-12 col-md-6"><p>
Rimac Nevera est une hypercar de luxe disponible en 1 variantes.
</p>
	<a href="nevera/" class="btn btn-outline-primary" role="button">Aller aux informations sur le modèle</a>
		</div>
	</div>
</div>
        </div>
