...
description: "Rivian R1S Dual-Motor AWD SP er en fuldelektrisk premium-SUV med en rækkevidde på EPA på op til 434 km (270 miles). EVKX.net har alle detaljerne."
weight: 10
hidden: true
shownavtabs: true
...
Vi har opdelt vores Rivian R1S Dual-Motor AWD SP artikel i sektioner. Hvis du vil vente med at læse hele artiklen, skal du klikke på nedenstående links til de forskellige områder. Vi har også en oversigt over de [fulde specifikationer](specifications/), et [billedgalleri](gallery/), detaljerede oplysninger om [opladningsydelse](chargingcurve/), og nogle [online anmeldelser](reviews/). Vores sektioner:
...
Rivian R1S Dual-Motor AWD SP leverer en solid præstation med en maksimal effekt på 398 kW (541 hk) og et totalt drejningsmoment på 827 Nm. Den kan accelerere fra 0 til 100 km/t på 4,5 sekunder og når en topfart på 201 km/t, hvilket gør den konkurrencedygtig i sin klasse.

## Batteri, rækkevidde og opladning

Det højkapacitetsbatteri har en bruttokapacitet på 92,5 kWh og en nettoanvendelig kapacitet på 90,6 kWh, hvilket giver en buffer på 1,9 kWh (3%) til batteribeskyttelse. Lithium-Ion-batteriet bruger [LFP-teknologi.](../../../../technology/battery/cellchemistry/#lithium-iron-phosphate-battery-lfp) Dette har nogle fordele og ulemper fra de typiske NCA/NCM-batterier.

Ifølge [EPA](../../../../guides/understandingrange/epa/) (Environmental Protection Agency) standarden har køretøjet en imponerende rækkevidde på 434 km med en energiforbrugsrate på 20,9 kWh/100km. For mere detaljerede virkelige data og rækkeviddeoplysninger, henvises til modellens dedikerede [rækkevidde- og forbrugsside.](rangeandconsumption/)

Den maksimale DC-opladningshastighed er kW. En fuld opladning fra 0 - 100 % ville tage 92 minutter, mens et mere almindeligt scenarie på 10-80 % ville tage 30 minutter. Hvis du antager, at du mister 5 minutters kørsel pr. ladestop ud over opladningstiden, er det optimale opladningsområde fra 0% til 51%, hvilket resulterer i en faktisk opladningshastighed, inklusive tidstab på 136kW. Hver opladningssession ville tage 20 minutter og 25 sekunder.

I en teoretisk 1000 km udfordring, der starter med et fuldt batteri og opretholder en konstant hastighed på 120 km/t under ideelle forhold med et antaget forbrug på 27 kWh/100 km, ville turen tage cirka 9 timer og 40 minutter. Denne rejse ville kræve to opladningsstop fra 0% til 50%, med en samlet opladningstid på 80 minutter

### Ombordlader

Den standard ombordlader understøtter op til 11,5 kW til Level 1 og Level 2 AC-opladning. Dette gør det muligt at fuldt oplade batteriet fra 0 til 100% på cirka 7 timer og 52 minutter ved brug af en hjemmeoplader.
...
Rivian R1S Dual-Motor AWD SP har et firehjulstræk, der understøttes af to motorer, en på hver aksel.
...
Den Rivian R1S Dual-Motor AWD SP, med dimensioner på 5100 mm i længde,  mm i bredde og 1966 mm i højde, tilhører fuldstørrelses SUV'er, der tilbyder mest plads, kraft og kapacitet blandt SUV-kategorier, hvilket gør dem velegnede til en specifik gruppe førere med unikke behov. Rivian R1S Dual-Motor AWD SP fås i alt 9 lakfarver, herunder flere iøjnefaldende metalliske muligheder.

Du kan vælge mellem flere hjul i forskellige størrelser på Rivian R1S Dual-Motor AWD SP, så du kan tilpasse din bil efter din stil og dine kørselspræferencer.
...
Rivian R1S Dual-Motor AWD SP tilbyder kun én type forreste sæde.
...
Rivian R1S Dual-Motor AWD SP inkluderer flere funktioner, der forbedrer komfort og bekvemmelighed:
...
Rivian R1S Dual-Motor AWD SP har flere integrerede skærme. Bag rattet er en [digital instrumentklynge](../../../../technology/userinterface/screens/#digital-instruments), og i midterkonsollen , der er én [infotainment-skærm](../../../../technology/userinterface/screens/#infotainment-skærm) øverst på midterkonsollen.
...
Rivian R1S Dual-Motor AWD SP er udstyret med en enkelt type rat:
...
Én type lydsystem er tilgængelig for Rivian R1S Dual-Motor AWD SP.
...
Den Rivian R1S Dual-Motor AWD SP inkluderer flere standard- og valgfri [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) for at forbedre sikkerhed og komfort.

### Sikkerhedssystemer

[**Anti-lock Bremsesystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Rivian R1S Dual-Motor AWD SP, dette system forhindrer hjulene i at låse under opbremsning.

[**Electronic Stability Control (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Rivian R1S Dual-Motor AWD SP, dette system forbedrer bilens stabilitet og håndtering under pludselige manøvrer eller på glatte vejforhold.
...
[**Front Cross Traffic Assist (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/): Standard på Rivian R1S Dual-Motor AWD SP, dette førerassistentsystem hjælper føreren med at opdage modkørende trafik ved krydsning af et kryds eller ved sving til venstre eller højre fra en stopposition.

[**Forward Collision Warning (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Rivian R1S Dual-Motor AWD SP, dette førerassistentsystem hjælper føreren med at undgå eller formilde frontale kollisioner.

[**Automatisk nødbremsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Rivian R1S Dual-Motor AWD SP, dette system anvender bremserne autonomt for at forhindre eller reducere alvoren af en kollision, hvis føreren ikke reagerer i tide.

[**Blind-spot Monitoring (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard på Rivian R1S Dual-Motor AWD SP, dette sideassistentsystem hjælper med at registrere trafik i døde vinkler.
...
Rivian R1S Dual-Motor AWD SP er udstyret med avancerede sikkerhedsfunktioner for at beskytte dig og dit køretøj. Disse inkluderer:
...
Denne model havde verdenspremiere den 06.06.2024, og leveringerne startede i August 2024.
