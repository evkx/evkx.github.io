...
description: "Rivian R1T Quad-Motor AWD er en helelektrisk premium pickup med en EPA rekkevidde på opptil 516 km. EVKX.net har alle detaljene."
weight: 10
hidden: true
shownavtabs: true
...
Vi har delt vår beskrivelse av Rivian R1T Quad-Motor AWD i seksjoner. Hvis du vil vente med å lese hele artikkelen, klikker du på lenkene nedenfor til de forskjellige seksjonene. Vi har også en oversikt over [fullstendige spesifikasjoner](specifications/), [detaljer om rekkevidde](rangeandconsumption/),  et [bildegalleri](gallery/), detaljert informasjon om [ladeytelse](chargingcurve/), og noen [online anmeldelser](reviews/). Våre seksjoner:
...
Høykapasitetsbatteriet har en brutto kapasitet på 135,0 kWh og en netto brukbar kapasitet på 125,0 kWh, som gir en buffer på 10,0 kWh (7,4%) for batteribeskyttelse.
...
Maksimal DC-ladehastighet er  kW. En full lading fra 0 - 100 % vil ta 106 minutter, mens et mer vanlig scenario på 10-80 % vil ta 43 minutter. Hvis du antar at du mister 5 minutters kjøring per ladestopp i tillegg til ladetiden, er det optimale ladeområdet fra 0% til 45%, noe som resulterer i en faktisk ladehastighet, inkludert tidstap, på 135kW. Hver ladeøkt vil ta 25 minutter og 55 sekunder.

I en teoretisk 1000 km utfordring, med fulladet batteri og en konstant hastighet på 120 km/t under ideelle forhold med et antatt forbruk på 30 kWh/100 km, ville turen ta omtrent 9 timer og 38 minutter. Denne reisen ville kreve to ladestopp fra 0% til 47%, med en total ladetid på 78 minutter.

### Ombordlader

Den standard ombordladeren støtter opptil 11,5 kW for Level 1 og Level 2 AC-lading. Dette gjør at du kan lade batteriet fullt fra 0 til 100% på omtrent 10 timer og 52 minutter med en hjemmelader.
...
Rivian R1T Quad-Motor AWD, med dimensjoner på 5514 mm i lengde,  mm i bredde og 1986 mm i høyde, skiller seg ut i Full-size Pick-Up truck kategorien og tilbyr eksepsjonell plass, kraft og kapasitet. Rivian R1T Quad-Motor AWD er tilgjengelig i totalt 9 lakkfarger, inkludert flere iøynefallende metalliske alternativer.

Du kan velge mellom flere hjulalternativer i forskjellige størrelser på Rivian R1T Quad-Motor AWD, slik at du kan tilpasse bilen din etter din stil og dine kjørepreferanser.
...
Rivian R1T Quad-Motor AWD har plass til fem passasjerer med to seter foran og en tre-seters benk bak.

#### Forseter

Rivian R1T Quad-Motor AWD Long Range tilbyr kun én type forsete.
...
Rivian R1T Quad-Motor AWD inkluderer flere funksjoner for å forbedre komfort og bekvemmelighet:
...
Rivian R1T Quad-Motor AWD er utstyrt med en enkelt type ratt:
...
Én type lydsystem er tilgjengelig for Rivian R1T Quad-Motor AWD.
...
Rivian R1T Quad-Motor AWD inkluderer flere [avanserte førerassistanse systemer](../../../../technology/driverassistance/) (ADAS) som standard og som tilvalg for å forbedre sikkerhet og komfort.

### Sikkerhetssystemer

[**Blokkeringsfrie bremser (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Rivian R1T Quad-Motor AWD, dette systemet forhindrer hjulene i å låse seg under bremsing.

[**Elektronisk Stabilitetskontroll (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Rivian R1T Quad-Motor AWD, dette systemet forbedrer kjøretøyets stabilitet og håndtering under plutselige manøvrer eller på glatte veier.

[**Kjørefeltassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på Rivian R1T Quad-Motor AWD, dette systemet hjelper til med å forhindre at kjøretøyet driver ut av kjørefeltet. Det inkluderer også et system for [**Advarsel om Utkjøring av Kjørebanen**](../../../../technology/driverassistance/lanedeparturewarning/) for å advare sjåføren hvis kjøretøyet kommer ut av kjørefeltet.

[**Frontkrysstrafikkassist (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/): Standard på Rivian R1T Quad-Motor AWD, dette førerassistentsystemet hjelper føreren med å oppdage møtende trafikk når man krysser et kryss eller svinger til venstre eller høyre fra en stoppet posisjon.

[**Frontkollisjonsvarsling (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Rivian R1T Quad-Motor AWD, dette assistansesystemet hjelper sjåfører med å unngå eller redusere alvorlighetsgraden av frontkollisjoner.

[**Automatisk nødbremsing (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Rivian R1T Quad-Motor AWD, dette systemet bruker bremsene autonomt for å forhindre eller redusere alvorlighetsgraden av en kollisjon hvis føreren ikke reagerer i tide.

[**Blindsoneovervåkning (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard på Rivian R1T Quad-Motor AWD, dette sideassistansesystemet hjelper til med å oppdage trafikk i blindsoner.
...
Rivian R1T Quad-Motor AWD er utstyrt med avanserte sikkerhetsfunksjoner for å beskytte deg og kjøretøyet ditt. Disse inkluderer:
...
Rivian R1T Quad-Motor AWD hadde sin verdenspremiere den 26.11.2018, med leveranser som startet i September 2021.
