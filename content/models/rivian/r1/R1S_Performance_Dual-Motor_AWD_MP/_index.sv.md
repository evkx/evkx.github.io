...
description: "Rivian R1S Performance Dual-Motor AWD MP är en helelektrisk SUV med en räckvidd på EPA på upp till 660 km. EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Rivian R1S Performance Dual-Motor AWD MP har en maximal effekt på 489 KW (665hk). Totalt vridmoment är 1123 Nm. Den gör sprinten 0-100 km/h på 3,6 sekunder. Topphastigheten är 201 km/h.
...
[EPA-räckvidd](../../../../guides/understandingrange/epa/) är 410 miles (660 km). Förbrukningen är 2.9mi/kWh för EPA-standardtestet. För mer information om sortimentet, se verkliga data och räckvidd på denna modells sida [rangeandconsumption](rangeandconsumption/).
...
För nivå 1 och nivå 2 AC-laddning stöder  inbyggd laddare upp till 11,5KW-laddning. Som ett resultat kan du ladda batteriet 0-100 % hemifrån på ca. 12 timmar och 22 minuter.
...
Det finns bara ett tak för denna modell. exterior.roof.optional.panoramic.TwoSeperatePartPartialFixed.TonedGlass
...
Endast en typ av framsäte är tillgänglig i Rivian R1S Performance Dual-Motor AWD MP.
...
Rivian R1S Performance Dual-Motor AWD MP har flera funktioner för att göra ditt liv som förare eller passagerare bekvämare.
...
Rivian R1S Performance Dual-Motor AWD MP har ett [**ABS-bromssystem**](../../../../technology/driverassistance/antilockbrakingsystem/) som standard-systemet. Detta system hjälper till att förhindra att ett fordons hjul låser sig under inbromsning.

Rivian R1S Performance Dual-Motor AWD MP har ett [**elektronisk stabilitetskontroll**](../../../../technology/driverassistance/electronicstabilitycontrol/) vilket standard-system är utformat för att förbättra ett fordons stabilitet och hantering under plötsliga manövrar eller halt väglag.

Rivian R1S Performance Dual-Motor AWD MP har en [**filhållningsassistent**](../../../../technology/driverassistance/lanekeepingassist/) som standard-system. Detta system bidrar för att förhindra att bilen lämnar körfältet. Dessutom har den ett [**filavvikelsevarning**](../../../../technology/driverassistance/lanedeparturewarning/) system som varnar föraren om fordonet lämnar körfältet.
...
Rivian R1S Performance Dual-Motor AWD MP har [**automatisk nödbroms**](../../../../technology/driverassistance/automaticemergencybraking/) som standard-system. Detta system hjälper till att förhindra eller mildra kollisioner genom att ansätta bromsarna autonomt om föraren inte reagerar på en förestående kollision.
