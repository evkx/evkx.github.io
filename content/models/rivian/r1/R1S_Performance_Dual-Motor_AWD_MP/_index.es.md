...
El [rango EPA](../../../../guides/understandingrange/epa/) es 410 millas (660 km). El consumo es 2.9mi/kWh para la prueba estándar de la EPA. Para obtener más detalles sobre el alcance, consulte los datos del mundo real y el listado de alcance en la página [rango y consumo](rangoyconsumo/) de este modelo.
