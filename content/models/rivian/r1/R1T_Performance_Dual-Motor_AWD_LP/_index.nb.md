...
description: "Rivian R1T Performance Dual-Motor AWD LP er en helelektrisk premium pickup med en EPA rekkevidde på opptil 566 km. EVKX.net har alle detaljene."
weight: 10
hidden: true
shownavtabs: true
...
Vi har delt vår beskrivelse av Rivian R1T Performance Dual-Motor AWD LP i seksjoner. Hvis du vil vente med å lese hele artikkelen, klikker du på lenkene nedenfor til de forskjellige seksjonene. Vi har også en oversikt over [fullstendige spesifikasjoner](specifications/), [detaljer om rekkevidde](rangeandconsumption/),  et [bildegalleri](gallery/), detaljert informasjon om [ladeytelse](chargingcurve/), og noen [online anmeldelser](reviews/). Våre seksjoner:
...
Rivian R1T Performance Dual-Motor AWD LP imponerer med en imponerende kraft på 495 kW (673 hk) og et betydelig dreiemoment på 1124 Nm. Denne høytytende maskinen kan sprinte fra 0 til 100 km/t på bare 3,5 sekunder og har en toppfart på 201 km/t, noe som gjør den til en markant modell i sin klasse.

## Batteri, rekkevidde og lading

Høykapasitetsbatteriet har en brutto kapasitet på 136,0 kWh og en netto brukbar kapasitet på 135,0 kWh, som gir en buffer på 1,0 kWh (0,7%) for batteribeskyttelse.
...
Maksimal DC-ladehastighet er  kW. En full lading fra 0 - 100 % vil ta 115 minutter, mens et mer vanlig scenario på 10-80 % vil ta 46 minutter. Hvis du antar at du mister 5 minutters kjøring per ladestopp i tillegg til ladetiden, er det optimale ladeområdet fra 0% til 45%, noe som resulterer i en faktisk ladehastighet, inkludert tidstap, på 137kW. Hver ladeøkt vil ta 27 minutter og 31 sekunder.

I en teoretisk 1000 km utfordring, med fulladet batteri og en konstant hastighet på 120 km/t under ideelle forhold med et antatt forbruk på 30 kWh/100 km, ville turen ta omtrent 9 timer og 32 minutter. Denne reisen ville kreve to ladestopp fra 0% til 41%, med en total ladetid på 73 minutter.

### Ombordlader

Den standard ombordladeren støtter opptil 11,5 kW for Level 1 og Level 2 AC-lading. Dette gjør at du kan lade batteriet fullt fra 0 til 100% på omtrent 11 timer og 44 minutter med en hjemmelader.
...
Rivian R1T Performance Dual-Motor AWD LP har et firehjulsdriftssystem som støttes av to motorer, en på hver aksel.
...
Rivian R1T Performance Dual-Motor AWD LP har plass til fem passasjerer med to seter foran og en tre-seters benk bak.

#### Forseter

Rivian R1T Performance Dual-Motor AWD LP Long Range tilbyr kun én type forsete.
...
Rivian R1T Performance Dual-Motor AWD LP inkluderer flere funksjoner for å forbedre komfort og bekvemmelighet:
...
Rivian R1T Performance Dual-Motor AWD LP har flere integrerte skjermer. Bak rattet er en [digital instrumentklynge](../../../../technology/userinterface/screens/#digital-instruments), og i midtkonsollen , det er én [infotainment-skjerm](../../../../technology/userinterface/screens/#infotainment-skjerm) øverst på midtkonsollen.
...
Rivian R1T Performance Dual-Motor AWD LP er utstyrt med en enkelt type ratt:
...
Én type lydsystem er tilgjengelig for Rivian R1T Performance Dual-Motor AWD LP.
...
Rivian R1T Performance Dual-Motor AWD LP inkluderer flere [avanserte førerassistanse systemer](../../../../technology/driverassistance/) (ADAS) som standard og som tilvalg for å forbedre sikkerhet og komfort.

### Sikkerhetssystemer

[**Blokkeringsfrie bremser (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Rivian R1T Performance Dual-Motor AWD LP, dette systemet forhindrer hjulene i å låse seg under bremsing.
...
[**Kjørefeltassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på Rivian R1T Performance Dual-Motor AWD LP, dette systemet hjelper til med å forhindre at kjøretøyet driver ut av kjørefeltet. Det inkluderer også et system for [**Advarsel om Utkjøring av Kjørebanen**](../../../../technology/driverassistance/lanedeparturewarning/) for å advare sjåføren hvis kjøretøyet kommer ut av kjørefeltet.

[**Frontkrysstrafikkassist (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/): Standard på Rivian R1T Performance Dual-Motor AWD LP, dette førerassistentsystemet hjelper føreren med å oppdage møtende trafikk når man krysser et kryss eller svinger til venstre eller høyre fra en stoppet posisjon.

[**Frontkollisjonsvarsling (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Rivian R1T Performance Dual-Motor AWD LP, dette assistansesystemet hjelper sjåfører med å unngå eller redusere alvorlighetsgraden av frontkollisjoner.

[**Automatisk nødbremsing (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Rivian R1T Performance Dual-Motor AWD LP, dette systemet bruker bremsene autonomt for å forhindre eller redusere alvorlighetsgraden av en kollisjon hvis føreren ikke reagerer i tide.

[**Blindsoneovervåkning (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard på Rivian R1T Performance Dual-Motor AWD LP, dette sideassistansesystemet hjelper til med å oppdage trafikk i blindsoner.
...
Rivian R1T Performance Dual-Motor AWD LP hadde sin verdenspremiere den 26.11.2018, med leveranser som startet i September 2021.
