...
El Rivian R1T Performance Dual-Motor AWD LP tiene una potencia máxima de 495 KW (673 hp/664 bhp). El par total es 1124 nm (830 ft-lb). Realiza el sprint de 0 a 100 km/h (0 a 62 mph) en 3,5 segundos. La velocidad máxima es 201 km/h.
...
El [rango EPA](../../../../guides/understandingrange/epa/) es 352 millas (566 km). El consumo es 2.7mi/kWh para la prueba estándar de la EPA. Para obtener más detalles sobre el alcance, consulte los datos del mundo real y el listado de alcance en la página [rango y consumo](rangoyconsumo/) de este modelo.
