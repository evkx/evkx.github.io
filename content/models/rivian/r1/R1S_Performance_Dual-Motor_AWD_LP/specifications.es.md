---
title: Rivian R1S Performance Dual-Motor AWD LP especificaciones
linktitle: "Especificaciones"
description: "EVKX.net le brinda las especificaciones completas para Rivian R1S Performance Dual-Motor AWD LP."
weight: 4
hidden: true
...
EVKX.net busca tener las especificaciones más completas para Rivian R1S Performance Dual-Motor AWD LP. Haga clic en la imagen de arriba para ver [artículo completo](../), visite la [galería de imágenes](../gallery/) para imágenes de alta resolución de Rivian R1S Performance Dual-Motor AWD LP, visite [chargeinfo](../chargecurve/) para Rivian R1S Performance Dual-Motor AWD LP con chargecurve, visite [información de rango extendido](../rangeandconsumption/) para rangos del mundo real.
