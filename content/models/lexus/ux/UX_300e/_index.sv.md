...
title: Lexus UX 300e
linktitle: "UX 300e"
description: "Lexus UX 300e är en helelektrisk crossover med en WLTP räckvidd på upp till 450 km. EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Lexus UX 300e erbjuder blygsamma prestanda med en maximal effekt på 150 kW (204 hk) och ett totalt vridmoment på 300 Nm. Den accelererar från 0 till 100 km/h på 7,5 sekunder och har en topphastighet på 160 km/h, vilket är mer i linje med traditionella förbränningsmotorfordon.
...
Enligt [WLTP (Worldwide Harmonized Light Vehicles Test Procedure)](../../../../guides/understandingrange/wltp/) standarden varierar fordonets räckvidd mellan 450 och 440 km, beroende på specifika konfigurationer och alternativ, såsom hjulstorlek. Större hjul kan till exempel öka energiförbrukningen och därmed minska den totala räckvidden. Fordonets energiförbrukning är bedömd till 14,2 kWh/100 km för basmodellen och 14,5 kWh/100 km för toppmodellen enligt WLTP-testcykeln. För mer detaljerad verklig data och information om räckvidd, se modellens dedikerade [räckvidds- och förbrukningssida.](rangeandconsumption/)

Maximal DC-laddningshastighet är 50 kW. En full laddning från 0 - 100 % tar 208 minuter, medan ett vanligare scenario på 10-80 % tar 92 minuter. Om du antar att du förlorar 5 minuters körning per laddningsstopp utöver laddningstiden, är den optimala laddningsytan från 3% till 35%, vilket resulterar i en faktisk laddning hastighet inklusive tidsförlust , på 33kW. Varje laddningssession tar 37 minuter och 54 sekunder.

I en teoretisk 1000 km-utmaning, med en fulladdad batteri och en konstant hastighet på 120 km/h (75 mph) under ideala förhållanden med en antagen förbrukning på 25 kWh/100 km, skulle resan ta ungefär 14 timmar och 0 minuter. Denna resa skulle kräva två laddningsstopp från 14% till 45%, med en total laddningstid på 341 minuter.
...
Bromsar bak och fram är [gjutjärnsskivor](../../../../technology/brakes/#disc-brakes). De främre skivorna är 305mm och de bakre skivorna är 317mm.
...
Lexus UX 300e inkluderar flera funktioner för att förbättra komfort och bekvämlighet:
...
Lexus UX 300e är utrustad med en enda typ av ratt:
...
Dessutom stöder Lexus UX 300e Android Auto och Apple CarPlay. Denna funktion gör att du kan visa telefonens skärm på bilens skärm så att du kan köra appar som Google Maps eller Waze.
...
Du kan välja mellan två typer av strålkastare för Lexus UX 300e.
...
Lexus UX 300e inkluderar flera [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) som standard och som tillval för att förbättra säkerheten och komforten.

### Säkerhetssystem

[**Låsningsfria bromsar (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Lexus UX 300e, detta system förhindrar att hjulen låser sig under bromsning.

[**Elektronisk Stabilitetskontroll (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Lexus UX 300e, detta system förbättrar fordonets stabilitet och hantering vid plötsliga manövrer eller på hala vägar.
...
[**Framåt Kollisionsvarning (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Lexus UX 300e, detta förarassistanssystem hjälper till att undvika eller mildra frontalkollisioner.

[**Automatisk nödbromsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Lexus UX 300e, detta system bromsar autonomt för att förhindra eller minska allvaret av en kollision om föraren inte reagerar i tid.
...
[**Blindspotsövervakning (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Valfritt på Lexus UX 300e, detta sidostödssystem hjälper till att upptäcka trafik i döda vinklar.
...
Bagageutrymmet erbjuder en lastkapacitet på 367 liter. Med tredje raden säten nedfällda ökar detta till 1451 liter. På taket kan du lasta upp till 80 kg. Valfria takräcken finns tillgängliga för enkel montering av ett takbox eller takräcke.
