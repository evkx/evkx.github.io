---
title: Lexus UX 300e spesifikasjoner
linktitle: "Spesifikasjoner"
description: "EVKX.net gir deg alle spesifikasjonene for Lexus UX 300e."
weight: 4
hidden: true
...
EVKX.net søker å ha de mest komplette spesifikasjonene for Lexus UX 300e. Klikk på bildet ovenfor for [full artikkel](../), besøk [bildegalleriet](../gallery/) for høyoppløselige bilder av Lexus UX 300e, gå til [chargeinfo](../chargingcurve/) for Lexus UX 300e med ladekurve, se [extended range info](../rangeandconsumption/) for real world ranges.
	...
	<tbody>
		<tr>
			...
			<td>
				Red (Rød)</br>
				Black (Svart)</br>
				SONIC WHITE METALLIC (Hvit)</br>
				SONIC TITANIUM METALLIC (Grå)</br>
				GRAPHITE BLACK METALLIC (Svart)</br>
				BLAZING CARNELIAN (Oransje)</br>
				TERRANE KHAKI (Grønn)</br>
				CELESTIAL BLUE (Blå)</br>
				SONIC PLATINUM (Hvit)</br>
				SONIC GREY (Grå)</br>
			</td>
		</tr>
	</tbody>
