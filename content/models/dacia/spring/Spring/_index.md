...
title: Dacia Spring
linktitle: "Spring"
description: "Dacia Spring is an all-electric hatchback with a WLTP range of up to N/A km (0 miles). EVKX.net has all the details."
weight: 10
hidden: true
shownavtabs: true
...
We have separated our Dacia Spring article into sections. If you want to wait to read the full article, click the links below to the different areas. We also have an overview of the [full specifications](specifications/), an [image gallery](gallery/), detailed information about [charging performance](chargingcurve/), and some [online reviews](reviews/). Our sections:
...
The Dacia Spring has a maximum power of  KW ( hp/ bhp). The total torque is  nm ( ft-lb). It performs the 0-100km/h sprint (0-62mph) in  seconds.

## Battery, range, and charging

The battery has a net capacity of kWh.
...
Only one front seat type is available in the Dacia Spring.
...
Dacia Spring has several features to make your life as a driver or passenger more comfortable.
...
One type of sound system is available for the Dacia Spring. With the , you get NULL speakers with a max system output of  watts.
...
The Dacia Spring has several standard and optional [advanced driver assistance systems](../../../../technology/driverassistance/)  (ADAS) for better safety and comfort.
### Safety systems
