...
title: Dacia Spring
linktitle: "Spring"
description: "Dacia Spring är en helelektrisk halvkombi med en WLTP räckvidd på upp till N/A km. EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Vi har delat in vår beskrivning av Dacia Spring i avsnitt. Om du vill vänta med att läsa hela artikeln, klicka på länkarna nedan till de olika avsnitten. Vi har även en översikt över [fullständiga specifikationer](specifications/), [räckvidde och förbrukning](rangeandconsumption/), ett [bildgalleri](gallery/), detaljerad information om [laddningsprestanda](chargingcurve/) och några [recensioner](reviews/). Våra avsnitt:
...
Dacia Spring har en maximal effekt på  KW (hk). Totalt vridmoment är  Nm. Den gör sprinten 0-100 km/h på  sekunder.

## Batteri, räckvidd och laddning

Batteriet har en nettokapacitet på kWh.

För mer information om sortimentet, se verkliga data och räckvidd på denna modells [räckvidd og förbruk](rangeandconsumption/) sida.
...
Endast en typ av framsäte är tillgänglig i Dacia Spring.
...
Dacia Spring har flera funktioner för att göra ditt liv som förare eller passagerare bekvämare.
...
En typ av ljudsystem är tillgänglig för Dacia Spring. Med  får du NULL högtalare med en maximal systemeffekt på  watt.
...
Dacia Spring har flera standard- och valfria [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) för bättre säkerhet och komfort.
### Säkerhetssystem
