...
description: "Dacia Spring 65HP ist ein vollelektrisches Schrägheck mit einer Reichweite von bis zu 220 km (137 Meilen). EVKX.net hat alle Details."
weight: 10
hidden: true
shownavtabs: true
...
Der Dacia Spring 65HP kWh bietet eine grundlegende Leistung mit einer maximalen Leistung von 48 kW (65 PS / 64 bhp) und einem Gesamtdrehmoment von 113 Nm (83 lb-ft). Er beschleunigt in 13,7 Sekunden von 0 auf 100 km/h (0 auf 62 mph) und erreicht eine Höchstgeschwindigkeit von 125 km/h (78 mph), was ihn eher mit Einstiegsfahrzeugen mit herkömmlichen Verbrennungsmotoren vergleichbar macht.

## Batterie, Reichweite und Laden

Die Hochkapazitätsbatterie hat eine Bruttokapazität von 26,8 kWh und eine nutzbare Nettokapazität von 25,0 kWh, was einen Puffer von 1,8 kWh (6,7%) zum Schutz der Batterie bietet. Die Lithium-Ionen-Batterie verwendet [LFP-Technologie.](../../../../technology/battery/cellchemistry/#lithium-iron-phosphate-battery-lfp) Dies hat einige Vorteile und Nachteile gegenüber den typischen NCA/NCM-Batterien.

Nach dem [WLTP](../../../../guides/understandingrange/wltp/) (Worldwide Harmonized Light Vehicles Test Procedure) Standard beträgt die Reichweite des Fahrzeugs 220 km (137 Meilen) mit einem Energieverbrauch von 11,4 kWh/100 km (3 mi/kWh). Für weitere Details zur Reichweite siehe reale Daten und Reichweitenliste auf der [Reichweite und Verbrauch](rangeandconsumption/) Seite dieses Modells.

Das Fahrzeug unterstützt schnelles DC-Laden mit einer maximalen Leistung von 30 kW. Das Laden von 0% auf 100% dauert etwa 81 Minuten, während ein typischer Ladevorgang von 10% auf 80% 41 Minuten dauert, mit einer durchschnittlichen Ladegeschwindigkeit von 26 kW. Unter Berücksichtigung von zusätzlichen 5 Minuten für jeden Ladestopp aufgrund von Fahrunterbrechungen liegt der optimale Ladebereich zwischen 4% und 67%. Dies führt zu einer effektiven Ladegeschwindigkeit, einschließlich der verlorenen Zeit, von 24 kW, wobei jede Ladesitzung etwa 39 Minuten und 13 Sekunden dauert.
...
Der Dacia Spring 65HP hat ein Frontantriebssystem, das von einem Motor an der Vorderachse unterstützt wird.
...
Der Dacia Spring 65HP, mit Abmessungen von 3701 mm Länge, 1622 mm Breite und 1519 mm Höhe, fällt in die Mini-Segment-Autos, oft als Stadtautos oder A-Segment-Autos bezeichnet, sind die kleinste Klasse von Autos. Sie sind hauptsächlich für städtische Umgebungen konzipiert und bieten eine kompakte Größe, hervorragende Manövrierfähigkeit und wirtschaftlichen Betrieb. Der Dacia Spring 65HP ist in insgesamt 6 Unilackfarben erhältlich.

Der Dacia Spring 65HP bietet mehrere Radoptionen in verschiedenen Größen, sodass Sie Ihr Fahrzeug an Ihren Stil und Ihre Fahrpräferenzen anpassen können. Die verfügbaren Reifen- und Radkombinationen umfassen:

- 165/70 Reifen auf 14" Felgen
- 175/60 Reifen auf 15" Felgen
...
Der Dacia Spring 65HP umfasst mehrere Funktionen, um Komfort und Bequemlichkeit zu verbessern:
...
Der Dacia Spring 65HP ist mit einem einzigen Lenkradtyp ausgestattet:
...
Der Dacia Spring 65HP unterstützt Android Auto und Apple CarPlay, sodass Sie den Bildschirm Ihres Telefons auf dem Display des Autos spiegeln können. Diese Funktion ermöglicht es Ihnen, Apps wie Google Maps oder Waze direkt von Ihrem Telefon aus zu nutzen.
...
Der Dacia Spring 65HP verfügt über eine Reihe von standardmäßigen und optionalen [fortschrittlichen Fahrerassistenzsystemen](../../../../technology/driverassistance/) (ADAS), die die Sicherheit und den Komfort verbessern sollen.

### Sicherheitssysteme

[**Antiblockiersystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard im Dacia Spring 65HP, dieses System verhindert das Blockieren der Räder beim Bremsen.

[**Spurhalteassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard im Dacia Spring 65HP, dieses System hilft, das Fahrzeug in seiner Spur zu halten. Es umfasst auch ein [**Spurverlassenswarnsystem**](../../../../technology/driverassistance/lanedeparturewarning/), das den Fahrer warnt, wenn das Fahrzeug die Spur verlässt.

[**Automatische Notbremsung (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard im Dacia Spring 65HP, dieses System bremst autonom, um eine Kollision zu verhindern oder deren Schwere zu verringern, wenn der Fahrer nicht rechtzeitig reagiert.
...
Der Dacia Spring 65HP ist mit wesentlichen Sicherheitsfunktionen ausgestattet, um Sie und Ihr Fahrzeug zu schützen und Einfachheit und Zuverlässigkeit zu bieten. Diese umfassen:
...
Der Kofferraum bietet ein Ladevolumen von 308 Litern (10,9 CU FT). Mit umgeklappter Rücksitzbank erweitert sich dies auf 1004 Liter (35,5 CU FT). Zusätzlich gibt es einen Frunk (vorderer Kofferraum) mit einem Ladevolumen von 35 Litern (1,2 CU FT).

Das maximale Gewicht des Fahrzeugs beträgt 1250 kg (2756 lbs) bei einem Leergewicht von 984 kg (2169 lbs). Dies ermöglicht eine maximale Zuladung von 266 kg (586 lbs), einschließlich Fahrer und Passagieren. Beachten Sie, dass einige Optionen das Leergewicht erhöhen und die maximale Zuladung verringern können.
...
{{< pagenavigation b_url="../" b_title="Dacia Spring" f_url="rangeandconsumption/" f_title="Reichweite" >}}
