...
description: "Dacia Spring 65HP est une berline entièrement électrique avec une autonomie de WLTP allant jusqu'à 220 km (137 miles). EVKX.net a tous les détails."
weight: 10
hidden: true
shownavtabs: true
...
La vitesse de charge DC maximale est de 30kW. Une charge complète de 0 à 100 % prendrait 81 minutes, tandis qu'un scénario plus courant de 10 à 80 % prendrait 41 minutes. Si vous supposez que vous perdez 5 minutes de conduite par arrêt de charge en plus du temps de charge, la zone de charge optimale est comprise entre 4 % et 67 %, ce qui correspond à une vitesse de charge réelle, y compris la perte de temps, de 24kW. Chaque session de charge prendrait 39 minutes et 13 secondes.
...
L'Dacia Spring 65HP comprend plusieurs fonctionnalités pour améliorer le confort et la commodité :
...
Le Dacia Spring 65HP comprend plusieurs [systèmes avancés d'assistance au conducteur](../../../../technology/driverassistance/) (ADAS) de série et en option pour améliorer la sécurité et le confort.
...
[**Assistance au Maintien de Voie (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard sur le Dacia Spring 65HP, ce système aide à prévenir le déplacement du véhicule hors de sa voie. Il comprend également un système de [**Alerte de Sortie de Voie**](../../../../technology/driverassistance/lanedeparturewarning/) pour alerter le conducteur si le véhicule quitte sa voie.

[**Freinage d'urgence automatique (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard sur le Dacia Spring 65HP, ce système applique les freins de manière autonome pour éviter ou réduire la gravité d'une collision si le conducteur ne réagit pas à temps.
...
Le coffre offre une capacité de chargement de 308 litres. Avec les sièges arrière rabattus, cette capacité passe à 1004 litres. De plus, il y a un frunk (coffre avant) avec une capacité de stockage de 35 litres.

Le poids maximum du véhicule est de 1250 kg, avec un poids de base de 984 kg. Cela permet une charge maximale de 266 kg, y compris le conducteur et les passagers. Notez que certaines options peuvent augmenter le poids de base et réduire la capacité maximale de chargement.

Ce modèle n'est pas disponible avec un attelage. Donc, pour remorquer une remorque, vous devrez envisager d'autres modèles.
{{< pagenavigation b_url="../" b_title="Dacia Spring" f_url="rangeandconsumption/" f_title="Plage" >}}
