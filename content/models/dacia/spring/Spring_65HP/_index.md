...
The vehicle supports fast DC charging with a maximum power of 30 kW. Charging from 0% to 100% takes approximately 81 minutes, while a more typical scenario from 10% to 80% takes 41 minutes with an average charging speed of 26 kW. Considering an additional 5 minutes for each charging stop due to driving interruptions, the optimal charging range is from 4% to 67%. This results in an effective charging speed, including time lost, of 24 kW, with each charging session taking about 39 minutes and 13 seconds.

### Onboard Charger

The standard onboard charger supports up to 7 kW for Level 1 and Level 2 AC charging. This allows you to fully charge the battery from 0 to 100% in approximately 3 hours and 34 minutes using a home charging setup.
...
The Dacia Spring 65HP offers a single type of front seat.
...
The Dacia Spring 65HP is equipped with a single type of steering wheel:
...
[**Lane-Keeping Assist (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard on the Dacia Spring 65HP, this system helps prevent the vehicle from drifting out of its lane. It also includes a [**Lane Departure Warning**](../../../../technology/driverassistance/lanedeparturewarning/) system to alert the driver if the vehicle veers out of the lane.

[**Automatic Emergency Braking (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard on the Dacia Spring 65HP, this system autonomously applies the brakes to prevent or reduce the severity of a collision if the driver does not react in time.
...
The Dacia Spring 65HP is equipped with essential security features to protect you and your vehicle, offering simplicity and reliability. These include:
...
The trunk offers a cargo capacity of 308 liters (10.9 CU FT). With the rear seat folded down, this expands to 1004 liters (35.5 CU FT). Additionally, there is a frunk (front trunk) with a storage capacity of 35 liters (1.2 CU FT).
