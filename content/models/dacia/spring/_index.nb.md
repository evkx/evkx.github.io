...
title: Dacia Spring
linktitle: "Spring"
description: "Se nedenfor for alle varianter av Dacia Spring"
weight: 30
---
...
<i class="bi bi-battery-full"></i> 26.8 kWh <i class="bi bi-ev-station"></i> 30 kW 
		...
		<div class="col col-12 col-md-6">
			<ul class="list-group list-group-flush">
				...
				<li class="list-group-item list-group-item-action"><a href="spring_65hp/reviews/" class="text-decoration-none text-black" ><i class="bi-person-video2"></i> Tester</a></li>
			</ul>
		</div>
	</div>
</div>
