---
title: Hyundai EV-Modelle
linktitle: "Hyundai"
description: "Hyundai Motor Company, gegründet 1967 in Südkorea, ist ein globaler Automobilhersteller, der für erschwingliche, zuverlässige Fahrzeuge und ein starkes Engagement für Elektrofahrzeuge bekannt ist und bis 2045 Kohlenstoffneutralität anstrebt."
weight: 30
---
...
Hyundai INSTER ist ein Schrägheck, das in 2 Varianten erhältlich ist.
</p>
	<a href="inster/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Hyundai Ioniq 5 ist ein SUV, der in 5 Varianten erhältlich ist.
</p>
    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Hyundai Ioniq 6 ist eine Limousine, die in 2 Varianten erhältlich ist.
</p>
	<a href="ioniq_6/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Hyundai Kona ist ein Crossover, das in 2 Varianten erhältlich ist.
</p>
	<a href="kona/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
        </div>
    ...
    <div id="module-company" class="accordion-collapse collapse">
        <div class="accordion-body">
{{% insert "content/models/hyundai/company.de.md" %}}
</div>
</div>
</div>
</div>
