...
El Hyundai Ioniq 6 Long Range RWD tiene una potencia máxima de 168 KW (228 hp/225 bhp). El par total es 350 nm (258 ft-lb). Realiza el sprint de 0 a 100 km/h (0 a 62 mph) en 7,4 segundos. La velocidad máxima es 185 km/h.

## Batería, autonomía y carga

La batería tiene una capacidad bruta de 77,4kWh y una capacidad neta de 74kWh, lo que significa que tienes un buffer de 3,4kWh para protección. (4,4%).

El [rango WLTP](../../../../guides/understandingrange/wltp/) varía de 614 a 545 km (382-339 mi), dependiendo de las opciones del coche. Las ruedas más grandes son un ejemplo de una opción de equipamiento que aumenta el consumo y reduce la autonomía eléctrica. El consumo está entre 12.1kWh/100 km para la versión básica y 13.6kWh/100 km para la versión superior según la prueba estándar WLTP. Para obtener más detalles sobre el alcance, consulte los datos del mundo real y el listado de alcance en la página [rango y consumo](rangoyconsumo/) de este modelo.

La velocidad máxima de carga de CC es 233kW. Una carga completa del 0 al 100 % tardaría 38 minutos, mientras que un escenario más común del 10 al 80 % tardaría 16 minutos. Si supone que pierde 5 minutos conduciendo por cada parada de carga, además del tiempo de carga, el área de carga óptima es del 1% al 76%, lo que da como resultado una velocidad de carga real, incluida la pérdida de tiempo, de 152kW. Cada sesión de carga tardaría 22 minutos y 59 segundos.

Para el desafío teórico de 1000 km, comenzando con la batería llena y conduciendo a 120 km/h (75 mph), suponiendo condiciones de conducción óptimas y un consumo de 19kWh/100 km, 1000 km tomarán 9 horas y 6 minutos. Este viaje requerirá dos sesiones de carga del 1 % al 80 %. El tiempo total perdido para cargar la batería será de 46 minutos.
...
Sólo hay un tipo de asiento delantero disponible en el Hyundai Ioniq 6 Long Range RWD.
...
Hay un sistema climático disponible. El sistema climático 2-zone admite diferentes temperaturas en dos zonas para el conductor y el pasajero. Este modelo tiene una [bomba de calor](../../../../technology/hvac/#heat-pump) como opción. Esta bomba de calor puede ahorrar una cantidad significativa de energía Se utiliza para calentar en climas fríos.

## Comodidad

Hyundai Ioniq 6 Long Range RWD tiene varias características para hacer tu vida como conductor o pasajero más cómoda.
...
El Hyundai Ioniq 6 Long Range RWD tiene pantallas gemelas en un marco compartido montado con soportes en el tablero. Detrás del volante hay un [grupo de instrumentos digitales](../../../../technology/userinterface/screens/#digital-instruments), y en la parte derecha , hay una [pantalla de infoentretenimiento](../../../../technology/userinterface/screens/#infotainment-screen). La  pantalla detrás del volante a la izquierda del marco mide 12.3 pulgadas de tamaño y tiene una resolución de 1920 x 720 píxeles. La touch pantalla en la parte derecha del marco compartido mide 12.3 pulgadas de tamaño y tiene una resolución de 2880 x 1080 píxeles.
...
Un tipo de sistema de sonido está disponible para el Hyundai Ioniq 6 Long Range RWD. Con el Bose Premium Sound System, obtienes ocho parlantes con una salida máxima del sistema de  vatios.

Además, con el sistema de navegación para automóvil estándar, obtienes la ayuda que necesitas para encontrar tu destino. Además, el Hyundai Ioniq 6 Long Range RWD es compatible con Android Auto y Apple CarPlay. Esta funcionalidad te permite presentar la pantalla de tu teléfono en la pantalla del auto para que puedas ejecutar aplicaciones como Google Maps o Waze.
...
El Hyundai Ioniq 6 Long Range RWD tiene varios [sistemas avanzados de asistencia al conductor](../../../../technology/driverassistance/) (ADAS) estándar y opcionales para mayor seguridad y comodidad.
### Sistemas de seguridad



El Hyundai Ioniq 6 Long Range RWD tiene un [**sistema de frenos antibloqueo (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/) como un estándar sistema. Este sistema ayuda a evitar que las ruedas del vehículo se bloqueen durante el frenado.

El Hyundai Ioniq 6 Long Range RWD tiene un [**Control Electrónico de Estabilidad**](../../../../technology/driverassistance/electronicstabilitycontrol/) como sistema un estándar diseñado para mejorar la estabilidad y el manejo de un vehículo durante maniobras repentinas o condiciones de carretera resbaladizas.

El Hyundai Ioniq 6 Long Range RWD tiene un [**asistente para mantenerse en el carril**](../../../../technology/driverassistance/lanekeepingassist/) como sistema un estándar. El sistema ayuda a evitar que el coche se salga de su carril. Además, cuenta con un sistema de [**aviso de salida de carril**](../../../../technology/driverassistance/lanedeparturewarning/) que avisa al conductor si el vehículo abandona el carril de conducción.
...
El Hyundai Ioniq 6 Long Range RWD tiene [**frenado automático de emergencia**](../../../../technology/driverassistance/automaticemergencybraking/) como sistema un estándar. Este sistema ayuda prevenir o mitigar colisiones aplicando los frenos de forma autónoma si el conductor no reacciona ante una colisión inminente.
...
La capacidad de carga en el maletero es de 401 litros. Con el asiento trasero abatido, es de 1578 litros. En el techo, puedes cargar hasta 80 kg (176,4 lbs). Debajo del capó, hay un maletero con más espacio de almacenamiento. Este maletero mide 12 litros (0,4 CU FT). El peso máximo del automóvil es 2520 kg (5556 lbs), y con el peso base de 2020 kg (4453 lbs), puedes cargar como máximo 500 kg (1102 lbs), incluidos el conductor y los pasajeros. Algunas opciones pueden aumentar el peso base y reducir el peso máximo de carga.

Puedes pedir el automóvil con una barra de remolque. El peso total máximo en un remolque con freno es 1500, y sin freno, es de 750 kg (3307/1653 lbs).<div class="mt-3 mb-3">
