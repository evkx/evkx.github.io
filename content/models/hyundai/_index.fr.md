...
Hyundai Inster est un hayon disponible en 1 variantes.
</p>
    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Hyundai Ioniq 5 est un SUV disponible en 3 variantes.
</p>
    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Hyundai Ioniq 6 est une berline disponible en 2 variantes.
</p>
	<a href="ioniq_6/" class="btn btn-outline-primary" role="button">Aller aux informations sur le modèle</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Hyundai Kona est un crossover disponible en 2 variantes.
</p>
	<a href="kona/" class="btn btn-outline-primary" role="button">Aller aux informations sur le modèle</a>
		</div>
	</div>
</div>
        </div>
