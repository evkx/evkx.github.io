...
El Hyundai Kona Standard Range tiene una potencia máxima de 160 KW (218 hp/215 bhp). El par total es 255 nm (188 ft-lb). Realiza el sprint de 0 a 100 km/h (0 a 62 mph) en 7,3 segundos. La velocidad máxima es 185 km/h.

## Batería, autonomía y carga

La batería tiene una capacidad bruta de 51kWh y una capacidad neta de 48,4kWh, lo que significa que tienes un buffer de 2,6kWh para protección. (5,1%).

El [rango WLTP](../../../../guides/understandingrange/wltp/) es 377 km (234 mi). El consumo es de 12,8kWh/100 km para la prueba estándar WLTP. Para obtener más detalles sobre el alcance, consulte los datos del mundo real y el listado de alcance en la página [rango y consumo](rangeandconsumption/) de este modelo.
...
Para el desafío teórico de 1000 km, comenzando con la batería llena y conduciendo a 120 km/h (75 mph), suponiendo condiciones de conducción óptimas y un consumo de 23kWh/100 km, 1000 km tomarán 11 horas y 9 minutos. Este viaje requerirá seis sesiones de carga del 4 % al 67 %. El tiempo total perdido para cargar la batería será de 170 minutos.

### Cargador a bordo

Para carga de CA de nivel 1 y 2, el cargador integrado  admite una carga de hasta 11 KW. Como resultado, puedes cargar la batería del 0 al 100 % desde casa en aproximadamente 4 horas y 23 minutos.
...
Puedes elegir entre 21 colores de pintura diferentes al pedir este modelo.
...
Hyundai Kona Standard Range tiene varias características para hacer tu vida como conductor o pasajero más cómoda.
...
Un tipo de sistema de sonido está disponible para el Hyundai Kona Standard Range. Con el Bose Premium Sound System, obtienes siete parlantes con una salida máxima del sistema de  vatios.

Además, con el sistema de navegación para automóvil estándar, obtienes la ayuda que necesitas para encontrar tu destino. Además, el Hyundai Kona Standard Range es compatible con Android Auto y Apple CarPlay. Esta funcionalidad te permite presentar la pantalla de tu teléfono en la pantalla del auto para que puedas ejecutar aplicaciones como Google Maps o Waze.
...
El Hyundai Kona Standard Range tiene varios [sistemas avanzados de asistencia al conductor](../../../../technology/driverassistance/) (ADAS) estándar y opcionales para mayor seguridad y comodidad.
### Sistemas de seguridad



El Hyundai Kona Standard Range tiene un [**sistema de frenos antibloqueo (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/) como un estándar sistema. Este sistema ayuda a evitar que las ruedas del vehículo se bloqueen durante el frenado.

El Hyundai Kona Standard Range tiene un [**Control Electrónico de Estabilidad**](../../../../technology/driverassistance/electronicstabilitycontrol/) como sistema un estándar diseñado para mejorar la estabilidad y el manejo de un vehículo durante maniobras repentinas o condiciones de carretera resbaladizas.

El Hyundai Kona Standard Range tiene un [**asistente para mantenerse en el carril**](../../../../technology/driverassistance/lanekeepingassist/) como sistema un estándar. El sistema ayuda a evitar que el coche se salga de su carril. Además, cuenta con un sistema de [**aviso de salida de carril**](../../../../technology/driverassistance/lanedeparturewarning/) que avisa al conductor si el vehículo abandona el carril de conducción.
...
El Hyundai Kona Standard Range tiene [**frenado automático de emergencia**](../../../../technology/driverassistance/automaticemergencybraking/) como sistema un estándar. Este sistema ayuda prevenir o mitigar colisiones aplicando los frenos de forma autónoma si el conductor no reacciona ante una colisión inminente.
