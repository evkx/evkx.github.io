---
title: Hyundai IONIQ 9 AWD Long Range especificaciones
linktitle: "Especificaciones"
description: "EVKX.net le brinda las especificaciones completas para Hyundai IONIQ 9 AWD Long Range."
weight: 4
hidden: true
...
EVKX.net busca tener las especificaciones más completas para Hyundai IONIQ 9 AWD Long Range. Haga clic en la imagen de arriba para ver [artículo completo](../), visite la [galería de imágenes](../gallery/) para imágenes de alta resolución de Hyundai IONIQ 9 AWD Long Range, visite [chargeinfo](../chargingcurve/) para Hyundai IONIQ 9 AWD Long Range con chargecurve, visite [información de rango extendido](../rangeandconsumption/) para rangos del mundo real.
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Ionosphere Green Pearl (Verde)</br>
				Sunset Brown Pearl (Marrón)</br>
				Cosmic Blue Pearl (Azul)</br>
				Abyss Black Pearl (Negro)</br>
				Serenity White Pearlk (Blanco)</br>
				Snow White Pearl (Blanco)</br>
				Cyber Gray Metallic (Gris)</br>
				Atlas White Matte (Blanco)</br>
