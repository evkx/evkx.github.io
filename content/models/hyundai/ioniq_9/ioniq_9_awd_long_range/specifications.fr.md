---
title: Hyundai IONIQ 9 AWD Long Range spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Hyundai IONIQ 9 AWD Long Range."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Hyundai IONIQ 9 AWD Long Range. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Hyundai IONIQ 9 AWD Long Range, visitez les [chargeinfo](../chargingcurve/) pour Hyundai IONIQ 9 AWD Long Range avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
