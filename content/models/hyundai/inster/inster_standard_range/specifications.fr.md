---
title: Hyundai INSTER Standard Range spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Hyundai INSTER Standard Range."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Hyundai INSTER Standard Range. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Hyundai INSTER Standard Range, visitez les [chargeinfo](../chargingcurve/) pour Hyundai INSTER Standard Range avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Aero Silver Matte (Argent)</br>
				Dusk Blue Matte (Bleu)</br>
				Abyss Black Pearl (Noir)</br>
				Buttercream Yellow Pearl (Jaune)</br>
			</td>
		</tr>
	</tbody>
</table>
