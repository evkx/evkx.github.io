...
description: "Hyundai INSTER Long Range est une berline entièrement électrique avec une autonomie de WLTP allant jusqu'à 355 km (221 miles). EVKX.net a tous les détails."
weight: 10
hidden: true
shownavtabs: true
...
La batterie haute capacité a une capacité brute de 49,0 kWh et une capacité nette utilisable de 46,0 kWh, offrant une réserve de 3,0 kWh (6,1%) pour la protection de la batterie. Avec une tension nominale de 310 volts, le système est classé comme un système de batterie de 400 volts, conforme aux normes de l'industrie. Cette batterie au lithium-ion utilise la technologie [NMC (Nickel Manganèse Cobalt).](../../../../technology/battery/cellchemistry/#lithium-nickel-manganese-cobalt-oxydes-nmc)
...
La vitesse de charge DC maximale est de 80kW. Une charge complète de 0 à 100 % prendrait 65 minutes, tandis qu'un scénario plus courant de 10 à 80 % prendrait 30 minutes. Si vous supposez que vous perdez 5 minutes de conduite par arrêt de charge en plus du temps de charge, la zone de charge optimale est comprise entre 4 % et 67 %, ce qui correspond à une vitesse de charge réelle, y compris la perte de temps, de 62kW. Chaque session de charge prendrait 28 minutes et 51 secondes.

Dans un défi théorique de 1000 km, en commençant avec une batterie pleine et en maintenant une vitesse constante de 120 km/h dans des conditions idéales avec une consommation supposée de 23 kWh/100 km, le voyage prendrait environ 11 heures et 19 minutes. Ce trajet nécessiterait deux arrêts de recharge de 1% à 68%, avec un temps de recharge total de 179 minutes.
...
L'Hyundai INSTER Long Range comprend plusieurs fonctionnalités pour améliorer le confort et la commodité :
...
Un type de système audio est disponible pour le Hyundai INSTER Long Range.

- **Bose Premium Sound System:** Comprend sept haut-parleurs.
...
Le Hyundai INSTER Long Range comprend plusieurs [systèmes avancés d'assistance au conducteur](../../../../technology/driverassistance/) (ADAS) de série et en option pour améliorer la sécurité et le confort.
...
[**Contrôle Électronique de Stabilité (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard sur le Hyundai INSTER Long Range, ce système améliore la stabilité et la maniabilité du véhicule lors de manœuvres soudaines ou en conditions de route glissantes.

[**Assistance au Maintien de Voie (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard sur le Hyundai INSTER Long Range, ce système aide à prévenir le déplacement du véhicule hors de sa voie. Il comprend également un système de [**Alerte de Sortie de Voie**](../../../../technology/driverassistance/lanedeparturewarning/) pour alerter le conducteur si le véhicule quitte sa voie.
...
[**Alerte de Trafic Croisé Arrière (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard sur le Hyundai INSTER Long Range, ce système utilise des capteurs pour détecter les véhicules qui approchent par les côtés lors de la marche arrière depuis une place de stationnement ou une entrée.

[**Alerte de Collision Frontale (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard sur le Hyundai INSTER Long Range, ce système d'assistance au conducteur aide à éviter ou à atténuer les collisions frontales.

[**Freinage d'urgence automatique (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard sur le Hyundai INSTER Long Range, ce système applique les freins de manière autonome pour éviter ou réduire la gravité d'une collision si le conducteur ne réagit pas à temps.
...
[**Alerte de Sortie**](../../../../technology/driverassistance/exitwarning/): Standard sur le Hyundai INSTER Long Range, ce système alerte les occupants avant d'ouvrir les portes s'il y a un risque de heurter quelque chose.
...
Le coffre offre une capacité de chargement de 280 litres. Avec les sièges arrière rabattus, cette capacité passe à 1050 litres. Sur le toit, vous pouvez charger jusqu'à 75 kg. Des rails de toit optionnels sont disponibles pour faciliter l'installation d'une boîte de toit ou d'un porte-vélos.

Le poids maximum du véhicule est de 1700 kg, avec un poids de base de 1375 kg. Cela permet une charge maximale de 325 kg, y compris le conducteur et les passagers. Notez que certaines options peuvent augmenter le poids de base et réduire la capacité maximale de chargement.
...
Ce modèle a été présenté en première mondiale le 27.06.2024 et les livraisons devraient commencer en January 2025.
{{< pagenavigation b_url="../" b_title="Hyundai INSTER" f_url="rangeandconsumption/" f_title="Plage" >}}
