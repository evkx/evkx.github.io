...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Cadillac</h2>
	<p>
	Cadillac a 2 modèles avec un total de 3 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Chevrolet</h2>
	<p>
	Chevrolet a 2 modèles avec un total de 4 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Ford</h2>
	<p>
	Ford a 3 modèles avec un total de 10 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Kia</h2>
	<p>
	Kia a 3 modèles avec un total de 10 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Mercedes</h2>
	<p>
	Mercedes a 7 modèles avec un total de 28 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Nio</h2>
	<p>
	Nio a 6 modèles avec un total de 7 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Nissan</h2>
	<p>
	Nissan a 1 modèles avec un total de 3 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Opel</h2>
	<p>
	Opel a 2 modèles avec un total de 3 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Peugot</h2>
	<p>
	Peugot a 4 modèles avec un total de 6 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Polestar</h2>
	<p>
	Polestar a 3 modèles avec un total de 6 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Porsche</h2>
	<p>
	Porsche a 2 modèles avec un total de 20 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Rivian</h2>
	<p>
	Rivian a 1 modèles avec un total de 6 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Skoda</h2>
	<p>
	Skoda a 1 modèles avec un total de 6 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Volkswagen</h2>
	<p>
	Volkswagen a 5 modèles avec un total de 19 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>XPENG</h2>
	<p>
	XPENG a 5 modèles avec un total de 8 variantes.
	</p>
