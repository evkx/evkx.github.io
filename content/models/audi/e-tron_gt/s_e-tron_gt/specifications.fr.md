---
title: Audi S e-tron GT spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Audi S e-tron GT."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Audi S e-tron GT. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Audi S e-tron GT, visitez les [chargeinfo](../chargingcurve/) pour Audi S e-tron GT avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
...
<table class="table table-striped border">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				Oui (Audi Cross Traffic Assist), équipement en option
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				Oui (Audi Collision Avoidance Assist), équipement standard
			</td>
		</tr>
		<tr>
			<td>
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Arkona White (Blanc)</br>
				Florett Silver (Argent)</br>
				Kemora Grey (Gris)</br>
				Bedford Green (Vert)</br>
				Mythos black (Noir)</br>
				Progressive Red (Rouge)</br>
