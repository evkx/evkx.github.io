...
description: "Audi RS e-tron GT (GEN1) er en fuldelektrisk luksussedan med en WLTP rækkevidde på op til 495 km (308 miles). EVKX.net har alle detaljerne."
weight: 10
hidden: true
shownavtabs: true
...
Vi har opdelt vores Audi RS e-tron GT (GEN1) artikel i sektioner. Hvis du vil vente med at læse hele artiklen, skal du klikke på nedenstående links til de forskellige områder. Vi har også en oversigt over de [fulde specifikationer](specifications/), et [billedgalleri](gallery/), detaljerede oplysninger om [opladningsydelse](chargingcurve/), og nogle [online anmeldelser](reviews/). Vores sektioner:
...
Den maksimale DC-opladningshastighed er 270kW. En fuld opladning fra 0 - 100 % ville tage 51 minutter, mens et mere almindeligt scenarie på 10-80 % ville tage 18 minutter. Hvis du antager, at du mister 5 minutters kørsel pr. ladestop ud over opladningstiden, er det optimale opladningsområde fra 3% til 64%, hvilket resulterer i en faktisk opladningshastighed, inklusive tidstab på 162kW. Hver opladningssession ville tage 19 minutter og 52 sekunder. Denne effektive opladningskapacitet gør Audi RS e-tron GT (GEN1) til et praktisk valg til langdistancerejser.
...
Audi RS e-tron GT (GEN1) har et firehjulstræk, der understøttes af to motorer, en på hver aksel. Dene anvendte motorer er [Permanent Magnet Synchronous Motors](../../../../technology/motors/pmsm/).
...
Du kan bestille Audi RS e-tron GT (GEN1) med en alternativ Adaptive Air Suspension hjulophæng. Forhjulsophænget er [double wishbone](../../../../technology/suspension/#double-wishbone), og baghjulsophænget er [Multilink](../../../../technology/suspension/#multilink). Den bruger luftaffjedring og hydrauliske dæmpere. Affjedringen er fuldt adaptiv på for- og bagakslen, så højde og dæmpning kan justeres manuelt og automatisk. Mindste frihøjde er 125 mm, og maksimum er 165 mm.

### Styring

Dynamisk styring er en standard-funktion på Audi RS e-tron GT (GEN1). Dynamisk styring varierer styreforholdet som en funktion af kørehastigheden. Derudover er baghjulsstyring tilgængelig som en standard-funktion. Baghjulsstyring reducerer drejecirklen, når du kører langsomt.
...
Den Audi RS e-tron GT (GEN1), med dimensioner på 4989 mm i længde, 1964 mm i bredde og 1396 mm i højde, tilhører E-segmentet af biler, også kendt som executive biler. De er større og mere luksuriøse end deres D-segment modparter. De er designet til at tilbyde overlegen komfort, avanceret teknologi og høj ydelse, hvilket gør dem velegnede til en specifik gruppe førere. Audi RS e-tron GT (GEN1) fås i alt i 54 lakfarver, herunder perlemors- og metalliske muligheder. Ud over standardpaletten er der eksklusive farver fra 'Audi exclusive'-paletten.
...
Audi RS e-tron GT (GEN1) har plads til fem passagerer med to sæder foran og en tre-personers bænk bagtil.
...
Audi RS e-tron GT (GEN1) inkluderer flere funktioner, der forbedrer komfort og bekvemmelighed:
...
Audi RS e-tron GT (GEN1) er udstyret med en enkelt type rat:
...
Yderligere understøtter Audi RS e-tron GT (GEN1) Android Auto og Apple CarPlay. Denne funktionalitet giver dig mulighed for at præsentere din telefons skærm på bilens skærm, så du kan køre apps som Google Maps eller Waze.

### Lydsystem

Du kan vælge mellem to lydsystemer på Audi RS e-tron GT (GEN1).
...
Den Audi RS e-tron GT (GEN1) kommer med sin dedikerede mobilapp, tilgængelig til både Android og iOS-enheder, som giver dig mulighed for at administrere og overvåge dit køretøj eksternt. Appen tilbyder et bredt udvalg af funktioner designet til at forbedre din køreoplevelse:
...
Den Audi RS e-tron GT (GEN1) inkluderer flere standard- og valgfri [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) for at forbedre sikkerhed og komfort.
...
[**Anti-lock Bremsesystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Audi RS e-tron GT (GEN1), dette system forhindrer hjulene i at låse under opbremsning.

[**Electronic Stability Control (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Audi RS e-tron GT (GEN1), dette system forbedrer bilens stabilitet og håndtering under pludselige manøvrer eller på glatte vejforhold.
...
[**Front Cross Traffic Assist (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/): Valgfrit på Audi RS e-tron GT (GEN1), dette førerassistentsystem hjælper føreren med at opdage modkørende trafik ved krydsning af et kryds eller ved sving til venstre eller højre fra en stopposition.

[**Rear Cross Traffic Alert (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Valgfrit på Audi RS e-tron GT (GEN1), dette system bruger sensorer til at registrere tilstødende køretøjer fra siden, når du bakker ud af en parkeringsplads eller indkørsel.

[**Forward Collision Warning (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Valgfrit på Audi RS e-tron GT (GEN1), dette førerassistentsystem hjælper føreren med at undgå eller formilde frontale kollisioner.

[**Automatisk nødbremsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Audi RS e-tron GT (GEN1), dette system anvender bremserne autonomt for at forhindre eller reducere alvoren af en kollision, hvis føreren ikke reagerer i tide.
...
[**Blind-spot Monitoring (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Valgfrit på Audi RS e-tron GT (GEN1), dette sideassistentsystem hjælper med at registrere trafik i døde vinkler.
...
Audi RS e-tron GT (GEN1) er udstyret med avancerede sikkerhedsfunktioner for at beskytte dig og dit køretøj. Disse inkluderer:
