---
title: Audi RS e-tron GT performance Specifikationer
linktitle: "Specifikationer"
description: "EVKX.net ger dig alla specifikationer för Audi RS e-tron GT performance."
weight: 4
hidden: true
...
EVKX.net vill ha de mest kompletta specifikationerna för Audi RS e-tron GT performance. Klicka på bilden ovan för [fullständig artikel](../), besök [bildgalleri](../gallery/) för hög upplösningsbilder av Audi RS e-tron GT performance, gå till [chargeinfo](../chargingcurve/) för Audi RS e-tron GT performance med laddningskurva, se [extended range info](../rangeandconsumption/) för verkliga räckvidd.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				<i class="bi-check-lg" style="color: green;"></i> Ja (Audi Active Lane Assist), standardfunktion
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				<i class="bi-check-lg" style="color: yellow;"></i> Ja (Cross traffic assist rear), valfritt
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				<i class="bi-check-lg" style="color: green;"></i> Ja (Audi Pre sense front), standardfunktion
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				<i class="bi-check-lg" style="color: yellow;"></i> Ja (Audi Turn Assist), valfritt
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<i class="bi-check-lg" style="color: yellow;"></i> Ja (Audi Collision Avoidance Assist), valfritt
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				<i class="bi-check-lg" style="color: yellow;"></i> Ja (Audi Cross Traffic Assist), valfritt
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<i class="bi-check-lg" style="color: green;"></i> Ja (Audi Efficency Assist), standardfunktion
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<i class="bi-check-lg" style="color: green;"></i> Ja (Audi Collision Avoidance Assist), standardfunktion
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<i class="bi-check-lg" style="color: yellow;"></i> Ja (Audi Traffic Sign Recongition), valfritt
			</td>
		</tr>
		<tr>
			<td>
...
<table class="table table-striped border">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<i class="bi-check-lg" style="color: yellow;"></i> Ja (Smartphone Interface), valfritt
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				<i class="bi-check-lg" style="color: green;"></i> Ja (MMI Navigation plus), standardfunktion
			</td>
		</tr>
		<tr>
			<td>
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Florett Silver</br>
				Kemora Grey (Grå)</br>
				Bedford Green (Grön)</br>
				Mythos black (Svart)</br>
				Progressive Red (Röd)</br>
				...
				Oak green, pearl effect (Grön)</br>
				Goodwood green, pearl effect (Grön)</br>
				Deep green, pearl effect (Grön)</br>
