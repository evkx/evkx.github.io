...
description: "Audi RS e-tron GT performance är en helt elektrisk lyxsedan med en WLTP-räckvidd på upp till 598 km (372 miles). EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Med överboost levererar Audi RS e-tron GT performance en häpnadsväckande maxeffekt på 680 kW (925 hk / 912 bhp). Även utan överboost har den en imponerande effekt på 610 kW (829 hk / 818 bhp). Det maximala vridmomentet når otroliga 1027 Nm (758 lb-ft). Denna kraftmaskin kan accelerera från 0 till 100 km/h på endast 2,5 sekunder och uppnår en toppfart på 250 km/h (155 mph), vilket understryker dess hisnande prestanda.
...
Audi RS e-tron GT performance har ett fyrhjulsdrivet system som drivs av två motorer, en på varje axel. Motorerna som används är [permanent magnet synkronmotorer](../../../../technology/motors/pmsm/).

### Fjädring

Framfjädringen är av typen [dubbel länkarm](../../../../technology/suspension/#double-wishbone) och bakfjädringen är [multilänk](../../../../technology/suspension/#multilink). Den använder luftfjädring och hydrauliska stötdämpare. Fjädringen är fullt adaptiv på både fram- och bakaxel, så både höjd och dämpning kan justeras manuellt och automatiskt. Den minsta markfrigången är 125 mm, och den maximala är 165 mm.

Du kan beställa Audi RS e-tron GT performance med en alternativ Active fjädring. Framfjädringen är av typen [dubbel länkarm](../../../../technology/suspension/#double-wishbone) och bakfjädringen är [multilänk](../../../../technology/suspension/#multilink). Den använder luftfjädring och aktiva hydrauliska stötdämpare. Dämparen motverkar aktivt oönskade rörelser i luftfjädringen. Detta gör att hjulen aktivt kan tryckas mot vägen eller dras in i karossen när som helst. Med en mjuk körning absorberar systemet nästan alla ojämnheter. Fjädringen är fullt adaptiv på både fram- och bakaxel, så både höjd och dämpning kan justeras manuellt och automatiskt. Den minsta markfrigången är 125 mm, och den maximala är 165 mm.
...
Audi RS e-tron GT performance, med måtten 4989 mm i längd, 1964 mm i bredd och 1396 mm i höjd, tillhör E-segmentet, även känt som stora premiumbilar. De är större och mer lyxiga än D-segmentets bilar och är designade för överlägsen komfort, avancerad teknik och hög prestanda. Audi RS e-tron GT performance finns tillgänglig i totalt 54 lackfärger, inklusive pärlemo- och metallic-alternativ. Utöver standardpaletten kommer vissa färger från den exklusiva 'Audi exclusive'-paletten.

Audi RS e-tron GT performance erbjuder flera hjulalternativ i olika storlekar, vilket låter dig anpassa ditt fordon efter din stil och körstil. De tillgängliga däck- och hjulkombinationerna inkluderar:
...
Det finns tre olika takalternativ att välja mellan. Standardtaket har ett stort panoramaglas som sträcker sig från fram till bak. Detta glas får bilens interiör att kännas mer rymlig och ljus, vilket kan förbättra stämningen och komforten för passagerarna. Glaset är tonat för att skydda mot värme från solen. Alternativt kan du välja ett panoramatak med elektrokromt glas som kan justeras för att kontrollera solljuset. Det tredje alternativet är ett kolfiber-tak som minskar fordonets totala vikt, vilket sänker tyngdpunkten och förbättrar väghållning och prestanda.
...
Audi RS e-tron GT performance rymmer fem passagerare med två framsäten och en tresätessoffa bak.
...
Följande funktioner finns tillgängliga på **sport pro** sätet:
...
I Audi RS e-tron GT performance ingår flera funktioner för att öka komfort och bekvämlighet:
...
Audi RS e-tron GT performance har flera integrerade skärmar. Bakom ratten finns en [digital instrumentgrupp](../../../../technology/userinterface/screens/#digital-instruments), och i mittkonsolen finns en [infotainmentskärm](../../../../technology/userinterface/screens/#infotainment-screen) högst upp.
...
Audi RS e-tron GT performance är utrustad med endast en typ av ratt:
...
Audi RS e-tron GT performance stödjer Android Auto och Apple CarPlay, vilket låter dig spegla din telefons skärm på bilens display. Detta gör det möjligt att köra appar som Google Maps eller Waze direkt från din telefon.

### Ljudsystem

Du kan välja mellan två ljudsystem för Audi RS e-tron GT performance:
...
Audi RS e-tron GT performance levereras med en dedikerad mobilapp, tillgänglig för både Android och iOS-enheter, som låter dig hantera och övervaka ditt fordon på distans. Appen erbjuder ett brett utbud av funktioner utformade för att förbättra din körupplevelse:
...
Du kan välja mellan tre olika typer av strålkastare för Audi RS e-tron GT performance.
...
- **LED Matrix-strålkastare med laserteknik:** Som tillval finns dessa strålkastare som kombinerar de adaptiva funktionerna hos LED Matrix-systemet med laserteknik för förbättrad ljusstyrka och räckvidd, vilket ger överlägsen belysning och säkerhet.
...
Audi RS e-tron GT performance har ett utbud av standard och tillvalda [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) utformade för att förbättra säkerhet och komfort.
...
[**Låsningsfria bromsar (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Audi RS e-tron GT performance, detta system förhindrar att hjulen låser sig vid inbromsning.

[**Elektronisk stabilitetskontroll (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Audi RS e-tron GT performance, detta system förbättrar fordonets stabilitet och hantering vid plötsliga manövrer eller på halt väglag.

[**Körfältsassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på Audi RS e-tron GT performance, detta system hjälper till att förhindra att fordonet driver ut ur sitt körfält. Den inkluderar också ett [**Körfilsvarningssystem**](../../../../technology/driverassistance/lanedeparturewarning/) som varnar föraren om fordonet avviker från körfältet.

[**Främre korsningsassistent (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/) : Tillval på Audi RS e-tron GT performance, ett förarassistanssystem som hjälper förare upptäcka mötande trafik vid korsningar eller när man svänger vänster eller höger från stillastående läge.

[**Varning för korsande trafik bak (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Tillval på Audi RS e-tron GT performance, detta system använder sensorer för att upptäcka annalkande fordon från sidan när man backar ut från en parkeringsplats eller uppfart.

[**Kollisionsvarning framåt (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Tillval på Audi RS e-tron GT performance, detta förarassistanssystem hjälper förare att undvika eller mildra frontalkrockar.

[**Automatisk nödbromsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Audi RS e-tron GT performance, detta system bromsar automatiskt för att förhindra eller minska allvarligheten av en kollision om föraren inte reagerar i tid.

[**Automatisk nödstyrning (AES)**](../../../../technology/driverassistance/automaticemergencysteering/): Standard på Audi RS e-tron GT performance, detta system hjälper till att undvika kollisioner genom att automatiskt styra fordonet i en nödsituation.

[**Dödvinkelvarnare (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Tillval på Audi RS e-tron GT performance, hjälper detta sidoassistanssystem till att upptäcka trafik i döda vinklar.

### Körautomation

Audi RS e-tron GT performance erbjuder [körautomation på nivå 1 eller 2](../../../../technology/driverassistance/#level-of-autonomous-driving), beroende på utrustningsnivå.
...
Audi RS e-tron GT performance är utrustad med avancerade säkerhetsfunktioner för att skydda dig och ditt fordon. Dessa inkluderar:
...
Bagageutrymmet har en lastkapacitet på 405 liter (14,3 kubikfot). På taket kan du lasta upp till 75 kg (165,3 lbs). Dessutom finns det en frunk (främre bagageutrymme) med en lagringskapacitet på 85 liter (3,0 CU FT).

Fordonets maximala vikt är 2860 kg (6305 lbs), med en tjänstevikt på 2340 kg (5159 lbs). Detta möjliggör en maximal last på 520 kg (1146 lbs), inklusive förare och passagerare. Observera att vissa tillval kan öka tjänstevikten och minska den maximala lastkapaciteten.

Denna modell kan inte utrustas med dragkrok. För att dra släp måste du titta på andra modeller.

## Tillgänglighet och priser

Audi RS e-tron GT performance hade sin världspremiär den 18.06.2024, och leveranserna startade September 2024.
