---
title: Audi RS e-tron GT performance especificaciones
linktitle: "Especificaciones"
description: "EVKX.net le brinda las especificaciones completas para Audi RS e-tron GT performance."
weight: 4
hidden: true
...
EVKX.net busca tener las especificaciones más completas para Audi RS e-tron GT performance. Haga clic en la imagen de arriba para ver [artículo completo](../), visite la [galería de imágenes](../gallery/) para imágenes de alta resolución de Audi RS e-tron GT performance, visite [chargeinfo](../chargingcurve/) para Audi RS e-tron GT performance con chargecurve, visite [información de rango extendido](../rangeandconsumption/) para rangos del mundo real.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Sí (Audi Active Lane Assist), equipo estándar
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				Sí (Audi Pre sense front), equipo estándar
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				Sí (Audi Turn Assist), equipo opcional
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				Sí (Audi Collision Avoidance Assist), equipo opcional
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				Sí (Audi Cross Traffic Assist), equipo opcional
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				Sí (Audi Efficency Assist), equipo estándar
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				Sí (Audi Collision Avoidance Assist), equipo estándar
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				Sí (Audi Traffic Sign Recongition), equipo opcional
			</td>
		</tr>
		<tr>
			<td>
...
<table class="table table-striped border">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				Sí (Smartphone Interface), equipo opcional
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				Sí (MMI Navigation plus), equipo estándar
			</td>
		</tr>
		<tr>
			<td>
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Arkona White (Blanco)</br>
				Florett Silver (Plata)</br>
				Kemora Grey (Gris)</br>
				Bedford Green (Verde)</br>
				Mythos black (Negro)</br>
				Progressive Red (Rojo)</br>
