...
EVKX.net søger at have de mest komplette specifikationer for Audi RS e-tron GT performance. Klik på billedet ovenfor for [fuld artikel](../), besøg [billedgalleriet](../gallery/) for billeder i høj opløsning af Audi RS e-tron GT performance, besøg [chargeinfo](../chargingcurve/) for Audi RS e-tron GT performance med chargecurve, se [extended range info](../rangeandconsumption/) for real world ranges.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Daytona Grey (Grå)</br>
				Arkona White (Hvid)</br>
				Florett Silver (Sølv)</br>
				Kemora Grey (Grå)</br>
				Bedford Green (Grøn)</br>
