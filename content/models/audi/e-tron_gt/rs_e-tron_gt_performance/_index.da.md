...
description: "Audi RS e-tron GT performance er en elektrisk luksus sedan med en WLTP rækkevidde på op til 598 km (372 miles). EVKX.net har alle detaljerne."
weight: 10
hidden: true
shownavtabs: true
...
Med overboost leverer Audi RS e-tron GT performance en imponerende maksimal effekt på 680 kW (925 hk / 912 bhp). Selv uden overboost har den en formidabel ydelse på 610 kW (829 hk / 818 bhp). Det maksimale drejningsmoment når op på utrolige 1027 Nm (758 lb-ft). Denne kraftmaskine kan accelerere fra 0 til 100 km/t (0 til 62 mph) på blot 2,5 sekunder og opnår en tophastighed på 250 km/t (155 mph), hvilket understreger dens enestående ydeevne.
...
Under [WLTP](../../../../guides/understandingrange/wltp/) (Worldwide Harmonized Light Vehicles Test Procedure) standarden varierer køretøjets rækkevidde mellem 598 og 527 km (372-328 miles), afhængigt af den specifikke konfiguration og tilvalg som f.eks. hjulstørrelse. Større hjul kan øge energiforbruget og dermed reducere den samlede rækkevidde. Køretøjets energiforbrug er vurderet til 16,2 kWh/100 km for basismodellen og 18,4 kWh/100 km for topmodellen under WLTP testcyklussen. For flere detaljer om rækkevidden, se data fra den virkelige verden og rækkeviddelister på denne models [rækkevidde og forbrug](rangeandconsumption/) side.

Køretøjet understøtter hurtig DC-opladning med en maksimal effekt på 320 kW. Opladning fra 0% til 100% tager cirka 47 minutter, mens et mere typisk scenario fra 10% til 80% tager 16 minutter med en gennemsnitlig ladehastighed på 260 kW. Når der medregnes yderligere 5 minutter for hvert opladningsstop på grund af køreafbrydelser, er det optimale opladningsområde fra 1% til 65%. Dette resulterer i en effektiv ladehastighed, inklusive tabt tid, på 209 kW, hvor hver opladningssession tager cirka 18 minutter og 48 sekunder. Denne exceptionelt hurtige opladningskapacitet gør Audi RS e-tron GT performance til en af de mest effektive og bekvemme elbiler til langdistancekørsel.
...
Audi RS e-tron GT performance har et firehjulstræksystem drevet af to motorer, én på hver aksel. Motorerne er [Permanent Magnet Synkron Motorer](../../../../technology/motors/pmsm/).
...
Dynamisk styring er standard på Audi RS e-tron GT performance, hvor styringsforholdet varierer baseret på kørehastighed for forbedret kontrol og komfort. Derudover er baghjulsstyring tilgængelig som valgfrit funktion. Baghjulsstyring reducerer vendediameteren ved langsom kørsel.
...
Audi RS e-tron GT performance, med dimensioner på 4989 mm i længde, 1964 mm i bredde og 1396 mm i højde, tilhører E-segment biler, også kendt som executive biler, der er større og mere luksuriøse end deres D-segment modstykker. De er designet til at tilbyde overlegen komfort, avanceret teknologi og høj ydeevne. Audi RS e-tron GT performance fås i alt i 54 lakfarver, inklusive perlemor og metalliske muligheder. Udover standardpaletten kommer nogle farver fra den eksklusive 'Audi exclusive' palette.

Audi RS e-tron GT performance tilbyder flere hjulmuligheder i forskellige størrelser, så du kan tilpasse din bil efter din stil og kørepræferencer. De tilgængelige dæk- og hjulkombinationer inkluderer:
...
Der er tre forskellige tagmuligheder at vælge imellem. Standardtaget inkluderer et stort panoramatag i glas, der strækker sig fra for til bag, hvilket forbedrer interiørets rummelige og lyse fornemmelse og dermed forbedrer stemningen og komforten for passagererne. Dette glas er tonet for at beskytte mod varme fra solen. Alternativt kan du vælge et panoramatag med elektrokromisk glas, der kan justeres for at kontrollere sollyset. Den tredje mulighed er et kulfibertag, som reducerer køretøjets samlede vægt og dermed sænker tyngdepunktet og forbedrer håndtering og ydeevne.
...
Audi RS e-tron GT performance har plads til fem passagerer med to forsæder og en trebænk bagtil.
...
Audi RS e-tron GT performance inkluderer flere funktioner for at forbedre komfort og bekvemmelighed:
...
Audi RS e-tron GT performance har flere integrerede skærme. Bag rattet er der et [digitalt instrumentpanel](../../../../technology/userinterface/screens/#digital-instruments), og i midterkonsollen er der én [infotainmentskærm](../../../../technology/userinterface/screens/#infotainment-screen) øverst i midterkonsollen.
...
Audi RS e-tron GT performance er udstyret med én type rat:
...
Audi RS e-tron GT performance understøtter Android Auto og Apple CarPlay, så du kan spejle din telefons skærm på bilens display. Denne funktionalitet gør det muligt at køre apps som Google Maps eller Waze direkte fra din telefon.

### Lydsystem

Du kan vælge mellem to lydsystemer til Audi RS e-tron GT performance:
...
Audi RS e-tron GT performance kommer med en dedikeret mobilapp, tilgængelig til både Android og iOS-enheder, så du kan styre og overvåge din bil på afstand. Appen tilbyder en bred vifte af funktioner designet til at forbedre din køreoplevelse:
...
Du kan vælge mellem tre typer forlygter til Audi RS e-tron GT performance.
...
Audi RS e-tron GT performance har en række standard og valgfrie [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) designet til at forbedre sikkerhed og komfort.
...
[**Antiblokeringssystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Audi RS e-tron GT performance, dette system forhindrer hjulene i at låse under bremsning.

[**Elektronisk Stabilitetskontrol (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Audi RS e-tron GT performance, dette system forbedrer bilens stabilitet og håndtering under pludselige manøvrer eller på glatte veje.

[**Vognbaneassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på Audi RS e-tron GT performance, dette system hjælper med at forhindre køretøjet i at drive ud af sin vognbane. Den inkluderer også et [**Vognbaneafvigelsesadvarsel**](../../../../technology/driverassistance/lanedeparturewarning/) system til at advare føreren, hvis køretøjet afviger fra vognbanen.

[**Front Tværgående Trafik Assistent (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/) : Ekstraudstyr på Audi RS e-tron GT performance, dette førerassistentsystem hjælper førere med at registrere modkørende trafik ved krydsning af et vejkryds eller når der drejes til venstre eller højre fra stillestående position.

[**Advarsel om Krydsende Trafik Bag (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Ekstraudstyr på Audi RS e-tron GT performance, dette system bruger sensorer til at opdage køretøjer, der nærmer sig fra siden, når man bakker ud af en parkeringsplads eller indkørsel.

[**Advarsel om Frontal Kollision (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Ekstraudstyr på Audi RS e-tron GT performance, dette førerassistentsystem hjælper førere med at undgå eller mindske frontale kollisioner.

[**Automatisk Nødbremsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Audi RS e-tron GT performance, dette system aktiverer automatisk bremserne for at forhindre eller reducere alvorligheden af en kollision, hvis føreren ikke reagerer i tide.

[**Automatisk Nødstyring (AES)**](../../../../technology/driverassistance/automaticemergencysteering/): Standard på Audi RS e-tron GT performance, dette system hjælper med at undgå kollisioner ved automatisk at styre køretøjet i en nødsituation.

[**Blindvinkel Overvågning (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Ekstraudstyr på Audi RS e-tron GT performance, dette system hjælper med at opdage trafik i blinde vinkler.

### Køreautomatisering

Audi RS e-tron GT performance tilbyder [køreautomatisering på niveau 1 eller 2](../../../../technology/driverassistance/#level-of-autonomous-driving), afhængigt af udstyrsniveauet.
...
Audi RS e-tron GT performance er udstyret med avancerede sikkerhedsfunktioner for at beskytte dig og dit køretøj. Disse omfatter:
...
Audi RS e-tron GT performance havde sin verdenspremiere den 18.06.2024, og leveringerne startede i September 2024.
