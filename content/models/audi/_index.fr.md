...
Audi A6 e-tron est une berline/break premium disponible en 6 variantes.
</p>
...
Audi e-tron est un SUV/SUV Coupé de luxe disponible en 6 variantes.
    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Audi e-tron GT est une berline de luxe disponible en 5 variantes.
</p>
...
Audi Q8 e-tron est un SUV/SUV Coupé de luxe disponible en 7 variantes.
    ...
    <div id="module-company" class="accordion-collapse collapse">
        <div class="accordion-body">
{{% insert "content/models/audi/company.fr.md" %}}
</div>
</div>
</div>
</div>
