...
Audi A6 e-tron ist eine Premium-Limousine/Kombi, die in 5 Varianten erhältlich ist.
</p>
    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Audi e-tron ist ein Luxus-SUV/Coupé-SUV, das in 6 Varianten erhältlich ist.
</p>
	<a href="e-tron/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Audi e-tron GT ist eine Luxuslimousine, die in 5 Varianten erhältlich ist.
</p>
	<a href="e-tron_gt/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Audi Q4 e-tron ist ein Premium-SUV/Coupé-SUV, das in 15 Varianten erhältlich ist.
</p>
	<a href="q4_e-tron/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Audi Q6 e-tron ist ein Premium-SUV/Coupé-SUV, das in 9 Varianten erhältlich ist.
</p>
	<a href="q6_e-tron/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Audi Q8 e-tron ist ein Luxus-SUV/Coupé-SUV, das in 7 Varianten erhältlich ist.
</p>
	<a href="q8_e-tron/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
        </div>
    ...
    <div id="module-company" class="accordion-collapse collapse">
        <div class="accordion-body">
{{% insert "content/models/audi/company.de.md" %}}
</div>
</div>
</div>
</div>
