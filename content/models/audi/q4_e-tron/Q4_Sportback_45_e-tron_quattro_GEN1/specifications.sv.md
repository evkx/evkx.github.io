---
title: Audi Q4 Sportback 45 e-tron quattro (GEN1) Specifikationer
linktitle: "Specifikationer"
description: "EVKX.net ger dig alla specifikationer för Audi Q4 Sportback 45 e-tron quattro (GEN1)."
weight: 30
hidden: true
...
EVKX.net vill ha de mest kompletta specifikationerna för Audi Q4 Sportback 45 e-tron quattro (GEN1). Klicka på bilden ovan för [fullständig artikel](../), besök [bildgalleri](../gallery/) för hög upplösningsbilder av Audi Q4 Sportback 45 e-tron quattro (GEN1), gå till [chargeinfo](../chargecurve/) för Audi Q4 Sportback 45 e-tron quattro (GEN1) med laddningskurva, se [extended range info](../rangeandconsumption/) för verkliga räckvidd.
...
<table class="table table-striped border">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<i class="bi-check-lg" style="color: yellow;"></i> Ja (Parking system plus), valfritt
			</td>
		</tr>
		<tr>
			<td>
...
<table class="table table-striped border">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<i class="bi-check-lg" style="color: yellow;"></i> Ja (MMI Navigation plus), valfritt
			</td>
		</tr>
		<tr>
			<td>
