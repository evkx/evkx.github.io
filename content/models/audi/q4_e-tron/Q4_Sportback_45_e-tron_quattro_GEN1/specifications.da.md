...
description: "EVKX.net giver dig de fulde specifikationer for Audi Q4 Sportback 45 e-tron quattro (GEN1)."
weight: 4
hidden: true
...
EVKX.net søger at have de mest komplette specifikationer for Audi Q4 Sportback 45 e-tron quattro (GEN1). Klik på billedet ovenfor for [fuld artikel](../), besøg [billedgalleriet](../gallery/) for billeder i høj opløsning af Audi Q4 Sportback 45 e-tron quattro (GEN1), besøg [chargeinfo](../chargecurve/) for Audi Q4 Sportback 45 e-tron quattro (GEN1) med chargecurve, se [extended range info](../rangeandconsumption/) for real world ranges.
...
<table class="table table-striped border">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				Ja (Parking system plus), ekstraudstyr
			</td>
		</tr>
		<tr>
			<td>
...
<table class="table table-striped border">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				Ja (MMI Navigation plus), ekstraudstyr
			</td>
		</tr>
		<tr>
			<td>
