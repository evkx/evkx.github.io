...
I en teoretisk 1000 km utfordring, med fulladet batteri og en konstant hastighet på 120 km/t under ideelle forhold med et antatt forbruk på 20 kWh/100 km, ville turen ta omtrent 8 timer og 57 minutter. Denne reisen ville kreve to ladestopp fra 1% til 57%, med en total ladetid på 37 minutter.
...
Dynamisk styring er standard-funksjonen på Audi A6 Sportback e-tron performance. Dynamisk styring varierer styreforholdet som en funksjon av kjørehastigheten.
...
Audi A6 Sportback e-tron performance har et førerfokusert interiør som forbedrer cockpitfølelsen, med førsteklasses materialer i alle viktige områder. I tillegg inkluderer den en tradisjonell midtkonsoll som skiller fører og passasjer, og gir praktisk oppbevaring og funksjonalitet.
...
[**Bakre Kryss Trafikkadvarsel (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Tilvalg på Audi A6 Sportback e-tron performance, dette systemet bruker sensorer for å oppdage tilnærmende kjøretøy fra siden når du rygger ut av en parkeringsplass eller innkjørsel.

[**Foran Kollisjonsadvarsel (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Audi A6 Sportback e-tron performance, dette assistansesystemet hjelper sjåfører med å unngå eller redusere alvorlighetsgraden av frontkollisjoner.
...
[**Blindsonemonitorering (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard på Audi A6 Sportback e-tron performance, dette sideassistansesystemet hjelper til med å oppdage trafikk i blindsoner.

[**Uttrekksadvarsel**](../../../../technology/driverassistance/exitwarning/): Tilvalg på Audi A6 Sportback e-tron performance, dette systemet advarer passasjerene mot å åpne dørene hvis det er risiko for å treffe noe.
...
Lastkapasiteten i bagasjerommet er 514 liter. Med baksetet nede er det 1517 liter. På taket kan du laste opptil 75 kg. Takrails er ekstrautstyr på denne modellen. Takrails gjør det enkelt å montere takboks eller stativ på bilen. Under panseret er det frunk med mer lagringsplass. Denne frunk er på 27 liter.

Maksimumsvekten til bilen er 2750 kg, og med basisvekten på 2175 kg kan du maksimalt laste 575 kg, inkludert sjåfør og passasjerer. Noen utstyrsalternativer kan øke basisvekten vekt og reduser maksimal lastevekt.
