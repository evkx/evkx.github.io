...
With overboost, the Audi SQ8 Sportback e-tron reaches a maximum power of 370 kW (503 hp / 496 bhp). Without overboost, it delivers 320 kW (435 hp / 429 bhp). The maximum torque is 973 Nm (718 ft-lb). It can accelerate from 0 to 100 km/h (0 to 62 mph) in 4.5 seconds and reaches a top speed of 200 km/h (124 mph), demonstrating its solid performance.
...
Dynamic steering is a standard feature on the Audi SQ8 Sportback e-tron. Dynamic steering varies the steering ratio as a function of driving speed.
...
The Audi SQ8 Sportback e-tron has [**automatic emergency braking**](../../../../technology/driverassistance/automaticemergencybraking/) as a standard system. This system helps prevent or mitigate collisions by applying the brakes autonomously if the driver fails to react to an impending collision.
