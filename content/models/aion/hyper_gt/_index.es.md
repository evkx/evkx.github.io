...
<i class="bi bi-record2-fill"></i> RWD <i class="bi bi-battery-full"></i> 80,1 kWh <i class="bi bi-ev-station"></i> 270 kW 
		...
		<div class="col col-12 col-md-6">
			<ul class="list-group list-group-flush">
				...
				<li class="list-group-item list-group-item-action"><a href="hyper_gt_710_supercharged/reviews/" class="text-decoration-none text-black" ><i class="bi-person-video2"></i> Reseñas</a></li>
			</ul>
		</div>
	</div>
</div>
