---
title: Kia EV9 GT especificaciones
linktitle: "Especificaciones"
description: "EVKX.net le brinda las especificaciones completas para Kia EV9 GT."
weight: 4
hidden: true
...
EVKX.net busca tener las especificaciones más completas para Kia EV9 GT. Haga clic en la imagen de arriba para ver [artículo completo](../), visite la [galería de imágenes](../gallery/) para imágenes de alta resolución de Kia EV9 GT, visite [chargeinfo](../chargingcurve/) para Kia EV9 GT con chargecurve, visite [información de rango extendido](../rangeandconsumption/) para rangos del mundo real.
...
Este modelo está disponible con una configuración de seis asientos.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Flare Red (Rojo)</br>
				Ocean Blue Matte (Azul)</br>
				Ocean Blue Metallic (Azul)</br>
				Pebble Gray (Gris)</br>
				Ocean Blue Metallic (Azul)</br>
				Ice Green Metallic (Verde)</br>
				Aurora Black (Negro)</br>
				Snow White Pearl (Blanco)</br>
				Ivory Silver Gloss (Plata)</br>
				Panthera Metal (Gris oscuro)</br>
			</td>
		</tr>
	</tbody>
</table>
