---
title: Kia EV6 Long Range 2WD (GEN1) Specifikationer
linktitle: "Specifikationer"
description: "EVKX.net ger dig alla specifikationer för Kia EV6 Long Range 2WD (GEN1)."
weight: 4
hidden: true
...
EVKX.net vill ha de mest kompletta specifikationerna för Kia EV6 Long Range 2WD (GEN1). Klicka på bilden ovan för [fullständig artikel](../), besök [bildgalleri](../gallery/) för hög upplösningsbilder av Kia EV6 Long Range 2WD (GEN1), gå till [chargeinfo](../chargingcurve/) för Kia EV6 Long Range 2WD (GEN1) med laddningskurva, se [extended range info](../rangeandconsumption/) för verkliga räckvidd.
...
<table class="table table-striped border">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<i class="bi-check-lg" style="color: yellow;"></i> Ja (Surround View Monitor), valfritt
			</td>
		</tr>
		<tr>
			<td>
