...
description: "EVKX.net ger dig alla specifikationer för Kia EV6 Long Range AWD (GEN1)."
weight: 4
hidden: true
...
EVKX.net vill ha de mest kompletta specifikationerna för Kia EV6 Long Range AWD (GEN1). Klicka på bilden ovan för [fullständig artikel](../), besök [bildgalleri](../gallery/) för hög upplösningsbilder av Kia EV6 Long Range AWD (GEN1), gå till [chargeinfo](../chargingcurve/) för Kia EV6 Long Range AWD (GEN1) med laddningskurva, se [extended range info](../rangeandconsumption/) för verkliga räckvidd.
