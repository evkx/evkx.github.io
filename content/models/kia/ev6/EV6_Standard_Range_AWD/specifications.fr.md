---
title: Kia EV6 Standard Range AWD spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Kia EV6 Standard Range AWD."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Kia EV6 Standard Range AWD. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Kia EV6 Standard Range AWD, visitez les [chargeinfo](../chargecurve/) pour Kia EV6 Standard Range AWD avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
