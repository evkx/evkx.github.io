---
title: Kia EV6 GT (GEN1) spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Kia EV6 GT (GEN1)."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Kia EV6 GT (GEN1). Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Kia EV6 GT (GEN1), visitez les [chargeinfo](../chargingcurve/) pour Kia EV6 GT (GEN1) avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
...
<table class="table table-striped border">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				Oui (Surround View Monitor), équipement standard
			</td>
		</tr>
		<tr>
			<td>
