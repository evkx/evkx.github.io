---
title: Kia EV6 GT (GEN1) spesifikasjoner
linktitle: "Spesifikasjoner"
description: "EVKX.net gir deg alle spesifikasjonene for Kia EV6 GT (GEN1)."
weight: 4
hidden: true
...
EVKX.net søker å ha de mest komplette spesifikasjonene for Kia EV6 GT (GEN1). Klikk på bildet ovenfor for [full artikkel](../), besøk [bildegalleriet](../gallery/) for høyoppløselige bilder av Kia EV6 GT (GEN1), gå til [chargeinfo](../chargingcurve/) for Kia EV6 GT (GEN1) med ladekurve, se [extended range info](../rangeandconsumption/) for real world ranges.
...
<table class="table table-striped border">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				Ja (Surround View Monitor), standardutstyr
			</td>
		</tr>
		<tr>
			<td>
