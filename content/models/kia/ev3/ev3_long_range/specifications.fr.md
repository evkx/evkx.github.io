...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Gravity Blue (Bleu)</br>
				Interstellar Grey (Gris)</br>
				Yacht Blue (Bleu)</br>
				Runway Red (Rouge)</br>
				Aurora Black (Noir)</br>
				Steel Grey (Gris)</br>
				Intersteller Grey (Gris)</br>
				Glacier (Blanc)</br>
				Deep Forest (Vert)</br>
				Moonscape (Argent)</br>
