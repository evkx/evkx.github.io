...
description: "MG ZS EV Standard Range er en helelektrisk SUV med en WLTP rekkevidde på opptil 320 km. EVKX.net har alle detaljene."
weight: 10
hidden: true
shownavtabs: true
...
Vi har delt vår beskrivelse av MG ZS EV Standard Range i seksjoner. Hvis du vil vente med å lese hele artikkelen, klikker du på lenkene nedenfor til de forskjellige seksjonene. Vi har også en oversikt over [fullstendige spesifikasjoner](specifications/), [detaljer om rekkevidde](rangeandconsumption/),  et [bildegalleri](gallery/), detaljert informasjon om [ladeytelse](chargingcurve/), og noen [online anmeldelser](reviews/). Våre seksjoner:
...
Maksimal DC-ladehastighet er 94 kW. En full lading fra 0 - 100 % vil ta 82 minutter, mens et mer vanlig scenario på 10-80 % vil ta 31 minutter. Hvis du antar at du mister 5 minutters kjøring per ladestopp i tillegg til ladetiden, er det optimale ladeområdet fra 7% til 61%, noe som resulterer i en faktisk ladehastighet, inkludert tidstap, på 59kW. Hver ladeøkt vil ta 27 minutter og 2 sekunder.

I en teoretisk 1000 km utfordring, med fulladet batteri og en konstant hastighet på 120 km/t under ideelle forhold med et antatt forbruk på 24 kWh/100 km, ville turen ta omtrent 11 timer og 35 minutter. Denne reisen ville kreve to ladestopp fra 7% til 72%, med en total ladetid på 195 minutter.
...
MG ZS EV Standard Range inkluderer flere funksjoner for å forbedre komfort og bekvemmelighet:
...
Du kan velge mellom to lydsystemer på MG ZS EV Standard Range.

- Med MG standard system får du fire høyttalere med en maksimal systemeffekt på  watt.
- Med MG luxury sound system får du seks høyttalere med en maksimal systemeffekt på  watt.
...
MG ZS EV Standard Range inkluderer flere [avanserte førerassistanse systemer](../../../../technology/driverassistance/) (ADAS) som standard og som tilvalg for å forbedre sikkerhet og komfort.
...
[**Kjørefeltassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på MG ZS EV Standard Range, dette systemet hjelper til med å forhindre at kjøretøyet driver ut av kjørefeltet. Det inkluderer også et system for [**Advarsel om Utkjøring av Kjørebanen**](../../../../technology/driverassistance/lanedeparturewarning/) for å advare sjåføren hvis kjøretøyet kommer ut av kjørefeltet.

[**Frontkollisjonsvarsling (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på MG ZS EV Standard Range, dette assistansesystemet hjelper sjåfører med å unngå eller redusere alvorlighetsgraden av frontkollisjoner.

[**Blindsoneovervåkning (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Valgfri på MG ZS EV Standard Range, dette sideassistansesystemet hjelper til med å oppdage trafikk i blindsoner.
...
MG ZS EV Standard Range er utstyrt med essensielle sikkerhetsfunksjoner for å beskytte deg og kjøretøyet ditt, og tilbyr enkelhet og pålitelighet. Disse inkluderer:

{{<evkxdisplayaddarticle />}}

## Lastekapasitet og slepeevne

Bagasjerommet tilbyr en lastekapasitet på 448 liter. Med baksetene nedfelt, utvides dette til 1166 liter. På taket kan du laste opptil 75 kg. I tillegg er det en frunk (frontbagasjerom) med en lagringskapasitet på 150 liter.

Kjøretøyets maksimale vekt er 2070 kg, med en basisvekt på 1620 kg. Dette gir en maksimal lastekapasitet på 450 kg, inkludert fører og passasjerer. Merk at noen alternativer kan øke basisvekten og redusere maksimal lastekapasitet. 450 kg anses som lavt for denne typen bil og kan begrense hvor mye ekstra du kan laste inn i tillegg til passasjerene.
...
MG ZS EV Standard Range hadde sin verdenspremiere den 07.10.2021, med leveranser som startet i January 2022.
