...
description: "MG ZS EV Standard Range ist ein vollelektrisches SUV mit einer Reichweite von bis zu 320 km (199 Meilen). EVKX.net hat alle Details."
weight: 10
hidden: true
shownavtabs: true
...
Der MG ZS EV Standard Range bietet eine bescheidene Leistung mit einer maximalen Leistung von 115 kW (156 PS / 154 bhp) und einem Gesamtdrehmoment von 280 Nm (207 lb-ft). Er beschleunigt in 8,6 Sekunden von 0 auf 100 km/h (0 auf 62 mph) und erreicht eine Höchstgeschwindigkeit von 175 km/h (109 mph), was ihn eher mit herkömmlichen Verbrennungsmotorfahrzeugen vergleichbar macht.

## Batterie, Reichweite und Laden

Die Hochkapazitätsbatterie hat eine Bruttokapazität von 51,1 kWh und eine nutzbare Nettokapazität von 49,0 kWh, was einen Puffer von 2,1 kWh (4,1%) zum Schutz der Batterie bietet.

Nach dem [WLTP](../../../../guides/understandingrange/wltp/) (Worldwide Harmonized Light Vehicles Test Procedure) Standard beträgt die Reichweite des Fahrzeugs 320 km (199 Meilen) mit einem Energieverbrauch von 15,3 kWh/100 km (3 mi/kWh). Für weitere Details zur Reichweite siehe reale Daten und Reichweitenliste auf der [Reichweite und Verbrauch](rangeandconsumption/) Seite dieses Modells.

Das Fahrzeug unterstützt schnelles DC-Laden mit einer maximalen Leistung von 94 kW. Das Laden von 0% auf 100% dauert etwa 82 Minuten, während ein typischer Ladevorgang von 10% auf 80% 31 Minuten dauert, mit einer durchschnittlichen Ladegeschwindigkeit von 67 kW. Unter Berücksichtigung von zusätzlichen 5 Minuten für jeden Ladestopp aufgrund von Fahrunterbrechungen liegt der optimale Ladebereich zwischen 7% und 61%. Dies führt zu einer effektiven Ladegeschwindigkeit, einschließlich der verlorenen Zeit, von 59 kW, wobei jede Ladesitzung etwa 27 Minuten und 2 Sekunden dauert.

In einer theoretischen 1000 km Herausforderung, beginnend mit einer vollen Batterie und einer konstanten Geschwindigkeit von 120 km/h (75 mph) unter idealen Bedingungen mit einem angenommenen Verbrauch von 24 kWh/100 km, würde die Fahrt etwa 11 Stunden und 35 Minuten dauern. Diese Reise würde sechs Ladestopps von 7% auf 72% erfordern, mit einer gesamten Ladezeit von 195 Minuten.
...
Der MG ZS EV Standard Range hat ein Heckantriebssystem, das von einem Motor an der Hinterachse unterstützt wird.
...
Der MG ZS EV Standard Range ist mit [Gusseisenscheibenbremsen](../../../../technology/brakes/#disc-brakes) sowohl vorne als auch hinten ausgestattet.
...
Der MG ZS EV Standard Range, mit Abmessungen von 4323 mm Länge, 1809 mm Breite und 1649 mm Höhe, fällt in die B-SUV-Segment-Autos, auch als subkompakte SUVs oder Crossover bekannt, bieten eine Kombination aus der kompakten Größe und Manövrierfähigkeit von B-Segment-Autos mit der höheren Sitzposition, dem erhöhten Laderaum und dem robusten Styling eines SUVs. Der MG ZS EV Standard Range ist in insgesamt 5 Lackfarben erhältlich, darunter mehrere auffällige Metallic-Optionen.

Sie können aus mehreren Raddesigns wählen, die alle in derselben Größe für den MG ZS EV Standard Range erhältlich sind, sodass Sie Ihr Fahrzeug an Ihren Stil und Ihre Fahrpräferenzen anpassen können. Die verfügbaren Reifen- und Radkombinationen umfassen:
...
Der MG ZS EV Standard Range bietet Platz für fünf Passagiere mit zwei Vordersitzen und einer Dreiersitzbank hinten.

#### Vordersitze

Der MG ZS EV Standard Range bietet nur einen Typ von Vordersitz.
...
Der MG ZS EV Standard Range umfasst mehrere Funktionen, um Komfort und Bequemlichkeit zu verbessern:
...
Der MG ZS EV Standard Range ist mit einem einzigen Lenkradtyp ausgestattet:
...
Der MG ZS EV Standard Range unterstützt Android Auto und Apple CarPlay, sodass Sie den Bildschirm Ihres Telefons auf dem Display des Autos spiegeln können. Diese Funktion ermöglicht es Ihnen, Apps wie Google Maps oder Waze direkt von Ihrem Telefon aus zu nutzen.

### Soundsystem

Sie können zwischen zwei Soundsystemen für den MG ZS EV Standard Range wählen:

- **MG standard system:** Verfügt über vier Lautsprecher und liefert eine maximale Ausgangsleistung von  Watt.
- **MG luxury sound system:** Verfügt über sechs Lautsprecher und liefert eine maximale Ausgangsleistung von  Watt.
...
Der MG ZS EV Standard Range verfügt über eine Reihe von standardmäßigen und optionalen [fortschrittlichen Fahrerassistenzsystemen](../../../../technology/driverassistance/) (ADAS), die die Sicherheit und den Komfort verbessern sollen.

### Sicherheitssysteme

[**Elektronische Stabilitätskontrolle (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard im MG ZS EV Standard Range, dieses System verbessert die Stabilität und das Handling des Fahrzeugs bei plötzlichen Manövern oder auf rutschigen Straßenbedingungen.

[**Spurhalteassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard im MG ZS EV Standard Range, dieses System hilft, das Fahrzeug in seiner Spur zu halten. Es umfasst auch ein [**Spurverlassenswarnsystem**](../../../../technology/driverassistance/lanedeparturewarning/), das den Fahrer warnt, wenn das Fahrzeug die Spur verlässt.

[**Vorwärtskollisionswarnung (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard im MG ZS EV Standard Range, dieses Fahrerassistenzsystem hilft Fahrern, Frontalzusammenstöße zu vermeiden oder zu mildern.

[**Totwinkelüberwachung (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/): Optional im MG ZS EV Standard Range, dieses Seitenassistenzsystem hilft, den Verkehr im toten Winkel zu erkennen.
...
Der MG ZS EV Standard Range ist mit wesentlichen Sicherheitsfunktionen ausgestattet, um Sie und Ihr Fahrzeug zu schützen und Einfachheit und Zuverlässigkeit zu bieten. Diese umfassen:

{{<evkxdisplayaddarticle />}}

## Ladekapazität und Anhängelast

Der Kofferraum bietet ein Ladevolumen von 448 Litern (15,8 CU FT). Mit umgeklappter Rücksitzbank erweitert sich dies auf 1166 Liter (41,2 CU FT). Auf dem Dach können Sie bis zu 75 kg (165,3 lbs) laden. Zusätzlich gibt es einen Frunk (vorderer Kofferraum) mit einem Ladevolumen von 150 Litern (5,3 CU FT).

Das maximale Gewicht des Fahrzeugs beträgt 2070 kg (4564 lbs) bei einem Leergewicht von 1620 kg (3571 lbs). Dies ermöglicht eine maximale Zuladung von 450 kg (992 lbs), einschließlich Fahrer und Passagieren. Beachten Sie, dass einige Optionen das Leergewicht erhöhen und die maximale Zuladung verringern können. 450 kg wird für diesen Fahrzeugtyp als niedrig angesehen und könnte einschränken, wie viel zusätzlich zu den Passagieren mitgenommen werden kann.
...
Der MG ZS EV Standard Range feierte seine Weltpremiere am 07.10.2021, mit Lieferungen ab January 2022.
{{< pagenavigation b_url="../" b_title="MG ZS" f_url="rangeandconsumption/" f_title="Reichweite" >}}
