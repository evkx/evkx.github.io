---
title: MG ZS EV Long Range specifikationer
linktitle: "Specifikationer"
description: "EVKX.net giver dig de fulde specifikationer for MG ZS EV Long Range."
weight: 4
hidden: true
...
EVKX.net søger at have de mest komplette specifikationer for MG ZS EV Long Range. Klik på billedet ovenfor for [fuld artikel](../), besøg [billedgalleriet](../gallery/) for billeder i høj opløsning af MG ZS EV Long Range, besøg [chargeinfo](../chargingcurve/) for MG ZS EV Long Range med chargecurve, se [extended range info](../rangeandconsumption/) for real world ranges.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Dover White (Hvid)</br>
				Pebble Black (Sort)</br>
				Como Blue (Blå)</br>
				Cosmic Silver (Sølv)</br>
				Diamond Red (Rød)</br>
			</td>
		</tr>
	</tbody>
