---
title: MG MG4 Electric Extended Range spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de MG MG4 Electric Extended Range."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour MG MG4 Electric Extended Range. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de MG MG4 Electric Extended Range, visitez les [chargeinfo](../chargingcurve/) pour MG MG4 Electric Extended Range avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Metallic Silver (Argent)</br>
				Brighton Blue (Bleu)</br>
				Fizzy Orange</br>
				Andes Grey (Gris)</br>
			</td>
		</tr>
