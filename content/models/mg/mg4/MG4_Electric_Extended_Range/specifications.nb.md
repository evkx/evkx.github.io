...
EVKX.net søker å ha de mest komplette spesifikasjonene for MG MG4 Electric Extended Range. Klikk på bildet ovenfor for [full artikkel](../), besøk [bildegalleriet](../gallery/) for høyoppløselige bilder av MG MG4 Electric Extended Range, gå til [chargeinfo](../chargingcurve/) for MG MG4 Electric Extended Range med ladekurve, se [extended range info](../rangeandconsumption/) for real world ranges.
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Diamond Red (Rød)</br>
				Metallic Silver (Sølv)</br>
				Brighton Blue (Blå)</br>
				Fizzy Orange (Oransje)</br>
				Andes Grey (Grå)</br>
			</td>
		</tr>
	</tbody>
