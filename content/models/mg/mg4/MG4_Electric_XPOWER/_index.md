...
MG MG4 Electric XPOWER features an all-wheel drive system powered by two motors, one on each axle.
...
You can select from multiple wheel designs, all available in the same size, on the MG MG4 Electric XPOWER, allowing you to personalize your vehicle to match your style and driving preferences. The available tire and wheel combinations include:
...
The MG MG4 Electric XPOWER has several standard and optional [advanced driver assistance systems](../../../../technology/driverassistance/) (ADAS) to enhance safety and comfort.
