...
Det højkapacitetsbatteri har en bruttokapacitet på 51,0 kWh og en nettoanvendelig kapacitet på 50,8 kWh, hvilket giver en buffer på 0,2 kWh (3%) til batteribeskyttelse. Lithium-Ion-batteriet bruger [LFP-teknologi.](../../../../technology/battery/cellchemistry/#lithium-iron-phosphate-battery-lfp) Dette har nogle fordele og ulemper fra de typiske NCA/NCM-batterier.
...
Den maksimale DC-opladningshastighed er 135kW. En fuld opladning fra 0 - 100 % ville tage 83 minutter, mens et mere almindeligt scenarie på 10-80 % ville tage 36 minutter. Hvis du antager, at du mister 5 minutters kørsel pr. ladestop ud over opladningstiden, er det optimale opladningsområde fra 3% til 60%, hvilket resulterer i en faktisk opladningshastighed, inklusive tidstab på 59kW. Hver opladningssession ville tage 29 minutter og 18 sekunder.

I en teoretisk 1000 km udfordring, der starter med et fuldt batteri og opretholder en konstant hastighed på 120 km/t under ideelle forhold med et antaget forbrug på 21 kWh/100 km, ville turen tage cirka 11 timer og 3 minutter. Denne rejse ville kræve to opladningsstop fra 3% til 56%, med en samlet opladningstid på 164 minutter
...
MG MG4 Electric Standard har plads til fem passagerer med to sæder foran og en tre-personers bænk bagtil.

#### Første række sæder

MG MG4 Electric Standard tilbyder kun én type forreste sæde.
...
MG MG4 Electric Standard inkluderer flere funktioner, der forbedrer komfort og bekvemmelighed:
...
MG MG4 Electric Standard er udstyret med en enkelt type rat:
...
Yderligere understøtter MG MG4 Electric Standard Android Auto og Apple CarPlay. Denne funktionalitet giver dig mulighed for at præsentere din telefons skærm på bilens skærm, så du kan køre apps som Google Maps eller Waze.

### Lydsystem

Én type lydsystem er tilgængelig for MG MG4 Electric Standard.
...
Den MG MG4 Electric Standard inkluderer flere standard- og valgfri [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) for at forbedre sikkerhed og komfort.
...
MG MG4 Electric Standard er udstyret med essentielle sikkerhedsfunktioner for at beskytte dig og dit køretøj og tilbyder enkelhed og pålidelighed. Disse inkluderer:
