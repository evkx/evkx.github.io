...
description: "MG MG4 Electric Long Range er en elektrisk crossover med en WLTP rækkevidde på op til 435 km (270 miles). EVKX.net har alle detaljerne."
weight: 10
hidden: true
shownavtabs: true
...
MG MG4 Electric Long Range tilbyder beskeden ydeevne med en maksimal effekt på 150 kW (204 hk / 201 bhp) og et samlet drejningsmoment på 250 Nm (184 lb-ft). Den accelererer fra 0 til 100 km/t (0 til 62 mph) på 7,9 sekunder og har en tophastighed på 160 km/t (99 mph), hvilket ligger tættere på traditionelle forbrændingsmotorer.

<a id="section-battery" style="display: block; position: relative; top: -60px; visibility: hidden;"></a>

## Batteri, Rækkevidde og Opladning

Det højkapacitets batteri har en brutto kapacitet på 64,0 kWh og en netto kapacitet på 61,7 kWh, hvilket giver en 2,3 kWh buffer (3,6%) til batteribeskyttelse. Dette lithium-ion batteri bruger [NMC (Nikkel Mangan Kobolt) teknologi](../../../../technology/battery/cellchemistry/#lithium-nickel-manganese-cobalt-oxides-nmc).

Ifølge [WLTP](../../../../guides/understandingrange/wltp/) (Worldwide Harmonized Light Vehicles Test Procedure) standarden er køretøjets rækkevidde 435 km (270 miles), med et energiforbrug på 14,2 kWh/100 km (3 mi/kWh). For flere detaljer om rækkevidden, se data fra den virkelige verden og rækkeviddelister på denne models [rækkevidde og forbrug](rangeandconsumption/) side.

Køretøjet understøtter hurtig DC-opladning med en maksimal effekt på 135 kW. Opladning fra 0% til 100% tager cirka 85 minutter, mens et mere typisk scenario fra 10% til 80% tager 27 minutter med en gennemsnitlig ladehastighed på 94 kW. Når der medregnes yderligere 5 minutter for hvert opladningsstop på grund af køreafbrydelser, er det optimale opladningsområde fra 3% til 58%. Dette resulterer i en effektiv ladehastighed, inklusive tabt tid, på 94 kW, hvor hver opladningssession tager cirka 22 minutter og 33 sekunder.

I en 1000 km udfordring ved konstant hastighed på 120 km/t med et antaget forbrug på 21 kWh/100 km, ville turen tage cirka 9 timer og 57 minutter, med fire opladningsstop fra 2% til 63%, i alt 97 minutters opladningstid.

### Indbygget oplader

Den standard indbyggede oplader understøtter op til 11 kW for Level 1 og Level 2 AC-opladning, hvilket muliggør en fuld opladning fra 0 til 100% på cirka 5 timer og 36 minutter ved brug af en hjemmeinstallation.
...
MG MG4 Electric Long Range har et baghjulstræksystem understøttet af én motor på bagakslen.
...
MG MG4 Electric Long Range er udstyret med [støbejerns-skivebremser](../../../../technology/brakes/#disc-brakes) både for og bag.
...
MG MG4 Electric Long Range, med dimensioner på 4287 mm i længde, 1836 mm i bredde og 1516 mm i højde, tilhører B-SUV segmentet, også kendt som kompakte SUV'er eller crossovers, der kombinerer B-segment bilers kompakte størrelse og manøvredygtighed med en højere køreposition, øget bagagerumsplads og robust styling fra en SUV. MG MG4 Electric Long Range fås i alt i 7 lakfarver, inklusive flere iøjnefaldende metalliske muligheder.

MG MG4 Electric Long Range tilbyder flere hjulmuligheder i forskellige størrelser, så du kan tilpasse din bil efter din stil og kørepræferencer. De tilgængelige dæk- og hjulkombinationer inkluderer:
...
MG MG4 Electric Long Range har plads til fem passagerer med to forsæder og en trebænk bagtil.

#### Forsæder

MG MG4 Electric Long Range tilbyder én type forsæde.
...
MG MG4 Electric Long Range inkluderer flere funktioner for at forbedre komfort og bekvemmelighed:
...
MG MG4 Electric Long Range er udstyret med én type rat:
...
MG MG4 Electric Long Range understøtter Android Auto og Apple CarPlay, så du kan spejle din telefons skærm på bilens display. Denne funktionalitet gør det muligt at køre apps som Google Maps eller Waze direkte fra din telefon.

### Lydsystem

MG MG4 Electric Long Range kommer med ét lydsystem:
...
MG MG4 Electric Long Range har en række standard og valgfrie [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) designet til at forbedre sikkerhed og komfort.
...
MG MG4 Electric Long Range er udstyret med grundlæggende sikkerhedsfunktioner for at beskytte dig og dit køretøj, og tilbyder enkelhed og pålidelighed. Disse omfatter:
...
Bagagerummet har en lastkapacitet på 363 liter (12,8 CU FT). Med bagsædet lagt ned udvides dette til 1165 liter (41,1 CU FT).

Køretøjets maksimale vægt er 2133 kg (4702 lbs), med en egenvægt på 1715 kg (3781 lbs). Dette giver en maksimal last på 418 kg (922 lbs), inklusive fører og passagerer. Bemærk at nogle tilvalg kan øge egenvægten og reducere den maksimale lasteevne.
...
MG MG4 Electric Long Range havde sin verdenspremiere den 13.06.2022, og leveringerne startede i September 2022.
