...
description: "MG MG4 Electric Long Range är en helelektrisk crossover med en WLTP räckvidd på upp till 435 km. EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Vi har delat in vår beskrivning av MG MG4 Electric Long Range i avsnitt. Om du vill vänta med att läsa hela artikeln, klicka på länkarna nedan till de olika avsnitten. Vi har även en översikt över [fullständiga specifikationer](specifications/), [räckvidde och förbrukning](rangeandconsumption/), ett [bildgalleri](gallery/), detaljerad information om [laddningsprestanda](chargingcurve/) och några [recensioner](reviews/). Våra avsnitt:
...
MG MG4 Electric Long Range erbjuder blygsamma prestanda med en maximal effekt på 150 kW (204 hk) och ett totalt vridmoment på 250 Nm. Den accelererar från 0 till 100 km/h på 7,9 sekunder och har en topphastighet på 160 km/h, vilket är mer i linje med traditionella förbränningsmotorfordon.
...
MG MG4 Electric Long Range har ett bakhjulsdriftssystem som stöds av en motor på bakaxeln.
...
MG MG4 Electric Long Range, med dimensioner på 4287 mm i längd, 1836 mm i bredd och 1516 mm i höjd, tillhör B-SUV-segmentet av bilar, även kallat subkompakta SUV:ar eller crossovers. De erbjuder en kombination av kompakt storlek och smidighet från B-segmentbilar med högre körposition, ökat lastutrymme och robust utformning från en SUV. MG MG4 Electric Long Range finns i totalt 7 lackfärger, inklusive flera iögonfallande metalliska alternativ.

Du kan välja mellan flera hjuldesigner, alla tillgängliga i samma storlek, på MG MG4 Electric Long Range, vilket gör att du kan anpassa din bil efter din stil och dina körpreferenser.
...
Endast en typ av framsäte är tillgänglig i MG MG4 Electric Long Range.
...
MG MG4 Electric Long Range har flera funktioner för att göra ditt liv som förare eller passagerare bekvämare.
...
En typ av ljudsystem är tillgänglig för MG MG4 Electric Long Range. Med  får du NULL högtalare med en maximal systemeffekt på  watt.

Dessutom, med standard navigationssystemet i bilen får du den hjälp du behöver för att hitta din destination. Dessutom stöder MG MG4 Electric Long Range Android Auto och Apple CarPlay. Denna funktion gör att du kan visa telefonens skärm på bilens skärm så att du kan köra appar som Google Maps eller Waze.
...
MG MG4 Electric Long Range har flera standard- och valfria [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) för bättre säkerhet och komfort.
### Säkerhetssystem



MG MG4 Electric Long Range har en [**filhållningsassistent**](../../../../technology/driverassistance/lanekeepingassist/) som standard-system. Detta system bidrar för att förhindra att bilen lämnar körfältet. Dessutom har den ett [**filavvikelsevarning**](../../../../technology/driverassistance/lanedeparturewarning/) system som varnar föraren om fordonet lämnar körfältet.
...
Lastkapaciteten i bagageutrymmet är 363 liter. Med baksätet nedfällt är det 1165 liter. Bilens maximala vikt är 2133 kg, och med basvikten på 1715 kg kan du lasta maximalt 418 kg, inklusive förare och passagerare. Vissa utrustningsalternativ kan öka basvikten och minska den maximala lastvikten.
