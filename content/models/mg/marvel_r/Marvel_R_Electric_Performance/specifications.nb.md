---
title: MG Marvel R Electric Performance spesifikasjoner
linktitle: "Spesifikasjoner"
description: "EVKX.net gir deg alle spesifikasjonene for MG Marvel R Electric Performance."
weight: 4
hidden: true
...
EVKX.net søker å ha de mest komplette spesifikasjonene for MG Marvel R Electric Performance. Klikk på bildet ovenfor for [full artikkel](../), besøk [bildegalleriet](../gallery/) for høyoppløselige bilder av MG Marvel R Electric Performance, gå til [chargeinfo](../chargingcurve/) for MG Marvel R Electric Performance med ladekurve, se [extended range info](../rangeandconsumption/) for real world ranges.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Cumulus White (Hvit)</br>
				Pebble Black (Svart)</br>
				Prism Blue (Blå)</br>
				Beton Grey (Grå)</br>
				Night Watch Grey (Grå)</br>
			</td>
		</tr>
	</tbody>
</table>
