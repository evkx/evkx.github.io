...
La MG Cyberster AWD Long Range impressionne avec une puissance maximale de 400 kW (544 ch) et un couple total impressionnant de 725 Nm. Cette machine haute performance peut sprinter de 0 à 100 km/h en seulement 3,2 secondes, et atteint une vitesse maximale de 200 km/h, ce qui en fait un modèle remarquable dans sa catégorie.
...
La [plage CLTC](../../../../guides/understandingrange/cltc/) est de 520 km (323 miles). La consommation est de 14,3kWh/100km pour le test standard CLTC. Pour des données réelles plus détaillées et des informations sur l'autonomie, veuillez consulter la page dédiée à [l'autonomie et à la consommation de ce modèle.](autonomie et consommation/)

La vitesse de charge DC maximale est de 135kW. Une charge complète de 0 à 100 % prendrait 101 minutes, tandis qu'un scénario plus courant de 10 à 80 % prendrait 34 minutes. Si vous supposez que vous perdez 5 minutes de conduite par arrêt de charge en plus du temps de charge, la zone de charge optimale est comprise entre 3 % et 50 %, ce qui correspond à une vitesse de charge réelle, y compris la perte de temps, de 91kW. Chaque session de charge prendrait 23 minutes et 10 secondes.

Dans un défi théorique de 1000 km, en commençant avec une batterie pleine et en maintenant une vitesse constante de 120 km/h dans des conditions idéales avec une consommation supposée de 21 kWh/100 km, le voyage prendrait environ 9 heures et 50 minutes. Ce trajet nécessiterait deux arrêts de recharge de 4% à 50%, avec un temps de recharge total de 91 minutes.
...
De plus, le MG Cyberster AWD Long Range prend en charge Android Auto et Apple CarPlay. Cette fonctionnalité vous permet d'afficher l'écran de votre téléphone sur l'écran de la voiture afin que vous puissiez exécuter des applications comme Google Maps ou Waze.

### Système audio

Un type de système audio est disponible pour le MG Cyberster AWD Long Range.

- Avec le Bose Sound System, vous obtenez six haut-parleurs avec une puissance système maximale de 300 watts.
...
Le MG Cyberster AWD Long Range comprend plusieurs [systèmes avancés d'assistance au conducteur](../../../../technology/driverassistance/) (ADAS) de série et en option pour améliorer la sécurité et le confort.

### Systèmes de Sécurité

[**Assistance au Maintien de Voie (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard sur le MG Cyberster AWD Long Range, ce système aide à prévenir le déplacement du véhicule hors de sa voie. Il comprend également un système de [**Alerte de Sortie de Voie**](../../../../technology/driverassistance/lanedeparturewarning/) pour alerter le conducteur si le véhicule quitte sa voie.
...
Le coffre offre une capacité de chargement de 240 litres.

Le poids maximum du véhicule est de 2250 kg, avec un poids de base de 1985 kg. Cela permet une charge maximale de 265 kg, y compris le conducteur et les passagers. Notez que certaines options peuvent augmenter le poids de base et réduire la capacité maximale de chargement.
...
Ce modèle a été présenté en première mondiale le 13.07.2023 et les livraisons ont commencé en December 2023.
{{< pagenavigation b_url="../" b_title="MG Cyberster" f_url="rangeandconsumption/" f_title="Plage" >}}
