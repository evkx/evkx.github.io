...
description: "MG Cyberster AWD Long Range es un convertible eléctrico con una autonomía CLTC de hasta 520 km (323 millas). EVKX.net tiene todos los detalles."
weight: 10
hidden: true
shownavtabs: true
...
El MG Cyberster AWD Long Range ofrece una impresionante potencia máxima de 400 kW (544 hp / 536 bhp) y un par total de 725 Nm (535 lb-ft). Este vehículo de alto rendimiento puede acelerar de 0 a 100 km/h (0 a 62 mph) en solo 3,2 segundos y alcanza una velocidad máxima de 200 km/h (124 mph), destacándose en su clase.
...
La autonomía del vehículo, según el estándar [CLTC](../../../../guides/understandingrange/cltc/) (Ciclo de Prueba de Vehículos Ligeros de China), es de 520 km (323 millas). El consumo de energía es de 14,3 kWh/100 km según la prueba estándar CLTC. Para más detalles sobre la autonomía, consulte los datos del mundo real y las listas de autonomía en la página de [autonomía y consumo](rangeandconsumption/) de este modelo.

El vehículo admite carga rápida DC con una potencia máxima de 135 kW. Cargar del 0% al 100% toma aproximadamente 100 minutos, mientras que un escenario más típico del 10% al 80% toma 34 minutos con una velocidad de carga promedio de 92 kW. Considerando 5 minutos adicionales para cada parada de carga debido a interrupciones de conducción, el rango de carga óptimo es del 2% al 49%. Esto resulta en una velocidad de carga efectiva, incluyendo el tiempo perdido, de 93 kW, con cada sesión de carga tomando aproximadamente 23 minutos y 33 segundos.

En un desafío de 1000 km a una velocidad constante de 120 km/h (75 mph) con una tasa de consumo asumida de 21 kWh/100 km, el viaje tomaría aproximadamente 9 horas y 48 minutos, requiriendo cuatro paradas de carga del 2% al 48%, totalizando 88 minutos de tiempo de carga.
...
El MG Cyberster AWD Long Range cuenta con un sistema de tracción en las cuatro ruedas impulsado por dos motores, uno en cada eje.

### Suspensión

La suspensión delantera emplea un diseño de [doble horquilla](../../../../technology/suspension/#double-wishbone), mientras que la trasera utiliza una configuración [Multilink](../../../../technology/suspension/#multilink). La suspensión estándar incluye resortes de acero y amortiguadores hidráulicos. La suspensión del  tiene una altura y amortiguación fijas. La distancia al suelo con esta suspensión es de 120 mm.

### Frenos

El MG Cyberster AWD Long Range está equipado con [frenos de disco de hierro fundido](../../../../technology/brakes/#disc-brakes) tanto en la parte delantera como en la trasera.
...
El MG Cyberster AWD Long Range está disponible en un total de 7 colores de pintura, incluidos varios llamativos colores metálicos.

Puede seleccionar entre varios diseños de ruedas, todos disponibles en el mismo tamaño, en el MG Cyberster AWD Long Range, lo que le permite personalizar su vehículo para que coincida con su estilo y preferencias de conducción. Las combinaciones de neumáticos y ruedas disponibles incluyen:

- 245/45 neumáticos en llantas de 19" delanteras y 275/40 neumáticos en llantas de 19" traseras

El coche tiene dos [puertas de tijera](../../../../technology/doors/) y un [portón trasero](../../../../technology/doors/#bootlid) en la parte trasera. Las puertas laterales tienen una función de apertura eléctrica una característica estándar.

Solo hay una opción de techo para este modelo. El techo estándar es un techo blando que se puede plegar.
...
El MG Cyberster AWD Long Range ofrece un solo tipo de asiento delantero.
...
- Red [tapicería de Alcantara/cuero sintético](../../../../technology/seats/materials/#alcantara)
...
- La pantalla  detrás del volante en el centro del marco compartido mide 10,0 pulgadas.
- La pantalla touch en la parte derecha del marco compartido mide 8,0 pulgadas.
- La pantalla touch en el medio de la consola central mide 7,0 pulgadas.
...
El MG Cyberster AWD Long Range es compatible con Android Auto y Apple CarPlay, lo que le permite reflejar la pantalla de su teléfono en la pantalla del coche. Esta funcionalidad le permite ejecutar aplicaciones como Google Maps o Waze directamente desde su teléfono.

### Sistema de Sonido

El MG Cyberster AWD Long Range viene equipado con una opción de sistema de sonido:

- **Bose Sound System:** Cuenta con seis altavoces y ofrece una potencia máxima de 300 vatios.
...
El MG Cyberster AWD Long Range cuenta con una gama de sistemas [avanzados de asistencia al conductor](../../../../technology/driverassistance/) (ADAS) estándar y opcionales diseñados para mejorar la seguridad y la comodidad.

### Sistemas de Seguridad

[**Asistencia de Mantenimiento de Carril (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Estándar en el MG Cyberster AWD Long Range, este sistema ayuda a evitar que el vehículo se desvíe de su carril. También incluye un sistema de [**Advertencia de Salida de Carril**](../../../../technology/driverassistance/lanedeparturewarning/) para alertar al conductor si el vehículo se desvía del carril.
...
El MG Cyberster AWD Long Range está equipado con características de seguridad esenciales para protegerlo a usted y a su vehículo, ofreciendo simplicidad y fiabilidad. Estas incluyen:

{{<evkxdisplayaddarticle />}}

## Capacidad de Carga y Remolque

El maletero ofrece una capacidad de carga de 240 litros (8,5 pies cúbicos).

El peso máximo del vehículo es de 2250 kg (4960 libras), con un peso base de 1985 kg (4376 libras). Esto permite una carga máxima de 265 kg (584 libras), incluyendo el conductor y los pasajeros. Tenga en cuenta que algunas opciones pueden aumentar el peso base y reducir la capacidad máxima de carga.
...
El MG Cyberster AWD Long Range tuvo su estreno mundial el 13.07.2023, con entregas comenzando en December 2023.
{{< pagenavigation b_url="../" b_title="MG Cyberster" f_url="rangeandconsumption/" f_title="Autonomía" >}}
