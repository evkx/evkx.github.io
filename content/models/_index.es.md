...
Haga clic en los logotipos a continuación para ir directamente a la página de la marca, o desplácese hacia abajo para leer la introducción de cada marca.
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Acura</h2>
	<p>
		Acura es la división de lujo y rendimiento del fabricante de automóviles japonés Honda, con sede principalmente en América del Norte. La marca se lanzó en 1986, comercializando automóviles de lujo y rendimiento. Acura vende coches en Estados Unidos, Canadá, México, Panamá y Kuwait.
	</p>
	<p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Alpine</h2>
	<p>
		Alpine es una marca francesa de coches deportivos, fundada en 1955 por Jean Rédélé, inicialmente especializada en coches deportivos ligeros y ágiles. Conocida por su asociación con Renault, Alpine ganó fama en las décadas de 1960 y 1970 con su A110 Berlinette ganadora de rallies, celebrada por su manejo ágil y éxito en el automovilismo, especialmente en eventos como el Rally de Monte Carlo.
	</p>
	<p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Audi</h2>
	<p>
		Audi es un fabricante de automóviles alemán que forma parte del Grupo Volkswagen. Es conocida por sus vehículos premium y deportivos, así como por su lema 'Vorsprung durch Technik', que significa 'Progreso a través de la tecnología'.
	</p>
	<p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>BYD</h2>
	<p>
		BYD (Build Your Dreams) es un gigante automotriz y tecnológico chino fundado en 1995 en Shenzhen. Inicialmente líder en baterías recargables, BYD ingresó al mercado automotriz en 2003, convirtiéndose rápidamente en un pionero global en vehículos eléctricos (EVs). Conocido por innovaciones como la Blade Battery y su avanzada e-Platform 3.0, BYD combina eficiencia, seguridad y asequibilidad. Con una creciente presencia global que abarca China, Europa, el sudeste asiático y América Latina, BYD produce vehículos eléctricos, autobuses y soluciones energéticas, impulsando el cambio hacia la movilidad sostenible. Los modelos clave incluyen el BYD Dolphin, Seal y las ofertas de lujo bajo Yangwang.
	</p>
	<p>
	BYD tiene 8 modelos con un total de 13 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Cadillac</h2>
	<p>
		Cadillac, un pionero en autos de lujo americanos desde 1902, combina herencia con innovación. Como la marca premium de General Motors, Cadillac ahora está impulsando un audaz cambio hacia la electrificación. Con un compromiso con una línea totalmente eléctrica para 2030, la marca se enfoca en tecnología avanzada, sostenibilidad y mantener su atractivo de lujo característico.
	</p>
	<p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<p>
	Kia tiene 4 modelos con un total de 15 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	<h2>Maserati</h2>
	<p>
	Maserati tiene 3 modelos con un total de 3 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	<h2>MHERO</h2>
	<p>
		La marca MHERO es una línea de vehículos todoterreno eléctricos de lujo lanzada por Dongfeng Motor Corporation de China a través de su subsidiaria Mengshi. Dirigida a los mercados de vehículos eléctricos de alta gama, MHERO, introducida en Europa en 2023, muestra una ingeniería avanzada adaptada para terrenos difíciles y movilidad sostenible.
	</p>
	<p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	<h2>OMODA</h2>
	<p>
		Omoda es una marca de automóviles relativamente nueva que surgió de Chery, uno de los mayores fabricantes de automóviles de China. Lanzada oficialmente en 2022, Omoda representa el intento de Chery de atender a los consumidores jóvenes y conocedores de la tecnología, con un enfoque en el diseño vanguardista, la tecnología avanzada y la sostenibilidad. La marca enfatiza las opciones de vehículos eléctricos e híbridos, alineándose con las tendencias globales hacia soluciones de transporte más ecológicas y sostenibles.
	</p>
	<p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	<h2>Onvo</h2>
	<p>
		Onvo es la segunda marca de vehículos eléctricos (EV) de Nio, lanzada oficialmente en mayo de 2024. La marca está diseñada para dirigirse al mercado familiar general, con un enfoque en ofrecer EVs inteligentes y de alta calidad a precios más accesibles en comparación con la línea de lujo de Nio. El nombre 'Onvo' significa 'En Viaje', simbolizando un viaje hacia la felicidad, especialmente con la familia.
	</p>
	<p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Volkswagen</h2>
	<p>
	Volkswagen tiene 6 modelos con un total de 29 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Zeekr</h2>
	<p>
	Zeekr tiene 6 modelos con un total de 12 variantes.
	</p>
