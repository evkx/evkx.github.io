...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<p>
	Audi tiene 5 modelos con un total de 31 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Cadillac</h2>
	<p>
	Cadillac tiene 2 modelos con un total de 3 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Citroën</h2>
	<p>
	Citroën tiene 2 modelos con un total de 2 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Fiat</h2>
	<p>
	Fiat tiene 1 modelos con un total de 1 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Ford</h2>
	<p>
	Ford tiene 3 modelos con un total de 10 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>GMC</h2>
	<p>
	GMC tiene 1 modelos con un total de 1 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Hyundai</h2>
	<p>
	Hyundai tiene 3 modelos con un total de 7 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Kia</h2>
	<p>
	Kia tiene 3 modelos con un total de 10 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	<h2>Maserati</h2>
	<p>
	Maserati tiene 1 modelos con un total de 1 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Mercedes</h2>
	<p>
	Mercedes tiene 8 modelos con un total de 31 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Opel</h2>
	<p>
	Opel tiene 2 modelos con un total de 3 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Porsche</h2>
	<p>
	Porsche tiene 2 modelos con un total de 23 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Rivian</h2>
	<p>
	Rivian tiene 1 modelos con un total de 6 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Volkswagen</h2>
	<p>
	Volkswagen tiene 5 modelos con un total de 20 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Zeekr</h2>
	<p>
	Zeekr tiene 4 modelos con un total de 8 variantes.
	</p>
