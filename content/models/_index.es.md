...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<p>
	Audi tiene 6 modelos con un total de 42 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Chevrolet</h2>
	<p>
	Chevrolet tiene 3 modelos con un total de 7 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Lexus</h2>
	<p>
	Lexus tiene 2 modelos con un total de 2 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<p>
	Skoda tiene 2 modelos con un total de 15 variantes.
	</p>
...
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
	...
	<h2>Tesla</h2>
	<p>
	Tesla tiene 5 modelos con un total de 18 variantes.
	</p>
