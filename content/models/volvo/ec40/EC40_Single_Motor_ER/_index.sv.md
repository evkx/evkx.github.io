...
description: "Volvo EC40 Single Motor ER är en elektrisk crossover med en WLTP-räckvidd på upp till 581 km (361 miles). EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Volvo EC40 Single Motor ER har ett bakhjulsdrivet system med en motor på bakaxeln.
...
Volvo EC40 Single Motor ER är utrustad med [gjutjärnsskivbromsar](../../../../technology/brakes/#disc-brakes) både fram och bak.
...
Volvo EC40 Single Motor ER, med måtten 4440 mm i längd, 1873 mm i bredd och 1596 mm i höjd, tillhör B-SUV-segmentet, även känt som kompakta SUV:ar eller crossovers. De kombinerar den kompakta storleken och manövrerbarheten från B-segmentets bilar med högre körposition, ökat lastutrymme och robust SUV-styling. Volvo EC40 Single Motor ER finns tillgänglig i totalt 9 lackfärger, alla med metallic- och pärlemo-alternativ.

Volvo EC40 Single Motor ER erbjuder flera hjulalternativ i olika storlekar, vilket låter dig anpassa ditt fordon efter din stil och körstil. De tillgängliga däck- och hjulkombinationerna inkluderar:
...
Volvo EC40 Single Motor ER rymmer fem passagerare med två framsäten och en tresätessoffa bak.
...
I Volvo EC40 Single Motor ER ingår flera funktioner för att öka komfort och bekvämlighet:
...
Volvo EC40 Single Motor ER har flera integrerade skärmar. Bakom ratten finns en [digital instrumentgrupp](../../../../technology/userinterface/screens/#digital-instruments), och i mittkonsolen finns en [infotainmentskärm](../../../../technology/userinterface/screens/#infotainment-screen) högst upp.
...
Volvo EC40 Single Motor ER är utrustad med endast en typ av ratt:
...
Du kan välja mellan två ljudsystem för Volvo EC40 Single Motor ER:
...
Du kan välja mellan två olika typer av strålkastare för Volvo EC40 Single Motor ER.
...
Volvo EC40 Single Motor ER har ett utbud av standard och tillvalda [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) utformade för att förbättra säkerhet och komfort.
...
[**Elektronisk stabilitetskontroll (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Volvo EC40 Single Motor ER, detta system förbättrar fordonets stabilitet och hantering vid plötsliga manövrer eller på halt väglag.

[**Körfältsassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på Volvo EC40 Single Motor ER, detta system hjälper till att förhindra att fordonet driver ut ur sitt körfält. Den inkluderar också ett [**Körfilsvarningssystem**](../../../../technology/driverassistance/lanedeparturewarning/) som varnar föraren om fordonet avviker från körfältet.

[**Varning för korsande trafik bak (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard på Volvo EC40 Single Motor ER, detta system använder sensorer för att upptäcka annalkande fordon från sidan när man backar ut från en parkeringsplats eller uppfart.

[**Kollisionsvarning framåt (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Volvo EC40 Single Motor ER, detta förarassistanssystem hjälper förare att undvika eller mildra frontalkrockar.

[**Automatisk nödbromsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Volvo EC40 Single Motor ER, detta system bromsar automatiskt för att förhindra eller minska allvarligheten av en kollision om föraren inte reagerar i tid.
...
Volvo EC40 Single Motor ER är utrustad med avancerade säkerhetsfunktioner för att skydda dig och ditt fordon. Dessa inkluderar:
...
Volvo EC40 Single Motor ER hade sin världspremiär den 20.02.2024, och leveranserna startade April 2024.
