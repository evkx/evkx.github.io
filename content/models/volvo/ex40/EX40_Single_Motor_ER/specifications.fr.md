---
title: Volvo EX40 Single Motor ER spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Volvo EX40 Single Motor ER."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Volvo EX40 Single Motor ER. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Volvo EX40 Single Motor ER, visitez les [chargeinfo](../chargingcurve/) pour Volvo EX40 Single Motor ER avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
