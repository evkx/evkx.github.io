---
title: Volvo C40 Recharge Single Motor ER Spezifikationen
linktitle: "Spezifikationen"
description: "EVKX.net bietet Ihnen die vollständigen Spezifikationen für Volvo C40 Recharge Single Motor ER."
weight: 4
hidden: true
...
EVKX.net strebt an, die vollständigsten Spezifikationen für Volvo C40 Recharge Single Motor ER zu haben. Klicken Sie auf das Bild oben für den [vollständigen Artikel](../), besuchen Sie die [Bildergalerie](../gallery/) für hochauflösende Bilder von Volvo C40 Recharge Single Motor ER, besuchen Sie die [Ladeinformationen](../chargingcurve/) für Volvo C40 Recharge Single Motor ER mit Ladekurve, besuchen Sie die [erweiterten Reichweiteninformationen](../rangeandconsumption/) für reale Reichweiten.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Cloud Blue (Blau)</br>
				Onyx Black (Schwarz)</br>
				Fjord Blue (Blau)</br>
				Silver Dawn (Silber)</br>
				Silver Dawn (Silber)</br>
				Bright Dusk (Silber)</br>
				Vapour Grey (Grau)</br>
				Crystal White (Weiß)</br>
				Sage Green (Grün)</br>
			</td>
		</tr>
	</tbody>
