---
title: Volvo C40 Recharge Single Motor especificaciones
linktitle: "Especificaciones"
description: "EVKX.net le brinda las especificaciones completas para Volvo C40 Recharge Single Motor."
weight: 4
hidden: true
...
EVKX.net busca tener las especificaciones más completas para Volvo C40 Recharge Single Motor. Haga clic en la imagen de arriba para ver [artículo completo](../), visite la [galería de imágenes](../gallery/) para imágenes de alta resolución de Volvo C40 Recharge Single Motor, visite [chargeinfo](../chargecurve/) para Volvo C40 Recharge Single Motor con chargecurve, visite [información de rango extendido](../rangeandconsumption/) para rangos del mundo real.
