...
description: "Volvo EX30 Twin Motor Performance es un crossover eléctrico con una autonomía WLTP de hasta 460 km (286 millas). EVKX.net tiene todos los detalles."
weight: 10
hidden: true
shownavtabs: true
...
El Volvo EX30 Twin Motor Performance ofrece un rendimiento sólido con una potencia máxima de 315 kW (428 hp / 422 bhp) y un par total de 543 Nm (401 lb-ft). Acelera de 0 a 100 km/h (0 a 62 mph) en 3,6 segundos y alcanza una velocidad máxima de 180 km/h (112 mph), siendo competitivo dentro de su clase.
...
Según el estándar [WLTP](../../../../guides/understandingrange/wltp/) (Procedimiento de Prueba de Vehículos Ligeros Armonizado a Nivel Mundial), la autonomía del vehículo es de 460 km (286 millas), con una tasa de consumo de energía de 13,9 kWh/100 km (3 mi/kWh). Para más detalles sobre la autonomía, consulte los datos del mundo real y las listas de autonomía en la página de [autonomía y consumo](rangeandconsumption/) de este modelo.

El vehículo admite carga rápida DC con una potencia máxima de 153 kW. Cargar del 0% al 100% toma aproximadamente 73 minutos, mientras que un escenario más típico del 10% al 80% toma 30 minutos con una velocidad de carga promedio de 91 kW. Considerando 5 minutos adicionales para cada parada de carga debido a interrupciones de conducción, el rango de carga óptimo es del 11% al 52%. Esto resulta en una velocidad de carga efectiva, incluyendo el tiempo perdido, de 90 kW, con cada sesión de carga tomando aproximadamente 17 minutos y 25 segundos.

En un desafío de 1000 km a una velocidad constante de 120 km/h (75 mph) con una tasa de consumo asumida de 24 kWh/100 km, el viaje tomaría aproximadamente 10 horas y 18 minutos, requiriendo seis paradas de carga del 11% al 57%, totalizando 119 minutos de tiempo de carga.
...
El Volvo EX30 Twin Motor Performance cuenta con un sistema de tracción en las cuatro ruedas impulsado por dos motores, uno en cada eje.
...
El Volvo EX30 Twin Motor Performance está equipado con [frenos de disco de hierro fundido](../../../../technology/brakes/#disc-brakes) tanto en la parte delantera como en la trasera. Los discos delanteros miden 350 mm, mientras que los discos traseros son de 333 mm.
...
El Volvo EX30 Twin Motor Performance, con dimensiones de 4233 mm de longitud, 1837 mm de ancho y 1549 mm de altura, pertenece al segmento de coches B-SUV, también conocidos como SUV subcompactos o crossovers, que ofrecen una combinación del tamaño compacto y la maniobrabilidad de los coches del segmento B con la posición de conducción más alta, mayor espacio de carga y estilo robusto de un SUV. El Volvo EX30 Twin Motor Performance está disponible en un total de 5 colores de pintura, todos los cuales incluyen opciones metálicas y perladas.

El Volvo EX30 Twin Motor Performance ofrece múltiples opciones de ruedas en diferentes tamaños, lo que le permite personalizar su vehículo para adaptarse a su estilo y preferencias de conducción. Las combinaciones de neumáticos y ruedas disponibles incluyen:
...
El Volvo EX30 Twin Motor Performance acomoda cinco pasajeros con dos asientos delanteros y un banco de tres asientos en la parte trasera.

#### Asientos de la Primera Fila

El Volvo EX30 Twin Motor Performance ofrece un solo tipo de asiento delantero.
...
El Volvo EX30 Twin Motor Performance incluye varias características para mejorar la comodidad y conveniencia:
...
El Volvo EX30 Twin Motor Performance tiene una sola pantalla para el conductor. El centro del tablero tiene una sola [pantalla de infoentretenimiento](../../../../technology/userinterface/screens/#infotainment-screen) que sirve como la pantalla principal para la información del vehículo y las funciones de infoentretenimiento.
...
Puede elegir entre dos sistemas de sonido para el Volvo EX30 Twin Motor Performance:
...
Puede elegir entre dos tipos de faros delanteros para el Volvo EX30 Twin Motor Performance.
...
El Volvo EX30 Twin Motor Performance cuenta con una gama de sistemas [avanzados de asistencia al conductor](../../../../technology/driverassistance/) (ADAS) estándar y opcionales diseñados para mejorar la seguridad y la comodidad.
...
[**Sistema de frenos antibloqueo (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Estándar en el Volvo EX30 Twin Motor Performance, este sistema evita que las ruedas se bloqueen durante el frenado.

[**Control Electrónico de Estabilidad (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Estándar en el Volvo EX30 Twin Motor Performance, este sistema mejora la estabilidad y el manejo del vehículo durante maniobras repentinas o en condiciones de carretera resbaladiza.

[**Asistencia de Mantenimiento de Carril (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Estándar en el Volvo EX30 Twin Motor Performance, este sistema ayuda a evitar que el vehículo se desvíe de su carril. También incluye un sistema de [**Advertencia de Salida de Carril**](../../../../technology/driverassistance/lanedeparturewarning/) para alertar al conductor si el vehículo se desvía del carril.

[**Alerta de Tráfico Cruzado Trasero (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Estándar en el Volvo EX30 Twin Motor Performance, este sistema utiliza sensores para detectar vehículos que se aproximan desde el lado al retroceder de un espacio de estacionamiento o entrada.

[**Advertencia de Colisión Frontal (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Estándar en el Volvo EX30 Twin Motor Performance, este sistema de asistencia al conductor ayuda a los conductores a evitar o mitigar colisiones frontales.

[**Frenado automático de emergencia (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Estándar en el Volvo EX30 Twin Motor Performance, este sistema aplica los frenos de manera autónoma para prevenir o reducir la gravedad de una colisión si el conductor no reacciona a tiempo.

[**Advertencia de Salida**](../../../../technology/driverassistance/exitwarning/): Estándar en el Volvo EX30 Twin Motor Performance, este sistema alerta a los ocupantes contra la apertura de puertas si hay riesgo de golpear algo.
...
El Volvo EX30 Twin Motor Performance está equipado con características de seguridad avanzadas para protegerlo a usted y a su vehículo. Estas incluyen:
...
El peso máximo del vehículo es de 2338 kg (5154 libras), con un peso base de 1869 kg (4120 libras). Esto permite una carga máxima de 469 kg (1034 libras), incluyendo el conductor y los pasajeros. Tenga en cuenta que algunas opciones pueden aumentar el peso base y reducir la capacidad máxima de carga.
