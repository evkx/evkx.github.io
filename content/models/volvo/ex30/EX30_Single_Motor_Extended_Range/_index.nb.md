...
description: "Volvo EX30 Single Motor Extended Range er en helelektrisk crossover med en WLTP rekkevidde på opptil 460 km. EVKX.net har alle detaljene."
weight: 10
hidden: true
shownavtabs: true
...
Volvo EX30 Single Motor Extended Range tilbyr beskjedne ytelser med en maksimal effekt på 200 kW (272 hk) og et totalt dreiemoment på 343 Nm. Den akselererer fra 0 til 100 km/t på 5,3 sekunder og har en toppfart på 180 km/t, noe som ligger nærmere tradisjonelle bensin- og dieselbiler.
...
I en teoretisk 1000 km utfordring, med fulladet batteri og en konstant hastighet på 120 km/t under ideelle forhold med et antatt forbruk på 220 kWh/100 km, ville turen ta omtrent 8 timer og 5 minutter. Denne reisen ville kreve to ladestopp fra 11% til 49%, med en total ladetid på 1425 minutter.
...
Volvo EX30 Single Motor Extended Range, med dimensjoner på 4233 mm i lengde, 1837 mm i bredde og 1549 mm i høyde, tilhører B-SUV-segmentet av biler, også kjent som subkompakte SUV-er eller crossovere. De tilbyr en kombinasjon av kompakt størrelse og manøvrerbarhet fra B-segmentbiler med høyere kjøreposisjon, økt lasteplass og robust utseende fra en SUV. Volvo EX30 Single Motor Extended Range er tilgjengelig i totalt 5 lakkfarger, alle inkluderer metalliske og perlemorsalternativer.
...
Volvo EX30 Single Motor Extended Range inkluderer flere funksjoner for å forbedre komfort og bekvemmelighet:
...
Volvo EX30 Single Motor Extended Range er utstyrt med en enkelt type ratt:
...
Du kan velge mellom to lydsystemer på Volvo EX30 Single Motor Extended Range.
...
Volvo EX30 Single Motor Extended Range inkluderer flere [avanserte førerassistanse systemer](../../../../technology/driverassistance/) (ADAS) som standard og som tilvalg for å forbedre sikkerhet og komfort.
...
[**Blokkeringsfrie bremser (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Volvo EX30 Single Motor Extended Range, dette systemet forhindrer hjulene i å låse seg under bremsing.
...
[**Kjørefeltassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på Volvo EX30 Single Motor Extended Range, dette systemet hjelper til med å forhindre at kjøretøyet driver ut av kjørefeltet. Det inkluderer også et system for [**Advarsel om Utkjøring av Kjørebanen**](../../../../technology/driverassistance/lanedeparturewarning/) for å advare sjåføren hvis kjøretøyet kommer ut av kjørefeltet.

[**Bakre Kryss Trafikkadvarsel (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard på Volvo EX30 Single Motor Extended Range, dette systemet bruker sensorer for å oppdage tilnærmende kjøretøy fra siden når du rygger ut av en parkeringsplass eller innkjørsel.

[**Frontkollisjonsvarsling (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Volvo EX30 Single Motor Extended Range, dette assistansesystemet hjelper sjåfører med å unngå eller redusere alvorlighetsgraden av frontkollisjoner.

[**Automatisk nødbremsing (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Volvo EX30 Single Motor Extended Range, dette systemet bruker bremsene autonomt for å forhindre eller redusere alvorlighetsgraden av en kollisjon hvis føreren ikke reagerer i tide.

[**Uttrekksadvarsel**](../../../../technology/driverassistance/exitwarning/): Standard på Volvo EX30 Single Motor Extended Range, dette systemet advarer passasjerene mot å åpne dørene hvis det er risiko for å treffe noe.
...
Kjøretøyets maksimale vekt er 2235 kg, med en basisvekt på 1755 kg. Dette gir en maksimal lastekapasitet på 480 kg, inkludert fører og passasjerer. Merk at noen alternativer kan øke basisvekten og redusere maksimal lastekapasitet.
