...
Vi har opdelt vores Volvo EX30 Single Motor Extended Range artikel i sektioner. Hvis du vil vente med at læse hele artiklen, skal du klikke på nedenstående links til de forskellige områder. Vi har også en oversigt over de [fulde specifikationer](specifications/), et [billedgalleri](gallery/), detaljerede oplysninger om [opladningsydelse](chargingcurve/), og nogle [online anmeldelser](reviews/). Vores sektioner:
...
I en teoretisk 1000 km udfordring, der starter med et fuldt batteri og opretholder en konstant hastighed på 120 km/t under ideelle forhold med et antaget forbrug på 220 kWh/100 km, ville turen tage cirka 8 timer og 5 minutter. Denne rejse ville kræve to opladningsstop fra 11% til 49%, med en samlet opladningstid på 1425 minutter
...
Den Volvo EX30 Single Motor Extended Range, med dimensioner på 4233 mm i længde, 1837 mm i bredde og 1549 mm i højde, tilhører B-SUV segmentet af biler, også kendt som subkompakte SUV'er eller crossovers. De tilbyder en kombination af den kompakte størrelse og manøvredygtighed fra B-segment biler med den højere kørestilling, øgede lastkapacitet og robuste styling af en SUV. Volvo EX30 Single Motor Extended Range fås i alt 5 lakfarver, som alle inkluderer metalliske og perlemorsmuligheder.

Du kan vælge mellem flere hjul i forskellige størrelser på Volvo EX30 Single Motor Extended Range, så du kan tilpasse din bil efter din stil og dine kørselspræferencer.
...
Volvo EX30 Single Motor Extended Range har plads til fem passagerer med to sæder foran og en tre-personers bænk bagtil.

#### Første række sæder

Volvo EX30 Single Motor Extended Range tilbyder kun én type forreste sæde.
...
Volvo EX30 Single Motor Extended Range er udstyret med en enkelt type rat:
...
Du kan vælge mellem to lydsystemer på Volvo EX30 Single Motor Extended Range.
...
Den Volvo EX30 Single Motor Extended Range inkluderer flere standard- og valgfri [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) for at forbedre sikkerhed og komfort.
...
[**Anti-lock Bremsesystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Volvo EX30 Single Motor Extended Range, dette system forhindrer hjulene i at låse under opbremsning.

[**Electronic Stability Control (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Volvo EX30 Single Motor Extended Range, dette system forbedrer bilens stabilitet og håndtering under pludselige manøvrer eller på glatte vejforhold.
...
[**Rear Cross Traffic Alert (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard på Volvo EX30 Single Motor Extended Range, dette system bruger sensorer til at registrere tilstødende køretøjer fra siden, når du bakker ud af en parkeringsplads eller indkørsel.

[**Forward Collision Warning (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Volvo EX30 Single Motor Extended Range, dette førerassistentsystem hjælper føreren med at undgå eller formilde frontale kollisioner.

[**Automatisk nødbremsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Volvo EX30 Single Motor Extended Range, dette system anvender bremserne autonomt for at forhindre eller reducere alvoren af en kollision, hvis føreren ikke reagerer i tide.

[**Exit Warning**](../../../../technology/driverassistance/exitwarning/): Standard på Volvo EX30 Single Motor Extended Range, dette system advarer passagererne mod at åbne dørene, hvis der er risiko for at ramme noget.
...
Køretøjets maksimale vægt er 2235 kg, med en basisvægt på 1755 kg. Dette giver en maksimal last på 480 kg, inklusive fører og passagerer. Bemærk, at nogle valgmuligheder kan øge basisvægten og reducere den maksimale lastekapacitet.

En anhængertræk kan tilføjes til køretøjet. Den maksimale tilladte vægt for en bremset trailer er 1400 kg, mens den for en ubremset trailer er 750 kg.
