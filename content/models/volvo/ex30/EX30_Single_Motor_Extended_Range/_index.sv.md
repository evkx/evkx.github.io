...
description: "Volvo EX30 Single Motor Extended Range är en helelektrisk crossover med en WLTP räckvidd på upp till 460 km. EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Volvo EX30 Single Motor Extended Range erbjuder blygsamma prestanda med en maximal effekt på 200 kW (272 hk) och ett totalt vridmoment på 343 Nm. Den accelererar från 0 till 100 km/h på 5,3 sekunder och har en topphastighet på 180 km/h, vilket är mer i linje med traditionella förbränningsmotorfordon.
...
Volvo EX30 Single Motor Extended Range rymmer fem passagerare med två säten fram och en tre-sitsig bänk bak.
...
Volvo EX30 Single Motor Extended Range inkluderar flera funktioner för att förbättra komfort och bekvämlighet:
...
Volvo EX30 Single Motor Extended Range är utrustad med en enda typ av ratt:
...
Du kan välja mellan två ljudsystem på Volvo EX30 Single Motor Extended Range.
...
Du kan välja mellan två typer av strålkastare för Volvo EX30 Single Motor Extended Range.
...
Volvo EX30 Single Motor Extended Range inkluderar flera [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) som standard och som tillval för att förbättra säkerheten och komforten.
...
[**Låsningsfria bromsar (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Volvo EX30 Single Motor Extended Range, detta system förhindrar att hjulen låser sig under bromsning.

[**Elektronisk Stabilitetskontroll (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Volvo EX30 Single Motor Extended Range, detta system förbättrar fordonets stabilitet och hantering vid plötsliga manövrer eller på hala vägar.

[**Körfältsassistans (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på Volvo EX30 Single Motor Extended Range, detta system hjälper till att förhindra att fordonet driver ut ur sitt körfält. Det inkluderar även ett system för [**Varning för Utträde från Körfält**](../../../../technology/driverassistance/lanedeparturewarning/) som varnar föraren om fordonet är på väg ut ur körfältet.

[**Bakre Korsande Trafikvarning (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard på Volvo EX30 Single Motor Extended Range, detta system använder sensorer för att upptäcka närstående fordon från sidan när du backar ut från en parkeringsplats eller in- och utfart.

[**Framåt Kollisionsvarning (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Volvo EX30 Single Motor Extended Range, detta förarassistanssystem hjälper till att undvika eller mildra frontalkollisioner.

[**Automatisk nödbromsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Volvo EX30 Single Motor Extended Range, detta system bromsar autonomt för att förhindra eller minska allvaret av en kollision om föraren inte reagerar i tid.

[**Utgångsvarning**](../../../../technology/driverassistance/exitwarning/): Standard på Volvo EX30 Single Motor Extended Range, detta system varnar passagerarna om att inte öppna dörrarna om det finns risk att träffa något.
...
Fordonets maximala vikt är 2235 kg, med en grundvikt på 1755 kg. Detta tillåter en maximal last på 480 kg, inklusive förare och passagerare. Observera att vissa alternativ kan öka grundvikten och minska den maximala lastkapaciteten.

En dragkrok kan läggas till fordonet. Den maximala tillåtna vikten för en bromsad släpvagn är 1400 kg, medan för en obromsad släpvagn är den 750 kg.
