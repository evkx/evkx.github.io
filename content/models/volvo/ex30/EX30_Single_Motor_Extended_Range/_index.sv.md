...
description: "Volvo EX30 Single Motor Extended Range är en elektrisk crossover med en WLTP-räckvidd på upp till 460 km (286 miles). EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
I ett 1000 km test med konstant hastighet på 120 km/h med en antagen förbrukning på 220 kWh/100 km, skulle resan ta ungefär 8 timmar och 5 minuter, med 88 laddningsstopp från 11% till 49%, totalt 1425 minuters laddtid.
...
Volvo EX30 Single Motor Extended Range har ett bakhjulsdrivet system med en motor på bakaxeln.
...
Volvo EX30 Single Motor Extended Range är utrustad med [gjutjärnsskivbromsar](../../../../technology/brakes/#disc-brakes) både fram och bak. De främre skivorna mäter 350 mm, medan de bakre skivorna är 333 mm.
...
Volvo EX30 Single Motor Extended Range, med måtten 4233 mm i längd, 1837 mm i bredd och 1549 mm i höjd, tillhör B-SUV-segmentet, även känt som kompakta SUV:ar eller crossovers. De kombinerar den kompakta storleken och manövrerbarheten från B-segmentets bilar med högre körposition, ökat lastutrymme och robust SUV-styling. Volvo EX30 Single Motor Extended Range finns tillgänglig i totalt 5 lackfärger, alla med metallic- och pärlemo-alternativ.

Volvo EX30 Single Motor Extended Range erbjuder flera hjulalternativ i olika storlekar, vilket låter dig anpassa ditt fordon efter din stil och körstil. De tillgängliga däck- och hjulkombinationerna inkluderar:
...
Volvo EX30 Single Motor Extended Range rymmer fem passagerare med två framsäten och en tresätessoffa bak.

#### Första radens säten

Volvo EX30 Single Motor Extended Range erbjuder endast en typ av framsäte.
...
I Volvo EX30 Single Motor Extended Range ingår flera funktioner för att öka komfort och bekvämlighet:
...
Volvo EX30 Single Motor Extended Range har en enda skärm för föraren. I mitten av instrumentbrädan finns en enda [infotainmentskärm](../../../../technology/userinterface/screens/#infotainment-screen) som fungerar som huvuddisplay för både fordonsinformation och infotainment.
...
Volvo EX30 Single Motor Extended Range är utrustad med endast en typ av ratt:
...
Du kan välja mellan två ljudsystem för Volvo EX30 Single Motor Extended Range:
...
Du kan välja mellan två olika typer av strålkastare för Volvo EX30 Single Motor Extended Range.
...
Volvo EX30 Single Motor Extended Range har ett utbud av standard och tillvalda [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) utformade för att förbättra säkerhet och komfort.
...
[**Låsningsfria bromsar (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Volvo EX30 Single Motor Extended Range, detta system förhindrar att hjulen låser sig vid inbromsning.

[**Elektronisk stabilitetskontroll (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Volvo EX30 Single Motor Extended Range, detta system förbättrar fordonets stabilitet och hantering vid plötsliga manövrer eller på halt väglag.

[**Körfältsassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på Volvo EX30 Single Motor Extended Range, detta system hjälper till att förhindra att fordonet driver ut ur sitt körfält. Den inkluderar också ett [**Körfilsvarningssystem**](../../../../technology/driverassistance/lanedeparturewarning/) som varnar föraren om fordonet avviker från körfältet.

[**Varning för korsande trafik bak (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard på Volvo EX30 Single Motor Extended Range, detta system använder sensorer för att upptäcka annalkande fordon från sidan när man backar ut från en parkeringsplats eller uppfart.

[**Kollisionsvarning framåt (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Volvo EX30 Single Motor Extended Range, detta förarassistanssystem hjälper förare att undvika eller mildra frontalkrockar.

[**Automatisk nödbromsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Volvo EX30 Single Motor Extended Range, detta system bromsar automatiskt för att förhindra eller minska allvarligheten av en kollision om föraren inte reagerar i tid.

[**Utstigningsvarning**](../../../../technology/driverassistance/exitwarning/): Standard på Volvo EX30 Single Motor Extended Range, detta system varnar passagerare mot att öppna dörrar om det finns risk för kollision.
...
Volvo EX30 Single Motor Extended Range är utrustad med avancerade säkerhetsfunktioner för att skydda dig och ditt fordon. Dessa inkluderar:
...
Fordonets maximala vikt är 2235 kg (4927 lbs), med en tjänstevikt på 1755 kg (3869 lbs). Detta möjliggör en maximal last på 480 kg (1058 lbs), inklusive förare och passagerare. Observera att vissa tillval kan öka tjänstevikten och minska den maximala lastkapaciteten.

Dragkrok kan installeras som tillval. Maximal tillåten vikt för bromsad släpvagn är 1400 kg (3086 lbs), medan för obromsad släpvagn är det 750 kg (1653 lbs).
