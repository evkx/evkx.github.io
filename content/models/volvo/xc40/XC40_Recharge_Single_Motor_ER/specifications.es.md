...
EVKX.net busca tener las especificaciones más completas para Volvo XC40 Recharge Single Motor ER. Haga clic en la imagen de arriba para ver [artículo completo](../), visite la [galería de imágenes](../gallery/) para imágenes de alta resolución de Volvo XC40 Recharge Single Motor ER, visite [chargeinfo](../chargingcurve/) para Volvo XC40 Recharge Single Motor ER con chargecurve, visite [información de rango extendido](../rangeandconsumption/) para rangos del mundo real.
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Onyx Black (Negro)</br>
				Fjord Blue (Azul)</br>
				Silver Dawn (Plata)</br>
				Silver Dawn (Plata)</br>
				Bright Dusk (Plata)</br>
				Vapour Grey (Gris)</br>
				Crystal White (Blanco)</br>
				Sage Green (Verde)</br>
			</td>
		</tr>
	</tbody>
