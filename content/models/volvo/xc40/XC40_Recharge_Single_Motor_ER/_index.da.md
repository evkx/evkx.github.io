...
description: "Volvo XC40 Recharge Single Motor ER er en elektrisk crossover med en WLTP rækkevidde på op til 572 km (356 miles). EVKX.net har alle detaljerne."
weight: 10
hidden: true
shownavtabs: true
...
Denne model er blevet erstattet af [Volvo EX40 Single Motor ER](/nb-NO/models/volvo/ex40/ex40_single_motor_er/).
...
Volvo XC40 Recharge Single Motor ER tilbyder beskeden ydeevne med en maksimal effekt på 185 kW (252 hk / 248 bhp) og et samlet drejningsmoment på 420 Nm (310 lb-ft). Den accelererer fra 0 til 100 km/t (0 til 62 mph) på 7,3 sekunder og har en tophastighed på 160 km/t (99 mph), hvilket ligger tættere på traditionelle forbrændingsmotorer.
...
Under [WLTP](../../../../guides/understandingrange/wltp/) (Worldwide Harmonized Light Vehicles Test Procedure) standarden varierer køretøjets rækkevidde mellem 572 og 553 km (356-344 miles), afhængigt af den specifikke konfiguration og tilvalg som f.eks. hjulstørrelse. Større hjul kan øge energiforbruget og dermed reducere den samlede rækkevidde. Køretøjets energiforbrug er vurderet til 13,8 kWh/100 km for basismodellen og 14,3 kWh/100 km for topmodellen under WLTP testcyklussen. For flere detaljer om rækkevidden, se data fra den virkelige verden og rækkeviddelister på denne models [rækkevidde og forbrug](rangeandconsumption/) side.
...
Volvo XC40 Recharge Single Motor ER har et baghjulstræksystem understøttet af én motor på bagakslen.
...
Volvo XC40 Recharge Single Motor ER er udstyret med [støbejerns-skivebremser](../../../../technology/brakes/#disc-brakes) både for og bag.
...
Volvo XC40 Recharge Single Motor ER, med dimensioner på 4425 mm i længde, 1873 mm i bredde og 1652 mm i højde, tilhører B-SUV segmentet, også kendt som kompakte SUV'er eller crossovers, der kombinerer B-segment bilers kompakte størrelse og manøvredygtighed med en højere køreposition, øget bagagerumsplads og robust styling fra en SUV. Volvo XC40 Recharge Single Motor ER fås i alt i 9 lakfarver, som alle inkluderer metalliske og perlemoreffekter.

Volvo XC40 Recharge Single Motor ER tilbyder flere hjulmuligheder i forskellige størrelser, så du kan tilpasse din bil efter din stil og kørepræferencer. De tilgængelige dæk- og hjulkombinationer inkluderer:
...
Volvo XC40 Recharge Single Motor ER har plads til fem passagerer med to forsæder og en trebænk bagtil.

#### Forsæder

Volvo XC40 Recharge Single Motor ER tilbyder én type forsæde.
...
Volvo XC40 Recharge Single Motor ER inkluderer flere funktioner for at forbedre komfort og bekvemmelighed:
...
Volvo XC40 Recharge Single Motor ER har flere integrerede skærme. Bag rattet er der et [digitalt instrumentpanel](../../../../technology/userinterface/screens/#digital-instruments), og i midterkonsollen er der én [infotainmentskærm](../../../../technology/userinterface/screens/#infotainment-screen) øverst i midterkonsollen.
...
Volvo XC40 Recharge Single Motor ER er udstyret med én type rat:
...
Du kan vælge mellem to lydsystemer til Volvo XC40 Recharge Single Motor ER:
...
Du kan vælge mellem to typer forlygter til Volvo XC40 Recharge Single Motor ER.
...
Volvo XC40 Recharge Single Motor ER har en række standard og valgfrie [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) designet til at forbedre sikkerhed og komfort.
...
[**Elektronisk Stabilitetskontrol (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Volvo XC40 Recharge Single Motor ER, dette system forbedrer bilens stabilitet og håndtering under pludselige manøvrer eller på glatte veje.

[**Vognbaneassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på Volvo XC40 Recharge Single Motor ER, dette system hjælper med at forhindre køretøjet i at drive ud af sin vognbane. Den inkluderer også et [**Vognbaneafvigelsesadvarsel**](../../../../technology/driverassistance/lanedeparturewarning/) system til at advare føreren, hvis køretøjet afviger fra vognbanen.

[**Advarsel om Krydsende Trafik Bag (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard på Volvo XC40 Recharge Single Motor ER, dette system bruger sensorer til at opdage køretøjer, der nærmer sig fra siden, når man bakker ud af en parkeringsplads eller indkørsel.

[**Advarsel om Frontal Kollision (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Volvo XC40 Recharge Single Motor ER, dette førerassistentsystem hjælper førere med at undgå eller mindske frontale kollisioner.

[**Automatisk Nødbremsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Volvo XC40 Recharge Single Motor ER, dette system aktiverer automatisk bremserne for at forhindre eller reducere alvorligheden af en kollision, hvis føreren ikke reagerer i tide.
...
Volvo XC40 Recharge Single Motor ER er udstyret med avancerede sikkerhedsfunktioner for at beskytte dig og dit køretøj. Disse omfatter:
...
Denne model havde sin verdenspremiere den 18.05.2022, og leveringerne startede i August 2022. Denne model er nu udgået. Denne model er blevet erstattet af [Volvo EX40 Single Motor ER](/models/volvo/ex40/ex40_single_motor_er).
