---
title: Volvo XC40 Recharge Twin Motor Specifikationer
linktitle: "Specifikationer"
description: "EVKX.net ger dig alla specifikationer för Volvo XC40 Recharge Twin Motor."
weight: 4
hidden: true
...
EVKX.net vill ha de mest kompletta specifikationerna för Volvo XC40 Recharge Twin Motor. Klicka på bilden ovan för [fullständig artikel](../), besök [bildgalleri](../gallery/) för hög upplösningsbilder av Volvo XC40 Recharge Twin Motor, gå till [chargeinfo](../chargingcurve/) för Volvo XC40 Recharge Twin Motor med laddningskurva, se [extended range info](../rangeandconsumption/) för verkliga räckvidd.
...
<table class="table table-striped border">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<i class="bi-check-lg" style="color: green;"></i> Ja (BLIS Cross Traffic Alert), standardfunktion
			</td>
		</tr>
		<tr>
			<td>
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Silver Dawn</br>
				Silver Dawn</br>
				Bright Dusk (Silver)</br>
				Vapour Grey (Grå)</br>
				Crystal White (Vit)</br>
				Sage Green (Grön)</br>
			</td>
		</tr>
	</tbody>
