...
description: "Volvo XC40 Recharge Twin Motor est un crossover entièrement électrique avec une autonomie de WLTP allant jusqu'à 535 km (333 miles). EVKX.net a tous les détails."
weight: 10
hidden: true
shownavtabs: true
...
Ce modèle a été remplacé par [Volvo EX40 Twin Motor](/models/volvo/ex40/ex40_twin_motor/).
...
Volvo XC40 Recharge Twin Motor dispose d'un système de transmission intégrale pris en charge par deux moteurs, un sur chaque essieu.
...
La Volvo XC40 Recharge Twin Motor, avec des dimensions de 4425 mm de longueur, 1873 mm de largeur et 1652 mm de hauteur, appartient au segment des SUV sous-compacts, également connus sous le nom de sous-compact SUVs ou crossovers. Ils offrent une combinaison de la taille compacte et de la maniabilité des voitures du segment B avec la position de conduite plus haute, un espace de chargement accru et un style robuste d'un SUV. La Volvo XC40 Recharge Twin Motor est disponible en un total de 9 couleurs de peinture, toutes comprenant des options métalliques et nacrées.
...
Le Volvo XC40 Recharge Twin Motor peut accueillir cinq passagers avec deux sièges à l'avant et une banquette arrière à trois places.

#### Sièges de première rangée

Le Volvo XC40 Recharge Twin Motor propose un seul type de siège avant.
...
L'Volvo XC40 Recharge Twin Motor comprend plusieurs fonctionnalités pour améliorer le confort et la commodité :
...
Le Volvo XC40 Recharge Twin Motor est équipé d'un seul type de volant :
...
Vous pouvez choisir entre deux systèmes audio sur le Volvo XC40 Recharge Twin Motor.
...
Vous pouvez choisir entre deux types de phares pour le Volvo XC40 Recharge Twin Motor.
...
Le Volvo XC40 Recharge Twin Motor comprend plusieurs [systèmes avancés d'assistance au conducteur](../../../../technology/driverassistance/) (ADAS) de série et en option pour améliorer la sécurité et le confort.
...
[**Contrôle Électronique de Stabilité (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard sur le Volvo XC40 Recharge Twin Motor, ce système améliore la stabilité et la maniabilité du véhicule lors de manœuvres soudaines ou en conditions de route glissantes.

[**Assistance au Maintien de Voie (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard sur le Volvo XC40 Recharge Twin Motor, ce système aide à prévenir le déplacement du véhicule hors de sa voie. Il comprend également un système de [**Alerte de Sortie de Voie**](../../../../technology/driverassistance/lanedeparturewarning/) pour alerter le conducteur si le véhicule quitte sa voie.

[**Alerte de Trafic Croisé Arrière (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard sur le Volvo XC40 Recharge Twin Motor, ce système utilise des capteurs pour détecter les véhicules qui approchent par les côtés lors de la marche arrière depuis une place de stationnement ou une entrée.

[**Alerte de Collision Frontale (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard sur le Volvo XC40 Recharge Twin Motor, ce système d'assistance au conducteur aide à éviter ou à atténuer les collisions frontales.

[**Freinage d'urgence automatique (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard sur le Volvo XC40 Recharge Twin Motor, ce système applique les freins de manière autonome pour éviter ou réduire la gravité d'une collision si le conducteur ne réagit pas à temps.
...
Le Volvo XC40 Recharge Twin Motor est équipé de fonctionnalités de sécurité avancées pour vous protéger, vous et votre véhicule. Celles-ci incluent :
...
Ce modèle a été présenté en première mondiale le 18.05.2022 et les livraisons ont commencé en August 2022. Ce modèle a maintenant été abandonné. Ce modèle a été remplacé par [Volvo EX40 Twin Motor](/models/volvo/ex40/ex40_twin_motor).
