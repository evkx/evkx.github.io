...
description: "Volvo XC40 Recharge Twin Motor är en elektrisk crossover med en WLTP-räckvidd på upp till 535 km (333 miles). EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Denna modell har ersatts av [Volvo EX40 Twin Motor](/nb-NO/models/volvo/ex40/ex40_twin_motor/).
...
Volvo XC40 Recharge Twin Motor levererar en solid prestanda med en maxeffekt på 300 kW (408 hk / 402 bhp) och ett totalt vridmoment på 670 Nm (494 lb-ft). Den accelererar från 0 till 100 km/h på 4,8 sekunder och når en toppfart på 180 km/h (112 mph), vilket gör den konkurrenskraftig inom sin klass.
...
Volvo XC40 Recharge Twin Motor har ett fyrhjulsdrivet system som drivs av två motorer, en på varje axel.
...
Volvo XC40 Recharge Twin Motor är utrustad med [gjutjärnsskivbromsar](../../../../technology/brakes/#disc-brakes) både fram och bak.
...
Volvo XC40 Recharge Twin Motor, med måtten 4425 mm i längd, 1873 mm i bredd och 1652 mm i höjd, tillhör B-SUV-segmentet, även känt som kompakta SUV:ar eller crossovers. De kombinerar den kompakta storleken och manövrerbarheten från B-segmentets bilar med högre körposition, ökat lastutrymme och robust SUV-styling. Volvo XC40 Recharge Twin Motor finns tillgänglig i totalt 9 lackfärger, alla med metallic- och pärlemo-alternativ.

Volvo XC40 Recharge Twin Motor erbjuder flera hjulalternativ i olika storlekar, vilket låter dig anpassa ditt fordon efter din stil och körstil. De tillgängliga däck- och hjulkombinationerna inkluderar:
...
Volvo XC40 Recharge Twin Motor rymmer fem passagerare med två framsäten och en tresätessoffa bak.

#### Första radens säten

Volvo XC40 Recharge Twin Motor erbjuder endast en typ av framsäte.
...
I Volvo XC40 Recharge Twin Motor ingår flera funktioner för att öka komfort och bekvämlighet:
...
Volvo XC40 Recharge Twin Motor har flera integrerade skärmar. Bakom ratten finns en [digital instrumentgrupp](../../../../technology/userinterface/screens/#digital-instruments), och i mittkonsolen finns en [infotainmentskärm](../../../../technology/userinterface/screens/#infotainment-screen) högst upp.
...
Volvo XC40 Recharge Twin Motor är utrustad med endast en typ av ratt:
...
Du kan välja mellan två ljudsystem för Volvo XC40 Recharge Twin Motor:
...
Du kan välja mellan två olika typer av strålkastare för Volvo XC40 Recharge Twin Motor.
...
Volvo XC40 Recharge Twin Motor har ett utbud av standard och tillvalda [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) utformade för att förbättra säkerhet och komfort.
...
[**Elektronisk stabilitetskontroll (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Volvo XC40 Recharge Twin Motor, detta system förbättrar fordonets stabilitet och hantering vid plötsliga manövrer eller på halt väglag.

[**Körfältsassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på Volvo XC40 Recharge Twin Motor, detta system hjälper till att förhindra att fordonet driver ut ur sitt körfält. Den inkluderar också ett [**Körfilsvarningssystem**](../../../../technology/driverassistance/lanedeparturewarning/) som varnar föraren om fordonet avviker från körfältet.

[**Varning för korsande trafik bak (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard på Volvo XC40 Recharge Twin Motor, detta system använder sensorer för att upptäcka annalkande fordon från sidan när man backar ut från en parkeringsplats eller uppfart.

[**Kollisionsvarning framåt (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Volvo XC40 Recharge Twin Motor, detta förarassistanssystem hjälper förare att undvika eller mildra frontalkrockar.

[**Automatisk nödbromsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Volvo XC40 Recharge Twin Motor, detta system bromsar automatiskt för att förhindra eller minska allvarligheten av en kollision om föraren inte reagerar i tid.
...
Volvo XC40 Recharge Twin Motor är utrustad med avancerade säkerhetsfunktioner för att skydda dig och ditt fordon. Dessa inkluderar:
...
Denna modell hade sin världspremiär den 18.05.2022, och leveranserna startade August 2022. Denna modell har nu utgått ur produktion. Denna modell har ersatts av [Volvo EX40 Twin Motor](/models/volvo/ex40/ex40_twin_motor).
{{< pagenavigation b_url="../" b_title="Volvo XC40" f_url="rangeandconsumption/" f_title="Räckvidd" >}}
