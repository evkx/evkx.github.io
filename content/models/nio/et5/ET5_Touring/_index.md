...
The Nio ET5 Touring has a maximum power of 480KW (653hp). The total torque is 850nm. It performs the 0-100km/h sprint (0-62mph) in 3,9 seconds. The top speed is 200 km/h. 
...
Nio ET5 Touring has an all-wheel drive system supported by two motors, one on each axle. The motors used are [Induction Motors](../../../../technology/motors/asm/) at the front axle and [Permanent Magnet Synchronous Motors](../../../../technology/motors/pmsm/) at the rear axle. 



### Steering

Dynamic steering is a standard feature on the Nio ET5 Touring. Dynamic steering varies the steering ratio as a function of driving speed. 
...
Only one front seat type is available in the Nio ET5 Touring. 
...
Nio ET5 Touring has several features to make your life as a driver or passenger more comfortable. 
...
The Nio ET5 Touring has an [**anti-lock braking system (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/)  as a standard system. This system helps to prevent a vehicle's wheels from locking up during braking.

The Nio ET5 Touring has an [**Electronic Stability Control**](../../../../technology/driverassistance/electronicstabilitycontrol/)  as a standard system designed to improve a vehicle's stability and handling during sudden maneuvers or slippery road conditions. 

The Nio ET5 Touring has a [**lane-keeping assist**](../../../../technology/driverassistance/lanekeepingassist/)  as a standard system. This system helps to prevent the car from getting out of its lane. In addition, it has a [**lane departure warning**](../../../../technology/driverassistance/lanedeparturewarning/) system that warns the driver if the vehicle leaves the driving lane.
...
The Nio ET5 Touring has [**automatic emergency braking**](../../../../technology/driverassistance/automaticemergencybraking/) as a standard system. This system helps prevent or mitigate collisions by applying the brakes autonomously if the driver fails to react to an impending collision.
...
The Nio ET5 Touring offers [driving automation on level 1 or 2](../../../../technology/driverassistance/#level-of-autonomous-driving), depending on the equipment level.
...
The cargo capacity in the trunk is 450 liters. With the rear seat down, it is 1447 liters. On the roof, you can load up to 100kg. The maxium weight of the car is 2900kg, and with the base weight of 2379 kg, you can max load 521 kg, including driver and passengers. Some options can increase the base weight and reduce the maximum loading weight. 
