---
title: Porsche Taycan (GEN1)
linktitle: "Taycan GEN1"
description: "Porsche Taycan (GEN1) is an all-electric luxury sedan with a WLTP range of up to 484 km (301 miles). EVKX.net has all the details."
weight: 10
hidden: true
shownavtabs: true
...
{{< sitefiguresized thumb="models/porsche/taycan/taycan_gen1/main_1_st.jpg" title="Porsche Taycan (GEN1)" width="3000" height="1687"  >}}
...
This model has been replaced by [Porsche Taycan](/models/porsche/taycan/taycan/).
...
With the optional Performance Battery Plus battery, you get other performance numbers. With overboost, the Porsche Taycan (GEN1) reaches a maximum power of 350 kW (476 hp / 469 bhp). Without overboost, it delivers 280 kW (381 hp / 376 bhp). The maximum torque is 357 Nm (263 lb-ft). It can accelerate from 0 to 100 km/h (0 to 62 mph) in 5.4 seconds and reaches a top speed of 230 km/h (143 mph), demonstrating its solid performance.
...
The Porsche Taycan (GEN1) has a rear-wheel drive system supported by one motor on the rear axle. The motor used are [Permanent Magnet Synchronous Motors](../../../../technology/motors/pmsm/).
...
You can order Porsche Taycan (GEN1) with an alternative Adaptive Air Suspension suspension. The front suspension is [double wishbone](../../../../technology/suspension/#double-wishbone), and the rear suspension is [Multilink](../../../../technology/suspension/#multilink). It uses air suspension and hydraulic dampers. The suspension is fully adaptive on the front and rear axle, so height and damping can be adjusted manually and automatically. The minimum ground clearance is 103 mm, and the maximum is 127 mm.

### Steering

Dynamic steering is a standard feature on the Porsche Taycan (GEN1). Dynamic steering varies the steering ratio as a function of driving speed. In addition,  rear-wheel steering is available as an optional feature. Rear wheel steering reduces the turning circle when going slow.
...
You can select from multiple wheel options in different sizes on the Porsche Taycan (GEN1), allowing you to customize your vehicle to suit your style and driving preferences. The available tire and wheel combinations include:
...
{{< sitefiguresized thumb="models/porsche/taycan/taycan_gen1/exterior_1_st.jpg" title="Porsche Taycan (GEN1)" width="3000" height="1713"  >}}
...
For the front row, the Porsche Taycan (GEN1) offers three different seat types to choose from, catering to a range of comfort and style preferences.
...
The Porsche Taycan (GEN1) includes several features to enhance comfort and convenience:
...
The Porsche Taycan (GEN1) is equipped with a single type of steering wheel:
...
Furthermore, the Porsche Taycan (GEN1) supports Android Auto and Apple CarPlay. This functionality allows you to present your phone's screen in the car's screen so you can run apps like Google Maps or Waze.

### Sound System

You can choose between three sound systems on the Porsche Taycan (GEN1).
...
You can choose between two types of headlights for the Porsche Taycan (GEN1).
...
The Porsche Taycan (GEN1) includes several standard and optional [advanced driver assistance systems](../../../../technology/driverassistance/) (ADAS) to enhance safety and comfort.

[**Efficiency Assist**](../../../../technology/driverassistance/efficencyassist/): A Standard feature that helps drivers anticipate driving conditions and conserve energy.

### Safety Systems

[**Anti-lock Braking System (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard on the Porsche Taycan (GEN1), this system prevents the wheels from locking during braking.

[**Electronic Stability Control (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard on the Porsche Taycan (GEN1), this system improves the vehicle's stability and handling during sudden maneuvers or on slippery road conditions.

[**Lane-Keeping Assist (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard on the Porsche Taycan (GEN1), this system helps prevent the vehicle from drifting out of its lane. It also includes a [**Lane Departure Warning**](../../../../technology/driverassistance/lanedeparturewarning/) system to alert the driver if the vehicle veers out of the lane.

[**Front Cross Traffic Assist (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/) : Optional on the Porsche Taycan (GEN1), this driver assist system that helps drivers detect oncoming traffic when crossing an intersection or turning left or right from a stopped position.

[**Rear Cross Traffic Alert (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Optional on the Porsche Taycan (GEN1), this system uses sensors to detect approaching vehicles from the side when backing out of a parking space or driveway.

[**Forward Collision Warning (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Optional on the Porsche Taycan (GEN1), this driver assist system helps drivers avoid or mitigate frontal collisions.

[**Automatic Emergency Braking (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard on the Porsche Taycan (GEN1), this system autonomously applies the brakes to prevent or reduce the severity of a collision if the driver does not react in time.

[**Automatic Emergency Steering (AES)**](../../../../technology/driverassistance/automaticemergencysteering/): Standard on the Porsche Taycan (GEN1), this system assists in avoiding collisions by automatically steering the vehicle in an emergency.

[**Blind-spot Monitoring (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Optional on the Porsche Taycan (GEN1), this side assist system helps to detect traffic in blind spots.

### Driving Automation

The Porsche Taycan (GEN1) offers [driving automation at levels 1 or 2](../../../../technology/driverassistance/#level-of-autonomous-driving), depending on the equipment level.
...
{{< sitefiguresized thumb="models/porsche/taycan/taycan_gen1/trunk_1_st.jpg" title="Porsche Taycan (GEN1)" width="3000" height="2250"  >}}
