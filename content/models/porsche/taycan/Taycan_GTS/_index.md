...
Porsche Taycan GTS has a rear-wheel drive system supported by one motor on the rear axle. 
...
You can choose between two types of headlights for the Porsche Taycan GTS. The standard headlights use LED technology.  Headlights based on LED Matrix technology are available as an option. LED Matrix is an adaptive system that splits the traditional single headlight beam into dozens of smaller rays that can be turned on and off individually to un-light small areas in front.  In addition, the standard taillights use LED technology. 
