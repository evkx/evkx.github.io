---
title: Porsche Macan 4 especificaciones
linktitle: "Especificaciones"
description: "EVKX.net le brinda las especificaciones completas para Porsche Macan 4."
weight: 4
hidden: true
...
EVKX.net busca tener las especificaciones más completas para Porsche Macan 4. Haga clic en la imagen de arriba para ver [artículo completo](../), visite la [galería de imágenes](../gallery/) para imágenes de alta resolución de Porsche Macan 4, visite [chargeinfo](../chargingcurve/) para Porsche Macan 4 con chargecurve, visite [información de rango extendido](../rangeandconsumption/) para rangos del mundo real.
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Papaya Metallic (Naranja)</br>
				Oak Green Metallic (Verde)</br>
				Copper Ruby Metallic (Cobre)</br>
				Aventurine Green Metallic (Verde)</br>
			</td>
		</tr>
	</tbody>
</table>
