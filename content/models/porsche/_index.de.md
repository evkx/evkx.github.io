...
Porsche Macan ist ein Premium-Coupé-SUV, das in 4 Varianten erhältlich ist.
</p>
	<a href="macan/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Porsche Taycan ist eine Luxuslimousine/Kombi, die in 28 Varianten erhältlich ist.
</p>
    ...
    <div id="module-company" class="accordion-collapse collapse">
        <div class="accordion-body">
{{% insert "content/models/porsche/company.de.md" %}}
</div>
</div>
</div>
</div>
