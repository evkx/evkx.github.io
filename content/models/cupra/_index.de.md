...
CUPRA BORN ist ein Schrägheck, das in 4 Varianten erhältlich ist.
</p>
	<a href="born/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
CUPRA Tavascan ist ein SUV, der in 2 Varianten erhältlich ist.
</p>
	<a href="tavascan/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
        </div>
