...
description: "Neta GT 580 AWD ist ein vollelektrisches Coupé mit einer Reichweite von bis zu 580 km (361 Meilen). EVKX.net hat alle Details."
weight: 10
hidden: true
shownavtabs: true
...
Der Neta GT 580 AWD liefert eine solide Leistung mit einer maximalen Leistung von 340 kW (462 PS / 456 bhp) und einem Gesamtdrehmoment von 620 Nm (458 lb-ft). Er beschleunigt in 3,7 Sekunden von 0 auf 100 km/h (0 auf 62 mph) und erreicht eine Höchstgeschwindigkeit von 190 km/h (118 mph), was ihn wettbewerbsfähig in seiner Klasse macht.

## Batterie, Reichweite und Laden

Die Hochkapazitätsbatterie hat eine Bruttokapazität von 78,0 kWh und eine nutzbare Nettokapazität von 75,0 kWh, was einen Puffer von 3,0 kWh (3,8%) zum Schutz der Batterie bietet.

Die Reichweite des Fahrzeugs nach dem [CLTC](../../../../guides/understandingrange/cltc/) (China Light-Duty Vehicle Test Cycle) Standard beträgt 580 km (361 Meilen). Der Energieverbrauch beträgt 12,9 kWh/100 km basierend auf dem CLTC-Standardtest. Für weitere Details zur Reichweite siehe reale Daten und Reichweitenliste auf der [Reichweite und Verbrauch](rangeandconsumption/) Seite dieses Modells.

Das Fahrzeug unterstützt schnelles DC-Laden mit einer maximalen Leistung von 120 kW. Das Laden von 0% auf 100% dauert etwa 63 Minuten, während ein typischer Ladevorgang von 10% auf 80% 32 Minuten dauert, mit einer durchschnittlichen Ladegeschwindigkeit von 100 kW. Unter Berücksichtigung von zusätzlichen 5 Minuten für jeden Ladestopp aufgrund von Fahrunterbrechungen liegt der optimale Ladebereich zwischen 4% und 76%. Dies führt zu einer effektiven Ladegeschwindigkeit, einschließlich der verlorenen Zeit, von 88 kW, wobei jede Ladesitzung etwa 37 Minuten und 46 Sekunden dauert.

In einer theoretischen 1000 km Herausforderung, beginnend mit einer vollen Batterie und einer konstanten Geschwindigkeit von 120 km/h (75 mph) unter idealen Bedingungen mit einem angenommenen Verbrauch von 23 kWh/100 km, würde die Fahrt etwa 10 Stunden und 5 Minuten dauern. Diese Reise würde drei Ladestopps von 5% auf 74% erfordern, mit einer gesamten Ladezeit von 106 Minuten.
...
Der Neta GT 580 AWD verfügt über ein Allradantriebssystem, das von zwei Motoren angetrieben wird, einem an jeder Achse. Die verwendeten Motoren sind [Permanentmagnet-Synchronmotoren](../../../../technology/motors/pmsm/).
...
Sie können aus mehreren Raddesigns wählen, die alle in derselben Größe für den Neta GT 580 AWD erhältlich sind, sodass Sie Ihr Fahrzeug an Ihren Stil und Ihre Fahrpräferenzen anpassen können. Die verfügbaren Reifen- und Radkombinationen umfassen:
...
Der Neta GT 580 AWD bietet nur einen Typ von Vordersitz.
...
Der Neta GT 580 AWD umfasst mehrere Funktionen, um Komfort und Bequemlichkeit zu verbessern:
...
Der Neta GT 580 AWD ist mit einem einzigen Lenkradtyp ausgestattet:
...
Der Neta GT 580 AWD verfügt über eine Reihe von standardmäßigen und optionalen [fortschrittlichen Fahrerassistenzsystemen](../../../../technology/driverassistance/) (ADAS), die die Sicherheit und den Komfort verbessern sollen.

### Sicherheitssysteme

[**Antiblockiersystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard im Neta GT 580 AWD, dieses System verhindert das Blockieren der Räder beim Bremsen.

[**Elektronische Stabilitätskontrolle (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard im Neta GT 580 AWD, dieses System verbessert die Stabilität und das Handling des Fahrzeugs bei plötzlichen Manövern oder auf rutschigen Straßenbedingungen.

[**Spurhalteassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard im Neta GT 580 AWD, dieses System hilft, das Fahrzeug in seiner Spur zu halten. Es umfasst auch ein [**Spurverlassenswarnsystem**](../../../../technology/driverassistance/lanedeparturewarning/), das den Fahrer warnt, wenn das Fahrzeug die Spur verlässt.

[**Front Cross Traffic Assist (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/): Standard im Neta GT 580 AWD, dieses Fahrerassistenzsystem hilft Fahrern, den Querverkehr zu erkennen, wenn sie eine Kreuzung überqueren oder von einer stehenden Position nach links oder rechts abbiegen.

[**Querverkehrswarnung hinten (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard im Neta GT 580 AWD, dieses System verwendet Sensoren, um herannahende Fahrzeuge von der Seite zu erkennen, wenn Sie aus einer Parklücke oder Einfahrt zurücksetzen.

[**Vorwärtskollisionswarnung (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard im Neta GT 580 AWD, dieses Fahrerassistenzsystem hilft Fahrern, Frontalzusammenstöße zu vermeiden oder zu mildern.

[**Automatische Notbremsung (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard im Neta GT 580 AWD, dieses System bremst autonom, um eine Kollision zu verhindern oder deren Schwere zu verringern, wenn der Fahrer nicht rechtzeitig reagiert.

[**Totwinkelüberwachung (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/): Standard im Neta GT 580 AWD, dieses Seitenassistenzsystem hilft, den Verkehr im toten Winkel zu erkennen.

[**Aussteigewarnung**](../../../../technology/driverassistance/exitwarning/): Standard im Neta GT 580 AWD, dieses System warnt Insassen davor, Türen zu öffnen, wenn die Gefahr besteht, etwas zu treffen.
...
Der Neta GT 580 AWD ist mit fortschrittlichen Sicherheitsfunktionen ausgestattet, um Sie und Ihr Fahrzeug zu schützen. Diese umfassen:
...
Der Kofferraum bietet ein Ladevolumen von 297 Litern (10,5 CU FT). Zusätzlich gibt es einen Frunk (vorderer Kofferraum) mit einem Ladevolumen von 50 Litern (1,8 CU FT).
...
Der Neta GT 580 AWD feierte seine Weltpremiere am 13.07.2023, mit Lieferungen ab December 2023. Bitte beachten Sie, dass dieses Modell ausschließlich in China erhältlich ist.
{{< pagenavigation b_url="../" b_title="Neta GT" f_url="rangeandconsumption/" f_title="Reichweite" >}}
