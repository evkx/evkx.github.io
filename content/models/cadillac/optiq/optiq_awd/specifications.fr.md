---
title: Cadillac OPTIQ AWD spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Cadillac OPTIQ AWD."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Cadillac OPTIQ AWD. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Cadillac OPTIQ AWD, visitez les [chargeinfo](../chargingcurve/) pour Cadillac OPTIQ AWD avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Emerald Lake Metallic (Vert)</br>
				Nimbus Metallic (Blanc)</br>
				Stellar Black Metallic (Noir)</br>
				Celestial Metallic (Bleu)</br>
				Opulent Blue Metallic (Bleu)</br>
				Crystal White Tricoat (Blanc)</br>
				Radiant Red Tricoat (Rouge)</br>
			</td>
		</tr>
	</tbody>
</table>
