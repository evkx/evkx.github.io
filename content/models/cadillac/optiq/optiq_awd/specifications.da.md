---
title: Cadillac OPTIQ AWD specifikationer
linktitle: "Specifikationer"
description: "EVKX.net giver dig de fulde specifikationer for Cadillac OPTIQ AWD."
weight: 4
hidden: true
...
EVKX.net søger at have de mest komplette specifikationer for Cadillac OPTIQ AWD. Klik på billedet ovenfor for [fuld artikel](../), besøg [billedgalleriet](../gallery/) for billeder i høj opløsning af Cadillac OPTIQ AWD, besøg [chargeinfo](../chargingcurve/) for Cadillac OPTIQ AWD med chargecurve, se [extended range info](../rangeandconsumption/) for real world ranges.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Argent Silver Metallic (Sølv)</br>
				Emerald Lake Metallic (Grøn)</br>
				Nimbus Metallic (Hvid)</br>
				Stellar Black Metallic (Sort)</br>
				Celestial Metallic (Blå)</br>
				Opulent Blue Metallic (Blå)</br>
				Crystal White Tricoat (Hvid)</br>
				Radiant Red Tricoat (Rød)</br>
			</td>
		</tr>
	</tbody>
</table>
