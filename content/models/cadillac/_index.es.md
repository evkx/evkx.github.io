---
title: Modelos EV de Cadillac
linktitle: "Cadillac"
description: "Cadillac, un pionero en autos de lujo americanos desde 1902, combina herencia con innovación. Como la marca premium de General Motors, Cadillac ahora está impulsando un audaz cambio hacia la electrificación. Con un compromiso con una línea totalmente eléctrica para 2030, la marca se enfoca en tecnología avanzada, sostenibilidad y mantener su atractivo de lujo característico."
weight: 30
---
...
Cadillac ESCALADE es un SUV disponible en 1 variantes.
</p>
	<a href="escalade/" class="btn btn-outline-primary" role="button">Ir a la información del modelo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Cadillac LYRIQ es un SUV disponible en 2 variantes.
</p>
	<a href="lyriq/" class="btn btn-outline-primary" role="button">Ir a la información del modelo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Cadillac OPTIQ es un SUV disponible en 1 variantes.
</p>
	<a href="optiq/" class="btn btn-outline-primary" role="button">Ir a la información del modelo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
...
Cadillac VISTIQ es un SUV disponible en 1 variantes.
    ...
    <div id="module-company" class="accordion-collapse collapse">
        <div class="accordion-body">
{{% insert "content/models/cadillac/company.es.md" %}}
</div>
</div>
</div>
</div>
