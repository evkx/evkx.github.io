...
Cadillac LYRIQ is a SUV available in 2 variants.
    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Cadillac OPTIQ is a SUV available in 1 variants.
</p>
	<a href="optiq/" class="btn btn-outline-primary" role="button">Go to model info</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Cadillac VISTIQ is a SUV available in 1 variants.
</p>
	<a href="vistiq/" class="btn btn-outline-primary" role="button">Go to model info</a>
		</div>
	</div>
</div>
        </div>
