...
linktitle: "VISTIQ"
description: "Consulta a continuación los detalles de las diferentes variantes de Cadillac VISTIQ"
weight: 30
---
...
<i class="bi bi-record2-fill"></i> AWD <i class="bi bi-battery-full"></i> 112,5 kWh <i class="bi bi-ev-station"></i> 190 kW 
		...
		<div class="col col-12 col-md-6">
			<ul class="list-group list-group-flush">
				...
				<li class="list-group-item list-group-item-action"><a href="vistiq_awd/rangeandconsumption/" class="text-decoration-none text-black" ><i class="bi-file-earmark-bar-graph"></i> Rango</a></li>
