...
description: "Cadillac VISTIQ AWD er en elektrisk SUV med en EPA rækkevidde på op til 525 km (326 miles). EVKX.net har alle detaljerne."
weight: 10
hidden: true
shownavtabs: true
...
Cadillac VISTIQ AWD har en imponerende styrke med en maksimal effekt på 458,6 kW (624 hk / 615 bhp) og et kommanderende samlet drejningsmoment på 880 Nm (649 lb-ft). Denne højtydende maskine kan sprinte fra 0 til 100 km/t (0 til 62 mph) på kun 3,7 sekunder, og den når en tophastighed på 210 km/t (131 mph), hvilket gør den til en frontløber i sin klasse.
...
[EPA](../../../../guides/understandingrange/epa/) (Environmental Protection Agency) estimeret rækkevidde varierer mellem 326 og 307 miles (525-494 km), afhængigt af køretøjets konfiguration og tilvalg. For eksempel kan større hjul øge energiforbruget og reducere den samlede rækkevidde.
...
Cadillac VISTIQ AWD har et firehjulstræksystem drevet af to motorer, én på hver aksel. Motorerne er [Permanent Magnet Synkron Motorer](../../../../technology/motors/pmsm/).

### Affjedring

### Styring

Dynamisk styring er standard på Cadillac VISTIQ AWD, hvor styringsforholdet varierer baseret på kørehastighed for forbedret kontrol og komfort. Derudover er baghjulsstyring tilgængelig som standard funktion. Baghjulsstyring reducerer vendediameteren ved langsom kørsel.

### Køretilstande

Cadillac VISTIQ AWD lader brugeren vælge forskellige [køretilstande](../../../../technology/drivemodes/) som påvirker bilens håndtering. Føreren kan vælge mellem 3 tilstande:

- Tour: Afbalanceret styring og effektiv gaspedal.
- Sport: Afbalanceret styring og gaspedal.
- My Mode: Brugerdefinerede indstillinger for styring og gaspedal.

### Bremser

Du kan vælge mellem forskellige bremsesystemer. standard bremsevalget bruger almindelige [støbejerns-skiver](../../../../technology/brakes/#disc-brakes). De forreste skiver måler 343 mm, mens de bageste skiver er 345 mm. second bremsevalget bruger almindelige [støbejerns-skiver](../../../../technology/brakes/#disc-brakes). De forreste skiver måler 410 mm, mens de bageste skiver er 345 mm.
...
Cadillac VISTIQ AWD, med dimensioner på 5222 mm i længde, 1977 mm i bredde og 1804 mm i højde, tilhører store SUV'er, der tilbyder mest plads, kraft og kapacitet blandt SUV-kategorier, hvilket gør dem velegnede til specifikke bilister med særlige behov. Cadillac VISTIQ AWD fås i alt i 8 lakfarver, inklusive flere iøjnefaldende metalliske muligheder.

Cadillac VISTIQ AWD tilbyder flere hjulmuligheder i forskellige størrelser, så du kan tilpasse din bil efter din stil og kørepræferencer. De tilgængelige dæk- og hjulkombinationer inkluderer:

- 285/45 dæk på 21" fælge
- 295/40 dæk på 22" fælge
- 305/35 dæk på 23" fælge
...
Interiøret i Cadillac VISTIQ AWD er funktionelt og har førsteklasses materialer overalt. Den svævende midterkonsol skaber et åbent rum mellem passager og fører, og giver praktiske opbevaringsmuligheder. Du kan vælge mellem forskellige typer sædematerialer og interiørstyling. Du kan vælge mellem flere interiørdesigns.
...
Cadillac VISTIQ AWD tilbyder én type forsæde.
...
Cadillac VISTIQ AWD inkluderer flere funktioner for at forbedre komfort og bekvemmelighed:
...
Kontrolgrænsefladen for Cadillac VISTIQ AWD kombinerer knapper, kontaktarme og skærme for en problemfri og brugervenlig oplevelse.

Cadillac VISTIQ AWD har en enkelt skærm til føreren. Instrumentbrættets midte har en enkelt [infotainmentskærm](../../../../technology/userinterface/screens/#infotainment-screen), der fungerer som den primære skærm for både køretøjsinformation og infotainment-funktioner.
...
Cadillac VISTIQ AWD er udstyret med én type rat:
...
Cadillac VISTIQ AWD kommer med ét lydsystem:
...
Cadillac VISTIQ AWD kommer med en dedikeret mobilapp, tilgængelig til både Android og iOS-enheder, så du kan styre og overvåge din bil på afstand. Appen tilbyder en bred vifte af funktioner designet til at forbedre din køreoplevelse:
...
Cadillac VISTIQ AWD har en række standard og valgfrie [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) designet til at forbedre sikkerhed og komfort.

### Sikkerhedssystemer

[**Antiblokeringssystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Cadillac VISTIQ AWD, dette system forhindrer hjulene i at låse under bremsning.

[**Elektronisk Stabilitetskontrol (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Cadillac VISTIQ AWD, dette system forbedrer bilens stabilitet og håndtering under pludselige manøvrer eller på glatte veje.
...
[**Front Tværgående Trafik Assistent (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/) : Ekstraudstyr på Cadillac VISTIQ AWD, dette førerassistentsystem hjælper førere med at registrere modkørende trafik ved krydsning af et vejkryds eller når der drejes til venstre eller højre fra stillestående position.

[**Advarsel om Krydsende Trafik Bag (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard på Cadillac VISTIQ AWD, dette system bruger sensorer til at opdage køretøjer, der nærmer sig fra siden, når man bakker ud af en parkeringsplads eller indkørsel.

[**Advarsel om Frontal Kollision (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Cadillac VISTIQ AWD, dette førerassistentsystem hjælper førere med at undgå eller mindske frontale kollisioner.

[**Automatisk Nødbremsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Cadillac VISTIQ AWD, dette system aktiverer automatisk bremserne for at forhindre eller reducere alvorligheden af en kollision, hvis føreren ikke reagerer i tide.

[**Blindvinkel Overvågning (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard på Cadillac VISTIQ AWD, dette system hjælper med at opdage trafik i blinde vinkler.
...
Cadillac VISTIQ AWD er udstyret med flere airbags for at sikre beskyttelse af passagererne i tilfælde af en kollision. Airbagsystemet omfatter:
...
Cadillac VISTIQ AWD er udstyret med avancerede sikkerhedsfunktioner for at beskytte dig og dit køretøj. Disse omfatter:
...
Bagagerummet har en lastkapacitet på 431 liter (15,2 CU FT). Med bagsædet lagt ned udvides dette til 2272 liter (80,2 CU FT). På taget kan du laste op til 75 kg (165,3 lbs).

Køretøjets maksimale vægt er 3450 kg (7606 lbs), med en egenvægt på 2869 kg (6325 lbs). Dette giver en maksimal last på 581 kg (1281 lbs), inklusive fører og passagerer. Bemærk at nogle tilvalg kan øge egenvægten og reducere den maksimale lasteevne.

Anhængertræk kan tilføjes til køretøjet. Den maksimalt tilladte vægt for en bremset trailer er 2268 kg (5000 lbs), mens det for en ubremset trailer er 750 kg (1653 lbs).

## Tilgængelighed & Priser

Denne model havde sin verdenspremiere den 02.11.2024, og leveringerne forventes at begynde i July 2025.
...
{{< pagenavigation b_url="../" b_title="Cadillac VISTIQ" f_url="rangeandconsumption/" f_title="Rækkevidde" >}}
