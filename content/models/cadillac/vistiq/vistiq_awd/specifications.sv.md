---
title: Cadillac VISTIQ AWD Specifikationer
linktitle: "Specifikationer"
description: "EVKX.net ger dig alla specifikationer för Cadillac VISTIQ AWD."
weight: 4
hidden: true
...
EVKX.net vill ha de mest kompletta specifikationerna för Cadillac VISTIQ AWD. Klicka på bilden ovan för [fullständig artikel](../), besök [bildgalleri](../gallery/) för hög upplösningsbilder av Cadillac VISTIQ AWD, gå till [chargeinfo](../chargingcurve/) för Cadillac VISTIQ AWD med laddningskurva, se [extended range info](../rangeandconsumption/) för verkliga räckvidd.
...
Denna modell är tillgänglig med en konfiguration med sex sittplatser.
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Emerald Lake Metallic (Grön)</br>
				Nimbus Metallic (Vit)</br>
				Stellar Black Metallic (Svart)</br>
				Celestial Metallic (Blå)</br>
				Opulent Blue Metallic (Blå)</br>
				Crystal White Tricoat (Vit)</br>
				Radiant Red Tricoat (Röd)</br>
			</td>
		</tr>
	</tbody>
</table>
