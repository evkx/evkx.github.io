---
title: KGM Torres EVX especificaciones
linktitle: "Especificaciones"
description: "EVKX.net le brinda las especificaciones completas para KGM Torres EVX."
weight: 4
hidden: true
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Grand White (Blanco)</br>
				Platinium White (Gris)</br>
				Dandy Blue (Azul)</br>
				Iron Silver (Plata)</br>
