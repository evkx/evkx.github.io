---
title: Leapmotor C10 69kWh RWD spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Leapmotor C10 69kWh RWD."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Leapmotor C10 69kWh RWD. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Leapmotor C10 69kWh RWD, visitez les [chargeinfo](../chargingcurve/) pour Leapmotor C10 69kWh RWD avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
