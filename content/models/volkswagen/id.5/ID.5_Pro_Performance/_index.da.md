...
description: "Volkswagen ID.5 Pro Performance er en elektrisk coupé SUV med en WLTP rækkevidde på op til 529 km (329 miles). EVKX.net har alle detaljerne."
weight: 10
hidden: true
shownavtabs: true
...
Volkswagen ID.5 Pro Performance tilbyder beskeden ydeevne med en maksimal effekt på 150 kW (204 hk / 201 bhp) og et samlet drejningsmoment på 310 Nm (229 lb-ft). Den accelererer fra 0 til 100 km/t (0 til 62 mph) på 8,4 sekunder og har en tophastighed på 160 km/t (99 mph), hvilket ligger tættere på traditionelle forbrændingsmotorer.
...
Volkswagen ID.5 Pro Performance har et baghjulstræksystem understøttet af én motor på bagakslen. Den anvendte motor er en [induktionsmotor](../../../../technology/motors/asm/).
...
Volkswagen ID.5 Pro Performance, med dimensioner på 4599 mm i længde, 1852 mm i bredde og 1615 mm i højde, tilhører kategorien Kompakt SUV, også kendt som C-SUV. Disse tilbyder en balance mellem mindre bilers praktiske egenskaber og manøvredygtighed og større SUV'ers plads og alsidighed. Volkswagen ID.5 Pro Performance fås i alt i 5 lakfarver, inklusive både almindelige og metalliske muligheder.

Volkswagen ID.5 Pro Performance tilbyder flere hjulmuligheder i forskellige størrelser, så du kan tilpasse din bil efter din stil og kørepræferencer. De tilgængelige dæk- og hjulkombinationer inkluderer:
...
Volkswagen ID.5 Pro Performance har plads til fem passagerer med to forsæder og en trebænk bagtil.
...
Volkswagen ID.5 Pro Performance inkluderer flere funktioner for at forbedre komfort og bekvemmelighed:
...
To forskellige skærmopsætninger er tilgængelige på Volkswagen ID.5 Pro Performance.
...
Volkswagen ID.5 Pro Performance er udstyret med én type rat:
...
Volkswagen ID.5 Pro Performance understøtter Android Auto og Apple CarPlay, så du kan spejle din telefons skærm på bilens display. Denne funktionalitet gør det muligt at køre apps som Google Maps eller Waze direkte fra din telefon.

### Lydsystem

Du kan vælge mellem to lydsystemer til Volkswagen ID.5 Pro Performance:
...
Du kan vælge mellem to typer forlygter til Volkswagen ID.5 Pro Performance.
...
Volkswagen ID.5 Pro Performance har en række standard og valgfrie [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) designet til at forbedre sikkerhed og komfort.
...
[**Antiblokeringssystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Volkswagen ID.5 Pro Performance, dette system forhindrer hjulene i at låse under bremsning.

[**Elektronisk Stabilitetskontrol (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Volkswagen ID.5 Pro Performance, dette system forbedrer bilens stabilitet og håndtering under pludselige manøvrer eller på glatte veje.

[**Vognbaneassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på Volkswagen ID.5 Pro Performance, dette system hjælper med at forhindre køretøjet i at drive ud af sin vognbane. Den inkluderer også et [**Vognbaneafvigelsesadvarsel**](../../../../technology/driverassistance/lanedeparturewarning/) system til at advare føreren, hvis køretøjet afviger fra vognbanen.

[**Front Tværgående Trafik Assistent (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/) : Standard på Volkswagen ID.5 Pro Performance, dette førerassistentsystem hjælper førere med at registrere modkørende trafik ved krydsning af et vejkryds eller når der drejes til venstre eller højre fra stillestående position.

[**Advarsel om Frontal Kollision (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Volkswagen ID.5 Pro Performance, dette førerassistentsystem hjælper førere med at undgå eller mindske frontale kollisioner.

[**Automatisk Nødbremsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Volkswagen ID.5 Pro Performance, dette system aktiverer automatisk bremserne for at forhindre eller reducere alvorligheden af en kollision, hvis føreren ikke reagerer i tide.

[**Automatisk Nødstyring (AES)**](../../../../technology/driverassistance/automaticemergencysteering/): Standard på Volkswagen ID.5 Pro Performance, dette system hjælper med at undgå kollisioner ved automatisk at styre køretøjet i en nødsituation.

[**Blindvinkel Overvågning (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Ekstraudstyr på Volkswagen ID.5 Pro Performance, dette system hjælper med at opdage trafik i blinde vinkler.

### Køreautomatisering

Volkswagen ID.5 Pro Performance tilbyder [køreautomatisering på niveau 1 eller 2](../../../../technology/driverassistance/#level-of-autonomous-driving), afhængigt af udstyrsniveauet.
...
Volkswagen ID.5 Pro Performance er udstyret med avancerede sikkerhedsfunktioner for at beskytte dig og dit køretøj. Disse omfatter:
