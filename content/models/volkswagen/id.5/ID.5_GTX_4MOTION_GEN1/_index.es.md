...
Con overboost, el Volkswagen ID.5 GTX 4MOTION (GEN1) alcanza una potencia máxima de 220 kW (299 hp). Sin overboost, ofrece 195 kW (265 hp). El par máximo es de 460 Nm. Acelera de 0 a 100 km/h en 6,3 segundos y alcanza una velocidad máxima de 180 km/h, ofreciendo un rendimiento más similar a los vehículos tradicionales de motor de combustión interna.

## Batería, autonomía y carga

La batería de alta capacidad tiene una capacidad bruta de 82 kWh y una capacidad neta utilizable de 77 kWh, proporcionando un buffer de 5 kWh (6,1%) para la protección de la batería.
