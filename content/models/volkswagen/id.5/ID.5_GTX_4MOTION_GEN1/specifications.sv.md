---
title: Volkswagen ID.5 GTX 4MOTION (GEN1) Specifikationer
linktitle: "Specifikationer"
description: "EVKX.net ger dig alla specifikationer för Volkswagen ID.5 GTX 4MOTION (GEN1)."
weight: 30
hidden: true
...
EVKX.net vill ha de mest kompletta specifikationerna för Volkswagen ID.5 GTX 4MOTION (GEN1). Klicka på bilden ovan för [fullständig artikel](../), besök [bildgalleri](../gallery/) för hög upplösningsbilder av Volkswagen ID.5 GTX 4MOTION (GEN1), gå till [chargeinfo](../chargecurve/) för Volkswagen ID.5 GTX 4MOTION (GEN1) med laddningskurva, se [extended range info](../rangeandconsumption/) för verkliga räckvidd.
...
<table class="table table-striped border">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				Ja (Dynamic Chassis Control), valfritt
			</td>
		</tr>
		<tr>
			<td>
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Ja (Lane Assist), standardfunktion
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				Ja (Front assist), standardfunktion
			</td>
		</tr>
		<tr>
			<td>
