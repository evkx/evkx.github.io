...
description: "Volkswagen ID.5 GTX 4MOTION (GEN1) är en helelektrisk coupé-SUV med en WLTP räckvidd på upp till 496 km. EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Med overboost når Volkswagen ID.5 GTX 4MOTION (GEN1) en maximal effekt på 220 kW (299 hk). Utan overboost levererar den 195 kW (265 hk). Det maximala vridmomentet är 460 Nm. Den kan accelerera från 0 till 100 km/h på 6,3 sekunder och når en topphastighet på 180 km/h, vilket demonstrerar dess solida prestanda.
...
Dynamisk styrning är valfritt-funktionen för Volkswagen ID.5 GTX 4MOTION (GEN1). Dynamisk styrning varierar styrförhållandet som en funktion av körhastigheten.
...
Volkswagen ID.5 GTX 4MOTION (GEN1), med dimensioner på 4599 mm i längd, 1852 mm i bredd och 1615 mm i höjd, tillhör kompakta SUV:ar, även kända som C-SUV:ar. De erbjuder en balans mellan praktiskt användande och smidighet hos mindre fordon samt utrymme och mångsidighet hos större SUV:ar. Volkswagen ID.5 GTX 4MOTION (GEN1) finns i totalt 5 lackfärger, inklusive både solida och metalliska alternativ.

Du kan välja mellan flera hjulalternativ i olika storlekar på Volkswagen ID.5 GTX 4MOTION (GEN1), vilket gör att du kan anpassa din bil efter din stil och dina körpreferenser.
...
Volkswagen ID.5 GTX 4MOTION (GEN1) rymmer fem passagerare med två säten fram och en tre-sitsig bänk bak.
...
Volkswagen ID.5 GTX 4MOTION (GEN1) inkluderar flera funktioner för att förbättra komfort och bekvämlighet:
...
Dessutom stöder Volkswagen ID.5 GTX 4MOTION (GEN1) Android Auto och Apple CarPlay. Denna funktion gör att du kan visa telefonens skärm på bilens skärm så att du kan köra appar som Google Maps eller Waze.

### Ljudsystem

Du kan välja mellan två ljudsystem på Volkswagen ID.5 GTX 4MOTION (GEN1).
...
Volkswagen ID.5 GTX 4MOTION (GEN1) inkluderar flera [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) som standard och som tillval för att förbättra säkerheten och komforten.
...
[**Låsningsfria bromsar (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Volkswagen ID.5 GTX 4MOTION (GEN1), detta system förhindrar att hjulen låser sig under bromsning.

[**Elektronisk Stabilitetskontroll (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Volkswagen ID.5 GTX 4MOTION (GEN1), detta system förbättrar fordonets stabilitet och hantering vid plötsliga manövrer eller på hala vägar.
...
[**Frontkorsningstrafikassist (FCTA)**](../../../../technology/driverassistance/frontcrosstrafficassist/): Standard på Volkswagen ID.5 GTX 4MOTION (GEN1), detta förarassistanssystem hjälper till att upptäcka mötande trafik vid korsningar eller vid svängning till vänster eller höger från en stillastående position.

[**Framåt Kollisionsvarning (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Volkswagen ID.5 GTX 4MOTION (GEN1), detta förarassistanssystem hjälper till att undvika eller mildra frontalkollisioner.

[**Automatisk nödbromsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Volkswagen ID.5 GTX 4MOTION (GEN1), detta system bromsar autonomt för att förhindra eller minska allvaret av en kollision om föraren inte reagerar i tid.
...
[**Blindspotsövervakning (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Valfritt på Volkswagen ID.5 GTX 4MOTION (GEN1), detta sidostödssystem hjälper till att upptäcka trafik i döda vinklar.

### Körautomatisering

Volkswagen ID.5 GTX 4MOTION (GEN1) erbjuder [körautomatisering på nivå 1 eller 2](../../../../technology/driverassistance/#level-of-autonomous-driving), beroende på utrustningsnivå.
