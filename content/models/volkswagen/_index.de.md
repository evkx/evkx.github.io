...
Volkswagen ID. Buzz ist ein MPV, das in 4 Varianten erhältlich ist.
</p>
	<a href="id._buzz/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Volkswagen Id. UNYX ist ein Coupé-SUV, das in 1 Varianten erhältlich ist.
</p>
	<a href="id._unyx/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Volkswagen ID.3 ist ein Schrägheck, das in 5 Varianten erhältlich ist.
</p>
	<a href="id.3/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Volkswagen ID.4 ist ein SUV, der in 8 Varianten erhältlich ist.
</p>
	<a href="id.4/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
...
Volkswagen ID.5 ist ein Coupé-SUV, das in 4 Varianten erhältlich ist.
    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Volkswagen ID.7 ist eine Limousine/Kombi, die in 6 Varianten erhältlich ist.
</p>
	<a href="id.7/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
        </div>
