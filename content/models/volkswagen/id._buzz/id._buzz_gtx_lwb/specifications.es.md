---
title: Volkswagen ID. Buzz GTX LWB especificaciones
linktitle: "Especificaciones"
description: "EVKX.net le brinda las especificaciones completas para Volkswagen ID. Buzz GTX LWB."
weight: 4
hidden: true
...
EVKX.net busca tener las especificaciones más completas para Volkswagen ID. Buzz GTX LWB. Haga clic en la imagen de arriba para ver [artículo completo](../), visite la [galería de imágenes](../gallery/) para imágenes de alta resolución de Volkswagen ID. Buzz GTX LWB, visite [chargeinfo](../chargingcurve/) para Volkswagen ID. Buzz GTX LWB con chargecurve, visite [información de rango extendido](../rangeandconsumption/) para rangos del mundo real.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Candy white (Blanco)</br>
				Mono Silver Metallic (Plata)</br>
				Bay Leaf Green Metallic (Verde)</br>
				Bay Leaf Green Metallic (Verde)</br>
				Candy White/Bay Leaf Green (Verde)</br>
				Candy White/Energetic Orange (Naranja)</br>
				Candy White/Pomelo Yellow (Amarillo)</br>
				Candy White/Starlight Blue (Azul)</br>
				Energetic Orange Metallic (Naranja)</br>
				Pomelo Yellow Metallic (Amarillo)</br>
				Starlight Blue Metallic (Azul)</br>
				Deep Black Pearlescent (Azul)</br>
			</td>
		</tr>
	</tbody>
</table>
