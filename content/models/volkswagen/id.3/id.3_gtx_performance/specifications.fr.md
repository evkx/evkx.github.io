---
title: Volkswagen ID.3 GTX Performance spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Volkswagen ID.3 GTX Performance."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Volkswagen ID.3 GTX Performance. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Volkswagen ID.3 GTX Performance, visitez les [chargeinfo](../chargingcurve/) pour Volkswagen ID.3 GTX Performance avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
...
<table class="table table-striped border">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				Oui (Dynamic Chassis Control), équipement standard
			</td>
		</tr>
		<tr>
			<td>
