...
description: "Volkswagen ID.3 Pro S es un hatchback eléctrico con una autonomía WLTP de hasta 553 km (344 millas). EVKX.net tiene todos los detalles."
weight: 10
hidden: true
shownavtabs: true
...
El Volkswagen ID.3 Pro S ofrece un rendimiento modesto con una potencia máxima de 170 kW (231 hp / 228 bhp) y un par total de 310 Nm (229 lb-ft). Acelera de 0 a 100 km/h (0 a 62 mph) en 7,1 segundos y alcanza una velocidad máxima de 160 km/h (99 mph), alineándose más con los vehículos tradicionales de motor de combustión interna.
...
En un desafío de 1000 km a una velocidad constante de 120 km/h (75 mph) con una tasa de consumo asumida de 21 kWh/100 km, el viaje tomaría aproximadamente 9 horas y 41 minutos, requiriendo cuatro paradas de carga del 2% al 46%, totalizando 82 minutos de tiempo de carga.
...
El Volkswagen ID.3 Pro S tiene un sistema de tracción trasera soportado por un motor en el eje trasero. El motor utilizado es un [Motor de Inducción](../../../../technology/motors/asm/).
...
La dirección dinámica es una opción en el Volkswagen ID.3 Pro S, variando la relación de dirección según la velocidad de conducción para un control y comodidad mejorados.
...
El Volkswagen ID.3 Pro S, con dimensiones de 4261 mm de longitud, 1809 mm de ancho y 1568 mm de altura, pertenece al segmento de coches C, también conocidos como coches compactos, que equilibran el tamaño, el rendimiento y la asequibilidad, haciéndolos versátiles para una variedad de conductores. El Volkswagen ID.3 Pro S está disponible en un total de 5 colores de pintura, incluidos tanto colores sólidos como metálicos.

El Volkswagen ID.3 Pro S ofrece múltiples opciones de ruedas en diferentes tamaños, lo que le permite personalizar su vehículo para adaptarse a su estilo y preferencias de conducción. Las combinaciones de neumáticos y ruedas disponibles incluyen:
...
El Volkswagen ID.3 Pro S ofrece un solo tipo de asiento delantero.
...
El Volkswagen ID.3 Pro S incluye varias características para mejorar la comodidad y conveniencia:
...
Hay dos configuraciones de pantalla diferentes disponibles en el Volkswagen ID.3 Pro S.
...
El Volkswagen ID.3 Pro S está equipado con un solo tipo de volante:
...
El Volkswagen ID.3 Pro S es compatible con Android Auto y Apple CarPlay, lo que le permite reflejar la pantalla de su teléfono en la pantalla del coche. Esta funcionalidad le permite ejecutar aplicaciones como Google Maps o Waze directamente desde su teléfono.

### Sistema de Sonido

Puede elegir entre dos sistemas de sonido para el Volkswagen ID.3 Pro S:
...
Puede elegir entre dos tipos de faros delanteros para el Volkswagen ID.3 Pro S.
...
El Volkswagen ID.3 Pro S cuenta con una gama de sistemas [avanzados de asistencia al conductor](../../../../technology/driverassistance/) (ADAS) estándar y opcionales diseñados para mejorar la seguridad y la comodidad.
...
[**Sistema de frenos antibloqueo (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Estándar en el Volkswagen ID.3 Pro S, este sistema evita que las ruedas se bloqueen durante el frenado.

[**Control Electrónico de Estabilidad (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Estándar en el Volkswagen ID.3 Pro S, este sistema mejora la estabilidad y el manejo del vehículo durante maniobras repentinas o en condiciones de carretera resbaladiza.
...
[**Advertencia de Colisión Frontal (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Estándar en el Volkswagen ID.3 Pro S, este sistema de asistencia al conductor ayuda a los conductores a evitar o mitigar colisiones frontales.

[**Frenado automático de emergencia (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Estándar en el Volkswagen ID.3 Pro S, este sistema aplica los frenos de manera autónoma para prevenir o reducir la gravedad de una colisión si el conductor no reacciona a tiempo.

[**Dirección automática de emergencia (AES)**](../../../../technology/driverassistance/automaticemergencysteering/): Estándar en el Volkswagen ID.3 Pro S, este sistema ayuda a evitar colisiones al dirigir automáticamente el vehículo en una emergencia.

[**Monitoreo de Punto Ciego (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/): Opcional en el Volkswagen ID.3 Pro S, este sistema de asistencia lateral ayuda a detectar el tráfico en los puntos ciegos.

### Automatización de la Conducción

El Volkswagen ID.3 Pro S ofrece [automatización de la conducción en niveles 1 o 2](../../../../technology/driverassistance/#level-of-autonomous-driving), dependiendo del nivel de equipamiento.
...
El Volkswagen ID.3 Pro S está equipado con características de seguridad avanzadas para protegerlo a usted y a su vehículo. Estas incluyen:
...
El peso máximo del vehículo es de 2420 kg (5335 libras), con un peso base de 1884 kg (4154 libras). Esto permite una carga máxima de 536 kg (1182 libras), incluyendo el conductor y los pasajeros. Tenga en cuenta que algunas opciones pueden aumentar el peso base y reducir la capacidad máxima de carga.
