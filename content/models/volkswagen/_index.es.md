...
<h3> Volkswagen ID. Buzz</h3>
	<div class="row">
		...
		<div class="col col-12 col-md-6">
<p>
Volkswagen ID. Buzz es un monovolumen disponible en 3 variantes.
</p>
...
<h3> Volkswagen ID.3</h3>
	<div class="row">
		...
		<div class="col col-12 col-md-6">
<p>
Volkswagen ID.3 es un hatchback disponible en 2 variantes.
</p>
	<a href="id.3/" class="btn btn-outline-primary" role="button">Ir a la información del modelo</a>
		</div>
	</div>
</div>
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
<h3> Volkswagen ID.4</h3>
	<div class="row">
		...
		<div class="col col-12 col-md-6">
<p>
Volkswagen ID.4 es un SUV disponible en 5 variantes.
</p>
	<a href="id.4/" class="btn btn-outline-primary" role="button">Ir a la información del modelo</a>
		</div>
	</div>
</div>
<div class="container p-3 mb-4 bg-body-tertiary rounded border">
