...
description: "Volkswagen ID.7 GTX Tourer is an all-electric station wagon with a WLTP range of up to 685 km (426 miles). EVKX.net has all the details."
weight: 10
hidden: true
shownavtabs: true
...
For the front row, the Volkswagen ID.7 GTX Tourer offers two different seat types to choose from, catering to a range of comfort and style preferences.
...
You can choose between two sound systems on the Volkswagen ID.7 GTX Tourer.
...
[**Blind-spot Monitoring (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Optional on the Volkswagen ID.7 GTX Tourer, this side assist system helps to detect traffic in blind spots.
