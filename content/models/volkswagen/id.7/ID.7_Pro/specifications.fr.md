---
title: Volkswagen ID.7 Pro spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Volkswagen ID.7 Pro."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Volkswagen ID.7 Pro. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Volkswagen ID.7 Pro, visitez les [chargeinfo](../chargingcurve/) pour Volkswagen ID.7 Pro avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
...
<table class="table table-striped border">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				Oui (Discover Pro), équipement standard
			</td>
		</tr>
		<tr>
			<td>
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Aquamarine blue (Bleu)</br>
				Glacier White Metallic (Blanc)</br>
				Kings red metallic (Rouge)</br>
				Scale silver metallic (Argent)</br>
				Stonewashed Blue metallic (Bleu)</br>
				Aquamarine blue with black roof (Bleu)</br>
				Glacier White Metallic (Blanc)</br>
				Kings red metallic (Rouge)</br>
				Scale silver metallic with black roof (Argent)</br>
				Stonewashed Blue metallic with black roof (Bleu)</br>
			</td>
		</tr>
	</tbody>
</table>
