---
title: Alfa Romeo Junior Veloce spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Alfa Romeo Junior Veloce."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Alfa Romeo Junior Veloce. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Alfa Romeo Junior Veloce, visitez les [chargeinfo](../chargingcurve/) pour Alfa Romeo Junior Veloce avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				White Banqui (Blanc)</br>
				Black Perla Nera (Noir)</br>
				Grey Artense (Gris)</br>
				Red Diva (Rouge)</br>
				Grey Platinium (Gris)</br>
			</td>
		</tr>
	</tbody>
</table>
