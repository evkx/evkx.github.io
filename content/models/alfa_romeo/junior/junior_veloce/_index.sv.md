...
description: "Alfa Romeo Junior Veloce är en elektrisk crossover med en WLTP-räckvidd på upp till 370 km (230 miles). EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Alfa Romeo Junior Veloce erbjuder modest prestanda med en maxeffekt på 176 kW (239 hk / 236 bhp) och ett totalt vridmoment på 400 Nm (295 lb-ft). Den accelererar från 0 till 100 km/h på 5,9 sekunder och har en toppfart på 150 km/h (93 mph), vilket ligger mer i linje med traditionella fordon med förbränningsmotor.
...
Enligt [WLTP](../../../../guides/understandingrange/wltp/) (Worldwide Harmonized Light Vehicles Test Procedure) standarden är fordonets räckvidd 370 km (230 miles), med en energiförbrukning på 13,7 kWh/100 km (3 mi/kWh). För mer information om räckvidden, se verkliga data och räckviddslistor på denna modells [räckvidd och förbrukning](rangeandconsumption/) sida.
...
Alfa Romeo Junior Veloce har ett fyrhjulsdrivet system som drivs av två motorer, en på varje axel.
...
Alfa Romeo Junior Veloce, med måtten 4170 mm i längd, 1780 mm i bredd och 1500 mm i höjd, tillhör B-SUV-segmentet, även känt som kompakta SUV:ar eller crossovers. De kombinerar den kompakta storleken och manövrerbarheten från B-segmentets bilar med högre körposition, ökat lastutrymme och robust SUV-styling. Alfa Romeo Junior Veloce finns tillgänglig i totalt 5 solida lackfärger.

Alfa Romeo Junior Veloce erbjuder flera hjulalternativ i olika storlekar, vilket låter dig anpassa ditt fordon efter din stil och körstil. De tillgängliga däck- och hjulkombinationerna inkluderar:
...
Alfa Romeo Junior Veloce rymmer fem passagerare med två framsäten och en tresätessoffa bak.

#### Första radens säten

Alfa Romeo Junior Veloce erbjuder endast en typ av framsäte.
...
I Alfa Romeo Junior Veloce ingår flera funktioner för att öka komfort och bekvämlighet:
...
Alfa Romeo Junior Veloce är utrustad med endast en typ av ratt:
...
Alfa Romeo Junior Veloce har ett utbud av standard och tillvalda [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) utformade för att förbättra säkerhet och komfort.

### Säkerhetssystem

[**Låsningsfria bromsar (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Alfa Romeo Junior Veloce, detta system förhindrar att hjulen låser sig vid inbromsning.

[**Körfältsassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på Alfa Romeo Junior Veloce, detta system hjälper till att förhindra att fordonet driver ut ur sitt körfält. Den inkluderar också ett [**Körfilsvarningssystem**](../../../../technology/driverassistance/lanedeparturewarning/) som varnar föraren om fordonet avviker från körfältet.

[**Automatisk nödbromsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Alfa Romeo Junior Veloce, detta system bromsar automatiskt för att förhindra eller minska allvarligheten av en kollision om föraren inte reagerar i tid.

### Körautomation

Alfa Romeo Junior Veloce erbjuder [körautomation på nivå 1](../../../../technology/driverassistance/#level-of-autonomous-driving), beroende på utrustningsnivå.
...
Alfa Romeo Junior Veloce är utrustad med avancerade säkerhetsfunktioner för att skydda dig och ditt fordon. Dessa inkluderar:
...
Bagageutrymmet har en lastkapacitet på 400 liter (14,1 kubikfot). Med baksätet nedfällt ökar detta till 1467 liter (51,8 kubikfot).
...
{{< pagenavigation b_url="../" b_title="Alfa Romeo Junior" f_url="rangeandconsumption/" f_title="Räckvidd" >}}
