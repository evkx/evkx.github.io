...
linktitle: "Junior"
description: "Alfa Romeo Junior er en elektrisk crossover med en WLTP rekkevidde på opptil 410 km (255 miles). EVKX.net har alle detaljene."
weight: 10
hidden: true
shownavtabs: true
...
Alfa Romeo Junior tilbyr beskjeden ytelse med en maksimal effekt på 115 kW (156 hk / 154 bhp) og et totalt dreiemoment på 260 Nm (192 lb-ft). Den akselererer fra 0 til 100 km/t på 9 sekunder og har en topphastighet på 150 km/t (93 mph), mer på linje med tradisjonelle forbrenningsmotorer.
...
Ifølge [WLTP](../../../../guides/understandingrange/wltp/) (Worldwide Harmonized Light Vehicles Test Procedure) standarden, er kjørelengden 410 km (255 miles), med et energiforbruk på 12,4 kWh/100 km (5,0 mi/kWh). For mer informasjon om rekkevidde, se faktiske data og rekkeviddelister på denne modellens [rekkevidde og forbruk](rangeandconsumption/) side.
...
Alfa Romeo Junior har et firehjulsdrift-system drevet av to motorer, en på hver aksel.
...
Alfa Romeo Junior, med dimensjoner på 4170 mm i lengde, 1780 mm i bredde og 1500 mm i høyde, tilhører B-SUV segmentet. Også kjent som kompakte SUVer eller crossovere, kombinerer disse bilene den kompakte størrelsen og manøvrerbarheten til B-segment biler med høyere kjøreposisjon, økt bagasjeplass og robust styling fra en SUV. Alfa Romeo Junior er tilgjengelig i totalt 5 solide lakkfarger.

Alfa Romeo Junior tilbyr flere hjulalternativer i ulike størrelser, slik at du kan tilpasse kjøretøyet etter din stil og kjørepreferanser. De tilgjengelige dekk- og hjulkombinasjonene inkluderer:
...
Alfa Romeo Junior har plass til fem passasjerer med to forseter og en treseters benk bak.

#### Forseter

Alfa Romeo Junior tilbyr bare én type forsete.
...
Alfa Romeo Junior inkluderer flere funksjoner for å øke komfort og bekvemmelighet:
...
Alfa Romeo Junior er utstyrt med én type ratt:
...
Alfa Romeo Junior støtter Android Auto og Apple CarPlay, som lar deg speile telefonskjermen på bilens skjerm. Denne funksjonaliteten gjør at du kan kjøre apper som Google Maps eller Waze direkte fra telefonen.

### Lydsystem

Alfa Romeo Junior kommer med ett lydsystem:

- **standard:** Har NULL høyttalere.

## Lys

Alfa Romeo Junior kommer med avanserte LED Matrix frontlykter. Dette adaptive systemet deler den tradisjonelle frontlyktsstrålen inn i flere mindre stråler, som lar lyskontrolleren selektivt skru dem av og på for å unngå å blende andre sjåfører. For økt sikkerhet inkluderer frontlyktene også svinglys som lyser opp siden når du svinger.
...
Alfa Romeo Junior har en rekke standard og valgfrie [avanserte førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) designet for å øke sikkerhet og komfort.

### Sikkerhetssystemer

[**Blokkeringsfrie bremser (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Alfa Romeo Junior, dette systemet hindrer hjulene i å låse seg under bremsing.

[**Filholderassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på Alfa Romeo Junior, dette systemet hjelper med å hindre kjøretøyet i å drive ut av filen. Den inkluderer også et [**Filskiftevarsel**](../../../../technology/driverassistance/lanedeparturewarning/) system som varsler føreren hvis kjøretøyet beveger seg ut av filen.

[**Automatisk nødbrems (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Alfa Romeo Junior, dette systemet aktiverer bremsene automatisk for å forhindre eller redusere alvorlighetsgraden av en kollisjon hvis føreren ikke reagerer i tide.

### Kjøreautomatisering

Alfa Romeo Junior tilbyr [kjøreautomatisering på nivå 1](../../../../technology/driverassistance/#level-of-autonomous-driving), avhengig av utstyrsnivå.
...
Alfa Romeo Junior er utstyrt med avanserte sikkerhetsfunksjoner for å beskytte deg og kjøretøyet ditt. Disse inkluderer:
