...
linktitle: "Junior"
description: "Alfa Romeo Junior är en elektrisk crossover med en WLTP-räckvidd på upp till 410 km (255 miles). EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Alfa Romeo Junior erbjuder modest prestanda med en maxeffekt på 115 kW (156 hk / 154 bhp) och ett totalt vridmoment på 260 Nm (192 lb-ft). Den accelererar från 0 till 100 km/h på 9 sekunder och har en toppfart på 150 km/h (93 mph), vilket ligger mer i linje med traditionella fordon med förbränningsmotor.
...
Alfa Romeo Junior har ett fyrhjulsdrivet system som drivs av två motorer, en på varje axel.
...
Alfa Romeo Junior, med måtten 4170 mm i längd, 1780 mm i bredd och 1500 mm i höjd, tillhör B-SUV-segmentet, även känt som kompakta SUV:ar eller crossovers. De kombinerar den kompakta storleken och manövrerbarheten från B-segmentets bilar med högre körposition, ökat lastutrymme och robust SUV-styling. Alfa Romeo Junior finns tillgänglig i totalt 5 solida lackfärger.

Alfa Romeo Junior erbjuder flera hjulalternativ i olika storlekar, vilket låter dig anpassa ditt fordon efter din stil och körstil. De tillgängliga däck- och hjulkombinationerna inkluderar:
...
Alfa Romeo Junior rymmer fem passagerare med två framsäten och en tresätessoffa bak.
...
I Alfa Romeo Junior ingår flera funktioner för att öka komfort och bekvämlighet:
...
Alfa Romeo Junior är utrustad med endast en typ av ratt:
...
Alfa Romeo Junior stödjer Android Auto och Apple CarPlay, vilket låter dig spegla din telefons skärm på bilens display. Detta gör det möjligt att köra appar som Google Maps eller Waze direkt från din telefon.

### Ljudsystem

Alfa Romeo Junior levereras med ett ljudsystemalternativ:

- **standard:** Har NULL högtalare.

## Belysning

Alfa Romeo Junior levereras med avancerade LED Matrix-strålkastare. Detta adaptiva system delar upp den traditionella strålkastarljusstrålen i flera mindre strålar, vilket låter ljuskontrollern selektivt tända och släcka dem för att undvika att blända andra förare. För ökad säkerhet har strålkastarna också kurvljus som lyser upp sidan vid svängar.
...
Alfa Romeo Junior har ett utbud av standard och tillvalda [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) utformade för att förbättra säkerhet och komfort.

### Säkerhetssystem

[**Låsningsfria bromsar (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Alfa Romeo Junior, detta system förhindrar att hjulen låser sig vid inbromsning.

[**Körfältsassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på Alfa Romeo Junior, detta system hjälper till att förhindra att fordonet driver ut ur sitt körfält. Den inkluderar också ett [**Körfilsvarningssystem**](../../../../technology/driverassistance/lanedeparturewarning/) som varnar föraren om fordonet avviker från körfältet.

[**Automatisk nödbromsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Alfa Romeo Junior, detta system bromsar automatiskt för att förhindra eller minska allvarligheten av en kollision om föraren inte reagerar i tid.

### Körautomation

Alfa Romeo Junior erbjuder [körautomation på nivå 1](../../../../technology/driverassistance/#level-of-autonomous-driving), beroende på utrustningsnivå.
...
Alfa Romeo Junior är utrustad med avancerade säkerhetsfunktioner för att skydda dig och ditt fordon. Dessa inkluderar:
