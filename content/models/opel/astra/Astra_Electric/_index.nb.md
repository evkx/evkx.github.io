...
description: "Opel Astra Electric er en elektrisk kombi med en WLTP rekkevidde på opptil 413 km (257 miles). EVKX.net har alle detaljene."
weight: 10
hidden: true
shownavtabs: true
...
Opel Astra Electric tilbyr beskjeden ytelse med en maksimal effekt på 115 kW (156 hk / 154 bhp) og et totalt dreiemoment på 260 Nm (192 lb-ft). Den akselererer fra 0 til 100 km/t på 10,5 sekunder og har en topphastighet på 170 km/t (106 mph), mer på linje med tradisjonelle forbrenningsmotorer.
...
Ifølge [WLTP](../../../../guides/understandingrange/wltp/) (Worldwide Harmonized Light Vehicles Test Procedure) standarden, er kjørelengden 413 km (257 miles), med et energiforbruk på 12,3 kWh/100 km (5,1 mi/kWh). For mer informasjon om rekkevidde, se faktiske data og rekkeviddelister på denne modellens [rekkevidde og forbruk](rangeandconsumption/) side.
...
Opel Astra Electric har et forhjulsdrift-system med én motor på forakselen.
...
Opel Astra Electric, med dimensjoner på 4374 mm i lengde, 1860 mm i bredde og 1470 mm i høyde, tilhører C-segmentet. Også kjent som kompaktbiler, gir disse en balanse mellom størrelse, ytelse og pris, noe som gjør dem allsidige for mange sjåfører. Opel Astra Electric er tilgjengelig i totalt 7 lakkfarger, inkludert flere slående metallic-lakker.

Du kan velge mellom flere hjuldesign, alle tilgjengelige i samme størrelse, på Opel Astra Electric, slik at du kan tilpasse kjøretøyet etter din stil og kjørepreferanser. De tilgjengelige dekk- og hjulkombinasjonene inkluderer:
...
Opel Astra Electric har plass til fem passasjerer med to forseter og en treseters benk bak.

#### Forseter

Opel Astra Electric tilbyr bare én type forsete.
...
Opel Astra Electric inkluderer flere funksjoner for å øke komfort og bekvemmelighet:
...
Opel Astra Electric har to skjermer med informasjon for fører og passasjerer. Bak rattet er det et [digitalt instrumentpanel](../../../../technology/userinterface/screens/#digital-instruments), og på høyre side er det en [infotainmentskjerm](../../../../technology/userinterface/screens/#infotainment-screen).
...
Opel Astra Electric er utstyrt med én type ratt:
...
Opel Astra Electric støtter Android Auto og Apple CarPlay, som lar deg speile telefonskjermen på bilens skjerm. Denne funksjonaliteten gjør at du kan kjøre apper som Google Maps eller Waze direkte fra telefonen.

### Lydsystem

Opel Astra Electric kommer med ett lydsystem:
...
Opel Astra Electric kommer med avanserte LED Matrix frontlykter. Dette adaptive systemet deler den tradisjonelle frontlyktsstrålen inn i flere mindre stråler, som lar lyskontrolleren selektivt skru dem av og på for å unngå å blende andre sjåfører. For økt sikkerhet inkluderer frontlyktene også svinglys som lyser opp siden når du svinger.
...
Opel Astra Electric har en rekke standard og valgfrie [avanserte førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) designet for å øke sikkerhet og komfort.

### Sikkerhetssystemer

[**Blokkeringsfrie bremser (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på Opel Astra Electric, dette systemet hindrer hjulene i å låse seg under bremsing.

[**Filholderassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på Opel Astra Electric, dette systemet hjelper med å hindre kjøretøyet i å drive ut av filen. Den inkluderer også et [**Filskiftevarsel**](../../../../technology/driverassistance/lanedeparturewarning/) system som varsler føreren hvis kjøretøyet beveger seg ut av filen.

[**Automatisk nødbrems (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Opel Astra Electric, dette systemet aktiverer bremsene automatisk for å forhindre eller redusere alvorlighetsgraden av en kollisjon hvis føreren ikke reagerer i tide.

[**Blindsoneovervåking (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard på Opel Astra Electric, dette sideassistentsystemet hjelper med å oppdage trafikk i blindsoner.

### Kjøreautomatisering

Opel Astra Electric tilbyr [kjøreautomatisering på nivå 1](../../../../technology/driverassistance/#level-of-autonomous-driving), avhengig av utstyrsnivå.
...
Opel Astra Electric er utstyrt med avanserte sikkerhetsfunksjoner for å beskytte deg og kjøretøyet ditt. Disse inkluderer:
...
Kjøretøyets maksimale vekt er 2100 kg (4630 lbs), med en egenvekt på 1736 kg (3827 lbs). Dette tillater en maksimal last på 364 kg (802 lbs), inkludert fører og passasjerer. Merk at noen tilvalg kan øke egenvekten og redusere maksimal lastekapasitet.
...
Opel Astra Electric hadde sin verdenspremiere 06.07.2023, med leveringer som startet i November 2023.
