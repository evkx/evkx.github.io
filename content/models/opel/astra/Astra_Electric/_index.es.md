...
description: "Opel Astra Electric es un hatchback totalmente eléctrico con un WLTP alcance de hasta 413 km (257 millas). EVKX.net tiene todos los detalles."
weight: 10
hidden: true
shownavtabs: true
...
El Opel Astra Electric ofrece un rendimiento modesto con una potencia máxima de 115 kW (156 hp) y un par total de 260 Nm. Acelera de 0 a 100 km/h en 10,5 segundos y tiene una velocidad máxima 170 km/h, lo que lo alinea más con los vehículos de motor de combustión interna tradicionales.
...
Opel Astra Electric tiene un sistema de tracción delantera sostenido por un motor en el eje delantero.
...
Además, el Opel Astra Electric es compatible con Android Auto y Apple CarPlay. Esta funcionalidad te permite presentar la pantalla de tu teléfono en la pantalla del auto para que puedas ejecutar aplicaciones como Google Maps o Waze.
...
El Opel Astra Electric incluye varios [sistemas avanzados de asistencia al conductor](../../../../technology/driverassistance/) (ADAS) estándar y opcionales para mejorar la seguridad y el confort.
...
[**Frenado de emergencia automático (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Estándar en el Opel Astra Electric, este sistema aplica los frenos automáticamente para prevenir o reducir la gravedad de una colisión si el conductor no reacciona a tiempo.

[**Monitoreo de Punto Ciego (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Estándar en el Opel Astra Electric, este sistema de asistencia lateral ayuda a detectar tráfico en los puntos ciegos.

### Automatización de la Conducción

Opel Astra Electric ofrece [automatización de la conducción en nivel 1](../../../../technology/driverassistance/#level-of-autonomous-driving), dependiendo del nivel de equipamiento.
...
El Opel Astra Electric está equipado con características de seguridad avanzadas para protegerlo a usted y a su vehículo. Estos incluyen:
...
El peso máximo del vehículo es 2100 kg, con un peso base de 1736 kg. Esto permite una carga máxima de 364 kg, incluyendo el conductor y los pasajeros. Ten en cuenta que algunas opciones pueden aumentar el peso base y reducir la capacidad máxima de carga.
...
Este modelo tuvo un estreno mundial el 06.07.2023 y las entregas comenzaron en November 2023.
