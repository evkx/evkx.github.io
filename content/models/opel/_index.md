...
Opel Astra is a hatcback / station wagon available in 2 variants.
</p>
...
Opel Frontera is a crossover available in 1 variants.
    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Opel Grandland is a SUV available in 1 variants.
</p>
	<a href="grandland/" class="btn btn-outline-primary" role="button">Go to model info</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
