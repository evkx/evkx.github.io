...
description: "Polestar 4 Long range Dual motor es un SUV cupé totalmente eléctrico con un WLTP alcance de hasta 580 km (361 millas). EVKX.net tiene todos los detalles."
weight: 10
hidden: true
shownavtabs: true
...
Hemos separado nuestro artículo Polestar 4 Long range Dual motor en secciones. Si desea esperar para leer el artículo completo, haga clic en los enlaces a continuación para acceder a las diferentes áreas. También tenemos una descripción general de las [especificaciones completas](specifications/), una [galería de imágenes](gallery/), información detallada sobre [rendimiento de carga](chargingcurve/) y algunas [reseñas en línea](reviews/). Nuestras secciones:
...
La batería de alta capacidad tiene una capacidad bruta de 100,0 kWh y una capacidad neta utilizable de 94,0 kWh, proporcionando un buffer de 6,0 kWh (6,0%) para la protección de la batería. Con un voltaje nominal de 370 voltios, el sistema se clasifica como un sistema de batería de 400 voltios, alineándose con los estándares de la industria. Esta batería de iones de litio utiliza tecnología [NMC (Níquel Manganeso Cobalto)](../../../../technology/battery/cellchemistry/#óxidos-de-litio-níquel-manganeso-y-cobalto-nmc).
...
La velocidad máxima de carga de CC es 200kW. Una carga completa del 0 al 100 % tardaría 61 minutos, mientras que un escenario más común del 10 al 80 % tardaría 29 minutos. Si supone que pierde 5 minutos conduciendo por cada parada de carga, además del tiempo de carga, el área de carga óptima es del 4% al 55%, lo que da como resultado una velocidad de carga real, incluida la pérdida de tiempo, de 130kW. Cada sesión de carga tardaría 22 minutos y 3 segundos.

En un desafío teórico de 1000 km, comenzando con una batería completa y manteniendo una velocidad constante de 120 km/h en condiciones ideales con un consumo asumido de 23 kWh/100 km, el viaje tomaría aproximadamente 9 horas y 23 minutos. Este viaje requeriría dos paradas de carga del 5% al 54%, con un tiempo total de carga de 64 minutos.

### Cargador a bordo

El cargador a bordo estándar soporta hasta 22 kW para carga AC de Nivel 1 y Nivel 2. Esto permite cargar completamente la batería del 0 al 100% en aproximadamente 4 horas y 16 minutos usando un cargador en casa.
...
El Polestar 4 Long range Dual motor, con dimensiones de 4840 mm de longitud, 2008 mm de anchura y 1534 mm de altura, pertenece a los SUV de tamaño mediano y ofrece una mezcla de espacio, confort, rendimiento y versatilidad, siendo adecuados para una amplia gama de conductores con necesidades diversas. El Polestar 4 Long range Dual motor está disponible en un total de 6 colores de pintura, incluyendo varias opciones metálicas llamativas.

Puedes seleccionar entre múltiples diseños de ruedas, todos disponibles en el mismo tamaño, en el Polestar 4 Long range Dual motor, lo que te permite personalizar tu vehículo según tu estilo y preferencias de conducción.
...
El Polestar 4 Long range Dual motor tiene capacidad para cinco pasajeros con dos asientos delanteros y un banco trasero de tres plazas.

#### Asientos de primera fila

El Polestar 4 Long range Dual motor ofrece un único tipo de asiento delantero.
...
El Polestar 4 Long range Dual motor tiene múltiples pantallas integradas. Detrás del volante hay un [grupo de instrumentos digitales](../../../../technology/userinterface/screens/#digital-instruments), y en la consola central , hay una [pantalla de infoentretenimiento](../../../../technology/userinterface/screens/#infotainment-screen) en la parte superior de la consola central.
...
Puedes elegir entre dos sistemas de sonido en el Polestar 4 Long range Dual motor.
...
Puedes elegir entre dos tipos de faros para el Polestar 4 Long range Dual motor.
...
El Polestar 4 Long range Dual motor incluye varios [sistemas avanzados de asistencia al conductor](../../../../technology/driverassistance/) (ADAS) estándar y opcionales para mejorar la seguridad y el confort.
...
[**Control Electrónico de Estabilidad (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Estándar en el Polestar 4 Long range Dual motor, este sistema mejora la estabilidad y el manejo del vehículo durante maniobras repentinas o en condiciones de carretera resbaladizas.

[**Asistencia para Mantener el Carril (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Estándar en el Polestar 4 Long range Dual motor, este sistema ayuda a prevenir que el vehículo se desplace fuera de su carril. También incluye un sistema de [**Advertencia de Salida de Carril**](../../../../technology/driverassistance/lanedeparturewarning/) para alertar al conductor si el vehículo se sale del carril.

[**Advertencia de Tráfico Cruzado Trasero (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Estándar en el Polestar 4 Long range Dual motor, este sistema usa sensores para detectar vehículos que se aproximan desde los laterales al retroceder de un espacio de estacionamiento o entrada.

[**Advertencia de Colisión Frontal (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Estándar en el Polestar 4 Long range Dual motor, este sistema de asistencia al conductor ayuda a evitar o mitigar colisiones frontales.

[**Frenado de emergencia automático (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Estándar en el Polestar 4 Long range Dual motor, este sistema aplica los frenos automáticamente para prevenir o reducir la gravedad de una colisión si el conductor no reacciona a tiempo.
...
El Polestar 4 Long range Dual motor está equipado con características de seguridad avanzadas para protegerlo a usted y a su vehículo. Estos incluyen:
...
El maletero ofrece una capacidad de carga de 526 litros. Con el asiento trasero plegado, esto se expande a 1536 litros. En el techo, puedes cargar hasta 100 kg. Además, hay un frunk (maletero delantero) con una capacidad de almacenamiento de 15 litros.

El peso máximo del vehículo es 3080 kg, con un peso base de 2351 kg. Esto permite una carga máxima de 729 kg, incluyendo el conductor y los pasajeros. Ten en cuenta que algunas opciones pueden aumentar el peso base y reducir la capacidad máxima de carga.
...
{{< pagenavigation b_url="../" b_title="Polestar 4" f_url="rangeandconsumption/" f_title="Rango" >}}
