---
title: Polestar 4 Long range Single motor especificaciones
linktitle: "Especificaciones"
description: "EVKX.net le brinda las especificaciones completas para Polestar 4 Long range Single motor."
weight: 4
hidden: true
...
EVKX.net busca tener las especificaciones más completas para Polestar 4 Long range Single motor. Haga clic en la imagen de arriba para ver [artículo completo](../), visite la [galería de imágenes](../gallery/) para imágenes de alta resolución de Polestar 4 Long range Single motor, visite [chargeinfo](../chargecurve/) para Polestar 4 Long range Single motor con chargecurve, visite [información de rango extendido](../rangeandconsumption/) para rangos del mundo real.
