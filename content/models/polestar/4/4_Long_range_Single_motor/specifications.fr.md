---
title: Polestar 4 Long range Single motor spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Polestar 4 Long range Single motor."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Polestar 4 Long range Single motor. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Polestar 4 Long range Single motor, visitez les [chargeinfo](../chargecurve/) pour Polestar 4 Long range Single motor avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
