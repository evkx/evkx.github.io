...
description: "Polestar 2 Long Range Single Motor es un sedán eléctrico con una autonomía WLTP de hasta 635 km (395 millas). EVKX.net tiene todos los detalles."
weight: 10
hidden: true
shownavtabs: true
...
El Polestar 2 Long Range Single Motor ofrece un rendimiento sólido con una potencia máxima de 220 kW (299 hp / 295 bhp) y un par total de 490 Nm (362 lb-ft). Acelera de 0 a 100 km/h (0 a 62 mph) en 6,2 segundos y alcanza una velocidad máxima de 205 km/h (127 mph), siendo competitivo dentro de su clase.
...
Según el estándar [WLTP](../../../../guides/understandingrange/wltp/) (Procedimiento de Prueba de Vehículos Ligeros Armonizado a Nivel Mundial), la autonomía del vehículo varía entre 635 a 591 km (395-367 millas), dependiendo de la configuración específica y las opciones, como el tamaño de las ruedas. Las ruedas más grandes pueden aumentar el consumo de energía y, posteriormente, reducir la autonomía general. El consumo de energía del vehículo se califica en 12,4 kWh/100 km para el modelo base y 13,4 kWh/100 km para el modelo de gama alta según el ciclo de prueba WLTP. Para más detalles sobre la autonomía, consulte los datos del mundo real y las listas de autonomía en la página de [autonomía y consumo](rangeandconsumption/) de este modelo.
...
En un desafío de 1000 km a una velocidad constante de 120 km/h (75 mph) con una tasa de consumo asumida de 21,5 kWh/100 km, el viaje tomaría aproximadamente 9 horas y 30 minutos, requiriendo tres paradas de carga del 1% al 59%, totalizando 71 minutos de tiempo de carga.
...
El Polestar 2 Long Range Single Motor tiene un sistema de tracción trasera soportado por un motor en el eje trasero.
...
El Polestar 2 Long Range Single Motor está equipado con [frenos de disco de hierro fundido](../../../../technology/brakes/#disc-brakes) tanto en la parte delantera como en la trasera.
...
El Polestar 2 Long Range Single Motor, con dimensiones de 4606 mm de longitud, 1859 mm de ancho y 1652 mm de altura, pertenece al segmento de coches D, también conocidos como coches de tamaño medio o familiares, que ofrecen más espacio, comodidad y características que los segmentos más pequeños, haciéndolos adecuados para una variedad de conductores. El Polestar 2 Long Range Single Motor está disponible en un total de 6 colores de pintura, incluidos varios llamativos colores metálicos.

El Polestar 2 Long Range Single Motor ofrece múltiples opciones de ruedas en diferentes tamaños, lo que le permite personalizar su vehículo para adaptarse a su estilo y preferencias de conducción. Las combinaciones de neumáticos y ruedas disponibles incluyen:
...
El Polestar 2 Long Range Single Motor acomoda cinco pasajeros con dos asientos delanteros y un banco de tres asientos en la parte trasera.

#### Asientos de la Primera Fila

El Polestar 2 Long Range Single Motor ofrece un solo tipo de asiento delantero.
...
El Polestar 2 Long Range Single Motor incluye varias características para mejorar la comodidad y conveniencia:
...
El Polestar 2 Long Range Single Motor tiene múltiples pantallas integradas. Detrás del volante hay un [panel de instrumentos digital](../../../../technology/userinterface/screens/#digital-instruments), y en la consola central, hay una [pantalla de infoentretenimiento](../../../../technology/userinterface/screens/#infotainment-screen) en la parte superior de la consola central.
...
Puede elegir entre dos sistemas de sonido para el Polestar 2 Long Range Single Motor:
...
Puede elegir entre dos tipos de faros delanteros para el Polestar 2 Long Range Single Motor.
...
El Polestar 2 Long Range Single Motor cuenta con una gama de sistemas [avanzados de asistencia al conductor](../../../../technology/driverassistance/) (ADAS) estándar y opcionales diseñados para mejorar la seguridad y la comodidad.
...
[**Control Electrónico de Estabilidad (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Estándar en el Polestar 2 Long Range Single Motor, este sistema mejora la estabilidad y el manejo del vehículo durante maniobras repentinas o en condiciones de carretera resbaladiza.

[**Asistencia de Mantenimiento de Carril (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Estándar en el Polestar 2 Long Range Single Motor, este sistema ayuda a evitar que el vehículo se desvíe de su carril. También incluye un sistema de [**Advertencia de Salida de Carril**](../../../../technology/driverassistance/lanedeparturewarning/) para alertar al conductor si el vehículo se desvía del carril.

[**Alerta de Tráfico Cruzado Trasero (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Estándar en el Polestar 2 Long Range Single Motor, este sistema utiliza sensores para detectar vehículos que se aproximan desde el lado al retroceder de un espacio de estacionamiento o entrada.

[**Advertencia de Colisión Frontal (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Estándar en el Polestar 2 Long Range Single Motor, este sistema de asistencia al conductor ayuda a los conductores a evitar o mitigar colisiones frontales.

[**Frenado automático de emergencia (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Estándar en el Polestar 2 Long Range Single Motor, este sistema aplica los frenos de manera autónoma para prevenir o reducir la gravedad de una colisión si el conductor no reacciona a tiempo.
...
El Polestar 2 Long Range Single Motor está equipado con características de seguridad avanzadas para protegerlo a usted y a su vehículo. Estas incluyen:
