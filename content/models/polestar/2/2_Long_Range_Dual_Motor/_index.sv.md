...
description: "Polestar 2 Long Range Dual Motor är en helt elektrisk sedan med en WLTP-räckvidd på upp till 592 km (368 miles). EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Polestar 2 Long Range Dual Motor levererar en solid prestanda med en maxeffekt på 310 kW (422 hk / 416 bhp) och ett totalt vridmoment på 740 Nm (546 lb-ft). Den accelererar från 0 till 100 km/h på 4,5 sekunder och når en toppfart på 205 km/h (127 mph), vilket gör den konkurrenskraftig inom sin klass.
...
Polestar 2 Long Range Dual Motor har ett fyrhjulsdrivet system som drivs av två motorer, en på varje axel.
...
Polestar 2 Long Range Dual Motor är utrustad med [gjutjärnsskivbromsar](../../../../technology/brakes/#disc-brakes) både fram och bak.
...
Polestar 2 Long Range Dual Motor, med måtten 4606 mm i längd, 1859 mm i bredd och 1652 mm i höjd, tillhör D-segmentet, även känt som mellanklassen eller familjebilar. De erbjuder mer utrymme, komfort och funktioner än mindre segment, vilket gör dem lämpliga för många olika förare. Polestar 2 Long Range Dual Motor finns tillgänglig i totalt 6 lackfärger, inklusive flera slående metallic-alternativ.

Polestar 2 Long Range Dual Motor erbjuder flera hjulalternativ i olika storlekar, vilket låter dig anpassa ditt fordon efter din stil och körstil. De tillgängliga däck- och hjulkombinationerna inkluderar:
...
Polestar 2 Long Range Dual Motor rymmer fem passagerare med två framsäten och en tresätessoffa bak.

#### Första radens säten

Polestar 2 Long Range Dual Motor erbjuder endast en typ av framsäte.
...
I Polestar 2 Long Range Dual Motor ingår flera funktioner för att öka komfort och bekvämlighet:
...
Polestar 2 Long Range Dual Motor har flera integrerade skärmar. Bakom ratten finns en [digital instrumentgrupp](../../../../technology/userinterface/screens/#digital-instruments), och i mittkonsolen finns en [infotainmentskärm](../../../../technology/userinterface/screens/#infotainment-screen) högst upp.
...
Polestar 2 Long Range Dual Motor är utrustad med endast en typ av ratt:
...
Du kan välja mellan två ljudsystem för Polestar 2 Long Range Dual Motor:
...
Du kan välja mellan två olika typer av strålkastare för Polestar 2 Long Range Dual Motor.
...
Polestar 2 Long Range Dual Motor har ett utbud av standard och tillvalda [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) utformade för att förbättra säkerhet och komfort.
...
[**Elektronisk stabilitetskontroll (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på Polestar 2 Long Range Dual Motor, detta system förbättrar fordonets stabilitet och hantering vid plötsliga manövrer eller på halt väglag.

[**Körfältsassistent (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på Polestar 2 Long Range Dual Motor, detta system hjälper till att förhindra att fordonet driver ut ur sitt körfält. Den inkluderar också ett [**Körfilsvarningssystem**](../../../../technology/driverassistance/lanedeparturewarning/) som varnar föraren om fordonet avviker från körfältet.

[**Varning för korsande trafik bak (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard på Polestar 2 Long Range Dual Motor, detta system använder sensorer för att upptäcka annalkande fordon från sidan när man backar ut från en parkeringsplats eller uppfart.

[**Kollisionsvarning framåt (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på Polestar 2 Long Range Dual Motor, detta förarassistanssystem hjälper förare att undvika eller mildra frontalkrockar.

[**Automatisk nödbromsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på Polestar 2 Long Range Dual Motor, detta system bromsar automatiskt för att förhindra eller minska allvarligheten av en kollision om föraren inte reagerar i tid.
...
Polestar 2 Long Range Dual Motor är utrustad med avancerade säkerhetsfunktioner för att skydda dig och ditt fordon. Dessa inkluderar:
