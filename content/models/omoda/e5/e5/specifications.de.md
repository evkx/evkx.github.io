---
title: OMODA E5 Spezifikationen
linktitle: "Spezifikationen"
description: "EVKX.net bietet Ihnen die vollständigen Spezifikationen für OMODA E5."
weight: 4
hidden: true
...
EVKX.net strebt an, die vollständigsten Spezifikationen für OMODA E5 zu haben. Klicken Sie auf das Bild oben für den [vollständigen Artikel](../), besuchen Sie die [Bildergalerie](../gallery/) für hochauflösende Bilder von OMODA E5, besuchen Sie die [Ladeinformationen](../chargingcurve/) für OMODA E5 mit Ladekurve, besuchen Sie die [erweiterten Reichweiteninformationen](../rangeandconsumption/) für reale Reichweiten.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Galena Silver (Silber)</br>
				Tourmaline Grey (Grau)</br>
				Obsidian Black (Schwarz)</br>
				Jade Green (Grün)</br>
				Cobalt Blue (Blau)</br>
				Selenite White (Weiß)</br>
				Garnet Red (Rot)</br>
				Jade Green (Grün)</br>
				Selenite White (Weiß)</br>
				Galena Silver (Silber)</br>
