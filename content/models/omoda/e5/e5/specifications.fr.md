---
title: OMODA E5 spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de OMODA E5."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour OMODA E5. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de OMODA E5, visitez les [chargeinfo](../chargingcurve/) pour OMODA E5 avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Galena Silver (Argent)</br>
				Tourmaline Grey (Gris)</br>
				Obsidian Black (Noir)</br>
				Jade Green (Vert)</br>
				Cobalt Blue (Bleu)</br>
				Selenite White (Blanc)</br>
				Garnet Red (Rouge)</br>
				Jade Green (Vert)</br>
				Selenite White (Blanc)</br>
				Galena Silver (Argent)</br>
