---
title: OMODA E5 especificaciones
linktitle: "Especificaciones"
description: "EVKX.net le brinda las especificaciones completas para OMODA E5."
weight: 4
hidden: true
...
EVKX.net busca tener las especificaciones más completas para OMODA E5. Haga clic en la imagen de arriba para ver [artículo completo](../), visite la [galería de imágenes](../gallery/) para imágenes de alta resolución de OMODA E5, visite [chargeinfo](../chargingcurve/) para OMODA E5 con chargecurve, visite [información de rango extendido](../rangeandconsumption/) para rangos del mundo real.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Galena Silver (Plata)</br>
				Tourmaline Grey (Gris)</br>
				Obsidian Black (Negro)</br>
				Jade Green (Verde)</br>
				Cobalt Blue (Azul)</br>
				Selenite White (Blanco)</br>
				Garnet Red (Rojo)</br>
				Jade Green (Verde)</br>
				Selenite White (Blanco)</br>
				Galena Silver (Plata)</br>
