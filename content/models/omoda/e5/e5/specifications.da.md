---
title: OMODA E5 specifikationer
linktitle: "Specifikationer"
description: "EVKX.net giver dig de fulde specifikationer for OMODA E5."
weight: 4
hidden: true
...
EVKX.net søger at have de mest komplette specifikationer for OMODA E5. Klik på billedet ovenfor for [fuld artikel](../), besøg [billedgalleriet](../gallery/) for billeder i høj opløsning af OMODA E5, besøg [chargeinfo](../chargingcurve/) for OMODA E5 med chargecurve, se [extended range info](../rangeandconsumption/) for real world ranges.
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Galena Silver (Sølv)</br>
				Tourmaline Grey (Grå)</br>
				Obsidian Black (Sort)</br>
				Jade Green (Grøn)</br>
				Cobalt Blue (Blå)</br>
				Selenite White (Hvid)</br>
				Garnet Red (Rød)</br>
				Jade Green (Grøn)</br>
				Selenite White (Hvid)</br>
				Galena Silver (Sølv)</br>
