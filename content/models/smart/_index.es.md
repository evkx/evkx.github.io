---
title: Smart modelos de vehículos eléctricos
linktitle: "Smart"
...
Smart #1 es un crossover disponible en 3 variantes.
</p>
	<a href="hash1/" class="btn btn-outline-primary" role="button">Ir a la información del modelo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
Smart #3 es un crossover disponible en 1 variantes.
</p>
	<a href="hash3/" class="btn btn-outline-primary" role="button">Ir a la información del modelo</a>
		</div>
	</div>
</div>
        </div>
