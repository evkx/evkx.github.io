...
linktitle: "#3 Brabus"
description: "Smart #3 Brabus es un crossover totalmente eléctrico con un WLTP alcance de hasta 415 km (258 millas). EVKX.net tiene todos los detalles."
weight: 10
hidden: true
shownavtabs: true
...
Hemos separado nuestro artículo Smart #3 Brabus en secciones. Si desea esperar para leer el artículo completo, haga clic en los enlaces a continuación para acceder a las diferentes áreas. También tenemos una descripción general de las [especificaciones completas](specifications/), una [galería de imágenes](gallery/), información detallada sobre [rendimiento de carga](chargingcurve/) y algunas [reseñas en línea](reviews/). Nuestras secciones:
...
El Smart #3 Brabus ofrece un rendimiento sólido con una potencia máxima de 315 kW (428 hp) y un par total de 543 Nm. Puede acelerar de 0 a 100 km/h en 3,7 segundos y alcanza una velocidad máxima de 180 km/h, lo que lo hace competitivo en su clase.
...
En un desafío teórico de 1000 km, comenzando con una batería completa y manteniendo una velocidad constante de 120 km/h en condiciones ideales con un consumo asumido de 23,7 kWh/100 km, el viaje tomaría aproximadamente 10 horas y 22 minutos. Este viaje requeriría dos paradas de carga del 5% al 53%, con un tiempo total de carga de 122 minutos.
...
Smart #3 Brabus tiene un sistema de tracción total sostenido por dos motores, uno en cada eje.
...
El Smart #3 Brabus tiene capacidad para cinco pasajeros con dos asientos delanteros y un banco trasero de tres plazas.

#### Asientos de primera fila

El Smart #3 Brabus ofrece un único tipo de asiento delantero.
...
Un tipo de sistema de sonido está disponible para el Smart #3 Brabus.
...
Puedes elegir entre dos tipos de faros para el Smart #3 Brabus.
...
El Smart #3 Brabus incluye varios [sistemas avanzados de asistencia al conductor](../../../../technology/driverassistance/) (ADAS) estándar y opcionales para mejorar la seguridad y el confort.
...
[**Control Electrónico de Estabilidad (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Estándar en el Smart #3 Brabus, este sistema mejora la estabilidad y el manejo del vehículo durante maniobras repentinas o en condiciones de carretera resbaladizas.

[**Asistencia para Mantener el Carril (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Estándar en el Smart #3 Brabus, este sistema ayuda a prevenir que el vehículo se desplace fuera de su carril. También incluye un sistema de [**Advertencia de Salida de Carril**](../../../../technology/driverassistance/lanedeparturewarning/) para alertar al conductor si el vehículo se sale del carril.

[**Advertencia de Tráfico Cruzado Trasero (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Estándar en el Smart #3 Brabus, este sistema usa sensores para detectar vehículos que se aproximan desde los laterales al retroceder de un espacio de estacionamiento o entrada.

[**Advertencia de Colisión Frontal (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Estándar en el Smart #3 Brabus, este sistema de asistencia al conductor ayuda a evitar o mitigar colisiones frontales.

[**Frenado de emergencia automático (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Estándar en el Smart #3 Brabus, este sistema aplica los frenos automáticamente para prevenir o reducir la gravedad de una colisión si el conductor no reacciona a tiempo.

[**Advertencia de Salida**](../../../../technology/driverassistance/exitwarning/): Estándar en el Smart #3 Brabus, este sistema alerta a los ocupantes para que no abran las puertas si hay riesgo de golpear algo.
...
El Smart #3 Brabus está equipado con características de seguridad avanzadas para protegerlo a usted y a su vehículo. Estos incluyen:
...
El maletero ofrece una capacidad de carga de 370 litros. Con el asiento trasero plegado, esto se expande a 1160 litros. En el techo, puedes cargar hasta 75 kg. Además, hay un frunk (maletero delantero) con una capacidad de almacenamiento de 15 litros.

El peso máximo del vehículo es 2360 kg, con un peso base de 1910 kg. Esto permite una carga máxima de 450 kg, incluyendo el conductor y los pasajeros. Ten en cuenta que algunas opciones pueden aumentar el peso base y reducir la capacidad máxima de carga.
...
Este modelo tuvo un estreno mundial el 03.09.2023 y se espera que las entregas comiencen en November 2023.
{{< pagenavigation b_url="../" b_title="Smart #3" f_url="rangeandconsumption/" f_title="Rango" >}}
