---
title: GMC Hummer EV SUV 3x spesifikasjoner
linktitle: "Spesifikasjoner"
description: "EVKX.net gir deg alle spesifikasjonene for GMC Hummer EV SUV 3x."
weight: 4
hidden: true
...
EVKX.net søker å ha de mest komplette spesifikasjonene for GMC Hummer EV SUV 3x. Klikk på bildet ovenfor for [full artikkel](../), besøk [bildegalleriet](../gallery/) for høyoppløselige bilder av GMC Hummer EV SUV 3x, gå til [chargeinfo](../chargingcurve/) for GMC Hummer EV SUV 3x med ladekurve, se [extended range info](../rangeandconsumption/) for real world ranges.
	...
	<tbody>
		<tr>
			...
			<td>
				...
				Deep Aurora Metallic (Bronse)</br>
			</td>
		</tr>
	</tbody>
</table>
