...
description: GMC Hummer EV Edition 1 Pickup is an all-electric Pickup Truck with a EPA range of up to 529 km (329 miles). EVKX.net have all the details. 
weight: 10
hidden: true
---
...
The battery has a gross capacity of 220kWh and a net capacity of 213kWh, meaning you have a 7kWh buffer for protection. (3,2%). For more details about the range, see real-world data and range listing on this model's [range and consumption](rangeandconsumption/) page. 
