...
description: "GMC Hummer EV Edition 1 Pickup är en helelektrisk pickup med en EPA räckvidd på upp till 529 km. EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Vi har delat in vår beskrivning av GMC Hummer EV Edition 1 Pickup i avsnitt. Om du vill vänta med att läsa hela artikeln, klicka på länkarna nedan till de olika avsnitten. Vi har även en översikt över [fullständiga specifikationer](specifications/), [räckvidde och förbrukning](rangeandconsumption/), ett [bildgalleri](gallery/), detaljerad information om [laddningsprestanda](chargingcurve/) och några [recensioner](reviews/). Våra avsnitt:
...
GMC Hummer EV Edition 1 Pickup levererar en häpnadsväckande maximal effekt på 746 KW (1014 hk) och ett massivt vridmoment på 1150 Nm. Denna kraftmaskin kan accelerera från 0 till 100 km/h på bara 3,5 sekunder, vilket visar på dess fantastiska acceleration. Dessutom uppnår den en topphastighet på 170 km/h, vilket gör den till ett verkligt ingenjörsmässigt och prestandamässigt underverk.
...
GMC Hummer EV Edition 1 Pickup har ett fyrhjulsdriftssystem som stöds av tre motorer. En på framaxeln och två på bakaxeln. Motorerna som används är [Permanent Magnet Synchronous Motors](../../../../technology/motors/pmsm/).
...
Dynamisk styrning är standard-funktionen för GMC Hummer EV Edition 1 Pickup. Dynamisk styrning varierar styrförhållandet som en funktion av körhastigheten. Dessutom är bakhjulsstyrning tillgänglig som en standard-funktion. Bakhjulsstyrning minskar svängcirkeln vid långsam körning.
...
GMC Hummer EV Edition 1 Pickup, med dimensioner på 5507 mm i längd, 2201 mm i bredd och 2009 mm i höjd, utmärker sig i kategorin Full-size Pick-Up truck och erbjuder exceptionellt utrymme, kraft och kapacitet. GMC Hummer EV Edition 1 Pickup finns i totalt 1 lackfärger, inklusive flera iögonfallande metalliska alternativ.

Du kan välja mellan flera hjulalternativ i olika storlekar på GMC Hummer EV Edition 1 Pickup, vilket gör att du kan anpassa din bil efter din stil och dina körpreferenser.
...
GMC Hummer EV Edition 1 Pickup har en förarfokuserad interiör som förbättrar cockpitkänslan med högkvalitativa material i flera områden istället för hård plast. Det inkluderar också en traditionell mittkonsol som separerar föraren och passageraren, och som erbjuder praktisk förvaring och funktionalitet.

### Säten

GMC Hummer EV Edition 1 Pickup rymmer fem passagerare med två säten fram och en tre-sitsig bänk bak.
...
GMC Hummer EV Edition 1 Pickup inkluderar flera funktioner för att förbättra komfort och bekvämlighet:
...
En typ av ljudsystem är tillgänglig för GMC Hummer EV Edition 1 Pickup.
...
GMC Hummer EV Edition 1 Pickup inkluderar flera [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) som standard och som tillval för att förbättra säkerheten och komforten.

### Säkerhetssystem

[**Låsningsfria bromsar (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på GMC Hummer EV Edition 1 Pickup, detta system förhindrar att hjulen låser sig under bromsning.

[**Elektronisk Stabilitetskontroll (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på GMC Hummer EV Edition 1 Pickup, detta system förbättrar fordonets stabilitet och hantering vid plötsliga manövrer eller på hala vägar.

[**Körfältsassistans (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Standard på GMC Hummer EV Edition 1 Pickup, detta system hjälper till att förhindra att fordonet driver ut ur sitt körfält. Det inkluderar även ett system för [**Varning för Utträde från Körfält**](../../../../technology/driverassistance/lanedeparturewarning/) som varnar föraren om fordonet är på väg ut ur körfältet.

[**Bakre Korsande Trafikvarning (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard på GMC Hummer EV Edition 1 Pickup, detta system använder sensorer för att upptäcka närstående fordon från sidan när du backar ut från en parkeringsplats eller in- och utfart.

[**Framåt Kollisionsvarning (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på GMC Hummer EV Edition 1 Pickup, detta förarassistanssystem hjälper till att undvika eller mildra frontalkollisioner.

[**Automatisk nödbromsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på GMC Hummer EV Edition 1 Pickup, detta system bromsar autonomt för att förhindra eller minska allvaret av en kollision om föraren inte reagerar i tid.

[**Blindspotsövervakning (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard på GMC Hummer EV Edition 1 Pickup, detta sidostödssystem hjälper till att upptäcka trafik i döda vinklar.
