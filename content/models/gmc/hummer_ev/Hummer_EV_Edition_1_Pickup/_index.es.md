...
description: "GMC Hummer EV Edition 1 Pickup es una camioneta totalmente eléctrica con un EPA alcance de hasta 529 km (329 millas). EVKX.net tiene todos los detalles."
weight: 10
hidden: true
shownavtabs: true
...
Hemos separado nuestro artículo GMC Hummer EV Edition 1 Pickup en secciones. Si desea esperar para leer el artículo completo, haga clic en los enlaces a continuación para acceder a las diferentes áreas. También tenemos una descripción general de las [especificaciones completas](specifications/), una [galería de imágenes](gallery/), información detallada sobre [rendimiento de carga](chargingcurve/) y algunas [reseñas en línea](reviews/). Nuestras secciones:
...
El GMC Hummer EV Edition 1 Pickup entrega una impresionante potencia máxima de 746 kW (1014 hp) y un enorme torque de 1150 Nm. Este monstruo puede acelerar de 0 a 100 km/h en solo 3,5 segundos, demostrando su asombrosa aceleración. Además, alcanza una velocidad máxima de 170 km/h, lo que lo convierte en una verdadera maravilla de la ingeniería y el rendimiento.
...
El GMC Hummer EV Edition 1 Pickup, con dimensiones de 5507 mm de largo, 2201 mm de ancho y 2009 mm de alto, destaca en la categoría de camionetas de tamaño completo, ofreciendo un espacio, potencia y capacidad excepcionales. El GMC Hummer EV Edition 1 Pickup está disponible en un total de 1 colores de pintura, incluyendo varias opciones metálicas llamativas.

Puedes seleccionar entre múltiples opciones de ruedas en diferentes tamaños en el GMC Hummer EV Edition 1 Pickup, lo que te permite personalizar tu vehículo según tu estilo y preferencias de conducción.
...
El GMC Hummer EV Edition 1 Pickup tiene capacidad para cinco pasajeros con dos asientos delanteros y un banco trasero de tres plazas.

#### Asientos de primera fila

El GMC Hummer EV Edition 1 Pickup ofrece un único tipo de asiento delantero.
...
El GMC Hummer EV Edition 1 Pickup cuenta con una interfaz de control fácil de usar que combina botones físicos para funciones de uso frecuente, como el control del clima, con palancas y pantallas para una experiencia sin interrupciones.
...
Además, el GMC Hummer EV Edition 1 Pickup es compatible con Android Auto y Apple CarPlay. Esta funcionalidad te permite presentar la pantalla de tu teléfono en la pantalla del auto para que puedas ejecutar aplicaciones como Google Maps o Waze.

### Sistema de sonido

Un tipo de sistema de sonido está disponible para el GMC Hummer EV Edition 1 Pickup.

- Con el Bose Premium Sound System, obtienes 14 parlantes con una salida máxima del sistema de 625 vatios.
...
El GMC Hummer EV Edition 1 Pickup incluye varios [sistemas avanzados de asistencia al conductor](../../../../technology/driverassistance/) (ADAS) estándar y opcionales para mejorar la seguridad y el confort.
...
[**Control Electrónico de Estabilidad (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Estándar en el GMC Hummer EV Edition 1 Pickup, este sistema mejora la estabilidad y el manejo del vehículo durante maniobras repentinas o en condiciones de carretera resbaladizas.

[**Asistencia para Mantener el Carril (LKA)**](../../../../technology/driverassistance/lanekeepingassist/): Estándar en el GMC Hummer EV Edition 1 Pickup, este sistema ayuda a prevenir que el vehículo se desplace fuera de su carril. También incluye un sistema de [**Advertencia de Salida de Carril**](../../../../technology/driverassistance/lanedeparturewarning/) para alertar al conductor si el vehículo se sale del carril.

[**Advertencia de Tráfico Cruzado Trasero (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Estándar en el GMC Hummer EV Edition 1 Pickup, este sistema usa sensores para detectar vehículos que se aproximan desde los laterales al retroceder de un espacio de estacionamiento o entrada.

[**Advertencia de Colisión Frontal (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Estándar en el GMC Hummer EV Edition 1 Pickup, este sistema de asistencia al conductor ayuda a evitar o mitigar colisiones frontales.

[**Frenado de emergencia automático (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Estándar en el GMC Hummer EV Edition 1 Pickup, este sistema aplica los frenos automáticamente para prevenir o reducir la gravedad de una colisión si el conductor no reacciona a tiempo.

[**Monitoreo de Punto Ciego (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Estándar en el GMC Hummer EV Edition 1 Pickup, este sistema de asistencia lateral ayuda a detectar tráfico en los puntos ciegos.
