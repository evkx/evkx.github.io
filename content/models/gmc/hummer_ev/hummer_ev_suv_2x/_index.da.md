...
description: "GMC Hummer EV SUV 2x er en fuldelektrisk SUV med en rækkevidde på EPA på op til 48 km (30 miles). EVKX.net har alle detaljerne."
weight: 10
hidden: true
shownavtabs: true
...
Vi har opdelt vores GMC Hummer EV SUV 2x artikel i sektioner. Hvis du vil vente med at læse hele artiklen, skal du klikke på nedenstående links til de forskellige områder. Vi har også en oversigt over de [fulde specifikationer](specifications/), et [billedgalleri](gallery/), detaljerede oplysninger om [opladningsydelse](chargingcurve/), og nogle [online anmeldelser](reviews/). Vores sektioner:
...
GMC Hummer EV SUV 2x imponerer med en maksimal effekt på 425 kW (578 hk) og et imponerende samlet drejningsmoment på 1150 Nm. Denne højtydende maskine kan accelerere fra 0 til 100 km/h på kun 3,6 sekunder og har en topfart på 171 km/h, hvilket gør den til en standout i sin klasse.
...
[EPA](../../../../guides/understandingrange/epa/) (Environmental Protection Agency) estimerede rækkevidde varierer mellem 30 til 303 miles (48-488 km), afhængigt af bilens konfiguration og muligheder. For eksempel kan større hjul øge energiforbruget og reducere den samlede rækkevidde.
Energiforbrugsraterne er 0,2 mi/kWh for basismodellen og 1,6 mi/kWh for topmodellen, ifølge EPA standardtest. For mere detaljerede virkelige data og rækkeviddeoplysninger, henvises til modellens dedikerede [rækkevidde- og forbrugsside.](rangeandconsumption/)

Den maksimale DC-opladningshastighed er 350kW. En fuld opladning fra 0 - 100 % ville tage 126 minutter, mens et mere almindeligt scenarie på 10-80 % ville tage 44 minutter. Hvis du antager, at du mister 5 minutters kørsel pr. ladestop ud over opladningstiden, er det optimale opladningsområde fra 1% til 62%, hvilket resulterer i en faktisk opladningshastighed, inklusive tidstab på 235kW. Hver opladningssession ville tage 30 minutter og 33 sekunder. Denne effektive opladningskapacitet gør GMC Hummer EV SUV 2x til et praktisk valg til langdistancerejser.
...
GMC Hummer EV SUV 2x har et firehjulstræk, der understøttes af to motorer, en på hver aksel. Dene anvendte motorer er [Permanent Magnet Synchronous Motors](../../../../technology/motors/pmsm/).
...
Dynamisk styring er en standard-funktion på GMC Hummer EV SUV 2x. Dynamisk styring varierer styreforholdet som en funktion af kørehastigheden. Derudover er baghjulsstyring tilgængelig som en standard-funktion. Baghjulsstyring reducerer drejecirklen, når du kører langsomt.

### Køretilstande

GMC Hummer EV SUV 2x lader brugeren vælge forskellige [drive modes](../../../../technology/drivemodes/), der påvirker bilens håndtering. Køreren kan vælge mellem 7 tilstande:
...
Den GMC Hummer EV SUV 2x, med dimensioner på 4999 mm i længde, 2197 mm i bredde og 1976 mm i højde, tilhører mellemstore SUV'er og tilbyder en blanding af plads, komfort, ydelse og alsidighed, hvilket gør dem velegnede til en bred vifte af førere med forskellige behov. GMC Hummer EV SUV 2x fås i alt 7 lakfarver, herunder flere iøjnefaldende metalliske muligheder. Nogle af disse lakmuligheder inkluderer to-tone lak, hvor taget og den øverste del af karosseriet er malet i en anden farve, hvilket giver et karakteristisk og stilfuldt look.

Du kan vælge mellem flere hjul i forskellige størrelser på GMC Hummer EV SUV 2x, så du kan tilpasse din bil efter din stil og dine kørselspræferencer.
...
GMC Hummer EV SUV 2x har et førerfokuseret interiør, der forbedrer cockpitfølelsen med materialer af høj kvalitet i flere områder i stedet for hård plast. Det inkluderer også en traditionel midterkonsol, der adskiller fører og passager, og som giver praktisk opbevaring og funktionalitet. Du kan vælge mellem flere interiørdesigns.

### Sæder

GMC Hummer EV SUV 2x har plads til fem passagerer med to sæder foran og en tre-personers bænk bagtil.

#### Første række sæder

GMC Hummer EV SUV 2x tilbyder kun én type forreste sæde.
...
GMC Hummer EV SUV 2x inkluderer flere funktioner, der forbedrer komfort og bekvemmelighed:
...
GMC Hummer EV SUV 2x har en brugervenlig kontrolgrænseflade, der kombinerer fysiske knapper til ofte brugte funktioner, såsom klimakontrol, med stænger og skærme for en problemfri oplevelse.

GMC Hummer EV SUV 2x har to skærme med information til fører og passagerer. Bag rattet er en [digital instrumentklynge](../../../../technology/userinterface/screens/#digital-instruments), og på den højre del , der er en [infotainment-skærm](../../../../technology/userinterface/screens/#infotainment-skærm).
...
GMC Hummer EV SUV 2x er udstyret med en enkelt type rat:
...
Yderligere understøtter GMC Hummer EV SUV 2x Android Auto og Apple CarPlay. Denne funktionalitet giver dig mulighed for at præsentere din telefons skærm på bilens skærm, så du kan køre apps som Google Maps eller Waze.

### Lydsystem

Én type lydsystem er tilgængelig for GMC Hummer EV SUV 2x.
...
Den GMC Hummer EV SUV 2x inkluderer flere standard- og valgfri [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) for at forbedre sikkerhed og komfort.

### Sikkerhedssystemer

[**Anti-lock Bremsesystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard på GMC Hummer EV SUV 2x, dette system forhindrer hjulene i at låse under opbremsning.

[**Electronic Stability Control (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard på GMC Hummer EV SUV 2x, dette system forbedrer bilens stabilitet og håndtering under pludselige manøvrer eller på glatte vejforhold.
...
[**Rear Cross Traffic Alert (RCTA)**](../../../../technology/driverassistance/rearcrosstrafficalert/): Standard på GMC Hummer EV SUV 2x, dette system bruger sensorer til at registrere tilstødende køretøjer fra siden, når du bakker ud af en parkeringsplads eller indkørsel.

[**Forward Collision Warning (FCW)**](../../../../technology/driverassistance/forwardcollisionwarning/): Standard på GMC Hummer EV SUV 2x, dette førerassistentsystem hjælper føreren med at undgå eller formilde frontale kollisioner.

[**Automatisk nødbremsning (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard på GMC Hummer EV SUV 2x, dette system anvender bremserne autonomt for at forhindre eller reducere alvoren af en kollision, hvis føreren ikke reagerer i tide.

[**Blind-spot Monitoring (BSM)**](../../../../technology/driverassistance/blindspotmonitoring/) : Standard på GMC Hummer EV SUV 2x, dette sideassistentsystem hjælper med at registrere trafik i døde vinkler.
...
GMC Hummer EV SUV 2x er udstyret med avancerede sikkerhedsfunktioner for at beskytte dig og dit køretøj. Disse inkluderer:
...
I det hastigt voksende marked for elbiler har EVKX.net identificeret flere alternativer til GMC Hummer EV SUV 2x, der er værd at overveje baseret på funktioner, specifikationer og pris. Selvom disse modeller måske ikke er helt identiske, kan det være nyttigt at sammenligne dem, før du træffer din endelige købsbeslutning:
