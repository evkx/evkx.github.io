...
GMC Hummer EV is a pickup truck / SUV available in 3 variants.
</p>
    ...
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
GMC Sierra EV is a pickup truck available in 1 variants.
</p>
	<a href="sierra_ev/" class="btn btn-outline-primary" role="button">Go to model info</a>
		</div>
	</div>
</div>
        </div>
