...
<i class="bi bi-record2-fill"></i> AWD <i class="bi bi-battery-full"></i> 240 kWh <i class="bi bi-ev-station"></i> 350 kW 
		...
		<div class="col col-12 col-md-6">
			<ul class="list-group list-group-flush">
				...
				<li class="list-group-item list-group-item-action"><a href="sierra_ev_denali_edition_1/reviews/" class="text-decoration-none text-black" ><i class="bi-person-video2"></i> Reseñas</a></li>
			</ul>
		</div>
	</div>
</div>
