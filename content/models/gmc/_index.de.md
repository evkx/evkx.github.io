...
GMC Hummer EV ist ein Pickup-Truck/SUV, der in 3 Varianten erhältlich ist.
</p>
	<a href="hummer_ev/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
GMC Sierra EV ist ein Pickup-Truck, der in 1 Varianten erhältlich ist.
</p>
	<a href="sierra_ev/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
        </div>
