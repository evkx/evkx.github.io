---
title: Xiaomi SU7 Ultra especificaciones
linktitle: "Especificaciones"
description: "EVKX.net le brinda las especificaciones completas para Xiaomi SU7 Ultra."
weight: 4
hidden: true
...
<table class="table table-striped border">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				Techo central sobre el parabrisas</br>
			</td>
		</tr>
	</tbody>
</table>
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Meteor Blue (Azul)</br>
				Radiant Purple (Púrpura)</br>
				Olive Green (Verde)</br>
				Lava Orange (Naranja)</br>
				Pearl White (Blanco)</br>
				Diamond Black (Negro)</br>
				Aqua Blue (Azul)</br>
