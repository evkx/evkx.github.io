---
title: Xiaomi SU7 Max spécifications
linktitle: "Spécifications"
description: "EVKX.net vous donne les spécifications complètes de Xiaomi SU7 Max."
weight: 4
hidden: true
...
EVKX.net cherche à avoir les spécifications les plus complètes pour Xiaomi SU7 Max. Cliquez sur l'image ci-dessus pour [article complet](../), visitez la [galerie d'images](../gallery/) pour des images haute résolution de Xiaomi SU7 Max, visitez les [chargeinfo](../chargingcurve/) pour Xiaomi SU7 Max avec chargecurve, visitez [extended range info](../rangeandconsumption/) pour les plages du monde réel.
...
<table class="table table-striped border">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				Toit central au-dessus du pare-brise</br>
			</td>
		</tr>
	</tbody>
</table>
...
<table class="table table-striped border">
	...
	<tbody>
		<tr>
			...
			<td>
				Meteor Blue (Bleu)</br>
				Radiant Purple (Violet)</br>
				Olive Green (Vert)</br>
				Lava Orange</br>
				Pearl White (Blanc)</br>
				Diamond Black (Noir)</br>
				Aqua Blue (Bleu)</br>
				Mineral gray (Gris)</br>
				Elegant gray (Gris)</br>
			</td>
		</tr>
	</tbody>
</table>
