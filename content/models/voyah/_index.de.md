...
VOYAH Courage ist ein SUV, der in 1 Varianten erhältlich ist.
</p>
	<a href="courage/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
    <div class="container p-3 mb-4 bg-body-tertiary rounded border">
        ...
        <div class="row">
            ...
            <div class="col col-12 col-md-6"><p>
VOYAH FREE ist ein SUV, der in 1 Varianten erhältlich ist.
</p>
	<a href="free/" class="btn btn-outline-primary" role="button">Gehe zu Modellinfo</a>
		</div>
	</div>
</div>
        </div>
