...
description: "Citroën ë-C3 Aircross ist ein vollelektrisches Crossover mit einer Reichweite von bis zu 306 km (190 Meilen). EVKX.net hat alle Details."
weight: 10
hidden: true
shownavtabs: true
...
Die dynamische Lenkung ist eine standard im Citroën ë-C3 Aircross, wobei das Lenkverhältnis je nach Fahrgeschwindigkeit variiert, um die Kontrolle und den Komfort zu verbessern.

### Bremsen

Der Citroën ë-C3 Aircross ist mit [Gusseisenscheibenbremsen](../../../../technology/brakes/#disc-brakes) sowohl vorne als auch hinten ausgestattet.
...
Der Citroën ë-C3 Aircross bietet mehrere Radoptionen in verschiedenen Größen, sodass Sie Ihr Fahrzeug an Ihren Stil und Ihre Fahrpräferenzen anpassen können. Die verfügbaren Reifen- und Radkombinationen umfassen:
...
Der Citroën ë-C3 Aircross bietet Platz für fünf Passagiere mit zwei Vordersitzen und einer Dreiersitzbank hinten.
...
Sie können zwei Sitztypen für die zweite Reihe im Citroën ë-C3 Aircross wählen.
...
Der Citroën ë-C3 Aircross hat mehrere integrierte Bildschirme. Hinter dem Lenkrad befindet sich ein [digitales Instrumentencluster](../../../../technology/userinterface/screens/#digital-instruments), und in der Mittelkonsole gibt es einen [Infotainment-Bildschirm](../../../../technology/userinterface/screens/#infotainment-screen) oben in der Mittelkonsole.
...
Der Citroën ë-C3 Aircross ist mit einem einzigen Lenkradtyp ausgestattet:
...
Der Citroën ë-C3 Aircross unterstützt Android Auto und Apple CarPlay, sodass Sie den Bildschirm Ihres Telefons auf dem Display des Autos spiegeln können. Diese Funktion ermöglicht es Ihnen, Apps wie Google Maps oder Waze direkt von Ihrem Telefon aus zu nutzen.

### Soundsystem

Sie können zwischen zwei Soundsystemen für den Citroën ë-C3 Aircross wählen:
...
Der Citroën ë-C3 Aircross verfügt über eine Reihe von standardmäßigen und optionalen [fortschrittlichen Fahrerassistenzsystemen](../../../../technology/driverassistance/) (ADAS), die die Sicherheit und den Komfort verbessern sollen.

### Sicherheitssysteme

[**Antiblockiersystem (ABS)**](../../../../technology/driverassistance/antilockbrakingsystem/): Standard im Citroën ë-C3 Aircross, dieses System verhindert das Blockieren der Räder beim Bremsen.

[**Elektronische Stabilitätskontrolle (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard im Citroën ë-C3 Aircross, dieses System verbessert die Stabilität und das Handling des Fahrzeugs bei plötzlichen Manövern oder auf rutschigen Straßenbedingungen.

[**Automatische Notbremsung (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard im Citroën ë-C3 Aircross, dieses System bremst autonom, um eine Kollision zu verhindern oder deren Schwere zu verringern, wenn der Fahrer nicht rechtzeitig reagiert.
...
Der Citroën ë-C3 Aircross ist mit wesentlichen Sicherheitsfunktionen ausgestattet, um Sie und Ihr Fahrzeug zu schützen und Einfachheit und Zuverlässigkeit zu bieten. Diese umfassen:
...
Der Kofferraum bietet ein Ladevolumen von 460 Litern (16,2 CU FT). Mit umgeklappter Rücksitzbank erweitert sich dies auf 1600 Liter (56,5 CU FT). Auf dem Dach können Sie bis zu 75 kg (165,3 lbs) laden.
...
Dieses Modell feierte seine Weltpremiere am 21.06.2024, mit erwarteten Lieferungen ab September 2024.
{{< pagenavigation b_url="../" b_title="Citroën ë-C3 Aircross" f_url="rangeandconsumption/" f_title="Reichweite" >}}
