...
The Citroën ë-C3 Aircross has a front-wheel drive system supported by one motor on the front axle.
...
Dynamic steering is a standard on the Citroën ë-C3 Aircross, varying the steering ratio based on driving speed for enhanced control and comfort.

### Brakes

The Citroën ë-C3 Aircross is equipped with [cast-iron disc brakes](../../../../technology/brakes/#disc-brakes) on both the front and rear.
...
The Citroën ë-C3 Aircross offers multiple wheel options in different sizes, allowing you to customize your vehicle to suit your style and driving preferences. The available tire and wheel combinations include:
...
The Citroën ë-C3 Aircross accommodates five passengers with two front seats and a three-seat bench in the rear.
...
The Citroën ë-C3 Aircross is equipped with a single type of steering wheel:
...
The Citroën ë-C3 Aircross supports Android Auto and Apple CarPlay, allowing you to mirror your phone's screen on the car's display. This functionality enables you to run apps like Google Maps or Waze directly from your phone.
...
[**Electronic Stability Control (ESC)**](../../../../technology/driverassistance/electronicstabilitycontrol/): Standard on the Citroën ë-C3 Aircross, this system improves the vehicle's stability and handling during sudden maneuvers or on slippery road conditions.

[**Automatic Emergency Braking (AEB)**](../../../../technology/driverassistance/automaticemergencybraking/): Standard on the Citroën ë-C3 Aircross, this system autonomously applies the brakes to prevent or reduce the severity of a collision if the driver does not react in time.
...
The Citroën ë-C3 Aircross is equipped with essential security features to protect you and your vehicle, offering simplicity and reliability. These include:
...
This model made its world premiere on 21.06.2024, with deliveries anticipated to begin in September 2024.
{{< pagenavigation b_url="../" b_title="Citroën ë-C3 Aircross" f_url="rangeandconsumption/" f_title="Range" >}}
