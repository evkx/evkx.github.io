...
linktitle: "ë-C4 X"
description: "Citroën ë-C4 X är en elektrisk crossover med en WLTP-räckvidd på upp till 402 km (250 miles). EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Citroën ë-C4 X erbjuder modest prestanda med en maxeffekt på 115 kW (156 hk / 154 bhp) och ett totalt vridmoment på 260 Nm (192 lb-ft). Den accelererar från 0 till 100 km/h på 9 sekunder och har en toppfart på 150 km/h (93 mph), vilket ligger mer i linje med traditionella fordon med förbränningsmotor.
...
I ett 1000 km test med konstant hastighet på 120 km/h med en antagen förbrukning på 19 kWh/100 km, skulle resan ta ungefär 10 timmar och 24 minuter, med fem laddningsstopp från 3% till 58%, totalt 124 minuters laddtid.
...
Citroën ë-C4 X har ett fyrhjulsdrivet system som drivs av två motorer, en på varje axel.
...
Citroën ë-C4 X, med måtten 4118 mm i längd, 1802 mm i bredd och 1534 mm i höjd, tillhör B-SUV-segmentet, även känt som kompakta SUV:ar eller crossovers. De kombinerar den kompakta storleken och manövrerbarheten från B-segmentets bilar med högre körposition, ökat lastutrymme och robust SUV-styling. Citroën ë-C4 X finns tillgänglig i totalt 5 solida lackfärger.

Citroën ë-C4 X erbjuder flera hjulalternativ i olika storlekar, vilket låter dig anpassa ditt fordon efter din stil och körstil. De tillgängliga däck- och hjulkombinationerna inkluderar:
...
Citroën ë-C4 X rymmer fem passagerare med två framsäten och en tresätessoffa bak.

#### Första radens säten

Citroën ë-C4 X erbjuder endast en typ av framsäte.
...
I Citroën ë-C4 X ingår flera funktioner för att öka komfort och bekvämlighet:
...
Citroën ë-C4 X är utrustad med endast en typ av ratt:
...
Citroën ë-C4 X stödjer Android Auto och Apple CarPlay, vilket låter dig spegla din telefons skärm på bilens display. Detta gör det möjligt att köra appar som Google Maps eller Waze direkt från din telefon.

### Ljudsystem

Citroën ë-C4 X levereras med ett ljudsystemalternativ:
...
Citroën ë-C4 X har ett utbud av standard och tillvalda [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) utformade för att förbättra säkerhet och komfort.
...
Citroën ë-C4 X erbjuder [körautomation på nivå 1](../../../../technology/driverassistance/#level-of-autonomous-driving), beroende på utrustningsnivå.
...
Citroën ë-C4 X är utrustad med avancerade säkerhetsfunktioner för att skydda dig och ditt fordon. Dessa inkluderar:
...
{{< pagenavigation b_url="../" b_title="Citroën ë-C4" f_url="rangeandconsumption/" f_title="Räckvidd" >}}
