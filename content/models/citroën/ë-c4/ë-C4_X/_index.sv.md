...
linktitle: "ë-C4 X"
description: "Citroën ë-C4 X är en helelektrisk crossover med en WLTP räckvidd på upp till 402 km. EVKX.net har alla detaljer."
weight: 10
hidden: true
shownavtabs: true
...
Citroën ë-C4 X erbjuder blygsamma prestanda med en maximal effekt på 115 kW (156 hk) och ett totalt vridmoment på 260 Nm. Den accelererar från 0 till 100 km/h på 9 sekunder och har en topphastighet på 150 km/h, vilket är mer i linje med traditionella förbränningsmotorfordon.
...
I en teoretisk 1000 km-utmaning, med en fulladdad batteri och en konstant hastighet på 120 km/h (75 mph) under ideala förhållanden med en antagen förbrukning på 19 kWh/100 km, skulle resan ta ungefär 10 timmar och 24 minuter. Denna resa skulle kräva två laddningsstopp från 10% till 58%, med en total laddningstid på 124 minuter.
...
Citroën ë-C4 X har ett fyrhjulsdriftsystem som stöds av två motorer, en på varje axel.
...
Citroën ë-C4 X, med dimensioner på 4118 mm i längd, 1802 mm i bredd och 1534 mm i höjd, tillhör B-SUV-segmentet av bilar, även kallat subkompakta SUV:ar eller crossovers. De erbjuder en kombination av kompakt storlek och smidighet från B-segmentbilar med högre körposition, ökat lastutrymme och robust utformning från en SUV. Citroën ë-C4 X finns i totalt 5 enfärgade lackfärger.

Du kan välja mellan flera hjulalternativ i olika storlekar på Citroën ë-C4 X, vilket gör att du kan anpassa din bil efter din stil och dina körpreferenser.
...
Citroën ë-C4 X rymmer fem passagerare med två säten fram och en tre-sitsig bänk bak.
...
Citroën ë-C4 X inkluderar flera funktioner för att förbättra komfort och bekvämlighet:
...
Citroën ë-C4 X är utrustad med en enda typ av ratt:
...
Dessutom stöder Citroën ë-C4 X Android Auto och Apple CarPlay. Denna funktion gör att du kan visa telefonens skärm på bilens skärm så att du kan köra appar som Google Maps eller Waze.
...
Citroën ë-C4 X inkluderar flera [avancerade förarassistanssystem](../../../../technology/driverassistance/) (ADAS) som standard och som tillval för att förbättra säkerheten och komforten.
