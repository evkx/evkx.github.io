...
linktitle: "ë-C4 X"
description: "Citroën ë-C4 X er en elektrisk crossover med en WLTP rekkevidde på opptil 402 km (250 miles). EVKX.net har alle detaljene."
weight: 10
hidden: true
shownavtabs: true
...
Citroën ë-C4 X tilbyr beskjeden ytelse med en maksimal effekt på 115 kW (156 hk / 154 bhp) og et totalt dreiemoment på 260 Nm (192 lb-ft). Den akselererer fra 0 til 100 km/t på 9 sekunder og har en topphastighet på 150 km/t (93 mph), mer på linje med tradisjonelle forbrenningsmotorer.
...
I en 1000 km utfordring ved konstant hastighet på 120 km/t med et antatt forbruk på 19 kWh/100 km, vil turen ta omtrent 10 timer og 24 minutter, og kreve fem ladestopp fra 3% til 58%, totalt 124 minutter ladetid.
...
Citroën ë-C4 X har et firehjulsdrift-system drevet av to motorer, en på hver aksel.
...
Citroën ë-C4 X, med dimensjoner på 4118 mm i lengde, 1802 mm i bredde og 1534 mm i høyde, tilhører B-SUV segmentet. Også kjent som kompakte SUVer eller crossovere, kombinerer disse bilene den kompakte størrelsen og manøvrerbarheten til B-segment biler med høyere kjøreposisjon, økt bagasjeplass og robust styling fra en SUV. Citroën ë-C4 X er tilgjengelig i totalt 5 solide lakkfarger.

Citroën ë-C4 X tilbyr flere hjulalternativer i ulike størrelser, slik at du kan tilpasse kjøretøyet etter din stil og kjørepreferanser. De tilgjengelige dekk- og hjulkombinasjonene inkluderer:
...
Citroën ë-C4 X har plass til fem passasjerer med to forseter og en treseters benk bak.

#### Forseter

Citroën ë-C4 X tilbyr bare én type forsete.
...
Citroën ë-C4 X inkluderer flere funksjoner for å øke komfort og bekvemmelighet:
...
Citroën ë-C4 X er utstyrt med én type ratt:
...
Citroën ë-C4 X støtter Android Auto og Apple CarPlay, som lar deg speile telefonskjermen på bilens skjerm. Denne funksjonaliteten gjør at du kan kjøre apper som Google Maps eller Waze direkte fra telefonen.

### Lydsystem

Citroën ë-C4 X kommer med ett lydsystem:
...
Citroën ë-C4 X har en rekke standard og valgfrie [avanserte førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) designet for å øke sikkerhet og komfort.
...
Citroën ë-C4 X tilbyr [kjøreautomatisering på nivå 1](../../../../technology/driverassistance/#level-of-autonomous-driving), avhengig av utstyrsnivå.
...
Citroën ë-C4 X er utstyrt med avanserte sikkerhetsfunksjoner for å beskytte deg og kjøretøyet ditt. Disse inkluderer:
