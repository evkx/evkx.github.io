...
linktitle: "ë-C4 X"
description: "Citroën ë-C4 X er en fuldelektrisk crossover med en WLTP rækkevidde på op til 402 km (250 miles). EVKX.net har alle detaljerne."
weight: 10
hidden: true
shownavtabs: true
...
Citroën ë-C4 X tilbyder beskedne præstationer med en maksimal effekt på 115 kW (156 hk) og et samlet drejningsmoment på 260 Nm. Den accelererer fra 0 til 100 km/t på 9 sekunder og har en topfart på 150 km/t, hvilket ligger tættere på traditionelle forbrændingsmotorbiler.
...
Den maksimale DC-opladningshastighed er 100kW. En fuld opladning fra 0 - 100 % ville tage 54 minutter, mens et mere almindeligt scenarie på 10-80 % ville tage 29 minutter. Hvis du antager, at du mister 5 minutters kørsel pr. ladestop ud over opladningstiden, er det optimale opladningsområde fra 2% til 60%, hvilket resulterer i en faktisk opladningshastighed, inklusive tidstab på 68kW. Hver opladningssession ville tage 26 minutter og 10 sekunder.

I en teoretisk 1000 km udfordring, der starter med et fuldt batteri og opretholder en konstant hastighed på 120 km/t under ideelle forhold med et antaget forbrug på 19 kWh/100 km, ville turen tage cirka 10 timer og 24 minutter. Denne rejse ville kræve to opladningsstop fra 3% til 58%, med en samlet opladningstid på 124 minutter
...
Citroën ë-C4 X har et firehjulstræk, der understøttes af to motorer, en på hver aksel.
...
Citroën ë-C4 X har plads til fem passagerer med to sæder foran og en tre-personers bænk bagtil.

#### Første række sæder

Citroën ë-C4 X tilbyder kun én type forreste sæde.
...
Citroën ë-C4 X inkluderer flere funktioner, der forbedrer komfort og bekvemmelighed:
...
Citroën ë-C4 X er udstyret med en enkelt type rat:
...
Yderligere understøtter Citroën ë-C4 X Android Auto og Apple CarPlay. Denne funktionalitet giver dig mulighed for at præsentere din telefons skærm på bilens skærm, så du kan køre apps som Google Maps eller Waze.

### Lydsystem

Én type lydsystem er tilgængelig for Citroën ë-C4 X.
...
Den Citroën ë-C4 X inkluderer flere standard- og valgfri [avancerede førerassistentsystemer](../../../../technology/driverassistance/) (ADAS) for at forbedre sikkerhed og komfort.
...
Citroën ë-C4 X er udstyret med avancerede sikkerhedsfunktioner for at beskytte dig og dit køretøj. Disse inkluderer:
