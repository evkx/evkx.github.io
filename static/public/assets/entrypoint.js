 ...
 *
 * @license MIT
 */function Ae(){return Ae=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},Ae.apply(this,arguments)}var lt;(function(e){e.Pop="POP",e.Push="PUSH",e.Replace="REPLACE"})(lt||(lt={}));const gv="popstate";function dP(e){e===void 0&&(e={});function t(r,i){let{pathname:a,search:l,hash:u}=r.location;return ss("",{pathname:a,search:l,hash:u},i.state&&i.state.usr||null,i.state&&i.state.key||"default")}function n(r,i){return typeof i=="string"?i:$o(i)}return hP(t,n,null,e)}function ke(e,t){if(e===!1||e===null||typeof e>"u")throw new Error(t)}function fP(){return Math.random().toString(36).substr(2,8)}function yv(e,t){return{usr:e.state,key:e.key,idx:t}}function ss(e,t,n,r){return n===void 0&&(n=null),Ae({pathname:typeof e=="string"?e:e.pathname,search:"",hash:""},typeof t=="string"?xr(t):t,{state:n,key:t&&t.key||r||fP()})}function $o(e){let{pathname:t="/",search:n="",hash:r=""}=e;return n&&n!=="?"&&(t+=n.charAt(0)==="?"?n:"?"+n),r&&r!=="#"&&(t+=r.charAt(0)==="#"?r:"#"+r),t}function xr(e){let t={};if(e){let n=e.indexOf("#");n>=0&&(t.hash=e.substr(n),e=e.substr(0,n));let r=e.indexOf("?");r>=0&&(t.search=e.substr(r),e=e.substr(0,r)),e&&(t.pathname=e)}return t}function hP(e,t,n,r){r===void 0&&(r={});let{window:i=document.defaultView,v5Compat:a=!1}=r,l=i.history,u=lt.Pop,d=null,f=_();f==null&&(f=0,l.replaceState(Ae({},l.state,{idx:f}),""));function _(){return(l.state||{idx:null}).idx}function m(){u=lt.Pop;let C=_(),y=C==null?null:C-f;f=C,d&&d({action:u,location:w.location,delta:y})}function p(C,y){u=lt.Push;let b=ss(w.location,C,y);n&&n(b,C),f=_()+1;let S=yv(b,f),P=w.createHref(b);try{l.pushState(S,"",P)}catch{i.location.assign(P)}a&&d&&d({action:u,location:w.location,delta:1})}function g(C,y){u=lt.Replace;let b=ss(w.location,C,y);n&&n(b,C),f=_();let S=yv(b,f),P=w.createHref(b);l.replaceState(S,"",P),a&&d&&d({action:u,location:w.location,delta:0})}function x(C){let y=i.location.origin!=="null"?i.location.origin:i.location.href,b=typeof C=="string"?C:$o(C);return ke(y,"No window.location.(origin|href) available to create URL for href: "+b),new URL(b,y)}let w={get action(){return u},get location(){return e(i,l)},listen(C){if(d)throw new Error("A history only accepts one active listener");return i.addEventListener(gv,m),d=C,()=>{i.removeEventListener(gv,m),d=null}},createHref(C){return t(i,C)},createURL:x,encodeLocation(C){let y=x(C);return{pathname:y.pathname,search:y.search,hash:y.hash}},push:p,replace:g,go(C){return l.go(C)}};return w}var wt;(function(e){e.data="data",e.deferred="deferred",e.redirect="redirect",e.error="error"})(wt||(wt={}));function pP(e){return e.index===!0}function Q0(e,t,n){return t===void 0&&(t=[]),n===void 0&&(n=new Set),e.map((r,i)=>{let a=[...t,i],l=typeof r.id=="string"?r.id:a.join("-");return ke(r.index!==!0||!r.children,"Cannot specify children on an index route"),ke(!n.has(l),'Found a route id collision on id "'+l+`".  Route id's must be globally unique within Data Router usages`),n.add(l),pP(r)?Ae({},r,{id:l}):Ae({},r,{id:l,children:r.children?Q0(r.children,a,n):void 0})})}function Oa(e,t,n){n===void 0&&(n="/");let r=typeof t=="string"?xr(t):t,i=J0(r.pathname||"/",n);if(i==null)return null;let a=G0(e);mP(a);let l=null;for(let u=0;l==null&&u<a.length;++u)l=SP(a[u],EP(i));return l}function G0(e,t,n,r){t===void 0&&(t=[]),n===void 0&&(n=[]),r===void 0&&(r="");let i=(a,l,u)=>{let d={relativePath:u===void 0?a.path||"":u,caseSensitive:a.caseSensitive===!0,childrenIndex:l,route:a};d.relativePath.startsWith("/")&&(ke(d.relativePath.startsWith(r),'Absolute route path "'+d.relativePath+'" nested under path '+('"'+r+'" is not valid. An absolute child route path ')+"must start with the combined path of all its parent routes."),d.relativePath=d.relativePath.slice(r.length));let f=Gr([r,d.relativePath]),_=n.concat(d);a.children&&a.children.length>0&&(ke(a.index!==!0,"Index routes must not have child routes. Please remove "+('all child routes from route path "'+f+'".')),G0(a.children,t,_,f)),!(a.path==null&&!a.index)&&t.push({path:f,score:wP(f,a.index),routesMeta:_})};return e.forEach((a,l)=>{var u;if(a.path===""||!((u=a.path)!=null&&u.includes("?")))i(a,l);else for(let d of X0(a.path))i(a,l,d)}),t}function X0(e){let t=e.split("/");if(t.length===0)return[];let[n,...r]=t,i=n.endsWith("?"),a=n.replace(/\?$/,"");if(r.length===0)return i?[a,""]:[a];let l=X0(r.join("/")),u=[];return u.push(...l.map(d=>d===""?a:[a,d].join("/"))),i&&u.push(...l),u.map(d=>e.startsWith("/")&&d===""?"/":d)}function mP(e){e.sort((t,n)=>t.score!==n.score?n.score-t.score:kP(t.routesMeta.map(r=>r.childrenIndex),n.routesMeta.map(r=>r.childrenIndex)))}const _P=/^:\w+$/,vP=3,gP=2,yP=1,bP=10,xP=-2,bv=e=>e==="*";function wP(e,t){let n=e.split("/"),r=n.length;return n.some(bv)&&(r+=xP),t&&(r+=gP),n.filter(i=>!bv(i)).reduce((i,a)=>i+(_P.test(a)?vP:a===""?yP:bP),r)}function kP(e,t){return e.length===t.length&&e.slice(0,-1).every((r,i)=>r===t[i])?e[e.length-1]-t[t.length-1]:0}function SP(e,t){let{routesMeta:n}=e,r={},i="/",a=[];for(let l=0;l<n.length;++l){let u=n[l],d=l===n.length-1,f=i==="/"?t:t.slice(i.length)||"/",_=PP({path:u.relativePath,caseSensitive:u.caseSensitive,end:d},f);if(!_)return null;Object.assign(r,_.params);let m=u.route;a.push({params:r,pathname:Gr([i,_.pathname]),pathnameBase:RP(Gr([i,_.pathnameBase])),route:m}),_.pathnameBase!=="/"&&(i=Gr([i,_.pathnameBase]))}return a}function PP(e,t){typeof e=="string"&&(e={path:e,caseSensitive:!1,end:!0});let[n,r]=CP(e.path,e.caseSensitive,e.end),i=t.match(n);if(!i)return null;let a=i[0],l=a.replace(/(.)\/+$/,"$1"),u=i.slice(1);return{params:r.reduce((f,_,m)=>{if(_==="*"){let p=u[m]||"";l=a.slice(0,a.length-p.length).replace(/(.)\/+$/,"$1")}return f[_]=OP(u[m]||"",_),f},{}),pathname:a,pathnameBase:l,pattern:e}}function CP(e,t,n){t===void 0&&(t=!1),n===void 0&&(n=!0),ls(e==="*"||!e.endsWith("*")||e.endsWith("/*"),'Route path "'+e+'" will be treated as if it were '+('"'+e.replace(/\*$/,"/*")+'" because the `*` character must ')+"always follow a `/` in the pattern. To get rid of this warning, "+('please change the route path to "'+e.replace(/\*$/,"/*")+'".'));let r=[],i="^"+e.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^$?{}|()[\]]/g,"\\$&").replace(/\/:(\w+)/g,(l,u)=>(r.push(u),"/([^\\/]+)"));return e.endsWith("*")?(r.push("*"),i+=e==="*"||e==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):n?i+="\\/*$":e!==""&&e!=="/"&&(i+="(?:(?=\\/|$))"),[new RegExp(i,t?void 0:"i"),r]}function EP(e){try{return decodeURI(e)}catch(t){return ls(!1,'The URL path "'+e+'" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent '+("encoding ("+t+").")),e}}function OP(e,t){try{return decodeURIComponent(e)}catch(n){return ls(!1,'The value for the URL param "'+t+'" will not be decoded because'+(' the string "'+e+'" is a malformed URL segment. This is probably')+(" due to a bad percent encoding ("+n+").")),e}}function J0(e,t){if(t==="/")return e;if(!e.toLowerCase().startsWith(t.toLowerCase()))return null;let n=t.endsWith("/")?t.length-1:t.length,r=e.charAt(n);return r&&r!=="/"?null:e.slice(n)||"/"}function ls(e,t){if(!e){typeof console<"u"&&console.warn(t);try{throw new Error(t)}catch{}}}function TP(e,t){t===void 0&&(t="/");let{pathname:n,search:r="",hash:i=""}=typeof e=="string"?xr(e):e;return{pathname:n?n.startsWith("/")?n:LP(n,t):t,search:zP(r),hash:AP(i)}}function LP(e,t){let n=t.replace(/\/+$/,"").split("/");return e.split("/").forEach(i=>{i===".."?n.length>1&&n.pop():i!=="."&&n.push(i)}),n.length>1?n.join("/"):"/"}function zd(e,t,n,r){return"Cannot include a '"+e+"' character in a manually specified "+("`to."+t+"` field ["+JSON.stringify(r)+"].  Please separate it out to the ")+("`to."+n+"` field. Alternatively you may provide the full path as ")+'a string in <Link to="..."> and the router will parse it for you.'}function Ip(e){return e.filter((t,n)=>n===0||t.route.path&&t.route.path.length>0)}function Y0(e,t,n,r){r===void 0&&(r=!1);let i;typeof e=="string"?i=xr(e):(i=Ae({},e),ke(!i.pathname||!i.pathname.includes("?"),zd("?","pathname","search",i)),ke(!i.pathname||!i.pathname.includes("#"),zd("#","pathname","hash",i)),ke(!i.search||!i.search.includes("#"),zd("#","search","hash",i)));let a=e===""||i.pathname==="",l=a?"/":i.pathname,u;if(r||l==null)u=n;else{let m=t.length-1;if(l.startsWith("..")){let p=l.split("/");for(;p[0]==="..";)p.shift(),m-=1;i.pathname=p.join("/")}u=m>=0?t[m]:"/"}let d=TP(i,u),f=l&&l!=="/"&&l.endsWith("/"),_=(a||l===".")&&n.endsWith("/");return!d.pathname.endsWith("/")&&(f||_)&&(d.pathname+="/"),d}const Gr=e=>e.join("/").replace(/\/\/+/g,"/"),RP=e=>e.replace(/\/+$/,"").replace(/^\/*/,"/"),zP=e=>!e||e==="?"?"":e.startsWith("?")?e:"?"+e,AP=e=>!e||e==="#"?"":e.startsWith("#")?e:"#"+e;class xv extends Error{}class BP{constructor(t,n){this.pendingKeysSet=new Set,this.subscribers=new Set,this.deferredKeys=[],ke(t&&typeof t=="object"&&!Array.isArray(t),"defer() only accepts plain objects");let r;this.abortPromise=new Promise((a,l)=>r=l),this.controller=new AbortController;let i=()=>r(new xv("Deferred data aborted"));this.unlistenAbortSignal=()=>this.controller.signal.removeEventListener("abort",i),this.controller.signal.addEventListener("abort",i),this.data=Object.entries(t).reduce((a,l)=>{let[u,d]=l;return Object.assign(a,{[u]:this.trackPromise(u,d)})},{}),this.done&&this.unlistenAbortSignal(),this.init=n}trackPromise(t,n){if(!(n instanceof Promise))return n;this.deferredKeys.push(t),this.pendingKeysSet.add(t);let r=Promise.race([n,this.abortPromise]).then(i=>this.onSettle(r,t,null,i),i=>this.onSettle(r,t,i));return r.catch(()=>{}),Object.defineProperty(r,"_tracked",{get:()=>!0}),r}onSettle(t,n,r,i){return this.controller.signal.aborted&&r instanceof xv?(this.unlistenAbortSignal(),Object.defineProperty(t,"_error",{get:()=>r}),Promise.reject(r)):(this.pendingKeysSet.delete(n),this.done&&this.unlistenAbortSignal(),r?(Object.defineProperty(t,"_error",{get:()=>r}),this.emit(!1,n),Promise.reject(r)):(Object.defineProperty(t,"_data",{get:()=>i}),this.emit(!1,n),i))}emit(t,n){this.subscribers.forEach(r=>r(t,n))}subscribe(t){return this.subscribers.add(t),()=>this.subscribers.delete(t)}cancel(){this.controller.abort(),this.pendingKeysSet.forEach((t,n)=>this.pendingKeysSet.delete(n)),this.emit(!0)}async resolveData(t){let n=!1;if(!this.done){let r=()=>this.cancel();t.addEventListener("abort",r),n=await new Promise(i=>{this.subscribe(a=>{t.removeEventListener("abort",r),(a||this.done)&&i(a)})})}return n}get done(){return this.pendingKeysSet.size===0}get unwrappedData(){return ke(this.data!==null&&this.done,"Can only unwrap data on initialized and settled deferreds"),Object.entries(this.data).reduce((t,n)=>{let[r,i]=n;return Object.assign(t,{[r]:IP(i)})},{})}get pendingKeys(){return Array.from(this.pendingKeysSet)}}function NP(e){return e instanceof Promise&&e._tracked===!0}function IP(e){if(!NP(e))return e;if(e._error)throw e._error;return e._data}class Mp{constructor(t,n,r,i){i===void 0&&(i=!1),this.status=t,this.statusText=n||"",this.internal=i,r instanceof Error?(this.data=r.toString(),this.error=r):this.data=r}}function e1(e){return e!=null&&typeof e.status=="number"&&typeof e.statusText=="string"&&typeof e.internal=="boolean"&&"data"in e}const t1=["post","put","patch","delete"],MP=new Set(t1),DP=["get",...t1],FP=new Set(DP),jP=new Set([301,302,303,307,308]),UP=new Set([307,308]),Ad={state:"idle",location:void 0,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0},$P={state:"idle",data:void 0,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0},wv={state:"unblocked",proceed:void 0,reset:void 0,location:void 0},n1=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,r1=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u",ZP=!r1;function HP(e){ke(e.routes.length>0,"You must provide a non-empty routes array to createRouter");let t=Q0(e.routes),n=null,r=new Set,i=null,a=null,l=null,u=e.hydrationData!=null,d=Oa(t,e.history.location,e.basename),f=null;if(d==null){let $=zr(404,{pathname:e.history.location.pathname}),{matches:H,route:G}=Ov(t);d=H,f={[G.id]:$}}let _=!d.some($=>$.route.loader)||e.hydrationData!=null,m,p={historyAction:e.history.action,location:e.history.location,matches:d,initialized:_,navigation:Ad,restoreScrollPosition:e.hydrationData!=null?!1:null,preventScrollReset:!1,revalidation:"idle",loaderData:e.hydrationData&&e.hydrationData.loaderData||{},actionData:e.hydrationData&&e.hydrationData.actionData||null,errors:e.hydrationData&&e.hydrationData.errors||f,fetchers:new Map,blockers:new Map},g=lt.Pop,x=!1,w,C=!1,y=!1,b=[],S=[],P=new Map,z=0,M=-1,F=new Map,j=new Set,W=new Map,T=new Map,Q=new Map,ae=!1;function me(){return n=e.history.listen($=>{let{action:H,location:G,delta:se}=$;if(ae){ae=!1;return}ls(Q.size===0||se!=null,"You are trying to use a blocker on a POP navigation to a location that was not created by @remix-run/router. This will fail silently in production. This can happen if you are navigating outside the router via `window.history.pushState`/`window.location.hash` instead of using router navigation APIs.  This can also happen if you are using createHashRouter and the user manually changes the URL.");let oe=Nn({currentLocation:p.location,nextLocation:G,historyAction:H});if(oe&&se!=null){ae=!0,e.history.go(se*-1),Ct(oe,{state:"blocked",location:G,proceed(){Ct(oe,{state:"proceeding",proceed:void 0,reset:void 0,location:G}),e.history.go(se)},reset(){ze(oe),U({blockers:new Map(m.state.blockers)})}});return}return V(H,G)}),p.initialized||V(lt.Pop,p.location),m}function ne(){n&&n(),r.clear(),w&&w.abort(),p.fetchers.forEach(($,H)=>Fe(H)),p.blockers.forEach(($,H)=>ze(H))}function fe($){return r.add($),()=>r.delete($)}function U($){p=Ae({},p,$),r.forEach(H=>H(p))}function ee($,H){var G,se;let oe=p.actionData!=null&&p.navigation.formMethod!=null&&sr(p.navigation.formMethod)&&p.navigation.state==="loading"&&((G=$.state)==null?void 0:G._isRedirect)!==!0,ve;H.actionData?Object.keys(H.actionData).length>0?ve=H.actionData:ve=null:oe?ve=p.actionData:ve=null;let he=H.loaderData?Ev(p.loaderData,H.loaderData,H.matches||[],H.errors):p.loaderData;for(let[pe]of Q)ze(pe);let ye=x===!0||p.navigation.formMethod!=null&&sr(p.navigation.formMethod)&&((se=$.state)==null?void 0:se._isRedirect)!==!0;U(Ae({},H,{actionData:ve,loaderData:he,historyAction:g,location:$,initialized:!0,navigation:Ad,revalidation:"idle",restoreScrollPosition:kr($,H.matches||p.matches),preventScrollReset:ye,blockers:new Map(p.blockers)})),C||g===lt.Pop||(g===lt.Push?e.history.push($,$.state):g===lt.Replace&&e.history.replace($,$.state)),g=lt.Pop,x=!1,C=!1,y=!1,b=[],S=[]}async function I($,H){if(typeof $=="number"){e.history.go($);return}let{path:G,submission:se,error:oe}=kv($,H),ve=p.location,he=ss(p.location,G,H&&H.state);he=Ae({},he,e.history.encodeLocation(he));let ye=H&&H.replace!=null?H.replace:void 0,pe=lt.Push;ye===!0?pe=lt.Replace:ye===!1||se!=null&&sr(se.formMethod)&&se.formAction===p.location.pathname+p.location.search&&(pe=lt.Replace);let it=H&&"preventScrollReset"in H?H.preventScrollReset===!0:void 0,xe=Nn({currentLocation:ve,nextLocation:he,historyAction:pe});if(xe){Ct(xe,{state:"blocked",location:he,proceed(){Ct(xe,{state:"proceeding",proceed:void 0,reset:void 0,location:he}),I($,H)},reset(){ze(xe),U({blockers:new Map(p.blockers)})}});return}return await V(pe,he,{submission:se,pendingError:oe,preventScrollReset:it,replace:H&&H.replace})}function re(){if(Ye(),U({revalidation:"loading"}),p.navigation.state!=="submitting"){if(p.navigation.state==="idle"){V(p.historyAction,p.location,{startUninterruptedRevalidation:!0});return}V(g||p.historyAction,p.navigation.location,{overrideNavigation:p.navigation})}}async function V($,H,G){w&&w.abort(),w=null,g=$,C=(G&&G.startUninterruptedRevalidation)===!0,Bt(p.location,p.matches),x=(G&&G.preventScrollReset)===!0;let se=G&&G.overrideNavigation,oe=Oa(t,H,e.basename);if(!oe){let je=zr(404,{pathname:H.pathname}),{matches:Nt,route:gt}=Ov(t);$t(),ee(H,{matches:Nt,loaderData:{},errors:{[gt.id]:je}});return}if(QP(p.location,H)&&!(G&&G.submission&&sr(G.submission.formMethod))){ee(H,{matches:oe});return}w=new AbortController;let ve=xa(e.history,H,w.signal,G&&G.submission),he,ye;if(G&&G.pendingError)ye={[xi(oe).route.id]:G.pendingError};else if(G&&G.submission&&sr(G.submission.formMethod)){let je=await O(ve,H,G.submission,oe,{replace:G.replace});if(je.shortCircuited)return;he=je.pendingActionData,ye=je.pendingActionError,se=Ae({state:"loading",location:H},G.submission),ve=new Request(ve.url,{signal:ve.signal})}let{shortCircuited:pe,loaderData:it,errors:xe}=await N(ve,H,oe,se,G&&G.submission,G&&G.replace,he,ye);pe||(w=null,ee(H,Ae({matches:oe},he?{actionData:he}:{},{loaderData:it,errors:xe})))}async function O($,H,G,se,oe){Ye();let ve=Ae({state:"submitting",location:H},G);U({navigation:ve});let he,ye=zv(se,H);if(!ye.route.action)he={type:wt.error,error:zr(405,{method:$.method,pathname:H.pathname,routeId:ye.route.id})};else if(he=await ba("action",$,ye,se,m.basename),$.signal.aborted)return{shortCircuited:!0};if(Oi(he)){let pe;return oe&&oe.replace!=null?pe=oe.replace:pe=he.location===p.location.pathname+p.location.search,await ue(p,he,{submission:G,replace:pe}),{shortCircuited:!0}}if(Fa(he)){let pe=xi(se,ye.route.id);return(oe&&oe.replace)!==!0&&(g=lt.Push),{pendingActionData:{},pendingActionError:{[pe.route.id]:he.error}}}if(Lo(he))throw zr(400,{type:"defer-action"});return{pendingActionData:{[ye.route.id]:he.data}}}async function N($,H,G,se,oe,ve,he,ye){let pe=se;pe||(pe=Ae({state:"loading",location:H,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0},oe));let it=oe||(pe.formMethod&&pe.formAction&&pe.formData&&pe.formEncType?{formMethod:pe.formMethod,formAction:pe.formAction,formData:pe.formData,formEncType:pe.formEncType}:void 0),[xe,je]=Sv(e.history,p,G,it,H,y,b,S,he,ye,W);if($t(pt=>!(G&&G.some(rn=>rn.route.id===pt))||xe&&xe.some(rn=>rn.route.id===pt)),xe.length===0&&je.length===0)return ee(H,Ae({matches:G,loaderData:{},errors:ye||null},he?{actionData:he}:{})),{shortCircuited:!0};if(!C){je.forEach(rn=>{let er=p.fetchers.get(rn.key),Go={state:"loading",data:er&&er.data,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0," _hasFetcherDoneAnything ":!0};p.fetchers.set(rn.key,Go)});let pt=he||p.actionData;U(Ae({navigation:pe},pt?Object.keys(pt).length===0?{actionData:null}:{actionData:pt}:{},je.length>0?{fetchers:new Map(p.fetchers)}:{}))}M=++z,je.forEach(pt=>P.set(pt.key,w));let{results:Nt,loaderResults:gt,fetcherResults:ho}=await _e(p.matches,G,xe,je,$);if($.signal.aborted)return{shortCircuited:!0};je.forEach(pt=>P.delete(pt.key));let Ko=Tv(Nt);if(Ko)return await ue(p,Ko,{replace:ve}),{shortCircuited:!0};let{loaderData:po,errors:Yn}=Cv(p,G,xe,gt,ye,je,ho,T);T.forEach((pt,rn)=>{pt.subscribe(er=>{(er||pt.done)&&T.delete(rn)})}),Oe();let Qo=Kt(M);return Ae({loaderData:po,errors:Yn},Qo||je.length>0?{fetchers:new Map(p.fetchers)}:{})}function B($){return p.fetchers.get($)||$P}function K($,H,G,se){if(ZP)throw new Error("router.fetch() was called during the server render, but it shouldn't be. You are likely calling a useFetcher() method in the body of your component. Try moving it to a useEffect or a callback.");P.has($)&&Ne($);let oe=Oa(t,G,e.basename);if(!oe){qe($,H,zr(404,{pathname:G}));return}let{path:ve,submission:he}=kv(G,se,!0),ye=zv(oe,ve);if(x=(se&&se.preventScrollReset)===!0,he&&sr(he.formMethod)){Y($,H,ve,ye,oe,he);return}W.set($,{routeId:H,path:ve,match:ye,matches:oe}),te($,H,ve,ye,oe,he)}async function Y($,H,G,se,oe,ve){if(Ye(),W.delete($),!se.route.action){let _n=zr(405,{method:ve.formMethod,pathname:G,routeId:H});qe($,H,_n);return}let he=p.fetchers.get($),ye=Ae({state:"submitting"},ve,{data:he&&he.data," _hasFetcherDoneAnything ":!0});p.fetchers.set($,ye),U({fetchers:new Map(p.fetchers)});let pe=new AbortController,it=xa(e.history,G,pe.signal,ve);P.set($,pe);let xe=await ba("action",it,se,oe,m.basename);if(it.signal.aborted){P.get($)===pe&&P.delete($);return}if(Oi(xe)){P.delete($),j.add($);let _n=Ae({state:"loading"},ve,{data:void 0," _hasFetcherDoneAnything ":!0});return p.fetchers.set($,_n),U({fetchers:new Map(p.fetchers)}),ue(p,xe,{isFetchActionRedirect:!0})}if(Fa(xe)){qe($,H,xe.error);return}if(Lo(xe))throw zr(400,{type:"defer-action"});let je=p.navigation.location||p.location,Nt=xa(e.history,je,pe.signal),gt=p.navigation.state!=="idle"?Oa(t,p.navigation.location,e.basename):p.matches;ke(gt,"Didn't find any matches after fetcher action");let ho=++z;F.set($,ho);let Ko=Ae({state:"loading",data:xe.data},ve,{" _hasFetcherDoneAnything ":!0});p.fetchers.set($,Ko);let[po,Yn]=Sv(e.history,p,gt,ve,je,y,b,S,{[se.route.id]:xe.data},void 0,W);Yn.filter(_n=>_n.key!==$).forEach(_n=>{let Yi=_n.key,Os=p.fetchers.get(Yi),zc={state:"loading",data:Os&&Os.data,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0," _hasFetcherDoneAnything ":!0};p.fetchers.set(Yi,zc),P.set(Yi,pe)}),U({fetchers:new Map(p.fetchers)});let{results:Qo,loaderResults:pt,fetcherResults:rn}=await _e(p.matches,gt,po,Yn,Nt);if(pe.signal.aborted)return;F.delete($),P.delete($),Yn.forEach(_n=>P.delete(_n.key));let er=Tv(Qo);if(er)return ue(p,er);let{loaderData:Go,errors:Xi}=Cv(p,p.matches,po,pt,void 0,Yn,rn,T),Rc={state:"idle",data:xe.data,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0," _hasFetcherDoneAnything ":!0};p.fetchers.set($,Rc);let Ji=Kt(ho);p.navigation.state==="loading"&&ho>M?(ke(g,"Expected pending action"),w&&w.abort(),ee(p.navigation.location,{matches:gt,loaderData:Go,errors:Xi,fetchers:new Map(p.fetchers)})):(U(Ae({errors:Xi,loaderData:Ev(p.loaderData,Go,gt,Xi)},Ji?{fetchers:new Map(p.fetchers)}:{})),y=!1)}async function te($,H,G,se,oe,ve){let he=p.fetchers.get($),ye=Ae({state:"loading",formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0},ve,{data:he&&he.data," _hasFetcherDoneAnything ":!0});p.fetchers.set($,ye),U({fetchers:new Map(p.fetchers)});let pe=new AbortController,it=xa(e.history,G,pe.signal);P.set($,pe);let xe=await ba("loader",it,se,oe,m.basename);if(Lo(xe)&&(xe=await s1(xe,it.signal,!0)||xe),P.get($)===pe&&P.delete($),it.signal.aborted)return;if(Oi(xe)){await ue(p,xe);return}if(Fa(xe)){let Nt=xi(p.matches,H);p.fetchers.delete($),U({fetchers:new Map(p.fetchers),errors:{[Nt.route.id]:xe.error}});return}ke(!Lo(xe),"Unhandled fetcher deferred data");let je={state:"idle",data:xe.data,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0," _hasFetcherDoneAnything ":!0};p.fetchers.set($,je),U({fetchers:new Map(p.fetchers)})}async function ue($,H,G){var se;let{submission:oe,replace:ve,isFetchActionRedirect:he}=G===void 0?{}:G;H.revalidate&&(y=!0);let ye=ss($.location,H.location,Ae({_isRedirect:!0},he?{_isFetchActionRedirect:!0}:{}));if(ke(ye,"Expected a location on the redirect navigation"),n1.test(H.location)&&r1&&typeof((se=window)==null?void 0:se.location)<"u"){let gt=e.history.createURL(H.location).origin;if(window.location.origin!==gt){ve?window.location.replace(H.location):window.location.assign(H.location);return}}w=null;let pe=ve===!0?lt.Replace:lt.Push,{formMethod:it,formAction:xe,formEncType:je,formData:Nt}=$.navigation;!oe&&it&&xe&&Nt&&je&&(oe={formMethod:it,formAction:xe,formEncType:je,formData:Nt}),UP.has(H.status)&&oe&&sr(oe.formMethod)?await V(pe,ye,{submission:Ae({},oe,{formAction:H.location}),preventScrollReset:x}):await V(pe,ye,{overrideNavigation:{state:"loading",location:ye,formMethod:oe?oe.formMethod:void 0,formAction:oe?oe.formAction:void 0,formEncType:oe?oe.formEncType:void 0,formData:oe?oe.formData:void 0},preventScrollReset:x})}async function _e($,H,G,se,oe){let ve=await Promise.all([...G.map(pe=>ba("loader",oe,pe,H,m.basename)),...se.map(pe=>ba("loader",xa(e.history,pe.path,oe.signal),pe.match,pe.matches,m.basename))]),he=ve.slice(0,G.length),ye=ve.slice(G.length);return await Promise.all([Lv($,G,he,oe.signal,!1,p.loaderData),Lv($,se.map(pe=>pe.match),ye,oe.signal,!0)]),{results:ve,loaderResults:he,fetcherResults:ye}}function Ye(){y=!0,b.push(...$t()),W.forEach(($,H)=>{P.has(H)&&(S.push(H),Ne(H))})}function qe($,H,G){let se=xi(p.matches,H);Fe($),U({errors:{[se.route.id]:G},fetchers:new Map(p.fetchers)})}function Fe($){P.has($)&&Ne($),W.delete($),F.delete($),j.delete($),p.fetchers.delete($)}function Ne($){let H=P.get($);ke(H,"Expected fetch controller: "+$),H.abort(),P.delete($)}function nt($){for(let H of $){let se={state:"idle",data:B(H).data,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0," _hasFetcherDoneAnything ":!0};p.fetchers.set(H,se)}}function Oe(){let $=[];for(let H of j){let G=p.fetchers.get(H);ke(G,"Expected fetcher: "+H),G.state==="loading"&&(j.delete(H),$.push(H))}nt($)}function Kt($){let H=[];for(let[G,se]of F)if(se<$){let oe=p.fetchers.get(G);ke(oe,"Expected fetcher: "+G),oe.state==="loading"&&(Ne(G),F.delete(G),H.push(G))}return nt(H),H.length>0}function Ut($,H){let G=p.blockers.get($)||wv;return Q.get($)!==H&&Q.set($,H),G}function ze($){p.blockers.delete($),Q.delete($)}function Ct($,H){let G=p.blockers.get($)||wv;ke(G.state==="unblocked"&&H.state==="blocked"||G.state==="blocked"&&H.state==="blocked"||G.state==="blocked"&&H.state==="proceeding"||G.state==="blocked"&&H.state==="unblocked"||G.state==="proceeding"&&H.state==="unblocked","Invalid blocker state transition: "+G.state+" -> "+H.state),p.blockers.set($,H),U({blockers:new Map(p.blockers)})}function Nn($){let{currentLocation:H,nextLocation:G,historyAction:se}=$;if(Q.size===0)return;Q.size>1&&ls(!1,"A router only supports one blocker at a time");let oe=Array.from(Q.entries()),[ve,he]=oe[oe.length-1],ye=p.blockers.get(ve);if(!(ye&&ye.state==="proceeding")&&he({currentLocation:H,nextLocation:G,historyAction:se}))return ve}function $t($){let H=[];return T.forEach((G,se)=>{(!$||$(se))&&(G.cancel(),H.push(se),T.delete(se))}),H}function Jn($,H,G){if(i=$,l=H,a=G||(se=>se.key),!u&&p.navigation===Ad){u=!0;let se=kr(p.location,p.matches);se!=null&&U({restoreScrollPosition:se})}return()=>{i=null,l=null,a=null}}function Bt($,H){if(i&&a&&l){let G=H.map(oe=>Rv(oe,p.loaderData)),se=a($,G)||$.key;i[se]=l()}}function kr($,H){if(i&&a&&l){let G=H.map(ve=>Rv(ve,p.loaderData)),se=a($,G)||$.key,oe=i[se];if(typeof oe=="number")return oe}return null}return m={get basename(){return e.basename},get state(){return p},get routes(){return t},initialize:me,subscribe:fe,enableScrollRestoration:Jn,navigate:I,fetch:K,revalidate:re,createHref:$=>e.history.createHref($),encodeLocation:$=>e.history.encodeLocation($),getFetcher:B,deleteFetcher:Fe,dispose:ne,getBlocker:Ut,deleteBlocker:ze,_internalFetchControllers:P,_internalActiveDeferreds:T},m}function WP(e){return e!=null&&"formData"in e}function kv(e,t,n){n===void 0&&(n=!1);let r=typeof e=="string"?e:$o(e);if(!t||!WP(t))return{path:r};if(t.formMethod&&!XP(t.formMethod))return{path:r,error:zr(405,{method:t.formMethod})};let i;if(t.formData&&(i={formMethod:t.formMethod||"get",formAction:a1(r),formEncType:t&&t.formEncType||"application/x-www-form-urlencoded",formData:t.formData},sr(i.formMethod)))return{path:r,submission:i};let a=xr(r),l=i1(t.formData);return n&&a.search&&l1(a.search)&&l.append("index",""),a.search="?"+l,{path:$o(a),submission:i}}function VP(e,t){let n=e;if(t){let r=e.findIndex(i=>i.route.id===t);r>=0&&(n=e.slice(0,r))}return n}function Sv(e,t,n,r,i,a,l,u,d,f,_){let m=f?Object.values(f)[0]:d?Object.values(d)[0]:void 0,p=e.createURL(t.location),g=e.createURL(i),x=a||p.toString()===g.toString()||p.search!==g.search,w=f?Object.keys(f)[0]:void 0,y=VP(n,w).filter((S,P)=>{if(S.route.loader==null)return!1;if(qP(t.loaderData,t.matches[P],S)||l.some(F=>F===S.route.id))return!0;let z=t.matches[P],M=S;return Pv(S,Ae({currentUrl:p,currentParams:z.params,nextUrl:g,nextParams:M.params},r,{actionResult:m,defaultShouldRevalidate:x||o1(z,M)}))}),b=[];return _&&_.forEach((S,P)=>{if(n.some(z=>z.route.id===S.routeId))u.includes(P)?b.push(Ae({key:P},S)):Pv(S.match,Ae({currentUrl:p,currentParams:t.matches[t.matches.length-1].params,nextUrl:g,nextParams:n[n.length-1].params},r,{actionResult:m,defaultShouldRevalidate:x}))&&b.push(Ae({key:P},S));else return}),[y,b]}function qP(e,t,n){let r=!t||n.route.id!==t.route.id,i=e[n.route.id]===void 0;return r||i}function o1(e,t){let n=e.route.path;return e.pathname!==t.pathname||n!=null&&n.endsWith("*")&&e.params["*"]!==t.params["*"]}function Pv(e,t){if(e.route.shouldRevalidate){let n=e.route.shouldRevalidate(t);if(typeof n=="boolean")return n}return t.defaultShouldRevalidate}async function ba(e,t,n,r,i,a,l,u){i===void 0&&(i="/"),a===void 0&&(a=!1),l===void 0&&(l=!1);let d,f,_,m=new Promise((g,x)=>_=x),p=()=>_();t.signal.addEventListener("abort",p);try{let g=n.route[e];ke(g,"Could not find the "+e+' to run on the "'+n.route.id+'" route'),f=await Promise.race([g({request:t,params:n.params,context:u}),m]),ke(f!==void 0,"You defined "+(e==="action"?"an action":"a loader")+" for route "+('"'+n.route.id+"\" but didn't return anything from your `"+e+"` ")+"function. Please return a value or `null`.")}catch(g){d=wt.error,f=g}finally{t.signal.removeEventListener("abort",p)}if(GP(f)){let g=f.status;if(jP.has(g)){let C=f.headers.get("Location");if(ke(C,"Redirects returned/thrown from loaders/actions must have a Location header"),n1.test(C)){if(!a){let y=new URL(t.url),b=C.startsWith("//")?new URL(y.protocol+C):new URL(C);b.origin===y.origin&&(C=b.pathname+b.search+b.hash)}}else{let y=r.slice(0,r.indexOf(n)+1),b=Ip(y).map(P=>P.pathnameBase),S=Y0(C,b,new URL(t.url).pathname);if(ke($o(S),"Unable to resolve redirect location: "+C),i){let P=S.pathname;S.pathname=P==="/"?i:Gr([i,P])}C=$o(S)}if(a)throw f.headers.set("Location",C),f;return{type:wt.redirect,status:g,location:C,revalidate:f.headers.get("X-Remix-Revalidate")!==null}}if(l)throw{type:d||wt.data,response:f};let x,w=f.headers.get("Content-Type");return w&&/\bapplication\/json\b/.test(w)?x=await f.json():x=await f.text(),d===wt.error?{type:d,error:new Mp(g,f.statusText,x),headers:f.headers}:{type:wt.data,data:x,statusCode:f.status,headers:f.headers}}return d===wt.error?{type:d,error:f}:f instanceof BP?{type:wt.deferred,deferredData:f}:{type:wt.data,data:f}}function xa(e,t,n,r){let i=e.createURL(a1(t)).toString(),a={signal:n};if(r&&sr(r.formMethod)){let{formMethod:l,formEncType:u,formData:d}=r;a.method=l.toUpperCase(),a.body=u==="application/x-www-form-urlencoded"?i1(d):d}return new Request(i,a)}function i1(e){let t=new URLSearchParams;for(let[n,r]of e.entries())t.append(n,r instanceof File?r.name:r);return t}function KP(e,t,n,r,i){let a={},l=null,u,d=!1,f={};return n.forEach((_,m)=>{let p=t[m].route.id;if(ke(!Oi(_),"Cannot handle redirect results in processLoaderData"),Fa(_)){let g=xi(e,p),x=_.error;r&&(x=Object.values(r)[0],r=void 0),l=l||{},l[g.route.id]==null&&(l[g.route.id]=x),a[p]=void 0,d||(d=!0,u=e1(_.error)?_.error.status:500),_.headers&&(f[p]=_.headers)}else Lo(_)?(i.set(p,_.deferredData),a[p]=_.deferredData.data):a[p]=_.data,_.statusCode!=null&&_.statusCode!==200&&!d&&(u=_.statusCode),_.headers&&(f[p]=_.headers)}),r&&(l=r,a[Object.keys(r)[0]]=void 0),{loaderData:a,errors:l,statusCode:u||200,loaderHeaders:f}}function Cv(e,t,n,r,i,a,l,u){let{loaderData:d,errors:f}=KP(t,n,r,i,u);for(let _=0;_<a.length;_++){let{key:m,match:p}=a[_];ke(l!==void 0&&l[_]!==void 0,"Did not find corresponding fetcher result");let g=l[_];if(Fa(g)){let x=xi(e.matches,p.route.id);f&&f[x.route.id]||(f=Ae({},f,{[x.route.id]:g.error})),e.fetchers.delete(m)}else if(Oi(g))ke(!1,"Unhandled fetcher revalidation redirect");else if(Lo(g))ke(!1,"Unhandled fetcher deferred data");else{let x={state:"idle",data:g.data,formMethod:void 0,formAction:void 0,formEncType:void 0,formData:void 0," _hasFetcherDoneAnything ":!0};e.fetchers.set(m,x)}}return{loaderData:d,errors:f}}function Ev(e,t,n,r){let i=Ae({},t);for(let a of n){let l=a.route.id;if(t.hasOwnProperty(l)?t[l]!==void 0&&(i[l]=t[l]):e[l]!==void 0&&(i[l]=e[l]),r&&r.hasOwnProperty(l))break}return i}function xi(e,t){return(t?e.slice(0,e.findIndex(r=>r.route.id===t)+1):[...e]).reverse().find(r=>r.route.hasErrorBoundary===!0)||e[0]}function Ov(e){let t=e.find(n=>n.index||!n.path||n.path==="/")||{id:"__shim-error-route__"};return{matches:[{params:{},pathname:"",pathnameBase:"",route:t}],route:t}}function zr(e,t){let{pathname:n,routeId:r,method:i,type:a}=t===void 0?{}:t,l="Unknown Server Error",u="Unknown @remix-run/router error";return e===400?(l="Bad Request",i&&n&&r?u="You made a "+i+' request to "'+n+'" but '+('did not provide a `loader` for route "'+r+'", ')+"so there is no way to handle the request.":a==="defer-action"&&(u="defer() is not supported in actions")):e===403?(l="Forbidden",u='Route "'+r+'" does not match URL "'+n+'"'):e===404?(l="Not Found",u='No route matches URL "'+n+'"'):e===405&&(l="Method Not Allowed",i&&n&&r?u="You made a "+i.toUpperCase()+' request to "'+n+'" but '+('did not provide an `action` for route "'+r+'", ')+"so there is no way to handle the request.":i&&(u='Invalid request method "'+i.toUpperCase()+'"')),new Mp(e||500,l,new Error(u),!0)}function Tv(e){for(let t=e.length-1;t>=0;t--){let n=e[t];if(Oi(n))return n}}function a1(e){let t=typeof e=="string"?xr(e):e;return $o(Ae({},t,{hash:""}))}function QP(e,t){return e.pathname===t.pathname&&e.search===t.search&&e.hash!==t.hash}function Lo(e){return e.type===wt.deferred}function Fa(e){return e.type===wt.error}function Oi(e){return(e&&e.type)===wt.redirect}function GP(e){return e!=null&&typeof e.status=="number"&&typeof e.statusText=="string"&&typeof e.headers=="object"&&typeof e.body<"u"}function XP(e){return FP.has(e)}function sr(e){return MP.has(e)}async function Lv(e,t,n,r,i,a){for(let l=0;l<n.length;l++){let u=n[l],d=t[l],f=e.find(m=>m.route.id===d.route.id),_=f!=null&&!o1(f,d)&&(a&&a[d.route.id])!==void 0;Lo(u)&&(i||_)&&await s1(u,r,i).then(m=>{m&&(n[l]=m||n[l])})}}async function s1(e,t,n){if(n===void 0&&(n=!1),!await e.deferredData.resolveData(t)){if(n)try{return{type:wt.data,data:e.deferredData.unwrappedData}}catch(i){return{type:wt.error,error:i}}return{type:wt.data,data:e.deferredData.data}}}function l1(e){return new URLSearchParams(e).getAll("index").some(t=>t==="")}function Rv(e,t){let{route:n,pathname:r,params:i}=e;return{id:n.id,pathname:r,params:i,data:t[n.id],handle:n.handle}}function zv(e,t){let n=typeof t=="string"?xr(t).search:t.search;if(e[e.length-1].route.index&&l1(n||""))return e[e.length-1];let r=Ip(e);return r[r.length-1]}/**
 * React Router v6.8.1
 *
 * Copyright (c) Remix Software Inc.
 *
...
`);const Sg=({children:e})=>Z.createElement("div",{className:Ti(zO["page-content"])},e);var _h;Ce(`.List-module_list__9aWGq {
  padding-left: 0;
...
`),function(e){e.Header="header",e.Body="body",e.Footer="footer"}(vh||(vh={})),function(e){e.Descending="desc",e.Ascending="asc",e.NotSortable="notSortable",e.NotActive="notActive"}(Og||(Og={}));R.createContext(void 0);R.createContext({variantStandard:vh.Body});Ce(`.TableHeader-module_table-header__mrqgB {
  background: #f5f5f5;
  flex: none;
  order: 1;
  align-self: stretch;
...
.Button-module_button__2ZuB7.Button-module_quiet__1KlhF.Button-module_inverted__VD6YO:focus-visible {\r
    outline-color: var(--colors-white);\r
}`),function(e){e.Small="small",e.Medium="medium",e.Large="large"}(yh||(yh={})),function(e){e.Primary="primary",e.Secondary="secondary",e.Success="success",e.Danger="danger",e.Inverted="inverted"}(bh||(bh={})),function(e){e.Filled="filled",e.Outline="outline",e.Quiet="quiet"}(xh||(xh={}));const R1=(e,t)=>{var{children:n,color:r=bh.Primary,variant:i=xh.Filled,size:a=yh.Small,fullWidth:l=!1,dashedBorder:u=!1,iconPlacement:d="left",icon:f,type:_="button",className:m}=e,p=Ki(e,["children","color","variant","size","fullWidth","dashedBorder","iconPlacement","icon","type","className"]);return Z.createElement("button",Object.assign({},p,{ref:t,className:St(ir.button,ir[a],ir[i],ir[r],{[ir.fullWidth]:l},{[ir.dashedBorder]:u},{[ir.onlyIcon]:!n&&f},m),type:_}),f&&d==="left"&&Z.createElement(gh,{svgIconComponent:f,className:ir.icon}),n,f&&d==="right"&&Z.createElement(gh,{svgIconComponent:f,className:ir.icon}))};R1.displayName="Button";R.forwardRef(R1);var jO="ErrorMessage-module_errorMessageWrapper__rSdCu";ct(`.ErrorMessage-module_errorMessageWrapper__rSdCu {\r
  color: var(--component-error_message-color-text);\r
  font-size: var(--component-error_message-font_size-xs);\r
}\r
`);const z1=({id:e,children:t,ariaLabel:n})=>Z.createElement("div",{"aria-label":n,className:jO,"data-testid":"ErrorMessage",id:e,role:"alertdialog"},t);function Mg(e,t){R.useEffect(()=>(document.addEventListener(e,t),()=>document.removeEventListener(e,t)),[e,t])}function Ud(e,t){R.useEffect(()=>{const n=r=>{r.key===e&&t()};return document.addEventListener("keydown",n),()=>document.removeEventListener("keydown",n)},[e,t])}function UO(e){const t=R.useRef();return R.useEffect(()=>{t.current=e},[e]),t.current}z1.displayName="ErrorMessage";const Wp=(e,t)=>{const n=R.useRef(!0);R.useEffect(()=>{if(!n.current)return e();n.current=!1},t)};function A1(e,t){if(e===t)return!0;if(e===void 0||t===void 0||e.length!==t.length)return!1;for(const n in e)if(e[n]!==t[n])return!1;return!0}function B1(e){return e.length===new Set(e).size}var $O="Tabs-module_tabs__QzIkz",ZO="Tabs-module_tablist__WR6ag",HO="Tabs-module_tab__IdDYc",WO="Tabs-module_selected__TxfYv",VO="Tabs-module_divider__-r5Cd",qO="Tabs-module_tabpanel__0vR1c";ct(`@import 'https://altinncdn.no/fonts/altinn-din/altinn-din.css';\r
\r
...
`),function(e){e.Default="default",e.Info="info",e.Warning="warning",e.Danger="danger"}(Cu||(Cu={}));const X1=R.createContext(null),Gp=()=>{const e=R.useContext(X1);if(e==null)throw new Error("Popover components must be wrapped in <Popover />");return e};function J1(e){var{children:t,trigger:n,arrow:r=!0,initialOpen:i=!1}=e,a=Ki(e,["children","trigger","arrow","initialOpen"]);const l=vT(Object.assign({arrow:r,initialOpen:i},a));return Z.createElement(X1.Provider,{value:l},Z.createElement(gT,null,n),Z.createElement(yT,null,t,l.arrow&&Z.createElement(bT,null)))}J1.displayName="Popover";const gT=R.forwardRef(function(e,t){var{children:n}=e,r=Ki(e,["children"]);const i=Gp(),a=n.ref,l=Qp([i.reference,t,a]);return R.isValidElement(n)?R.cloneElement(n,i.getReferenceProps(Object.assign(Object.assign(Object.assign({ref:l},r),n.props),{"data-state":i.open?"open":"closed","aria-expanded":i.open}))):null}),yT=R.forwardRef(function(e,t){var n,r;const i=Gp(),a=Qp([i.floating,t]);return i.open?Z.createElement("div",Object.assign({ref:a,style:{position:i.strategy,top:(n=i.y)!==null&&n!==void 0?n:0,left:(r=i.x)!==null&&r!==void 0?r:0,width:"max-content"},"data-placement":i.placement,className:St(Sh.popover,Sh[i.variant],i.className)},i.getFloatingProps(e),{tabIndex:-1,role:"dialog"}),e.children):null}),bT=R.forwardRef(function(e,t){var n,r;const i=Gp(),a=Qp([i.arrowRef,t]),l=(n=i.middlewareData.arrow)===null||n===void 0?void 0:n.x,u=(r=i.middlewareData.arrow)===null||r===void 0?void 0:r.y,d={top:"bottom",right:"left",bottom:"top",left:"right"}[i.placement.split("-")[0]];return Z.createElement("div",Object.assign({ref:a,style:Object.assign(Object.assign(Object.assign({},l!=null?{left:l}:{}),u!=null?{top:u}:{}),d?{[d]:"-7px"}:{}),className:Sh.arrow},e))});var xT="utility-module_visuallyHidden__R-C67";ct(`/**\r
...
`);const lr=({checkboxId:e,checked:t,compact:n,description:r,disabled:i,error:a,helpText:l,hideLabel:u,label:d,name:f,onChange:_,presentation:m,readOnly:p})=>Z.createElement(wT,{checked:t,className:St(kT,t&&CT,a&&PT,i&&ET,n&&ST,p&&OT),description:r,disabled:i,helpText:l,hideInput:p,hideLabel:u,inputId:e,label:d,name:f,onChange:_,presentation:m,size:n?ds.Xsmall:ds.Small,type:"checkbox"},Z.createElement("span",{className:TT},Z.createElement("span",{className:LT})));lr.displayName="Checkbox";var Ri,qd={checkboxGroup:"CheckboxGroup-module_checkboxGroup__LIGFC",compact:"CheckboxGroup-module_compact__IPuN8",vertical:"CheckboxGroup-module_vertical__R-l07",horizontal:"CheckboxGroup-module_horizontal__myCqF"};ct(`.CheckboxGroup-module_checkboxGroup__LIGFC {\r
...
`);var fs;(function(e){e.Primary="primary",e.Secondary="secondary"})(fs||(fs={}));const tx=R.createContext(void 0),Xp=()=>{const e=R.useContext(tx);if(e===void 0)throw new Error("useAccordionContext must be used within an AccordionContext");return e};var jT="Accordion-module_accordion__LVhhv";ct(`.Accordion-module_accordion__LVhhv {\r
...
`);const nx=({children:e,open:t,onClick:n,iconVariant:r=fs.Primary})=>{const i=R.useId(),a=R.useId();return Z.createElement("div",{className:jT},Z.createElement(tx.Provider,{value:{onClick:n,open:t,headerId:i,contentId:a,iconVariant:r}},e))};nx.displayName="Accordion";const rx=({children:e})=>{const{open:t,contentId:n,headerId:r}=Xp();return Z.createElement("div",null,t&&Z.createElement("div",{"aria-expanded":t,id:n,"aria-labelledby":r},e))};rx.displayName="AccordionContent";var UT="AccordionHeader-module_accordionHeader__nap0Y",$T="AccordionHeader-module_subtitle__CpDh7",ZT="AccordionHeader-module_withSubtitle__zCXnG",HT="AccordionHeader-module_title__3VVAA",WT="AccordionHeader-module_actions__WCBkS";ct(`.AccordionHeader-module_accordionHeader__nap0Y {\r
...
[redux-logger v3] to
[redux-logger v3] import { createLogger } from 'redux-logger'
`)};n.defaults=re,n.createLogger=j,n.logger=V,n.default=V,Object.defineProperty(n,"__esModule",{value:!0})})})(Lz,Nu);Nu.createLogger();const Rz=MR({reducer:{evsearchResult:QR}}),zz=e=>{if(e==="no_nb")return"no_nb";if(e==="en")return"en";if(e==="no_nn")return"no_nn"};JE(FC).init({lng:zz("no_nb"),fallbackLng:Oz("defaultLocale"),ns:["common"],defaultNS:"common",returnNull:!1},()=>{const e=new uE({defaultOptions:void 0});D0(document.getElementById("root")).render(ce(R.StrictMode,{children:ce(sP,{store:Rz,children:ce(mE,{client:e,children:ce(Tz,{children:ce(bC,{router:Pz})})})})}))});
