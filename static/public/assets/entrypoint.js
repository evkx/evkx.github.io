...
`);var fs;(function(e){e.Primary="primary",e.Secondary="secondary"})(fs||(fs={}));const tx=R.createContext(void 0),Gh=()=>{const e=R.useContext(tx);if(e===void 0)throw new Error("useAccordionContext must be used within an AccordionContext");return e};var jT="Accordion-module_accordion__LVhhv";ct(`.Accordion-module_accordion__LVhhv {\r
...
`);const nx=({children:e,open:t,onClick:n,iconVariant:r=fs.Primary})=>{const i=R.useId(),a=R.useId();return Z.createElement("div",{className:jT},Z.createElement(tx.Provider,{value:{onClick:n,open:t,headerId:i,contentId:a,iconVariant:r}},e))};nx.displayName="Accordion";const rx=({children:e})=>{const{open:t,contentId:n,headerId:r}=Gh();return Z.createElement("div",null,t&&Z.createElement("div",{"aria-expanded":t,id:n,"aria-labelledby":r},e))};rx.displayName="AccordionContent";var UT="AccordionHeader-module_accordionHeader__nap0Y",ry="AccordionHeader-module_subtitle__CpDh7",$T="AccordionHeader-module_title__3VVAA",ZT="AccordionHeader-module_actions__WCBkS";ct(`.AccordionHeader-module_accordionHeader__nap0Y {\r
